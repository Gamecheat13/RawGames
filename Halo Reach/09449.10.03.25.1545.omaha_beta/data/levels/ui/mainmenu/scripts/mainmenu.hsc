...
; Start time: 2018-06-28 4:27:38 PM
; 
...
(script static void exit_experience_flair
    ...
    (custom_animation "chief_exit" "objects\characters\spartans\spartans" "depot:rifle:flourish" true)
    (sleep (unit_get_custom_animation_time "chief_exit"))
    (unit_stop_custom_animation "chief_exit")
    (custom_animation_loop "chief_exit" "objects\characters\spartans\spartans" "combat:rifle:idle" true)
    (sleep_forever)
)
...
(script static void rank_up
    ...
    (custom_animation "chief_exit" "objects\characters\spartans\spartans" "depot:rifle:celebration" true)
    (sleep (unit_get_custom_animation_time "chief_exit"))
    (unit_stop_custom_animation "chief_exit")
    (custom_animation_loop "chief_exit" "objects\characters\spartans\spartans" "combat:rifle:idle" true)
    (sleep_forever)
...
(script static void elite_exit_experience_flair
    ...
    (custom_animation "elite_exit" "objects\characters\elite\elite" "depot:unarmed:experience_subgrade_up" true)
...
(script static void elite_subrank_up
    ...
    (sleep 30)
    (custom_animation "elite_exit" "objects\characters\elite\elite" "depot:rifle:experience_subgrade_up" true)
    (sleep (unit_get_custom_animation_time "elite_exit"))
    (unit_stop_custom_animation "elite_exit")
...
(script static void elite_rank_up
    ...
    (custom_animation "elite_exit" "objects\characters\elite\elite" "depot:rifle:flourish" true)
    (sleep (unit_get_custom_animation_time "elite_exit"))
    (unit_stop_custom_animation "elite_exit")
    (custom_animation_loop "elite_exit" "objects\characters\elite\elite" "depot:rifle:end_idle" true)
    (sleep_forever)
...
(script static void anim_depot_rifle_helmet
...
(script static void anim_depot_rifle_helmet_var1
    (custom_animation "chief_armory" "objects\characters\spartans\spartans" "depot:unarmed:helmet" true)
    (sleep (unit_get_custom_animation_time "chief_armory"))
    (unit_stop_custom_animation "chief_armory")
)

(script static void anim_depot_rifle_left_shoulder
    (custom_animation "chief_armory" "objects\characters\spartans\spartans" "depot:unarmed:left_shoulder" true)
    (sleep (unit_get_custom_animation_time "chief_armory"))
    (unit_stop_custom_animation "chief_armory")
)

(script static void anim_depot_rifle_left_shoulder_var1
    (custom_animation "chief_armory" "objects\characters\spartans\spartans" "depot:unarmed:left_shoulder" true)
    (sleep (unit_get_custom_animation_time "chief_armory"))
    (unit_stop_custom_animation "chief_armory")
)

(script static void anim_depot_rifle_right_shoulder
    (custom_animation "chief_armory" "objects\characters\spartans\spartans" "depot:unarmed:right_shoulder" true)
    (sleep (unit_get_custom_animation_time "chief_armory"))
    (unit_stop_custom_animation "chief_armory")
)

(script static void anim_depot_rifle_right_shoulder_var1
    (custom_animation "chief_armory" "objects\characters\spartans\spartans" "depot:unarmed:right_shoulder" true)
    (sleep (unit_get_custom_animation_time "chief_armory"))
    (unit_stop_custom_animation "chief_armory")
)

(script static void anim_depot_rifle_chest
    (custom_animation "chief_armory" "objects\characters\spartans\spartans" "depot:unarmed:chest" true)
    (sleep (unit_get_custom_animation_time "chief_armory"))
    (unit_stop_custom_animation "chief_armory")
)

(script static void anim_depot_rifle_chest_var1
    (custom_animation "chief_armory" "objects\characters\spartans\spartans" "depot:unarmed:chest" true)
    (sleep (unit_get_custom_animation_time "chief_armory"))
    (unit_stop_custom_animation "chief_armory")
)
...
(script static void helmet_purchase
    ...
    (begin_random_count
        1
        (anim_depot_rifle_helmet)
        (anim_depot_rifle_helmet_var1)
    )
...
(script static void left_shoulder_purchase
    ...
    (begin_random_count
        1
        (anim_depot_rifle_left_shoulder)
        (anim_depot_rifle_left_shoulder_var1)
    )
    (supply_depot_initialization)
)
...
(script static void right_shoulder_purchase
    ...
    (begin_random_count
        1
        (anim_depot_rifle_right_shoulder)
        (anim_depot_rifle_right_shoulder_var1)
    )
    (supply_depot_initialization)
)
...
(script static void chest_purchase
    ...
    (begin_random_count
        1
        (anim_depot_rifle_chest)
        (anim_depot_rifle_chest_var1)
    )
    (supply_depot_initialization)
)
...
(script static void (camera_path_campaign (short location))
    ...
    (sleep_location location 30)
    (camera_set "campaign_path_02" 1800)
    (sleep_location location 600)
    (camera_set "campaign_path_03" 1800)
    (sleep_location location 1800)
    (camera_set "campaign_path_04" 1800)
    (sleep_location location 600)
    (camera_set "campaign" 1800)
    (sleep_location location 1800)
)
...
; Decompilation finished in ~0.0250242s
