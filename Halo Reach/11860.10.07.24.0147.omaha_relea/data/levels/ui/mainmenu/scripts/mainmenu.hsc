...
; Start time: 2018-02-05 12:49:19 PM
; 
...
(script static boolean (update_elite_mandibles_idle (boolean mandibles_hidden))
    (if (!= mandibles_hidden g_elite_mandibles_hidden)
        (begin
            (if mandibles_hidden
                (begin
...
(script static boolean (update_elite_armory_mandibles_idle (boolean mandibles_hidden))
    (if (!= mandibles_hidden g_elite_armory_mandibles_hidden)
        (begin
            (if mandibles_hidden
                (begin
...
(script static boolean (update_elite_pgcr_mandibles_idle (boolean mandibles_hidden))
    (if (!= mandibles_hidden g_elite_pgcr_mandibles_hidden)
        (begin
            (if mandibles_hidden
                (begin
...
(script static boolean (update_elite_exit_mandibles_idle (boolean mandibles_hidden))
    (if (!= mandibles_hidden g_elite_exit_mandibles_hidden)
        (begin
            (if mandibles_hidden
                (begin
...
(script dormant void elites_mandibles_idle
    (sleep_until 
        (begin
...
; Decompilation finished in ~0.0540514s
