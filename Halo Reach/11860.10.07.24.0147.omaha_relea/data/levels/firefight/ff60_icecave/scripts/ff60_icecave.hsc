...
; 
; Source file: ff60_icecave.hsc
; Start time: 2018-02-05 1:00:44 PM
; 
...
(script startup void ff60_icecave
    (ai_allegiance human player)
    (ai_allegiance player human)
    (if (> (player_count) 0)
...
(script command_script void cs_sur_phantom_01
    ...
    (if (survival_mode_scenario_extras_enable)
        (if (and (= (random_range 0 2) 0) (<= (object_get_health (ai_vehicle_get_from_spawn_point "sq_sur_ghost_01/ghost")) 0))
    ...
    (begin
        (if (= (random_range 1 3) 1)
            ...
            (begin
                (vehicle_unload v_sur_phantom_01 32)
                (if (or (= (vehicle_test_seat v_sur_phantom_01 2) true) (= (vehicle_test_seat v_sur_phantom_01 3) true))
                    (begin
                        (f_unload_phantom v_sur_phantom_01 "left")
                    )
                    (begin
                        (sleep 150)
                    )
                ...
                (if (or (= (vehicle_test_seat v_sur_phantom_01 6) true) (= (vehicle_test_seat v_sur_phantom_01 7) true))
                    (begin
...
(script command_script void cs_sur_phantom_02
    ...
    (if (survival_mode_scenario_extras_enable)
        (if (and (= (random_range 0 3) 0) (<= (object_get_health (ai_vehicle_get_from_spawn_point "sq_sur_wraith_01/driver")) 0))
    ...
    (if (= (random_range 0 2) 0)
        ...
        (begin
            (unit_open v_sur_phantom_02)
            (sleep 30)
            (if (or (= (vehicle_test_seat v_sur_phantom_02 7) true) (= (vehicle_test_seat v_sur_phantom_02 2) true))
                (begin
                    (vehicle_unload v_sur_phantom_02 7)
                    (vehicle_unload v_sur_phantom_02 2)
                    (sleep_until (and (= (vehicle_test_seat v_sur_phantom_02 7) false) (= (vehicle_test_seat v_sur_phantom_02 2) false)))
                    (sleep 150)
                )
                (begin
                    (sleep 300)
            ...
            (if (= (vehicle_test_seat v_sur_phantom_02 6) true)
                (begin
                    ...
                    (sleep_until (= (vehicle_test_seat v_sur_phantom_02 6) false))
                    (sleep 60)
                )
                (begin
                    (cs_fly_to_and_face "ps_sur_phantom_02/p5_1" "ps_sur_phantom_02/face2" 1)
            ...
            (if (= (vehicle_test_seat v_sur_phantom_02 3) true)
                (begin
                    (cs_fly_to_and_face "ps_sur_phantom_02/p6" "ps_sur_phantom_02/face3" 1)
                    (vehicle_unload v_sur_phantom_02 3)
                    (sleep_until (= (vehicle_test_seat v_sur_phantom_02 3) false))
                    (sleep 30)
                )
                (begin
                    (cs_fly_to_and_face "ps_sur_phantom_02/p6" "ps_sur_phantom_02/face3" 1)
    ...
    (begin
        (if (= (random_range 1 3) 1)
            ...
            (begin
                ...
                (wake phantom_03_blip)
                (sleep 15)
                (if (or (= (vehicle_test_seat v_sur_phantom_03 6) true) (= (vehicle_test_seat v_sur_phantom_03 7) true))
                    (begin
                        (f_unload_phantom v_sur_phantom_03 "right")
                    )
                    (begin
                        (sleep 150)
                    )
                ...
                (set b_phantomw_03_2 false)
                (cs_fly_to_and_face "ps_sur_phantom_03/p3" "ps_sur_phantom_03/face" 1)
                (if (or (= (vehicle_test_seat v_sur_phantom_03 2) true) (= (vehicle_test_seat v_sur_phantom_03 3) true))
                    (begin
...
(script command_script void cs_sur_phantom_04
    ...
    (cs_ignore_obstacles true)
    (if (survival_mode_scenario_extras_enable)
        (if (and (= (random_range 0 3) 0) (<= (object_get_health (ai_vehicle_get_from_spawn_point "sq_sur_wraith_02/driver")) 0))
    ...
    (if (= (random_range 0 1) 0)
        (begin
            ...
            (if (= (vehicle_test_seat v_sur_phantom_04 2) true)
                (begin
                    (vehicle_unload v_sur_phantom_04 2)
                    (sleep_until (= (vehicle_test_seat v_sur_phantom_04 2) false))
                    (sleep 30)
                )
                (begin
                    (sleep 30)
            ...
            (if (= (vehicle_test_seat v_sur_phantom_04 3) true)
                (begin
                    (vehicle_unload v_sur_phantom_04 3)
                    (sleep_until (= (vehicle_test_seat v_sur_phantom_04 3) false))
                    (sleep 30)
                )
                (begin
                    (sleep 30)
            ...
            (if (or (= (vehicle_test_seat v_sur_phantom_04 7) true) (= (vehicle_test_seat v_sur_phantom_04 6) true))
                (begin
                    (f_unload_phantom v_sur_phantom_04 "right")
                    (sleep_until (and (= (vehicle_test_seat v_sur_phantom_04 7) false) (= (vehicle_test_seat v_sur_phantom_04 6) false)))
                    (sleep 30)
                )
                (begin
                    (sleep 30)
...
(script static boolean (resupply_pod_test_weapon (object pod))
    (or (!= (object_at_marker pod "laser01") none) (!= (object_at_marker pod "rock01") none) (!= (object_at_marker pod "sniper01") none))
)

(script continuous void weapon_waypoint_01
    (sleep_forever)
...
(script continuous void weapon_waypoint_02
    (sleep_forever)
...
(script continuous void weapon_waypoint_03
    (sleep_forever)
...
(script dormant void weapon_drop_control
    (sleep_until 
        (begin
...
; Decompilation finished in ~0.0785749s
