...
; 
; Source file: ff50_park.hsc
; Start time: 2018-02-05 1:00:03 PM
; 
            ...
            (if (not b_sur_bonus_end)
                (begin
                    ...
                    (sleep_until 
                        (begin
                            (if (= s_sur_dropship_type 1)
                                (vehicle_unload v_sur_bonus_phantom 8)
                                (vehicle_unload v_sur_bonus_phantom 16)
                            )
                            (sleep 1)
                            (ai_migrate_persistent ai_sur_wave_spawns ai_sur_bonus_wave)
                            b_sur_bonus_end
...
(script static void (f_survival_load_phantom (vehicle dropship, string load_side, ai load_squad))
    ...
    (if (= load_side "left")
        (begin
            ...
            (if (= (vehicle_test_seat dropship 0) false)
                (ai_vehicle_enter_immediate load_squad dropship 0)
            )
            (if (= (vehicle_test_seat dropship 1) false)
...
(script static void (f_survival_load_spirit (vehicle dropship, string load_side, ai load_squad))
    ...
    (if (= load_side "dual")
        (begin
            ...
            (ai_vehicle_enter_immediate load_squad dropship 32)
            (ai_vehicle_enter_immediate load_squad dropship 33)
            (ai_vehicle_enter_immediate load_squad dropship 34)
        )
    )
...
(script static void evaluate
    (if (= b_evaluate false)
        (begin
            ...
            (set ai_render_aiming_vectors true)
            (set b_evaluate true)
        )
        (begin
            ...
            (set ai_render_aiming_vectors false)
...
(script static void text
    (if (= ai_render_evaluations_text false)
        (begin
            (set ai_render_evaluations_text true)
        )
        (begin
...
(script command_script void cs_sur_phantom_01
    ...
    (cs_vehicle_speed 1)
    (if (survival_mode_scenario_extras_enable)
        (if (and (= (random_range 0 1) 0) (<= (object_get_health (ai_vehicle_get_from_spawn_point "sq_sur_ghost_01/ghost")) 0))
    ...
    (if (= (vehicle_test_seat v_sur_phantom_01 13) true)
        (begin
            ...
            (vehicle_unload v_sur_phantom_01 13)
    ...
    (vehicle_unload v_sur_phantom_01 4)
    (sleep 15)
    (sleep_until (= (vehicle_test_seat v_sur_phantom_01 4) false) 10)
    (cs_fly_by "ps_sur_phantom_01/run_04c")
    (cs_fly_to_and_face "ps_sur_phantom_01/drop_01b" "ps_sur_phantom_01/face_01b" 1)
    (vehicle_unload v_sur_phantom_01 5)
    (sleep 15)
    (sleep_until (= (vehicle_test_seat v_sur_phantom_01 5) false) 10)
    (cs_vehicle_speed 1)
    ...
    (sleep_until (and (= (vehicle_test_seat v_sur_phantom_01 6) false) (= (vehicle_test_seat v_sur_phantom_01 7) false)) 10)
    (sleep 15)
...
(script command_script void cs_sur_phantom_02
    ...
    (cs_ignore_obstacles true)
    (if (survival_mode_scenario_extras_enable)
        (if (and (= (random_range 0 1) 0) (<= (object_get_health (ai_vehicle_get_from_spawn_point "sq_sur_wraith_01/wraith")) 0))
            (f_load_phantom_cargo v_sur_phantom_02 "single" "sq_sur_wraith_01" none)
        )
    )
    (cs_vehicle_boost true)
    ...
    (vehicle_unload v_sur_phantom_02 5)
    (sleep 15)
    (vehicle_unload v_sur_phantom_02 4)
    (sleep_until (and (= (vehicle_test_seat v_sur_phantom_02 5) false) (= (vehicle_test_seat v_sur_phantom_02 4) false)) 10)
    (set b_wraith_01 false)
    (if (= (vehicle_test_seat v_sur_phantom_02 13) true)
        (begin
            ...
            (vehicle_unload v_sur_phantom_02 13)
        )
    )
    ...
    (sleep_until (and (= (vehicle_test_seat v_sur_phantom_02 6) false) (= (vehicle_test_seat v_sur_phantom_02 7) false)) 10)
    (cs_vehicle_speed 1)
...
(script command_script void cs_sur_phantom_03
    ...
    (sleep 1)
    (cs_vehicle_speed 0.5)
    (if (= (vehicle_test_seat v_sur_phantom_03 13) true)
        (begin
            ...
            (vehicle_unload v_sur_phantom_03 13)
            (cs_fly_to_and_face "ps_sur_phantom_03/hover_01" "ps_sur_phantom_03/face_01" 1)
            (cs_vehicle_speed 1)
        )
    )
    ...
    (vehicle_unload v_sur_phantom_03 1)
    (sleep 15)
    (vehicle_unload v_sur_phantom_03 0)
    (sleep_until (and (= (vehicle_test_seat v_sur_phantom_03 1) false) (= (vehicle_test_seat v_sur_phantom_03 0) false)) 10)
    ...
    (sleep_until (and (= (vehicle_test_seat v_sur_phantom_03 2) false) (= (vehicle_test_seat v_sur_phantom_03 3) false)) 10)
    (cs_fly_to_and_face "ps_sur_phantom_03/hover_03" "ps_sur_phantom_03/face_03" 1)
    (sleep 15)
...
(script command_script void cs_sur_phantom_04
    ...
    (cs_ignore_obstacles true)
    (if (survival_mode_scenario_extras_enable)
        (if (and (= (random_range 0 1) 0) (<= (object_get_health (ai_vehicle_get_from_spawn_point "sq_sur_wraith_02/wraith")) 0) (= (survival_mode_current_wave_is_initial) false))
            (f_load_phantom_cargo v_sur_phantom_04 "single" "sq_sur_wraith_02" none)
        )
    )
    (cs_vehicle_boost true)
    ...
    (if (= (vehicle_test_seat v_sur_phantom_04 13) true)
        (begin
            ...
            (vehicle_unload v_sur_phantom_04 13)
            (cs_fly_to_and_face "ps_sur_phantom_04/hover_01" "ps_sur_phantom_04/face_01" 1)
        )
    )
    (cs_vehicle_speed 0.5)
    ...
    (vehicle_unload v_sur_phantom_04 1)
    (sleep 15)
    (vehicle_unload v_sur_phantom_04 0)
    (sleep_until (and (= (vehicle_test_seat v_sur_phantom_04 1) false) (= (vehicle_test_seat v_sur_phantom_04 0) false)) 10)
    ...
    (sleep 15)
    (vehicle_unload v_sur_phantom_04 3)
    (sleep_until (and (= (vehicle_test_seat v_sur_phantom_04 2) false) (= (vehicle_test_seat v_sur_phantom_04 3) false)) 10)
    (cs_fly_to_and_face "ps_sur_phantom_04/hover_03" "ps_sur_phantom_04/face_03" 1)
    (sleep 15)
...
(script command_script void cs_wraith_lock
    (cs_run_command_script "sq_sur_wraith_01/gunner" abort_cs)
    (cs_run_command_script "sq_sur_wraith_02/gunner" abort_cs)
    (cs_enable_moving true)
    (sleep 5)
...
; Decompilation finished in ~0.0810776s
