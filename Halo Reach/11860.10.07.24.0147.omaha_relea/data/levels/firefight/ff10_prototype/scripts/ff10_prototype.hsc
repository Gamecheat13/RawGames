...
; Start time: 2018-02-05 12:58:06 PM
; 
...
(script command_script void cs_sur_phantom_01
    ...
    (vehicle_unload v_sur_phantom_01 9)
    (sleep (random_range 5 15))
    (cs_fly_to_and_face "ps_sur_phantom_01/p6" "ps_sur_phantom_01/face" 4)
    (vehicle_unload v_sur_phantom_01 8)
    (sleep_until (= (vehicle_test_seat v_sur_phantom_01 8) false))
    (sleep 30)
...
(script command_script void cs_sur_phantom_02
    ...
    (sleep_until (= (vehicle_test_seat v_sur_phantom_02 4) false))
    (sleep 30)
...
(script static boolean obj_shero__0_11
    (<= (ai_task_count "obj_survival/remaining") 3)
)

(script static boolean obj_sbonus_0_16
    b_sur_bonus_round_running
)

(script static boolean obj_sgener_0_20
    b_sur_generator_defense_active
)

(script static boolean obj_sgen0_0_21
...
(script static boolean obj_sgen2_0_23
    b_sur_generator2_alive
)

; Decompilation finished in ~0.0845809s
