...
; 
; Source file: ff60_airview.hsc
; Start time: 2018-02-05 1:00:23 PM
; 
...
(script static void (f_load_phantom_cargo (vehicle phantom, string load_number, ai load_squad_01, ai load_squad_02))
    (if (= load_number "single")
        (begin
            (ai_place load_squad_01)
            (sleep 1)
            (vehicle_load_magic phantom 32 (ai_vehicle_get_from_squad load_squad_01 0))
        )
        (if (= load_number "double")
            (begin
                ...
                (ai_place load_squad_02)
                (sleep 1)
                (vehicle_load_magic phantom 33 (ai_vehicle_get_from_squad load_squad_01 0))
                (vehicle_load_magic phantom 34 (ai_vehicle_get_from_squad load_squad_02 0))
            )
        )
    )
)
...
(script startup void ff60_airview
...
(script command_script void cs_sur_phantom_01
    ...
    (if (survival_mode_scenario_extras_enable)
        (if (and (= (random_range 0 2) 0) (<= (object_get_health (ai_vehicle_get_from_spawn_point "sq_sur_ghost_01/driver")) 0))
            (f_load_phantom_cargo v_sur_phantom_01 "single" "sq_sur_ghost_01" none)
        )
    )
    ...
    (vehicle_unload v_sur_phantom_01 32)
    (if (= (vehicle_test_seat v_sur_phantom_01 2) true)
        (begin
            (vehicle_unload v_sur_phantom_01 2)
            (sleep_until (= (vehicle_test_seat v_sur_phantom_01 2) false) 10)
            (sleep 15)
        )
        (begin
            (sleep 15)
    ...
    (if (or (= (vehicle_test_seat v_sur_phantom_01 7) true) (= (vehicle_test_seat v_sur_phantom_01 6) true))
        (begin
            (vehicle_unload v_sur_phantom_01 7)
            (vehicle_unload v_sur_phantom_01 6)
            (sleep_until (and (= (vehicle_test_seat v_sur_phantom_01 7) false) (= (vehicle_test_seat v_sur_phantom_01 6) false)) 10)
            (sleep 15)
        )
        (begin
            (sleep 15)
    ...
    (if (= (vehicle_test_seat v_sur_phantom_01 3) true)
        (begin
            (vehicle_unload v_sur_phantom_01 3)
            (sleep_until (= (vehicle_test_seat v_sur_phantom_01 3) false) 10)
            (sleep 15)
        )
        (begin
            (sleep 15)
...
(script command_script void cs_sur_phantom_02
    ...
    (if (survival_mode_scenario_extras_enable)
        (if (and (= (random_range 0 2) 0) (<= (object_get_health (ai_vehicle_get_from_spawn_point "sq_sur_ghost_02/driver")) 0))
            (f_load_phantom_cargo v_sur_phantom_02 "single" "sq_sur_ghost_02" none)
        )
    )
    (cs_vehicle_boost true)
    ...
    (if (= (vehicle_test_seat v_sur_phantom_02 32) true)
        (begin
            ...
            (vehicle_unload v_sur_phantom_02 32)
        )
        (begin
    ...
    (if (or (= (vehicle_test_seat v_sur_phantom_02 7) true) (= (vehicle_test_seat v_sur_phantom_02 6) true))
        (begin
            (vehicle_unload v_sur_phantom_02 7)
            (sleep 15)
            (vehicle_unload v_sur_phantom_02 6)
            (sleep_until (and (= (vehicle_test_seat v_sur_phantom_02 7) false) (= (vehicle_test_seat v_sur_phantom_02 6) false)) 10)
            (sleep 15)
        )
        (begin
            (sleep 15)
    ...
    (if (= (vehicle_test_seat v_sur_phantom_02 9) true)
        (begin
            (vehicle_unload v_sur_phantom_02 9)
            (sleep_until (= (vehicle_test_seat v_sur_phantom_02 9) false) 10)
            (sleep 15)
        )
        (begin
            (sleep 15)
    ...
    (if (= (vehicle_test_seat v_sur_phantom_02 8) true)
        (begin
            (vehicle_unload v_sur_phantom_02 8)
            (sleep_until (= (vehicle_test_seat v_sur_phantom_02 8) false) 10)
            (sleep 15)
        )
        (begin
            (sleep 15)
...
(script command_script void cs_sur_phantom_03
    ...
    (if (or (= (vehicle_test_seat v_sur_phantom_03 3) true) (= (vehicle_test_seat v_sur_phantom_03 2) true))
        (begin
            (vehicle_unload v_sur_phantom_03 3)
            (sleep 15)
            (vehicle_unload v_sur_phantom_03 2)
            (sleep_until (and (= (vehicle_test_seat v_sur_phantom_03 3) false) (= (vehicle_test_seat v_sur_phantom_03 2) false)) 10)
            (sleep 15)
        )
        (begin
            (sleep 15)
    ...
    (sleep 15)
    (if (or (= (vehicle_test_seat v_sur_phantom_03 4) true) (= (vehicle_test_seat v_sur_phantom_03 5) true))
        (begin
            (vehicle_unload v_sur_phantom_03 4)
            (sleep 15)
            (vehicle_unload v_sur_phantom_03 5)
            (sleep_until (and (= (vehicle_test_seat v_sur_phantom_03 4) false) (= (vehicle_test_seat v_sur_phantom_03 5) false)) 10)
            (sleep 15)
        )
        (begin
            (sleep 15)
...
(script command_script void cs_sur_phantom_04
    ...
    (if (or (= (vehicle_test_seat v_sur_phantom_04 7) true) (= (vehicle_test_seat v_sur_phantom_04 6) true))
        (begin
            (vehicle_unload v_sur_phantom_04 7)
            (sleep 15)
            (vehicle_unload v_sur_phantom_04 6)
            (sleep_until (and (= (vehicle_test_seat v_sur_phantom_04 7) false) (= (vehicle_test_seat v_sur_phantom_04 6) false)) 10)
            (sleep 15)
        )
        (begin
            (sleep 15)
    ...
    (sleep 15)
    (cs_vehicle_speed 1)
    (if (or (= (vehicle_test_seat v_sur_phantom_04 8) true) (= (vehicle_test_seat v_sur_phantom_04 9) true))
        (begin
            (vehicle_unload v_sur_phantom_04 8)
            (sleep 15)
            (vehicle_unload v_sur_phantom_04 9)
            (sleep_until (and (= (vehicle_test_seat v_sur_phantom_04 8) false) (= (vehicle_test_seat v_sur_phantom_04 9) false)) 10)
            (sleep 15)
        )
        (begin
            (sleep 15)
...
(script continuous void resupply_waypoint_06
    (sleep_forever)
...
(script continuous void resupply_waypoint_07
    (sleep_forever)
...
(script continuous void resupply_waypoint_08
    (sleep_forever)
...
(script continuous void resupply_waypoint_09
    (sleep_forever)
...
; Decompilation finished in ~0.0840815s
