...
; 
; Source file: ff30_waterfront.hsc
; Start time: 2018-02-05 12:58:51 PM
; 
...
(script startup void ff30_waterfront
    (ai_allegiance human player)
    (ai_allegiance player human)
    (if (> (player_count) 0)
...
(script command_script void cs_sur_phantom_01
    ...
    (sleep (random_range 5 15))
    (cs_fly_to_and_face "ps_sur_phantom_01/p5" "ps_sur_phantom_01/face" 1)
    (sleep 30)
    ...
    (cs_fly_by "ps_sur_phantom_01/p2")
    (cs_fly_by "ps_sur_phantom_01/p1")
    (cs_fly_by "ps_sur_phantom_01/erase" 5)
...
(script command_script void cs_sur_phantom_02
    ...
    (cs_fly_to_and_face "ps_sur_phantom_02/p4" "ps_sur_phantom_02/face")
    (vehicle_unload v_sur_phantom_02 7)
    (sleep (random_range 35 45))
    (cs_fly_to_and_face "ps_sur_phantom_02/p5" "ps_sur_phantom_02/face")
    (vehicle_unload v_sur_phantom_02 9)
    (sleep (random_range 35 45))
    (cs_fly_to_and_face "ps_sur_phantom_02/p6" "ps_sur_phantom_02/face")
    (vehicle_unload v_sur_phantom_02 8)
    (sleep_until (= (vehicle_test_seat v_sur_phantom_02 8) false))
    (sleep 30)
    ...
    (cs_fly_by "ps_sur_phantom_02/p0")
    (cs_vehicle_boost false)
    (cs_fly_by "ps_sur_phantom_02/erase" 5)
    (ai_erase ai_current_squad)
)
...
(script command_script void cs_sur_phantom_03
    ...
    (sleep (random_range 35 45))
    (cs_fly_to_and_face "ps_sur_phantom_03/p4" "ps_sur_phantom_03/face")
    (vehicle_unload v_sur_phantom_03 7)
    (sleep (random_range 35 45))
    (cs_fly_to_and_face "ps_sur_phantom_03/p5" "ps_sur_phantom_03/face")
    (vehicle_unload v_sur_phantom_03 9)
    (sleep (random_range 35 45))
    (cs_fly_to_and_face "ps_sur_phantom_03/p6" "ps_sur_phantom_03/face")
    (vehicle_unload v_sur_phantom_03 8)
    (sleep_until (= (vehicle_test_seat v_sur_phantom_03 8) false))
    (sleep 30)
...
(script command_script void cs_sur_phantom_04
    ...
    (sleep (random_range 35 45))
    (cs_fly_to_and_face "ps_sur_phantom_04/p4" "ps_sur_phantom_04/face")
    (vehicle_unload v_sur_phantom_04 3)
    (sleep (random_range 35 45))
    (cs_fly_to_and_face "ps_sur_phantom_04/p5" "ps_sur_phantom_04/face")
    (vehicle_unload v_sur_phantom_04 4)
    (sleep (random_range 35 45))
    (cs_fly_to_and_face "ps_sur_phantom_04/p6" "ps_sur_phantom_04/face")
    (vehicle_unload v_sur_phantom_04 5)
    (sleep_until (= (vehicle_test_seat v_sur_phantom_04 5) false))
    (sleep 30)
...
(script dormant void survival_banshee_spawn
    (sleep_until 
        (begin
            ...
            (if (<= (ai_task_count "obj_survival/extras_gate") 0)
                (begin_random_count
                    1
...
(script continuous void drop_pod_01
    ...
    (effect_new_on_object_marker "fx\fx_library\pod_impacts\water\pod_impact_water_large.effect" "dm_drop_01" "fx_impact")
...
(script continuous void drop_pod_02
    ...
    (effect_new_on_object_marker "fx\fx_library\pod_impacts\water\pod_impact_water_large.effect" "dm_drop_02" "fx_impact")
...
(script continuous void drop_pod_04
    ...
    (effect_new_on_object_marker "fx\fx_library\pod_impacts\water\pod_impact_water_large.effect" "dm_drop_04" "fx_impact")
...
(script continuous void drop_pod_05
    ...
    (sleep_until (>= (device_get_position "dm_drop_05") 0.98) 1)
...
(script continuous void resupply_target_02
    ...
    (effect_new_on_object_marker "fx\fx_library\pod_impacts\water\pod_impact_water_small.effect" "sc_target_02" "fx_impact")
...
(script continuous void resupply_pod_05
    ...
    (effect_new_on_object_marker "fx\fx_library\pod_impacts\water\pod_impact_water_small.effect" "sc_resupply_05" "fx_impact")
...
(script continuous void resupply_pod_08
    ...
    (effect_new_on_object_marker "fx\fx_library\pod_impacts\water\pod_impact_water_small.effect" "sc_resupply_08" "fx_impact")
...
; Decompilation finished in ~0.0905867s
