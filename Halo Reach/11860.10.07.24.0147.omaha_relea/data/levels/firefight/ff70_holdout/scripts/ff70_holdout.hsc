...
; 
; Source file: ff70_holdout.hsc
; Start time: 2018-02-05 1:01:16 PM
; 
...
(script stub void survival_kill_volumes_on
    (if debug
        (print "**turn on kill volumes**")
    )
)

(script stub void survival_kill_volumes_off
    (if debug
        (print "**turn off kill volumes**")
    )
)
...
(script startup void ff70_holdout
    (ai_allegiance human player)
    (ai_allegiance player human)
    (if (> (player_count) 0)
...
(script dormant void survival_poa_control
    (sleep_until 
        (begin
...
(script command_script void cs_sur_phantom_01
    ...
    (sleep_until (and (= (vehicle_test_seat v_sur_phantom_01 3) false) (= (vehicle_test_seat v_sur_phantom_01 2) false)) 10)
...
(script command_script void cs_sur_phantom_02
    ...
    (sleep_until (and (= (vehicle_test_seat v_sur_phantom_02 3) false) (= (vehicle_test_seat v_sur_phantom_02 2) false)) 10)
    (cs_vehicle_speed 0.5)
    (cs_fly_to_and_face "ps_sur_phantom_02/hover_01" "ps_sur_phantom_02/face_01" 1)
    ...
    (sleep_until (and (= (vehicle_test_seat v_sur_phantom_02 4) false) (= (vehicle_test_seat v_sur_phantom_02 5) false)) 10)
    (sleep 15)
    (cs_vehicle_speed 1)
    (cs_fly_to_and_face "ps_sur_phantom_02/hover_02" "ps_sur_phantom_02/face_02" 1)
...
(script command_script void cs_sur_phantom_03
    ...
    (sleep_until (and (= (vehicle_test_seat v_sur_phantom_03 7) false) (= (vehicle_test_seat v_sur_phantom_03 6) false)) 10)
    (cs_vehicle_speed 1)
    (cs_fly_to_and_face "ps_sur_phantom_03/hover_01" "ps_sur_phantom_03/face_01" 1)
...
(script command_script void cs_sur_phantom_04
    ...
    (sleep_until (and (= (vehicle_test_seat v_sur_phantom_04 3) false) (= (vehicle_test_seat v_sur_phantom_04 2) false)) 10)
    (cs_vehicle_speed 1)
    (cs_fly_to_and_face "ps_sur_phantom_04/hover_01" "ps_sur_phantom_04/face_01" 1)
    (cs_vehicle_speed 0.5)
...
(script dormant void survival_drop_spawn
    ...
    (sleep_until 
        (begin
            (sleep (* (* 30 60) 3))
            (sleep_until (and (<= (ai_living_count "gr_survival_waves") 10) (<= (ai_task_count "obj_survival/banshee_01") 0) (<= (ai_task_count "obj_survival/banshee_02") 0) (= (survival_mode_current_wave_is_boss) false) (= (survival_mode_current_wave_is_initial) false)))
...
(script dormant void survival_rain_control
    (wake survival_rain)
    (sleep_until 
        (begin
...
(script dormant void survival_rain
    (sleep_until 
        (begin
                        ...
                        (if (= s_rain_force 2)
                            ...
                            (if (= s_rain_force 3)
                                ...
                                (if (= s_rain_force 4)
                                    (begin
                                        (print "medium")
                                        (weather_animate_force "light_rain" 0.5 (random_range 5 15))
                                    )
                                    (if (= s_rain_force 5)
                                        (begin
                                        ...
                                        (if (= s_rain_force 6)
                                            (begin
                                                ...
                                                (weather_animate_force "heavy_rain" 0.5 (random_range 5 15))
                                                (set s_rain_force 5)
                                                (sleep (random_range (* 30 20) (* 30 60)))
                                            )
                                            (if (= s_rain_force 7)
...
; Decompilation finished in ~0.0900862s
