...
; 
; Source file: ff20_courtyard.hsc
; Start time: 2018-02-05 12:58:31 PM
; 
...
(script startup void ff20_courtyard
    (ai_allegiance human player)
    (ai_allegiance player human)
    (if (> (player_count) 0)
...
(script static void survival_generator
    (survival_refresh_sleep)
...
(script static boolean obj_sgen0_0_22
    b_sur_generator0_alive
)

(script static boolean obj_sgen1_0_23
...
; Decompilation finished in ~0.0830795s
