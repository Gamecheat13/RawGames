...
; 
; Source file: ff45_corvette.hsc
; Start time: 2018-02-05 12:59:38 PM
; 
...
(global short s_last_wave_index 65534)
...
(script dormant void ff45_wave_ticker
...
(script static void (ff45_load_wraith (vehicle phantom))
    (if (and (survival_mode_scenario_extras_enable) (= (random_range 0 5) 0) (<= (object_get_health (ai_vehicle_get_from_spawn_point "ff_wraith0/driver")) 0))
        (begin
...
(script continuous void phantom_unloader0
    (sleep_forever)
    (sleep 210)
...
(script continuous void phantom_unloader1
    (sleep_forever)
    (sleep 240)
...
(script continuous void phantom_unloader2
    (sleep_forever)
    (sleep 210)
...
(script continuous void phantom_unloader3
    (sleep_forever)
    (sleep 240)
...
(script continuous void phantom_callout
    (sleep_forever)
    (f_survival_callout_dropship g_callout_phantom)
)

(script command_script void cs_ff_phantom0
    ...
    (cs_vehicle_speed 1)
    (cs_fly_by "ps_phantom0/p5" 3)
    (cs_fly_by "ps_phantom0/p6")
    (ai_erase ai_current_squad)
)

(script command_script void cs_ff_phantom1
    ...
    (sleep 45)
    (sleep_until (or (= g_hangar_phantom none) (<= (object_get_health g_hangar_phantom) 0)) 5)
...
(script command_script void cs_ff_phantom2
...
(script command_script void cs_ff_phantom3
...
(script command_script void cs_ff_phantom_bonus
...
(script static void (ff45_resupply_launch (object_name pod, real english))
    ...
    (sleep_until (and (volume_test_object "tv_resupply_zone" pod) (object_get_at_rest pod) (resupply_pod_test_weapon pod)) 30 300)
    (object_can_take_damage pod)
    (object_damage_damage_section pod "panel" 100)
    (sound_impulse_start sfx_blip none 1)
    (f_blip_object pod blip_ordnance)
    (sleep_until (or (not (volume_test_object "tv_resupply_zone" pod)) (not (resupply_pod_test_weapon pod)) (not (>= (object_get_health pod) 0))) 5 1800)
    (f_unblip_object pod)
)

(script continuous void ff45_resupply0
    (sleep_forever)
    (sleep (random_range 0 15))
    (ff45_resupply_launch "resupply0" 2.25)
)

(script continuous void ff45_resupply1
    (sleep_forever)
    (sleep (random_range 0 15))
    (ff45_resupply_launch "resupply1" 3.25)
)

(script continuous void ff45_resupply2
    (sleep_forever)
    (sleep (random_range 0 15))
    (ff45_resupply_launch "resupply2" 4.75)
)

(script dormant void ff45_weapon_drops
    (sleep_until 
        (begin
...
(script static void ff45_spawn_engineers
    (if (and (survival_mode_scenario_extras_enable) (= (random_range 0 5) 0))
        (begin
            ...
            (if (not b_sur_bonus_end)
                (begin
                    ...
                    (sleep_until 
                        (begin
                            (if (= s_sur_dropship_type 1)
                                (vehicle_unload v_sur_bonus_phantom 23)
                                (vehicle_unload v_sur_bonus_phantom 2)
                            )
                            (sleep 1)
                            (ai_migrate_persistent ai_sur_wave_spawns ai_sur_bonus_wave)
                            b_sur_bonus_end
...
(script static void (f_survival_load_phantom (vehicle dropship, string load_side, ai load_squad))
    ...
    (if (= load_side "left")
        (begin
            ...
            (if (= (vehicle_test_seat dropship 24) false)
                (ai_vehicle_enter_immediate load_squad dropship 24)
            )
            (if (= (vehicle_test_seat dropship 25) false)
                (ai_vehicle_enter_immediate load_squad dropship 25)
            )
            (if (= (vehicle_test_seat dropship 26) false)
                (ai_vehicle_enter_immediate load_squad dropship 26)
            )
            (if (= (vehicle_test_seat dropship 27) false)
    ...
    (if (= load_side "right")
        (begin
            ...
            (if (= (vehicle_test_seat dropship 28) false)
                (ai_vehicle_enter_immediate load_squad dropship 28)
            )
            (if (= (vehicle_test_seat dropship 29) false)
                (ai_vehicle_enter_immediate load_squad dropship 29)
            )
            (if (= (vehicle_test_seat dropship 30) false)
                (ai_vehicle_enter_immediate load_squad dropship 30)
            )
            (if (= (vehicle_test_seat dropship 31) false)
    ...
    (if (= load_side "chute")
        (begin
            ...
            (if (= (vehicle_test_seat dropship 32) false)
                (ai_vehicle_enter_immediate load_squad dropship 32)
            )
            (if (= (vehicle_test_seat dropship 33) false)
                (ai_vehicle_enter_immediate load_squad dropship 33)
            )
            (if (= (vehicle_test_seat dropship 34) false)
                (ai_vehicle_enter_immediate load_squad dropship 34)
            )
            (if (= (vehicle_test_seat dropship 35) false)
                (ai_vehicle_enter_immediate load_squad dropship 35)
            )
            (set b_dropship_loaded true)
        )
    )
...
; Decompilation finished in ~0.0740719s
