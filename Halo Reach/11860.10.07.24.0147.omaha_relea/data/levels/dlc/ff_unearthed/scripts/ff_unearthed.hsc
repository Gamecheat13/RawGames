...
; 
; Source file: ff_unearthed.hsc
; Start time: 2018-02-05 1:11:03 PM
; 
...
(script startup void ff_unearthed
    (ai_allegiance human player)
    (ai_allegiance player human)
    (if (> (player_count) 0)
...
(script command_script void cs_wraith_shoot
...
(script command_script void cs_sur_phantom_01
    ...
    (if (survival_mode_scenario_extras_enable)
        (if (and (= (random_range 0 4) 0) (<= (object_get_health (ai_vehicle_get_from_spawn_point "sq_sur_wraith_01/driver")) 0))
    ...
    (if (= (vehicle_test_seat v_sur_phantom_01 32) true)
        (begin
    ...
    (sleep (random_range 5 15))
    (sleep_until (and (= (vehicle_test_seat v_sur_phantom_01 3) false) (= (vehicle_test_seat v_sur_phantom_01 7) false)) 10)
    (cs_vehicle_speed 1)
    ...
    (sleep (random_range 5 15))
    (sleep_until (and (= (vehicle_test_seat v_sur_phantom_01 2) false) (= (vehicle_test_seat v_sur_phantom_01 6) false)) 10)
    (sleep 15)
...
(script command_script void cs_sur_phantom_02
    ...
    (cs_ignore_obstacles true)
    (if (survival_mode_scenario_extras_enable)
        (if (and (= (random_range 0 4) 0) (<= (object_get_health (ai_vehicle_get_from_spawn_point "sq_sur_wraith_02/driver")) 0))
    ...
    (sleep (random_range 5 15))
    (vehicle_unload v_sur_phantom_02 3)
    (sleep (random_range 5 15))
    (sleep_until (and (= (vehicle_test_seat v_sur_phantom_02 3) false) (= (vehicle_test_seat v_sur_phantom_02 7) false)) 10)
    ...
    (sleep (random_range 5 15))
    (vehicle_unload v_sur_phantom_02 2)
    (sleep (random_range 5 15))
    (sleep_until (and (= (vehicle_test_seat v_sur_phantom_02 2) false) (= (vehicle_test_seat v_sur_phantom_02 6) false)) 10)
    (sleep 15)
...
(script command_script void cs_sur_phantom_03
    ...
    (cs_ignore_obstacles true)
    (if (survival_mode_scenario_extras_enable)
        (if (and (= (random_range 0 4) 0) (<= (object_get_health (ai_vehicle_get_from_spawn_point "sq_sur_ghost_01/driver")) 0))
    ...
    (cs_vehicle_boost false)
    (if (= (vehicle_test_seat v_sur_phantom_03 32) true)
        (begin
            ...
            (vehicle_unload v_sur_phantom_03 32)
        )
        (begin
    ...
    (vehicle_unload v_sur_phantom_03 7)
    (sleep (random_range 5 15))
    (vehicle_unload v_sur_phantom_03 3)
    (sleep (random_range 5 15))
    (sleep_until (and (= (vehicle_test_seat v_sur_phantom_03 3) false) (= (vehicle_test_seat v_sur_phantom_03 7) false)) 10)
    (cs_fly_to_and_face "ps_sur_phantom_03/drop_03" "ps_sur_phantom_03/face_03" 1)
    (vehicle_unload v_sur_phantom_03 6)
    (sleep (random_range 5 15))
    (vehicle_unload v_sur_phantom_03 2)
    (sleep (random_range 5 15))
    (sleep_until (and (= (vehicle_test_seat v_sur_phantom_03 2) false) (= (vehicle_test_seat v_sur_phantom_03 6) false)) 10)
    (sleep 15)
...
(script command_script void cs_sur_phantom_04
    ...
    (cs_ignore_obstacles true)
    (if (survival_mode_scenario_extras_enable)
        (if (and (= (random_range 0 4) 0) (<= (object_get_health (ai_vehicle_get_from_spawn_point "sq_sur_ghost_02/driver")) 0))
    ...
    (cs_vehicle_boost false)
    (if (= (vehicle_test_seat v_sur_phantom_04 32) true)
        (begin
            ...
            (vehicle_unload v_sur_phantom_04 32)
        )
    )
...
(script dormant void survival_drop_spawn
    ...
    (sleep_until 
        (begin
            ...
            (sleep_until (and (<= (ai_living_count "gr_survival_waves") 10) (= (survival_mode_current_wave_is_boss) false) (= (survival_mode_current_wave_is_initial) false)))
            (if debug
...
(script continuous void drop_pod_05
    (sleep_forever)
    (sleep (random_range 5 15))
    (if debug
        (print "squad pod 05...")
    ...
    (vehicle_unload v_sur_drop_05 none)
...
(script continuous void drop_blip_05
    (sleep_forever)
    (if debug
...
(script dormant void survival_sniper_spawn
...
(script continuous void target_waypoint_01
    (sleep_forever)
    (if debug
        (print "placing waypoing on target 01...")
    )
    (sound_impulse_start sfx_blip none 1)
...
(script continuous void target_waypoint_02
    (sleep_forever)
    (if debug
        (print "placing waypoing on target 02...")
    )
    (sound_impulse_start sfx_blip none 1)
...
(script continuous void target_waypoint_03
    (sleep_forever)
    (if debug
        (print "placing waypoing on target 03...")
    )
    (sound_impulse_start sfx_blip none 1)
...
; Decompilation finished in ~0.0995953s
