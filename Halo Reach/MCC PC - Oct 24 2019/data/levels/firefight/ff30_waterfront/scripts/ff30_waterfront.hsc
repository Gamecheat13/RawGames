; ================================================================================================================
; ====== M30 WATERFRONT FIREFIGHT SCIRPTS =========================================================================
; ================================================================================================================
...
(script startup ff30_waterfront
...
(script command_script cs_sur_phantom_02
	...
	(cs_vehicle_speed 0.1)
		; ========= DRIVE-BY DROPOFF =============================
				...
				(sleep_until (= (vehicle_test_seat v_sur_phantom_02 "phantom_p_mr_f") 0))
				(sleep 30)
...
;====================================================== TEST SCRIPTS ======================================================
;This is for the Audio and FX guys to test out Drop Pods
