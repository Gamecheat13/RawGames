...
musicPackageCombatListener()
{
	...
	for ( ;; )
	{
		for ( ;; )
		{
			...
			wait 1.5; // make sure the alertCount stays in range for a couple seconds, to try to prevent quick oscillation
		...
		for ( ;; )
		{
			...
			wait 2; // make sure the alertCount stays in range for a couple seconds, to try to prevent quick oscillation
