...
/*QUAKED actor_sink-hole_enemy_TND16 (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE ENEMYINFO
...
main()
{
	...
	if( !isdefined( level.aitypenext["sink-hole_enemy_TND16_Head"] ) )
	{
		startIndex = randomint( 4 );
		level.aitypenext["sink-hole_enemy_TND16_Head"] = startIndex;
	}
	level.aitypenext["sink-hole_enemy_TND16_Head"] += 1;
	if( level.aitypenext["sink-hole_enemy_TND16_Head"] >= 4 )
		level.aitypenext["sink-hole_enemy_TND16_Head"] = 0;

	character = level.aitypenext["sink-hole_enemy_TND16_Head"];
