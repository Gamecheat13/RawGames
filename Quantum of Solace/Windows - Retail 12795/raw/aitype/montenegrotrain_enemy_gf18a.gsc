...
/*QUAKED actor_montenegrotrain_enemy_GF18a (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE ENEMYINFO
...
main()
{
	...
	if( !isdefined( level.aitypenext["montenegrotrain_enemy_GF18a_Head"] ) )
	{
		startIndex = randomint( 4 );
		level.aitypenext["montenegrotrain_enemy_GF18a_Head"] = startIndex;
	}
	level.aitypenext["montenegrotrain_enemy_GF18a_Head"] += 1;
	if( level.aitypenext["montenegrotrain_enemy_GF18a_Head"] >= 4 )
		level.aitypenext["montenegrotrain_enemy_GF18a_Head"] = 0;

	character = level.aitypenext["montenegrotrain_enemy_GF18a_Head"];
