...
/*QUAKED actor_gettler_enemy_Mantis (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE ENEMYINFO
defaultmdl="lc_thug_1_complete"
...
main()
{
	...
	if( !isdefined( level.aitypenext["gettler_enemy_Mantis_Head"] ) )
	{
		startIndex = randomint( 3 );
		level.aitypenext["gettler_enemy_Mantis_Head"] = startIndex;
	}
	level.aitypenext["gettler_enemy_Mantis_Head"] += 1;
	if( level.aitypenext["gettler_enemy_Mantis_Head"] >= 3 )
		level.aitypenext["gettler_enemy_Mantis_Head"] = 0;

	character = level.aitypenext["gettler_enemy_Mantis_Head"];
