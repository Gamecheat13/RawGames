...
/*QUAKED actor_barge_enemy_Pistol (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE ENEMYINFO
...
main()
{
	...
	if( !isdefined( level.aitypenext["barge_enemy_Pistol_Head"] ) )
	{
		startIndex = randomint( 4 );
		level.aitypenext["barge_enemy_Pistol_Head"] = startIndex;
	}
	level.aitypenext["barge_enemy_Pistol_Head"] += 1;
	if( level.aitypenext["barge_enemy_Pistol_Head"] >= 4 )
		level.aitypenext["barge_enemy_Pistol_Head"] = 0;

	character = level.aitypenext["barge_enemy_Pistol_Head"];
