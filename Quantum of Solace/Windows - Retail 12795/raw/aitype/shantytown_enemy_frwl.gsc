...
/*QUAKED actor_shantytown_enemy_FRWL (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE ENEMYINFO
...
main()
{
	...
	if( !isdefined( level.aitypenext["shantytown_enemy_FRWL_Head"] ) )
	{
		startIndex = randomint( 3 );
		level.aitypenext["shantytown_enemy_FRWL_Head"] = startIndex;
	}
	level.aitypenext["shantytown_enemy_FRWL_Head"] += 1;
	if( level.aitypenext["shantytown_enemy_FRWL_Head"] >= 3 )
		level.aitypenext["shantytown_enemy_FRWL_Head"] = 0;

	character = level.aitypenext["shantytown_enemy_FRWL_Head"];
