...
/*QUAKED actor_casino_enemy_ob_SAF9 (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE ENEMYINFO
...
main()
{
	...
	if( !isdefined( level.aitypenext["casino_enemy_ob_SAF9_Head"] ) )
	{
		startIndex = randomint( 3 );
		level.aitypenext["casino_enemy_ob_SAF9_Head"] = startIndex;
	}
	level.aitypenext["casino_enemy_ob_SAF9_Head"] += 1;
	if( level.aitypenext["casino_enemy_ob_SAF9_Head"] >= 3 )
		level.aitypenext["casino_enemy_ob_SAF9_Head"] = 0;

	character = level.aitypenext["casino_enemy_ob_SAF9_Head"];
