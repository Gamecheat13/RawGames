...
/*QUAKED actor_casino_enemy_A3Raker (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE ENEMYINFO
...
main()
{
	...
	if( !isdefined( level.aitypenext["casino_enemy_A3Raker_Head"] ) )
	{
		startIndex = randomint( 3 );
		level.aitypenext["casino_enemy_A3Raker_Head"] = startIndex;
	}
	level.aitypenext["casino_enemy_A3Raker_Head"] += 1;
	if( level.aitypenext["casino_enemy_A3Raker_Head"] >= 3 )
		level.aitypenext["casino_enemy_A3Raker_Head"] = 0;

	character = level.aitypenext["casino_enemy_A3Raker_Head"];
