...
/*QUAKED actor_sink-hole_enemy_8CAT (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE ENEMYINFO
...
main()
{
	...
	if( !isdefined( level.aitypenext["sink-hole_enemy_8CAT_Head"] ) )
	{
		startIndex = randomint( 4 );
		level.aitypenext["sink-hole_enemy_8CAT_Head"] = startIndex;
	}
	level.aitypenext["sink-hole_enemy_8CAT_Head"] += 1;
	if( level.aitypenext["sink-hole_enemy_8CAT_Head"] >= 4 )
		level.aitypenext["sink-hole_enemy_8CAT_Head"] = 0;

	character = level.aitypenext["sink-hole_enemy_8CAT_Head"];
