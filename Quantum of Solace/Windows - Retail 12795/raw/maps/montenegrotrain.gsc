...
main()
{
				...
				// starting the vision set right away in the level
				// VisionSetNaked( "MontenegroTrain_in", 0.5 );

				// debug text
				// iprintlnbold( "inside vision set" );

				// debug text
				// iprintlnbold( "changed to normal vision set" );
				if( level.ps3 || level.bx ) //GEBE
				{
					setculldist( 10000 );
...
end_to_black()
{
				...
				//BX-SDOMPIERRE - fade to black to hide ugly anim at the end
				screenfade(0.05);
				wait (2.0);
