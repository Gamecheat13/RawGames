...
main()
{
	...
	// Fog
//	setExpFog(0.0,2700.0,0.36,0.36,0.36,0.0);
    ...
    //exterior events
	registerFXTargetName("casino_sauna_steam");		// Steam in sauna area
	registerFXTargetName("casino_pool_steam");		// Steam in pool area
	registerFXTargetName("ballroom_confetti1_fx"); 	//no more then every 6sec
	registerFXTargetName("ballroom_confetti2_fx"); 	//no more then every 6sec
	registerFXTargetName("ballroom_sparks1_fx"); 	//no more then every 20sec
	registerFXTargetName("ballroom_sparks2_fx"); 	//no more then every 6sec
	...
	registerFXTargetName("small_glass_burst_fx1"); //these are for the braking glass wall animation
	...
	//level thread test_glass_fxs(); //CGuzman: for testing effects only

	level thread animate_aircraft_effect();
...
animate_aircraft_effect()
{
	...
	//level thread animate_effect("casino_747", (270,29.821,38.1789), (1791.7,4517.97,2771.95), (-535.052,-2232.27,2771.95), 80);
...
piano_chandelier()
{
	...
	{
		//println("************* FX: NOTE FOUND - gems_explode *************");		
...
spa_wall()
{
	...
	//particle goodness... hang in there frame rate ;)
...
{
	level waittill("e7_start"); //wait till the start of the fight	
...
//threading this for out of order support
...
precacheFX()
{
	...
	level._effect["casino_sauna_steam2"] 		= loadfx ("maps/casino/casino_sauna_steam2"); //1.379MB for this effect?
	...
	level._effect["casino_fountain"] 			= loadfx ("maps/casino/casino_fountain");
	...
	//removing the ballroom party effects to save about 200KB in memory
	//level._effect["casino_confetti1"] 		= loadfx ("maps/casino/casino_confetti1");
	//level._effect["casino_confetti_runner"] 	= loadfx ("maps/casino/casino_confetti_runner");
	//level._effect["casino_sparkler1"] 		= loadfx ("maps/casino/casino_sparkler1");
	//level._effect["casino_sparkler2"] 		= loadfx ("maps/casino/casino_sparkler2");
	level._effect["casino_spa_splash1"] 		= loadfx ("maps/casino/casino_spa_splash1");
	level._effect["casino_spa_splash2"] 		= loadfx ("maps/casino/casino_spa_splash2");
	level._effect["casino_747"] 				= loadfx ("misc/distant747_night");
	...
	level._effect["casino_fallthroughvent"]	 		= loadfx ("maps/Casino/casino_fallthroughvent");	

	//testing water effects
	...
	level._effect["casino_smoke_poof1"]	 		= loadfx ("maps/casino/casino_smoke_poof1");
