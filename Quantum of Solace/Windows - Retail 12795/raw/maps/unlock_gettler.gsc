...
main()
{
	...
	strings = [];
	strings[0] = &"UNLOCK_GETTLER_DEBRIEFING";
	strings[1] = &"UNLOCK_GETTLER_VESPER";
...
set_up_models()
{
	...
	//character_02 animscripted("foo", character_02.origin, character_02.angles, idleAnim);
	//character_03 animscripted("foo", character_03.origin, character_03.angles, idleAnim);
...
stop_rotate_p99( whites_p99, trigger, stop_trigger )
{
	...
	tutorial_message("@UNLOCK_GETTLER_WEAPON_01", 1);
...
stop_rotate_1911( whites_1911, trigger, stop_trigger )
{
	...
	tutorial_message("@UNLOCK_GETTLER_WEAPON_02", 1);
	level.player waittill( "tutorialclosed" );
...
stop_rotate_saf45( whites_saf45, trigger, stop_trigger )
{
	...
	tutorial_message("@UNLOCK_GETTLER_WEAPON_03", 1);
	level.player waittill( "tutorialclosed" );
...
stop_rotate_phone( whites_phone, trigger, stop_trigger )
{
	...
	tutorial_message("@UNLOCK_GETTLER_WEAPON_04", 1);
	level.player waittill( "tutorialclosed" );
...
concept_info_01()
{
	...
	while ( 1 )
	{
		...
		tutorial_message("@UNLOCK_GETTLER_CONCEPT_01", 1);
		level.player waittill( "tutorialclosed" );
		wait( .1 );
		level.player unlink();
		org delete();
...
concept_info_02()
{
	...
	while ( 1 )
	{
		...
		tutorial_message("@UNLOCK_GETTLER_CONCEPT_02", 1);
		level.player waittill( "tutorialclosed" );
		wait( .1 );
		level.player unlink();
		org delete();
...
concept_info_03()
{
	...
	while ( 1 )
	{
		...
		tutorial_message("@UNLOCK_GETTLER_CONCEPT_03", 1);
		level.player waittill( "tutorialclosed" );
		wait( .1 );
		level.player unlink();
		org delete();
...
concept_info_04()
{
	...
	while ( 1 )
	{
		...
		tutorial_message("@UNLOCK_GETTLER_CONCEPT_04", 1);
		level.player waittill( "tutorialclosed" );
		wait( .1 );
		level.player unlink();
		org delete();
...
level_end1()
{
	...
	trigger sethintstring (&"UNLOCK_GETTLER_EXIT");
	trigger waittill("trigger");
	changelevel( "", false, 0 );
}
