...
methodsInit()
{
	...
	level._leak_methods["MOD_HEAD_SHOT"] 			= ::leak_calc_assert;
	level._leak_methods["MOD_CRUSH"] 				= ::leak_calc_assert;
	level._leak_methods["MOD_TELEFRAG"] 			= ::leak_calc_assert;
	level._leak_methods["MOD_FALLING"] 				= ::leak_calc_assert;
	level._leak_methods["MOD_SUICIDE"] 				= ::leak_calc_assert;
...
{
	assertMsg("Leaking object at (" + self getorigin() + ") impacted with unknown type: " + type + ".");
}
