...
bond_d_veh_death( iRadius, iMaxDmg, iMinDmg, sTag, vOffset, iWarnTime )
{
	...
	{	
		...
		//----------------------------------------------
		//This is a behavior which was present in the previous system and is necessary for ScienceA
		...
		//----------------------------------------------
		// Restaure previous state
		if( level.player isdemigod() && !playerWasDemiGod )
		{	
