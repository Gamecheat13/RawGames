...
main()
{
	...
	level.friendlyfire["enemy_kill_points"]	= 200;	// this many participation points are earned for killing an enemy
	level.friendlyfire["friend_kill_points"] = -700;// participation point penalty for killing a friendly
	level.friendlyfire["point_loss_interval"] = 0.4;// amount of time a point lasts
...
friendly_fire_think(entity)
{
	...
	for (;;)
	{
		...
		//At this point we made sure the attacker is the player... so I can freely use level.player
