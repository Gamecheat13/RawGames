...
main()
{
	...
	strings = [];
	strings[0] = &"UNLOCK_CONSTRUCTIONSITE_DEBRIEFING";
	strings[1] = &"UNLOCK_CONSTRUCTIONSITE_MADAGASCAR";
...
stop_rotate_p99( whites_p99, trigger, stop_trigger )
{
	...
	tutorial_message("@UNLOCK_CONSTRUCTIONSITE_WEAPON_01", 1);
...
stop_rotate_1911( whites_1911, trigger, stop_trigger )
{
	...
	tutorial_message("@UNLOCK_CONSTRUCTIONSITE_WEAPON_02", 1);
	level.player waittill( "tutorialclosed" );
...
stop_rotate_saf45( whites_saf45, trigger, stop_trigger )
{
	...
	tutorial_message("@UNLOCK_CONSTRUCTIONSITE_WEAPON_03", 1);
	level.player waittill( "tutorialclosed" );
...
stop_rotate_phone( whites_phone, trigger, stop_trigger )
{
	...
	tutorial_message("@UNLOCK_CONSTRUCTIONSITE_WEAPON_04", 1);
	level.player waittill( "tutorialclosed" );
...
concept_info_01()
{
	...
	while ( 1 )
	{
		...
		tutorial_message("@UNLOCK_CONSTRUCTIONSITE_CONCEPT_01", 1);
		level.player waittill( "tutorialclosed" );
		wait( .1 );
		level.player unlink();
		org delete();
...
concept_info_02()
{
	...
	while ( 1 )
	{
		...
		tutorial_message("@UNLOCK_CONSTRUCTIONSITE_CONCEPT_02", 1);
		level.player waittill( "tutorialclosed" );
		wait( .1 );
		level.player unlink();
		org delete();
...
concept_info_03()
{
	...
	while ( 1 )
	{
		...
		tutorial_message("@UNLOCK_CONSTRUCTIONSITE_CONCEPT_03", 1);
		level.player waittill( "tutorialclosed" );
		wait( .1 );
		level.player unlink();
		org delete();
...
concept_info_04()
{
	...
	while ( 1 )
	{
		...
		tutorial_message("@UNLOCK_CONSTRUCTIONSITE_CONCEPT_04", 1);
		level.player waittill( "tutorialclosed" );
		wait( .1 );
		level.player unlink();
		org delete();
...
link_weapons()
{
	...
	attachment2 linkto(base2);

	base3 = getent("whites_saf45", "targetname");
	attachment3 = getent("attachment3", "targetname");

	attachment3 linkto( base3, "TAG_CLIP_M60E3", ( 0, 0, 0 ), ( 0, 0, 0 ));
}

level_end1()
{
	trigger = getent("level_end_trigger1", "targetname");
	trigger sethintstring (&"UNLOCK_CONSTRUCTIONSITE_EXIT");
	trigger waittill("trigger");
	changelevel( "", false, 0 );
}
