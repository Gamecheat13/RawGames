...
{	
	...
	level._effect["exp_extinguisher"]   = loadfx ( "smoke/fire_extinguisher" );
	...
	level._effect["heat_shimmer"]		= loadfx ("weather/heat_shimmer_large");
	...
	level._effect["eco_heat_shimmer"]   	= loadfx ( "weather/heat_shimmer_large" );		
	level._effect["eco_vultures"]   		= loadfx ( "maps/eco_hotel/eco_vultures" );
	level._effect["eco_dust_devil_r2"]   	= loadfx ( "maps/eco_hotel/eco_dust_devil_r2" );
	level._effect["eco_windy_sand_r"]   	= loadfx ( "maps/eco_hotel/eco_windy_sand_r" );

		level._effect["fx_fire_small"]	= loadfx ("maps/Eco_Hotel/eco_fire_2");
		level._effect["fx_fire_med"]	= loadfx ("maps/Eco_Hotel/eco_fire_2");

	
if ( level.ps3 == false ) //GEBE
	{	
		level._effect["fx_fire_large"]	= loadfx ("maps/Eco_Hotel/eco_fire_1");
		level._effect[ "propane_fire" ]	= loadfx( "maps/Eco_Hotel/eco_fire_1" );
	}
	...
	{	
		level._effect["fx_fire_large"]	= loadfx ("maps/Eco_Hotel/eco_fire_1_PS3");
		level._effect[ "propane_fire" ]	= loadfx( "maps/Eco_Hotel/eco_fire_1_PS3" );
	}
