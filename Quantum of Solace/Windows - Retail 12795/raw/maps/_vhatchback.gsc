...
main(model, type)
{
	...
	switch(model)	
	{
		case "v_hatchback_clean_radiant":
			precachemodel("v_hatchback_clean_radiant");
			level.vehicle_deathmodel[model] = "v_hatchback_clean_radiant";
			break;

		case "v_hatchback_clean_silver_radiant":
			precachemodel("v_hatchback_clean_silver_radiant");
			level.vehicle_deathmodel[model] = "v_hatchback_clean_silver_radiant";
			break;

		case "v_hatchback_clean_black_radiant":
			precachemodel("v_hatchback_clean_black_radiant");
			level.vehicle_deathmodel[model] = "v_hatchback_clean_black_radiant";
			break;

		case "v_hatchback_clean_red_radiant":
			precachemodel("v_hatchback_clean_red_radiant");
			level.vehicle_deathmodel[model] = "v_hatchback_clean_red_radiant";
			break;

		case "v_hatchback_clean_blue_radiant":
			precachemodel("v_hatchback_clean_blue_radiant");
			level.vehicle_deathmodel[model] = "v_hatchback_clean_blue_radiant";
			break;
	}
