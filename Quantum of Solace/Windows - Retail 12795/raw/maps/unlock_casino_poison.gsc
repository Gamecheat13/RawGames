...
main()
{
	...
	strings = [];
	strings[0] = &"UNLOCK_CASINO_POISON_DEBRIEFING";
	strings[1] = &"UNLOCK_CASINO_POISON_MONTENEGRO";
...
stop_rotate_p99( whites_p99, trigger, stop_trigger )
{
	...
	tutorial_message("@UNLOCK_CASINO_POISON_WEAPON_01", 1);
...
stop_rotate_1911( whites_1911, trigger, stop_trigger )
{
	...
	tutorial_message("@UNLOCK_CASINO_POISON_WEAPON_02", 1);
	level.player waittill( "tutorialclosed" );
...
stop_rotate_saf45( whites_saf45, trigger, stop_trigger )
{
	...
	tutorial_message("@UNLOCK_CASINO_POISON_WEAPON_03", 1);
	level.player waittill( "tutorialclosed" );
...
stop_rotate_phone( whites_phone, trigger, stop_trigger )
{
	...
	tutorial_message("@UNLOCK_CASINO_POISON_WEAPON_04", 1);
	level.player waittill( "tutorialclosed" );
...
concept_info_01()
{
	...
	while ( 1 )
	{
		...
		tutorial_message("@UNLOCK_CASINO_POISON_CONCEPT_01", 1);
		level.player waittill( "tutorialclosed" );
		wait( .1 );
		level.player unlink();
		org delete();
...
concept_info_02()
{
	...
	while ( 1 )
	{
		...
		tutorial_message("@UNLOCK_CASINO_POISON_CONCEPT_02", 1);
		level.player waittill( "tutorialclosed" );
		wait( .1 );
		level.player unlink();
		org delete();
...
concept_info_03()
{
	...
	while ( 1 )
	{
		...
		tutorial_message("@UNLOCK_CASINO_POISON_CONCEPT_03", 1);
		level.player waittill( "tutorialclosed" );
		wait( .1 );
		level.player unlink();
		org delete();
...
concept_info_04()
{
	...
	while ( 1 )
	{
		...
		tutorial_message("@UNLOCK_CASINO_POISON_CONCEPT_04", 1);
		level.player waittill( "tutorialclosed" );
		wait( .1 );
		level.player unlink();
		org delete();
...
level_end1()
{
	...
	trigger sethintstring (&"UNLOCK_CASINO_POISON_EXIT");
	trigger waittill("trigger");
	changelevel( "", false, 0 );
}
