...
vehicle_exit()
{
	...
	// turn oon player health/damage
	level.player DisableInvulnerability();
	setDvar("ui_hud_showstanceicon","1");

	//todo - no referencing turret types here.
...
vehicle_enter()
{
	...
	self setPlayerControlled(true);	// adds the new code support for giving the player limited control
//	if ( (self.vehicletype == "tiger") || (self.vehicletype == "crusader") || (self.vehicletype == "crusader_player") || (self.vehicletype == "panzer2") || self.vehicletype == "flak88" || self.vehicletype == "flak88_forward")
	...
	//
	//TODO: we should do vehicle specific start up stuff here (rev up the engine, animation, etc.)
	//
...
//setup_vehicle_tank()	// no longer refferenced anywhere, and doesn't do anything
//{
...
//	self thread vehicle_hud_tank_fireicon();
	...
	self.maximumhealth = self.health / 2;	// Never regen to more than half of max health
...
///////////////////////////////////////////////////////////////////////////////////////////
// bond_veh_drive_damage -	Handles ehicle health meter and hud of player vehicle
//							Visible vehicle damage is handled in _vehicle::bond_veh_damage
///////////////////////////////////////////////////////////////////////////////////////////
