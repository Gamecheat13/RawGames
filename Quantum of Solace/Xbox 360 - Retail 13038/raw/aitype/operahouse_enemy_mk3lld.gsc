...
/*QUAKED actor_operahouse_enemy_MK3LLD (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE ENEMYINFO
...
main()
{
	...
	if( !isdefined( level.aitypenext["operahouse_enemy_MK3LLD_Head"] ) )
	{
		startIndex = randomint( 4 );
		level.aitypenext["operahouse_enemy_MK3LLD_Head"] = startIndex;
	}
	level.aitypenext["operahouse_enemy_MK3LLD_Head"] += 1;
	if( level.aitypenext["operahouse_enemy_MK3LLD_Head"] >= 4 )
		level.aitypenext["operahouse_enemy_MK3LLD_Head"] = 0;

	character = level.aitypenext["operahouse_enemy_MK3LLD_Head"];
