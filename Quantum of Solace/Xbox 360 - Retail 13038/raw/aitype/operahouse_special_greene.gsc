...
/*QUAKED actor_operahouse_special_Greene (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE ENEMYINFO
...
main()
{
	...
	character\character_greene_tux::main();
}
...
precache()
{
	character\character_greene_tux::precache();
