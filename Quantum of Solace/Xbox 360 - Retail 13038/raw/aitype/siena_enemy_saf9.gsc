...
/*QUAKED actor_siena_enemy_SAF9 (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE ENEMYINFO
...
main()
{
	...
	if( !isdefined( level.aitypenext["siena_enemy_SAF9_Head"] ) )
	{
		startIndex = randomint( 4 );
		level.aitypenext["siena_enemy_SAF9_Head"] = startIndex;
	}
	level.aitypenext["siena_enemy_SAF9_Head"] += 1;
	if( level.aitypenext["siena_enemy_SAF9_Head"] >= 4 )
		level.aitypenext["siena_enemy_SAF9_Head"] = 0;

	character = level.aitypenext["siena_enemy_SAF9_Head"];
