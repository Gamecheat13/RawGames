...
/*QUAKED actor_eco-hotel_enemy_M14 (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE ENEMYINFO
...
main()
{
	...
	if( !isdefined( level.aitypenext["eco-hotel_enemy_M14_Head"] ) )
	{
		startIndex = randomint( 4 );
		level.aitypenext["eco-hotel_enemy_M14_Head"] = startIndex;
	}
	level.aitypenext["eco-hotel_enemy_M14_Head"] += 1;
	if( level.aitypenext["eco-hotel_enemy_M14_Head"] >= 4 )
		level.aitypenext["eco-hotel_enemy_M14_Head"] = 0;

	character = level.aitypenext["eco-hotel_enemy_M14_Head"];
