...
/*QUAKED actor_gettler_civilian_Male (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE ENEMYINFO
...
main()
{
	...
	if( !isdefined( level.aitypenext["gettler_civilian_Male_Head"] ) )
	{
		startIndex = randomint( 3 );
		level.aitypenext["gettler_civilian_Male_Head"] = startIndex;
	}
	level.aitypenext["gettler_civilian_Male_Head"] += 1;
	if( level.aitypenext["gettler_civilian_Male_Head"] >= 3 )
		level.aitypenext["gettler_civilian_Male_Head"] = 0;

	character = level.aitypenext["gettler_civilian_Male_Head"];
