...
play_bus_crash()
{
	bus_var = GetEnt("gallery_bus","targetname");
	bus_var playsound("bus_move");
	wait(5.0);
	bus_var playsound("bus_skid");
	wait(2.0);
	bus_var playsound("bus_crash");
	
}

play_crowd_panic()
{
	market_crowd_zone_var = getent("market_crowd_zone", "targetname");
	
	if(IsDefined(market_crowd_zone_var))
	{
		//wait(0.5);
		market_crowd_zone_var playsound("crowd_panic");
	}
