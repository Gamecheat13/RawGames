...
vehicle_80s_wagon1( color )
{
	...
	destructible_create( "vehicle_80s_wagon1_" + color, 300, undefined, 32, "no_melee" );
		...
		// Glass ( Front )
		tag = "tag_glass_front";
		destructible_part( tag, "vehicle_80s_wagon1_glass_F", 99 );
			destructible_state( tag, "vehicle_80s_wagon1_glass_F_dam", 200 );
			destructible_fx( "tag_glass_front_fx", "props/car_glass_large" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Back )
		tag = "tag_glass_back";
		destructible_part( tag, "vehicle_80s_wagon1_glass_B", 99 );
			destructible_state( tag, "vehicle_80s_wagon1_glass_B_dam", 200 );
			destructible_fx( "tag_glass_back_fx", "props/car_glass_large" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Left Front )
		tag = "tag_glass_left_front";
		destructible_part( tag, "vehicle_80s_wagon1_glass_LF", 99 );
			destructible_state( tag, "vehicle_80s_wagon1_glass_LF_dam", 200 );
			destructible_fx( "tag_glass_left_front_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Right Front )
		tag = "tag_glass_right_front";
		destructible_part( tag, "vehicle_80s_wagon1_glass_RF", 99 );
			destructible_state( tag, "vehicle_80s_wagon1_glass_RF_dam", 200 );
			destructible_fx( "tag_glass_right_front_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Left Back )
		tag = "tag_glass_left_back";
		destructible_part( tag, "vehicle_80s_wagon1_glass_LB", 99 );
			destructible_state( tag, "vehicle_80s_wagon1_glass_LB_dam", 200 );
			destructible_fx( "tag_glass_left_back_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Right Back )
		tag = "tag_glass_right_back";
		destructible_part( tag, "vehicle_80s_wagon1_glass_RB", 99 );
			destructible_state( tag, "vehicle_80s_wagon1_glass_RB_dam", 200 );
			destructible_fx( "tag_glass_right_back_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Left Back 2 )
		tag = "tag_glass_left_back2";
		destructible_part( tag, "vehicle_80s_wagon1_glass_LB2", 99 );
			destructible_state( tag, "vehicle_80s_wagon1_glass_LB2_dam", 200 );
			destructible_fx( "tag_glass_left_back2_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Right Back 2 )
		tag = "tag_glass_right_back2";
		destructible_part( tag, "vehicle_80s_wagon1_glass_RB2", 99 );
			destructible_state( tag, "vehicle_80s_wagon1_glass_RB2_dam", 200 );
...
vehicle_80s_hatch1( color )
{
	...
	destructible_create( "vehicle_80s_hatch1_" + color, 300, undefined, 32, "no_melee" );
		...
		// Glass ( Front )
		tag = "tag_glass_front";
		destructible_part( tag, "vehicle_80s_hatch1_glass_F", 99 );
			destructible_state( tag, "vehicle_80s_hatch1_glass_F_dam", 200 );
			destructible_fx( "tag_glass_front_fx", "props/car_glass_large" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Back )
		tag = "tag_glass_back";
		destructible_part( tag, "vehicle_80s_hatch1_glass_B", 99 );
			destructible_state( tag, "vehicle_80s_hatch1_glass_B_dam", 200 );
			destructible_fx( "tag_glass_back_fx", "props/car_glass_large" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Left Front )
		tag = "tag_glass_left_front";
		destructible_part( tag, "vehicle_80s_hatch1_glass_LF", 99 );
			destructible_state( tag, "vehicle_80s_hatch1_glass_LF_dam", 200 );
			destructible_fx( "tag_glass_left_front_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Right Front )
		tag = "tag_glass_right_front";
		destructible_part( tag, "vehicle_80s_hatch1_glass_RF", 99 );
			destructible_state( tag, "vehicle_80s_hatch1_glass_RF_dam", 200 );
			destructible_fx( "tag_glass_right_front_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Left Back )
		tag = "tag_glass_left_back";
		destructible_part( tag, "vehicle_80s_hatch1_glass_LB", 99 );
			destructible_state( tag, "vehicle_80s_hatch1_glass_LB_dam", 200 );
			destructible_fx( "tag_glass_left_back_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Right Back )
		tag = "tag_glass_right_back";
		destructible_part( tag, "vehicle_80s_hatch1_glass_RB", 99 );
			destructible_state( tag, "vehicle_80s_hatch1_glass_RB_dam", 200 );
			destructible_fx( "tag_glass_right_back_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Head Light ( Left )
...
vehicle_80s_hatch2( color )
{
	...
	destructible_create( "vehicle_80s_hatch2_" + color, 300, undefined, 32, "no_melee" );
		...
		// Glass ( Front )
		tag = "tag_glass_front";
		destructible_part( tag, "vehicle_80s_hatch2_glass_F", 99 );
			destructible_state( tag, "vehicle_80s_hatch2_glass_F_dam", 200 );
			destructible_fx( "tag_glass_front_fx", "props/car_glass_large" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Back )
		tag = "tag_glass_back";
		destructible_part( tag, "vehicle_80s_hatch2_glass_B", 99 );
			destructible_state( tag, "vehicle_80s_hatch2_glass_B_dam", 200 );
			destructible_fx( "tag_glass_back_fx", "props/car_glass_large" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Left Front )
		tag = "tag_glass_left_front";
		destructible_part( tag, "vehicle_80s_hatch2_glass_LF", 99 );
			destructible_state( tag, "vehicle_80s_hatch2_glass_LF_dam", 200 );
			destructible_fx( "tag_glass_left_front_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Right Front )
		tag = "tag_glass_right_front";
		destructible_part( tag, "vehicle_80s_hatch2_glass_RF", 99 );
			destructible_state( tag, "vehicle_80s_hatch2_glass_RF_dam", 200 );
			destructible_fx( "tag_glass_right_front_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Left Back )
		tag = "tag_glass_left_back";
		destructible_part( tag, "vehicle_80s_hatch2_glass_LB", 99 );
			destructible_state( tag, "vehicle_80s_hatch2_glass_LB_dam", 200 );
			destructible_fx( "tag_glass_left_back_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Right Back )
		tag = "tag_glass_right_back";
		destructible_part( tag, "vehicle_80s_hatch2_glass_RB", 99 );
			destructible_state( tag, "vehicle_80s_hatch2_glass_RB_dam", 200 );
			destructible_fx( "tag_glass_right_back_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Head Light ( Left )
...
vehicle_small_wagon( color )
{
	...
	destructible_create( "vehicle_small_wagon_" + color, 300, undefined, 32, "no_melee" );
		...
		// Glass ( Front )
		tag = "tag_glass_front";
		destructible_part( tag, "vehicle_small_wagon_glass_F", 99 );
			destructible_state( tag, "vehicle_small_wagon_glass_F_dam", 200 );
			destructible_fx( "tag_glass_front_fx", "props/car_glass_large" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Back )
		tag = "tag_glass_back";
		destructible_part( tag, "vehicle_small_wagon_glass_B", 99 );
			destructible_state( tag, "vehicle_small_wagon_glass_B_dam", 200 );
			destructible_fx( "tag_glass_back_fx", "props/car_glass_large" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Left Front )
		tag = "tag_glass_left_front";
		destructible_part( tag, "vehicle_small_wagon_glass_LF", 99 );
			destructible_state( tag, "vehicle_small_wagon_glass_LF_dam", 200 );
			destructible_fx( "tag_glass_left_front_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Right Front )
		tag = "tag_glass_right_front";
		destructible_part( tag, "vehicle_small_wagon_glass_RF", 99 );
			destructible_state( tag, "vehicle_small_wagon_glass_RF_dam", 200 );
			destructible_fx( "tag_glass_right_front_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Left Back )
		tag = "tag_glass_left_back";
		destructible_part( tag, "vehicle_small_wagon_glass_LB", 99 );
			destructible_state( tag, "vehicle_small_wagon_glass_LB_dam", 200 );
			destructible_fx( "tag_glass_left_back_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Right Back )
		tag = "tag_glass_right_back";
		destructible_part( tag, "vehicle_small_wagon_glass_RB", 99 );
			destructible_state( tag, "vehicle_small_wagon_glass_RB_dam", 200 );
			destructible_fx( "tag_glass_right_back_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Head Light ( Left )
...
vehicle_small_hatch( color )
{
	...
	// small hatch
	//---------------------------------------------------------------------
	destructible_create( "vehicle_small_hatch_" + color, 500, undefined, 32, "no_melee" );
				destructible_loopfx( "tag_hood_fx", "smoke/car_damage_whitesmoke", 0.4 );
...
//			destructible_sound( "veh_tire_deflate", "bullet" );
		...
		// Glass ( Front )
		tag = "tag_glass_front";
		destructible_part( tag, "vehicle_small_hatch_glass_F", 99 );
			destructible_state( tag, "vehicle_small_hatch_glass_F_dam", 200 );
			destructible_fx( "tag_glass_front_fx", "props/car_glass_med" );
//			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Back )
		tag = "tag_glass_back";
		destructible_part( tag, "vehicle_small_hatch_glass_B", 99 );
			destructible_state( tag, "vehicle_small_hatch_glass_B_dam", 200 );
			destructible_fx( "tag_glass_back_fx", "props/car_glass_med" );
//			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Left Front )
		tag = "tag_glass_left_front";
		destructible_part( tag, "vehicle_small_hatch_glass_LF", 99 );
			destructible_state( tag, "vehicle_small_hatch_glass_LF_dam", 200 );
			destructible_fx( "tag_glass_left_front_fx", "props/car_glass_med" );
//			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Right Front )
		tag = "tag_glass_right_front";
		destructible_part( tag, "vehicle_small_hatch_glass_RF", 99 );
			destructible_state( tag, "vehicle_small_hatch_glass_RF_dam", 200 );
			destructible_fx( "tag_glass_right_front_fx", "props/car_glass_med" );
//			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Left Back )
		tag = "tag_glass_left_back";
		destructible_part( tag, "vehicle_small_hatch_glass_LB", 99 );
			destructible_state( tag, "vehicle_small_hatch_glass_LB_dam", 200 );
			destructible_fx( "tag_glass_left_back_fx", "props/car_glass_med" );
//			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Right Back )
		tag = "tag_glass_right_back";
		destructible_part( tag, "vehicle_small_hatch_glass_RB", 99 );
			destructible_state( tag, "vehicle_small_hatch_glass_RB_dam", 200 );
			destructible_fx( "tag_glass_right_back_fx", "props/car_glass_med" );
//			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Head Light ( Left )
