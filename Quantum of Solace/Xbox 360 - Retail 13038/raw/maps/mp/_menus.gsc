...
/*	thread initThumbstickLayout();
	...
	setting.displaytext[4] = &"MPUI_INTELLIGENCE_HUNT";
	setting.displaytext[5] = &"MPUI_BOMBING_RUN";
	setting.displaytext[6] = &"MPUI_RECRUITMENT";
	setting.displaytext[7] = &"MPUI_ASSASSINATION";
	setting.displaytext[8] = &"MPUI_TEAM_ASSASSINATION";
	setting.displaytext[9] = &"MPUI_TEAM_TERRITORY_CONTROL";
	setting.displaytext[10] = &"MPUI_BOND_VERSUS";
