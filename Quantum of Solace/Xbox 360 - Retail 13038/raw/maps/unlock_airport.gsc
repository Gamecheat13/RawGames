...
main()
{
	...
	strings = [];
	strings[0] = &"UNLOCK_AIRPORT_MI6_DEBRIEFING";
	strings[1] = &"UNLOCK_AIRPORT_MIAMI";
...
set_up_models()
{
	...
	character_01 animscripted("foo", character_01.origin, character_01.angles, maleidleAnim);
...
stop_rotate_p99( whites_p99, trigger, stop_trigger )
{
	...
	tutorial_message("@UNLOCK_AIRPORT_WEAPON_01", 1);
...
stop_rotate_1911( whites_1911, trigger, stop_trigger )
{
	...
	tutorial_message("@UNLOCK_AIRPORT_WEAPON_02", 1);
	level.player waittill( "tutorialclosed" );
...
stop_rotate_saf45( whites_saf45, trigger, stop_trigger )
{
	...
	tutorial_message("@UNLOCK_AIRPORT_WEAPON_03", 1);
	level.player waittill( "tutorialclosed" );
...
weapons_display_phone()
{
	...
	stop_trigger thread stop_rotate_phone( whites_phone, trigger, stop_trigger );
...
//avulaj
//
stop_rotate_phone( whites_phone, trigger, stop_trigger )
{
	self waittill ( "trigger" );
	...
	tutorial_message("@UNLOCK_AIRPORT_WEAPON_04", 1);
	level.player waittill( "tutorialclosed" );
...
concept_info_01()
{
	...
	while ( 1 )
	{
		...
		//trigger sethintstring (&"UNLOCK_AIRPORT_CONCEPT_01");
		trigger waittill ( "trigger" );
		org = spawn( "script_origin",level.player.origin );
		level.player playerlinktodelta ( org, undefined );
		trigger trigger_off();

		tutorial_message("@UNLOCK_AIRPORT_CONCEPT_01", 1);
		level.player waittill( "tutorialclosed" );
		wait( .1 );
		level.player unlink();
		org delete();
...
concept_info_02()
{
	...
	while ( 1 )
	{
		...
		//trigger sethintstring (&"UNLOCK_AIRPORT_CONCEPT_02");
		trigger waittill ( "trigger" );
		org = spawn( "script_origin",level.player.origin );
		level.player playerlinktodelta ( org, undefined );
		trigger trigger_off();

		tutorial_message("@UNLOCK_AIRPORT_CONCEPT_02", 1);
		level.player waittill( "tutorialclosed" );
		wait( .1 );
		level.player unlink();
		org delete();
...
concept_info_03()
{
	...
	while ( 1 )
	{
		...
		//trigger sethintstring (&"UNLOCK_AIRPORT_CONCEPT_03");
		trigger waittill ( "trigger" );
		org = spawn( "script_origin",level.player.origin );
		level.player playerlinktodelta ( org, undefined );
		trigger trigger_off();

		tutorial_message("@UNLOCK_AIRPORT_CONCEPT_03", 1);
		level.player waittill( "tutorialclosed" );
		wait( .1 );
		level.player unlink();
		org delete();
...
concept_info_04()
{
	...
	while ( 1 )
	{
		...
		//trigger sethintstring (&"UNLOCK_AIRPORT_CONCEPT_04");
		trigger waittill ( "trigger" );
		org = spawn( "script_origin",level.player.origin );
		level.player playerlinktodelta ( org, undefined );
		trigger trigger_off();

		tutorial_message("@UNLOCK_AIRPORT_CONCEPT_04", 1);
		level.player waittill( "tutorialclosed" );
		wait( .1 );
		level.player unlink();
		org delete();
...
link_weapons()
{
	base = getent("whites_phone", "targetname");
	...
	base2 = getent("whites_saf45", "targetname");
	attachment3 = getent("attachment3", "targetname");
	attachment4 = getent("attachment4", "targetname");
	attachment5 = getent("attachment5", "targetname");
	attachment6 = getent("attachment6", "targetname");

	attachment3 linkto(base2);
	attachment4 linkto(base2);
	attachment5 linkto(base2);
	attachment6 linkto(base2);


	base3 = getent("whites_1911", "targetname");
	...
	attachment7 linkto(base3);
	attachment8 linkto(base3);
	attachment9 linkto(base3);

	base4 = getent("whites_p99", "targetname");
	attachment11 = getent("attachment11", "targetname");
	attachment12 = getent("attachment12", "targetname");
	attachment13 = getent("attachment13", "targetname");
	attachment14 = getent("attachment14", "targetname");

	attachment11 linkto(base4);
	attachment12 linkto(base4);
	attachment13 linkto(base4);
	attachment14 linkto(base4);
}

level_end1()
{
	trigger = getent("level_end_trigger1", "targetname");
	trigger sethintstring (&"UNLOCK_AIRPORT_EXIT");
	trigger waittill("trigger");
	changelevel( "", false, 0 );
}
