...
constrainGameType(gametype)
{
	...
	for(i = 0; i < entities.size; i++)
	{
		...
		{
			if(isdefined(entity.script_gametype_ih) && entity.script_gametype_ih != "1")
			{
		...
		{
			if(isdefined(entity.script_gametype_br) && entity.script_gametype_br != "1")
			{
				
				entity delete();	
			}
		}
		else if(gametype == "rec")
		{
			if(isdefined(entity.script_gametype_rec) && entity.script_gametype_rec != "1")
			{
		...
		{
			if(isdefined(entity.script_gametype_as) && entity.script_gametype_as != "1")
			{
		...
		{
			if(isdefined(entity.script_gametype_vs) && entity.script_gametype_vs != "1")
			{
		...
		{
			if(isdefined(entity.script_gametype_spy) && entity.script_gametype_spy != "1")
			{
