...
init()
{
	...
	level.bcSounds = [];
	level.bcSounds["reload"] = "COVR_REL";
	level.bcSounds["frag_out"] = "THRW_FRT";
	level.bcSounds["flash_out"] = "THRW_FBT";
	level.bcSounds["smoke_out"] = "THRW_SGT";
	level.bcSounds["tear_out"] = "THRW_TGT";
	level.bcSounds["conc_out"] = "THRW_INT";
	...
	level.bcSounds["proxmine_plant"] = "BOMB_ARD";
	level.bcSounds["ied_plant"] = "BOMB_ARM";
	level.bcSounds["kill"] = "KILL_KIL";	
