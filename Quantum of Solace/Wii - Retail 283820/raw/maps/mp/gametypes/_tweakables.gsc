...
init()
{
	...
	registerTweakable( "game",			"countdowntime",		"scr_game_countdowntime",			10); 
	...
	registerTweakable( "weapon", 	"allowproxmines", 	"scr_weapon_allowproxmines", 1 );	
	...
	registerTweakable( "hud", 		"showcrosshair", 	"cg_drawCrosshair", 						1 ); 
	setClientTweakable( "hud", 		"showcrosshair" );

	registerTweakable( "hud", 		"showfragindicator", 	"cg_hudGrenadeIconMaxRangeFrag", 		250 ); 
	setClientTweakable( "hud", 		"showfragindicator" );

	registerTweakable( "hud", 		"showflashindicator", 	"cg_hudGrenadeIconMaxRangeFlash", 		500 ); 
