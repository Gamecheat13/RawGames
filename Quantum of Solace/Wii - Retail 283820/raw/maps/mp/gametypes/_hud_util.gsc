...
createPrimaryProgressBar(_color,_height)
{
	color = (0.5, 1, 0);		
	if (isDefined(_color))
		color = _color;
	...
	bar = createBar(color, level.primaryProgressBarWidth, height);
...
{
	bar = createBar( (0.5, 1, 0), level.secondaryProgressBarWidth, level.secondaryProgressBarHeight );
