	...
	while( 1 )
	{
		...
		if( awareness_object.enabled )
		{
			...
			if( radius_zone > 0 || level.awarenessZoneMix != 0 )
			{
				...
				else if( level.awarenessZoneMix == 2 ) 
				{
				...
				else if( level.awarenessZoneMix == 3 ) 
				{
					if( periphery_zone == 0 )
						periphery_zone = 4;
				...
				else if( level.awarenessZoneMix == 4 ) 
				{
					swap_zone = periphery_zone;
					periphery_zone = radius_zone;
					radius_zone = swap_zone;
				}
				else if( level.awarenessZoneMix == 5 ) 
				{
					periphery_zone = radius_zone;
				}
				else if( level.awarenessZoneMix == 6 ) 
				{
					radius_zone = periphery_zone;
				}
