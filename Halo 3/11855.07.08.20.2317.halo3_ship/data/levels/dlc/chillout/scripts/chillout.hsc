...
; 
; Source file: chillout.hsc
; Start time: 2018-06-29 7:44:18 AM
; 
...
(script startup void chillout_main
    (vehicle_auto_turret "camera0" "tv_camera0" 0 0 0)
)

(script continuous void chillout_all
    (add_recycling_volume "garbage" 30 30)
    (sleep 900)
)

; Decompilation finished in ~0.0490473s
