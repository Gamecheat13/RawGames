...
; 
; Source file: sandbox.hsc
; Start time: 2018-06-29 7:42:56 AM
; 
...
(script startup void sandbox_main
    (print "hi")
    (vehicle_auto_turret "turret_north0" "tv_turret_north0" 159 169 5)
    (vehicle_auto_turret "turret_north1" "tv_turret_north1" 166.4 176.4 5)
    (vehicle_auto_turret "turret_side0" "tv_turret_side0" 171.5 181.5 5)
    (vehicle_auto_turret "turret_south0" "tv_turret_south0" 160.2 170.2 5)
    (vehicle_auto_turret "turret_south1" "tv_turret_south1" 171 181 5)
    (vehicle_auto_turret "turret_side1" "tv_turret_side1" 174 184 5)
)

(script continuous void sandbox_main_collection
    (add_recycling_volume "garbage" 30 30)
    (sleep 900)
)

(script dormant void volume_test
    (sleep_until 
        (begin
            (if (volume_test_players "tv_turret_north0")
                (print "tv_turret_north0")
                (if (volume_test_players "tv_turret_north1")
                    (print "tv_turret_north1")
                    (if (volume_test_players "tv_turret_side0")
                        (print "tv_turret_side0")
                        (if (volume_test_players "tv_turret_side1")
                            (print "tv_turret_side1")
                            (if (volume_test_players "tv_turret_south0")
                                (print "tv_turret_south0")
                                (if (volume_test_players "tv_turret_south1")
...
; Decompilation finished in ~0.0350337s
