...
; 
; Source file: cyberdyne.hsc
; Start time: 2018-06-29 7:37:01 AM
; 
...
(script startup void cyberdyne_main
    (vehicle_auto_turret "camera0" "tv_camera0" 3000 0 0)
    (vehicle_auto_turret "camera1" "tv_camera1" 3000 0 0)
    (vehicle_auto_turret "camera2" "tv_camera2" 3000 0 0)
    (vehicle_auto_turret "camera3" "tv_camera3" 3000 0 0)
    (vehicle_auto_turret "camera4" "tv_camera4" 3000 0 0)
    (vehicle_auto_turret "camera5" "tv_camera5" 3000 0 0)
)

; Decompilation finished in ~0.0080077s
