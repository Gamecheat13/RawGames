...
// DEFINES --------------------------------------------------------------------------------------------------------------------------------------------------
// objectives
global short DEF_E8M2_INDEX_OBJECTIVE_ARTILLARY_01 = 								1;
global short DEF_E8M2_INDEX_OBJECTIVE_ARTILLARY_02 = 								2;
global short DEF_E8M2_INDEX_OBJECTIVE_ARTILLARY_03 = 								3;
...
script startup f_e8_m2_startup()
	...
	//Wait for start
	if ( f_spops_mission_startup_wait("e8_m2") ) then
...
script dormant f_e8_m2_init()
	...
	f_spops_mission_setup( "e8_m2", DEF_VORTEX_ZONESET_INDEX_E8M2_START, gr_e8_m2_all, fld_e8_m2_spawn_init, DEF_E8M2_INDEX_SPAWN_LOCS_INITIAL );
...
script dormant f_e8_m2_trigger()
	...
	wake( f_e8_m2_action_start );

end

// === f_e8_m2_action_start::: Action
script dormant f_e8_m2_action_start()
	dprint( "f_e8_m2_action_start" );

	// start dialog
	wake( f_e8_m2_dialog_start );
...
//set crate names
	f_add_crate_folder(cr_e8_m2_unsc_cover_1 ); //UNSC crates and barriers around the main spawn area
//	f_add_crate_folder(cr_e8_m2_power_cores ); //crates that blow up at the very back right
//	f_add_crate_folder(cr_e8_m2_unsc_cover_2 );  //UNSC barriers in and around the front middle base
////	f_add_crate_folder(sc_e8_m2_unsc_1 ); //UNSC scenery in the main starting area
//	//f_add_crate_folder(v_e8_m2_unsc ); //unsc vehicles
//	f_add_crate_folder(cr_e8_m2_unsc_props_1 ); //unsc vehicles
//	f_add_crate_folder(cr_e8_m2_unsc_roof_1 ); //unsc vehicles	
//	f_add_crate_folder(wp_e8_m2_unsc_heavy ); //unsc vehicles		
//	f_add_crate_folder(cr_e8_m2_unsc_ammo_crates ); //ammo crates	
//	f_add_crate_folder(dm_e8_m2_turret_base ); //turret bases
//	
//	
////set ammo crate names
//	f_add_crate_folder(eq_e8_m2_ammo_1 ); //ammo crates
...
//set spawn folder names
	 //spawns in the main starting area
//	firefight_mode_set_crate_folder_at(e8_m2_spawn_points_1, 91 ); //spawns in the front building
//	firefight_mode_set_crate_folder_at(e8_m2_spawn_points_2, 92 ); //spawns in the back building
//	firefight_mode_set_crate_folder_at(e8_m2_spawn_points_3, 93 ); //spawns by the left building
//	firefight_mode_set_crate_folder_at(e8_m2_spawn_points_4, 94 ); //spawns in the right side in the way back
//	firefight_mode_set_crate_folder_at(e8_m2_spawn_points_5, 95 ); //spawns in the right side in the way back
//	firefight_mode_set_crate_folder_at(e8_m2_spawn_points_6, 96 ); //spawns in the right side in the way back
//	firefight_mode_set_crate_folder_at(e8_m2_spawn_points_7, 97 ); //spawns in the back on the hill (facing the back)
//	firefight_mode_set_crate_folder_at(e8_m2_spawn_points_8, 98 ); //spawns in the very back facing down the hill
//	firefight_mode_set_crate_folder_at(sc_e8_m2_spawn_points_9, 99 ); //spawns in the very back facing down the hill
	
//puts certain objects into an index that is used to track objectives set in the player goals in the variant tag
//set objective names
	
	firefight_mode_set_objective_name_at(e8_m2_switch_1, 1 ); //computer terminal in the close side building
//	firefight_mode_set_objective_name_at(e8_m2_switch_2, 2 ); //computer terminal in the left side building
//	firefight_mode_set_objective_name_at(e8_m2_switch_3, 3 ); //computer terminal in the far right side building
...
//set LZ (location arrival) spots			
	firefight_mode_set_objective_name_at(e8_m2_lz_0, 50 ); //objective in the main spawn area
//	firefight_mode_set_objective_name_at(e8_m2_lz_1, 51 ); //objective in the middle front building
//	firefight_mode_set_objective_name_at(e8_m2_lz_2, 52 ); //objective in the middle back building
//	firefight_mode_set_objective_name_at(e8_m2_lz_3, 53 ); //objective in the left back area
//	firefight_mode_set_objective_name_at(e8_m2_lz_4, 54 ); //objective in the right in the way back
//	firefight_mode_set_objective_name_at(e8_m2_lz_5, 55 ); //objective in the back on the forerunner structure
//	firefight_mode_set_objective_name_at(e8_m2_lz_6, 56 ); //objective in the back on the smooth platform
//	firefight_mode_set_objective_name_at(e8_m2_lz_7, 57 ); //objective right by the tunnel entrance
	
//puts AI squads and groups into an index used by the variant tag to spawn in AI automatically
//set squad group names
	//guards
	firefight_mode_set_squad_at(gr_e8_m2_guards_1, 1 );	//left building
//	firefight_mode_set_squad_at(gr_e8_m2_guards_2, 2 );	//front by the main start area
//	firefight_mode_set_squad_at(gr_e8_m2_guards_3, 3 );	//back middle building
//	firefight_mode_set_squad_at(gr_e8_m2_guards_4, 4 ); //in the main start area
//	firefight_mode_set_squad_at(gr_e8_m2_guards_5, 5 ); //right side in the back
//	firefight_mode_set_squad_at(gr_e8_m2_guards_6, 6 ); //right side in the back at the back structure
//	firefight_mode_set_squad_at(gr_e8_m2_guards_7, 7 ); //middle building at the front
//	firefight_mode_set_squad_at(gr_e8_m2_guards_8, 8 ); //on the bridge
//	firefight_mode_set_squad_at(gr_e8_m2_allies_1, 9 ); //front building
//	firefight_mode_set_squad_at(gr_e8_m2_allies_2, 10 ); //back middle building
//	firefight_mode_set_squad_at(sq_e8_m2_hunters_grunts, 11 ); //back middle building
//
//	//phantoms
//	firefight_mode_set_squad_at(sq_e8_m2_phantom_01, 21 ); //phantoms 
//	firefight_mode_set_squad_at(sq_e8_m2_phantom_02, 22 ); //phantoms 
//	firefight_mode_set_squad_at(sq_e8_m2_phantom_03, 23 ); //phantoms 
//	firefight_mode_set_squad_at(sq_e8_m2_phantom_04, 24 ); //phantoms 
//	firefight_mode_set_squad_at(sq_e8_m2_phantom_attack_1, 31 ); //phantoms 
//	firefight_mode_set_squad_at(sq_e8_m2_phantom_attack_2, 32 ); //phantoms 
//	
//	//waves (enemies that come from drop pods or phantoms
//	firefight_mode_set_squad_at(gr_e8_m2_waves_1, 81 );	//left building
//	firefight_mode_set_squad_at(gr_e8_m2_waves_2, 82 );	//front by the main start area
//	firefight_mode_set_squad_at(gr_e8_m2_waves_3, 83 );	//back middle building
//	firefight_mode_set_squad_at(gr_e8_m2_waves_4, 84 ); //in the main start area
//	firefight_mode_set_squad_at(gr_e8_m2_waves_5, 85 ); //right side in the back
//	firefight_mode_set_squad_at(gr_e8_m2_waves_6, 86 ); //right side in the back at the back structure
//	firefight_mode_set_squad_at(gr_e8_m2_waves_7, 87 ); //right side in the back at the back structure
//	firefight_mode_set_squad_at(gr_e8_m2_waves_8, 88 ); //right side in the back at the back structure
//	firefight_mode_set_squad_at(gr_e8_m2_waves_9, 89 ); //right side in the back at the back structure
//	firefight_mode_set_squad_at(gr_e8_m2_waves_10,90 );
...
script static void f_start_all_events_e8_m2
	
//start all the event scripts	
	thread (f_end_events_e8_m2_1() );
	dprint( "ending e8_m2_1" );

//	thread (f_e8_m2_switches() );
//	dprint( "starting switches" );
//
//	thread (f_start_events_e8_m2_2() );
//	dprint( "starting e8_m2_2" );
//	
//	thread (f_end_events_e8_m2_2() );
//	dprint( "ending e8_m2_2" );
//	
//	thread (f_start_events_e8_m2_3() );
//	dprint( "starting e8_m2_3" );
//	
//	thread (f_end_events_e8_m2_3() );
//	dprint( "ending e8_m2_3" );
//	
//	thread (f_e8_m2_objective_vo() );
//	dprint( "starting objective VO" );
//	
//	thread (f_e8_m2_subplot_audio() );
//	dprint( "starting subplot_audio" );
//	
//	thread (f_misc_spawn_turrets() );
//	dprint( "starting spawn turrets" );
		
//	thread (f_start_events_e2_m2_4() );
//	dprint( "starting e2_m2_4" );
//	
//	thread (f_end_events_e2_m2_4() );
//	dprint( "ending e2_m2_4" );
//		
//	thread (f_start_events_e2_m2_5() );
//	dprint( "starting e2_m2_5" );
//	
//	thread (f_end_events_e2_m2_5() );
//	dprint( "ending e2_m2_5" );
//		
//	thread (f_start_events_e2_m2_6() );
//	dprint( "starting e2_m2_6" );
//	
//	thread (f_end_events_e2_m2_6() );
//	dprint( "ending e2_m2_6" );
//		
//	thread (f_start_events_e2_m2_7() );
//	dprint( "starting e2_m2_7" );
//	
//	thread (f_end_events_e2_m2_7() );
//	dprint( "ending e2_m2_7" );
//		
//	thread (f_start_events_e2_m2_8() );
//	dprint( "starting e2_m2_8" );
end
...
//
//script static void f_power_core_watch_e8_m2 (device_name switch, object_name core, short spawn_folder)
...
//	dprint( "damage the core a little" );
//	
...
//	damage_object (core, "default", object_health / 10 );
//	dprint( "damage the core a little more" );
//	object_cannot_take_damage (core );
//
//	sleep_s (1 );
//	object_can_take_damage (core );
...
//	dprint( "damage the core to death" );
//	object_cannot_take_damage (core );
//	
...
//
//script static void f_e8_m2_objective_vo
//	dprint( "objective vo started" );
//	
...
//		dprint( "playing second core exploded" );
//		sleep_s (1 );
...
//end
//
//script static void f_e8_m2_subplot_audio
//	//sleep until a free time, then play the subplot audio
//	dprint( "starting subplot audio" );
...
script static void f_start_events_e8_m2_1
	sleep_until (LevelEventStatus("start_e8_m2_1"), 1 );
	dprint( "STARTING start_switch_1" );

	thread(f_music_e3m2_start_switch_1_vo() );
	//	ai_place (sq_e8_m2_marines_run_around );
...
// track the switches and blow up the cores when they are switched plus VO
	sleep_until (object_valid (e8_m2_switch_1) and object_valid (power_core_unsc_1), 1 );
		dprint( "core watch 1 started" );
		thread (f_power_core_watch_e8_m2 (e8_m2_switch_1 ,power_core_unsc_1, 99) );
	sleep_until (object_valid (e8_m2_switch_2) and object_valid (power_core_unsc_2), 1 );	
		dprint( "core watch 2 started" );
		thread (f_power_core_watch_e8_m2 (e8_m2_switch_2 ,power_core_unsc_2, 95) );
	sleep_until (object_valid (e8_m2_switch_3) and object_valid (power_core_unsc_3), 1 );
		dprint( "core watch 3 started" );
		thread (f_power_core_watch_e8_m2 (e8_m2_switch_3 ,power_core_unsc_3, 98) );
...
//
//
//script static void f_start_events_e8_m2_2
//	sleep_until (LevelEventStatus("start_e8_m2_2"), 1 );
//	dprint( "STARTING start_e8_m2_turrets" );
//	
//	
//	b_wait_for_narrative_hud = TRUE;
//	
...
//		e3m2_vo_turret1on( );
//		
//		thread (f_e8_m2_bias_banshees() );
//	
//		sleep_until (s_all_objectives_count == 2 );
//		dprint( "both turrets turned on" );
//	
//		sleep_s (3 );
//	
...
//end
//
//script static void f_e8_m2_bias_banshees
//	dprint( "target banshees" );
//	local object banshee = ai_vehicle_get (sq_e8_m2_banshee_01.driver );
//	local real max_health = object_get_maximum_vitality (banshee, FALSE );
//	local real banshee_health = unit_get_health (ai_vehicle_get (sq_e8_m2_banshee_01.driver) );
//	
//	//if banshee 1 is alive target it and then blow it up once it is hit
//	if object_get_health (sq_e8_m2_banshee_01.driver) > 0 then
//
//		dprint( "targeting first banshee" );
//		banshee = ai_vehicle_get (sq_e8_m2_banshee_01.driver );
//		
//		ai_object_set_targeting_bias (banshee, 1 );
//		ai_prefer_target_ai (sq_ff_turrets, sq_e8_m2_banshee_01, TRUE );
//		cs_aim_object (sq_ff_turrets, TRUE, ai_vehicle_get (sq_e8_m2_banshee_01.driver) );
//		
//		banshee_health = unit_get_health (ai_vehicle_get (sq_e8_m2_banshee_01.driver) );
//		
//		//sleep until the banshee is hurt at all then kill it
//		sleep_until (object_get_health (banshee) < banshee_health, 1 );
//		unit_kill(ai_vehicle_get (sq_e8_m2_banshee_01.driver) );
//		dprint( "banshee should be dead" );
//		thread(f_music_e3m2_banshee_1_dead() );
//	end
//	
//	if object_get_health (sq_e8_m2_banshee_01.driver2) > 0 then
//	
//	//first banshee is dead targeting second banshee
//		dprint( "targeting second banshee" );
//		banshee = ai_vehicle_get (sq_e8_m2_banshee_01.driver2 );
//		
//		ai_object_set_targeting_bias (banshee, 1 );
//		ai_prefer_target_ai (sq_ff_turrets, sq_e8_m2_banshee_01, TRUE );
//		cs_aim_object (sq_ff_turrets, TRUE, ai_vehicle_get (sq_e8_m2_banshee_01.driver2) );
//		
//		banshee_health = unit_get_health (ai_vehicle_get (sq_e8_m2_banshee_01.driver2) );
//		
//		sleep_until (object_get_health (banshee) < banshee_health, 1 );
//		unit_kill(ai_vehicle_get (sq_e8_m2_banshee_01.driver2) );
//		dprint( "banshee2 should be dead" );
//		thread(f_music_e3m2_banshee_2_dead() );
//	end
//	
//	dprint( "both banshees dead" );
//	
//end
//
//script static void f_end_events_e8_m2_2
//	sleep_until (LevelEventStatus("end_e8_m2_2"), 1 );
//	dprint( "ending e8_m2_2 turrets" );
...
//
//
//script static void f_start_events_e8_m2_3
//	sleep_until (LevelEventStatus("start_e8_m2_3"), 1 );
//	dprint( "STARTING e8_m2_3 (no more waves)" );
//	//f_e8_m2_hunter_drop( );
//
////
////	sleep_until (ai_living_count (e8_m2_sq_wave_08) > 0, 1 );
////	//cinematic_set_title (more_enemies );
////	thread(f_music_e3m2_hunters_vo() );
////	e3m2_vo_hunters( );
////	f_new_objective (ch_e8_m2_3 );
////	f_e8_m2_phantom_vo( );
//end
//
//script static void f_e8_m2_hunter_drop
//	dprint( "hunter drop" );
//	
...
//	
//	//ai_place_in_limbo (sq_e8_m2_hunters_grunts );
//	//thread (f_load_drop_pod (dm_drop_04, sq_e8_m2_hunters_grunts, obj_drop_pod_4, FALSE) );
//
...
//	f_e8_m2_phantom_vo( );
//	
//	sleep_until (ai_living_count (gr_e8_m2_waves_10) > 1, 1 );
//	sleep_until (ai_living_count (gr_e8_m2_all) < 6, 1 );	
//	vo_glo_remainingcov_04( );
//	
//	f_blip_ai_cui(gr_e8_m2_all, "navpoint_enemy" );
//	
//end
//
//script static void f_end_events_e8_m2_3
//	//make sure our banshees are dead if the turrets didn't kill them
//	unit_kill(ai_vehicle_get(sq_e8_m2_banshee_01.driver) );
//	unit_kill(ai_vehicle_get(sq_e8_m2_banshee_01.driver2) );
//	
//	sleep_until (LevelEventStatus("end_e8_m2_3"), 1 );
//	dprint( "ENDING no more waves" );
//
//	sleep_s (4 );
//	
...
//end
//
//script static void f_e8_m2_phantom_vo
//	dprint( "start phantom VO" );
//	sleep_until (ai_living_count (sq_e8_m2_phantom_01) > 0, 1 );
...
//
//// PHANTOM ATTACK 1 =================================================================================================== 
//script command_script cs_e8_m2_phantom_attack_1()
...
//	cs_enable_targeting (TRUE );
//	cs_fly_by (ps_e8_m2_phantom_attack_1.p0 );
////	cs_fly_by (ps_ff_phantom_02.p3 );
//	cs_fly_by (ps_e8_m2_phantom_attack_1.p1 );
...
//	sleep_s (10 );
//	//ai_set_blind (ai_current_squad, TRUE );
//	cs_fly_by (ps_e8_m2_phantom_attack_1.p2 );
//	cs_fly_to (ps_e8_m2_phantom_attack_1.erase );
//	
//	//erase
//	object_set_scale ( ai_vehicle_get ( ai_current_actor ), 0.01, 120 ); //Shrink size over time
//	sleep_s (3 );
...
//
//// PHANTOM ATTACK 1 =================================================================================================== 
//script command_script cs_e8_m2_phantom_attack_2()
//	cs_ignore_obstacles (TRUE );
////	ai_set_blind (ai_current_squad, FALSE );
//	cs_fly_by (ps_ff_phantom_01.p0 );
//	cs_fly_by (ps_ff_phantom_01.p1 );
...
//	sleep_s (5 );
//	ai_set_objective (ai_current_squad, obj_e8_m2_survival );
//end
...
//	
//	ai_vehicle_exit (sq_e8_m2_marines_1 );
//	cs_pause(5 );
//	ai_set_objective (sq_e8_m2_marines_1, obj_survival );
...
//		dprint( "turret is damaged -- closing" );
