...
script static void highlight_wargames
	...
	SetObjectRealVariable(inf, var_obj_local_a, 0.2);
end
...
script static void highlight_spartanops
	...
	SetObjectRealVariable(inf, var_obj_local_a, 0.4);
...
script static void highlight_forge
	...
	SetObjectRealVariable(inf, var_obj_local_a, 0.6);
end
...
script static void highlight_theater
	...
	SetObjectRealVariable(inf, var_obj_local_a, 0.8);
end 
...
script static void f_new_infinity_user_experience()
	sleep_until(bink_is_local_playing(), 1);
	local long infinity_bink_thread = thread( f_infinity_bink_subtitles() );
	sleep_until(not bink_is_local_playing(), 1);
	kill_thread( infinity_bink_thread );
end

script static void f_infinity_bink_subtitles()
	sleep_s(2.0);
	cinematic_subtitle( spartanops_prologue_00100, 8.75 ); // "Lasky: For too many years, humanity was on the back foot, reacting to threats rather than preventing them."
	sleep_s(20.83);
	cinematic_subtitle( spartanops_prologue_00200, 4.17 ); // "Lasky: The rest of the galaxy was bigger than us. Stronger than us."
	sleep_s(5.0);
	cinematic_subtitle( spartanops_prologue_00300, 2.5 ); // "Lasky: We were mice, hiding in the shadows..."
	sleep_s(2.71);
	cinematic_subtitle( spartanops_prologue_00400, 2.92 ); // "Lasky: ...hoping the giants would not see us."
	sleep_s(3.54);
	cinematic_subtitle( spartanops_prologue_00500, 1.25 ); // "Lasky: No more."
	sleep_s(1.67);
	cinematic_subtitle( spartanops_prologue_00600, 2.92 ); // "Lasky: Humanity is no longer on the defense..."
	sleep_s(3.75);
	cinematic_subtitle( spartanops_prologue_00700, 2.5 ); // "Lasky: We are the giants now."
end
...
(script static void exit_experience_initialization
	...
	(unit_add_equipment chief_exit profile_assualtrifle TRUE FALSE)
	(custom_animation_loop chief_exit objects\characters\storm_masterchief\storm_masterchief "depot:rifle:idle" FALSE)
)
