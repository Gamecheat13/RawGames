...
script static void pip_e2m3_1_subtitles()
	sleep_s (1.21);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_02_mission_03\e2m3_savemarines_00100');
end
...
script static void e2m3_tts_2phantoms_dead()
	// all Phantoms down
	sleep_until (e2m3_narrative_in_use == FALSE);
	e2m3_narrative_in_use = TRUE;
...
script static void e2m3_tts_saveallmarines()
	sleep_until (e2m3_narrative_in_use == FALSE);
	e2m3_narrative_in_use = TRUE;
	sleep (30 * 1);
...
script static void e2m3_tts_savesomemarines()
	sleep_until (e2m3_narrative_in_use == FALSE);
	e2m3_narrative_in_use = TRUE;
	sleep (30 * 1);
...
script static void e2m3_tts_saveonemarine()
	sleep_until (e2m3_narrative_in_use == FALSE);
	e2m3_narrative_in_use = TRUE;
	sleep (30 * 1);
...
script static void e2m3_tts_savenomarines()
...
script static void pip_e2m3_2_subtitles()
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_02_mission_03\e2m3_alldone_00200');
end
