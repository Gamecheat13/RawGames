...
//343++343==343++343==343++343//	E2M3 Goal 04 Scripts (3. time_passed)	//343++343==343++343==343++343//
...
script static void e2m3_phantomfendoff_start()
	...
	else (thread (e2m3_tts_2phantoms_dead()));
	end
	sleep (30);
...
//343++343==343++343==343++343//	E2M3 Goal 05 Scripts (4. time_passed)	//343++343==343++343==343++343//
...
script static void e2m3_locationarrival02_start()
	...
	f_objective_complete();
	thread (e2m3_marinesleftalive_tts());
	...
	sleep (30 * 1);
	fade_out (0, 0, 0, 15);
	thread (e2m3_hide_players_outro());
