...
//	ai_place (sq_ff_pelican_intro);
	...
	//sound_impulse_start ( 'sound\environments\solo\m030\amb_m30_beta\amb_m30_machines\amb_m30_machine_forerunner_portal_flash', e4m2_scripted_portal_flash, 1 ); //AUDIO FOR PORTAL FLASH!
	sleep_s (1);
