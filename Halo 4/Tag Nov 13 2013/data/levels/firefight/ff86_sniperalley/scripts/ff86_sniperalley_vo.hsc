...
////	sound_looping_stop (music_mid_beat);
////	sleep(30 * 1);
...
//	sound_looping_stop (music_up_beat);
//	vo_oyo_m3_p11();
//	vo_oyo_m3_r3();
//	vo_oyo_m3_bb5();
//	vo_oyo_m3_p12();
...
//// ==============================================================================================================
//script continuous f_e1_m4_start_true  //setting the mission 
//	sleep_until (LevelEventStatus("e1_m4_start_true"), 1);
//	NotifyLevel ("start_intro");
//	mission_is_e1_m4 = true;
//end
//
...
//	device_set_power (objective_switch_1, 1);
////	sleep(30 * 5);
...
////	sleep(30 * 5);
////	//heavy resistance, here's some heavy weapons
////	//pause until some dudes are killed
