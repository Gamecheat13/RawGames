...
script static void pip_e1m2_1_subtitles()
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_01_mission_02\e1m2_shield1block_00600');
	sleep_s (0.11);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_01_mission_02\e1m2_shield1block_00700');
end
...
script static void pip_e1m2_2_subtitles()
	sleep_s (1.06);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_01_mission_02\e1m2_targethit_00300');
end
...
script static void pip_e2m4_1_subtitles()
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_02_mission_04\e2m4_aaguns_00300');
end
...
script static void pip_e2m4_2_subtitles()
	sleep_s (1.1);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_02_mission_04\e2m4_allclear_00400');
end
...
script static void pip_e4m1_1_subtitles()
	sleep_s (1.16);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_04_mission_01\e4m1_playstart_00100');
end
...
script static void pip_e4m1_2_subtitles()
	sleep_s (3.15);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_04_mission_01\e4m1_2ndpelican_00600');
end
