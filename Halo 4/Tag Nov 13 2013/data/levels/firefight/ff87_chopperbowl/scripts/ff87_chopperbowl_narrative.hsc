...
script static void pip_e1_m1_1_subtitles()
	sleep_s (1.04);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_01_mission_01\e1m1_objectives_00100');
end
...
script static void pip_e1_m1_2_subtitles()
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_01_mission_01\e1m1_missionend_00600');
end
...
script static void pip_e3_m1_1_subtitles()
	sleep_s (1.19);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_03_mission_01\e3m1_hornetsnest_00200');
end
...
script static void pip_e3_m1_2_subtitles()
	sleep_s (1.18);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_03_mission_01\e3m1_outro_00400');
end
...
script static void pip_e5_m5_1_subtitles()
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_05_mission_05\e5m5_overthere_00100');
end
...
script static void pip_e5_m5_2_subtitles()
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_05_mission_05\e5m5_nothorne_00200');
	// sleep_s(1);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_05_mission_05\e5m5_nothorne_00300');
	// sleep_s(1);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_05_mission_05\e5m5_nothorne_00400');
end
