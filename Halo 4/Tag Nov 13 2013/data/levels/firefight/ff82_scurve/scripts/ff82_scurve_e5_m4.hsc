...
script static void f_e5_m4_end_mission
	print ("ending the mission with fadeout and chapter complete");
	fade_out (0,0,0,60);
	ai_dialogue_enable (false);
	sleep (60);
	player_control_fade_out_all_input (.1);
	ai_braindead (gr_e5_m4_marines_1, true);
	ai_braindead (gr_e5_m4_marines_2, true);
...
script static void intro_vignette_e5_m4
	...
	if game_coop_player_count() <= 2 then
		...
		print ("2 or less players play e5_m4_intro vignette");
	else
		pup_play_show (e5_m4_intro_3pl);
		print ("2 or less players play e5_m4_intro_3pl vignette");
	end
	vo_e5m4_intro();
	//temp
	//b_wait_for_narrative = false;
