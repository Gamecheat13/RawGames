...
global boolean e5m2_scaredscientists = FALSE;
...
script static void e5m1_scientist()
	...
	object_immune_to_friendly_damage (ai_actors (sq_e5m1_scientists_01), TRUE);
...
script static void e5m2_machines_animate()
	...
	effect_new( levels\firefight\ff84_temple\fx\energy\tmpl_energy_beam_up_02.effect, fx_portal_energy_beam_02_botm );
	effect_new( levels\firefight\ff84_temple\fx\energy\tmpl_energy_beam_down_01.effect, fx_portal_energy_beam_02_top );
	sleep (10);
...
script static void e5m2_dissolve_shell()
	...
	effect_kill_from_flag( levels\firefight\ff84_temple\fx\energy\tmpl_energy_beam_up_02.effect, fx_portal_energy_beam_02_botm );
	effect_kill_from_flag( levels\firefight\ff84_temple\fx\energy\tmpl_energy_beam_down_01.effect, fx_portal_energy_beam_02_top );
	sleep (30 * 10);
