...
script static void pip_e2m5_1_subtitles()
	sleep_s (1.17);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_02_mission_05\e2m5_playstart_00200');
end
...
script static void pip_e2m5_2_subtitles()
	//sleep_s (1.17);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_02_mission_05\e2m5_badguys01_00100');
end
...
script static void pip_e2m5_3_subtitles()
	sleep_s (1.05);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_02_mission_05\e2m5_gettolz_00200');
end
