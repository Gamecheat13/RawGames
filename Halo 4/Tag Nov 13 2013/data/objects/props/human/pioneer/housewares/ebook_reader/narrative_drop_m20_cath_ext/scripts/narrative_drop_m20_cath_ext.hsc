...
script startup instanced fill_narrative_drop_content_m20_cath_ext()
		static real distance = 0.922;
		static boolean end_narrative_device = 0;

 	 	static real length = 7.2;
 	 	static string content = " The Covenant forces cannot gain access to the holy site. The door with not open for them.";
