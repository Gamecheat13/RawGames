...
script startup instanced fill_narrative_drop_content_m41 ()
		static real distance = 0.922;
		static boolean end_narrative_device = 0;
 	 	
 	 	static real length = 7.2;
 	 	static string content = "Grunts love war because it allows them to look serious; because it is the only thing that stops female Grunts laughing at them. - YapYap Bahalo";
