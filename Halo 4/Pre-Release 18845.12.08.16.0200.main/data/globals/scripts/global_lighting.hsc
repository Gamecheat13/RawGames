...
local short l_lighting_thread_local = 0;
	...
	thread( f_lighting_direct_set(r_time, r_lighting_direct_start, r_lighting_direct_end, s_rate) );
	thread( f_lighting_indirect_set(r_time, r_lighting_indirect_start, r_lighting_indirect_end, s_rate) );
	
	sleep_until( ((f_lighting_direct_get() == r_lighting_direct_end) and (f_lighting_indirect_get() == r_lighting_indirect_end)) or (l_lighting_thread_local != l_lighting_thread_static), 1 );
...
local long l_lighting_thread_local = 0;
	...
	sleep_until( (r_lighting_end == f_lighting_direct_get()) or (l_lighting_thread_local != l_lighting_thread_static), 1 );
