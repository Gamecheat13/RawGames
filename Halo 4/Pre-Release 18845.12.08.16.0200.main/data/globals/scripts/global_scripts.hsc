...
script static long f_blip_auto_object_distance( object obj_target, string str_type, real r_distance, boolean b_blip_in )
	f_blip_auto_object_title_offset_distance( obj_target, str_type, "", 0.0, r_distance, b_blip_in, 0 );
end
script static long f_blip_auto_object_distance( object obj_target, string str_type, real r_distance, boolean b_blip_in, long l_thread )
	f_blip_auto_object_title_offset_distance( obj_target, str_type, "", 0.0, r_distance, b_blip_in, l_thread );
end
...
script static long f_blip_auto_object_title_distance( object obj_target, string str_type, string_id sid_title, real r_distance, boolean b_blip_in )
	f_blip_auto_object_title_offset_distance( obj_target, str_type, sid_title, 0.0, r_distance, b_blip_in, 0 );
end
script static long f_blip_auto_object_title_distance( object obj_target, string str_type, string_id sid_title, real r_distance, boolean b_blip_in, long l_thread )
	f_blip_auto_object_title_offset_distance( obj_target, str_type, sid_title, 0.0, r_distance, b_blip_in, l_thread );
end
...
script static long f_blip_auto_object_offset_distance( object obj_target, string str_type, real r_offset, real r_distance, boolean b_blip_in )
	f_blip_auto_object_title_offset_distance( obj_target, str_type, "", r_offset, r_distance, b_blip_in, 0 );
end
script static long f_blip_auto_object_offset_distance( object obj_target, string str_type, real r_offset, real r_distance, boolean b_blip_in, long l_thread )
	f_blip_auto_object_title_offset_distance( obj_target, str_type, "", r_offset, r_distance, b_blip_in, l_thread );
end
...
script static long f_blip_auto_object_title_offset_distance( object obj_target, string str_type, string_id sid_title, real r_offset, real r_distance, boolean b_blip_in )
	f_blip_auto_object_title_offset_distance( obj_target, str_type, sid_title, r_offset, r_distance, b_blip_in, 0 );
end
script static long f_blip_auto_object_title_offset_distance( object obj_target, string str_type, string_id sid_title, real r_offset, real r_distance, boolean b_blip_in, long l_thread )
	...
	// setup blip on players
	thread( sys_blip_auto_object_title_offset_distance(player0, obj_target, sid_type, sid_title, r_distance, b_blip_in, l_thread) );
	thread( sys_blip_auto_object_title_offset_distance(player1, obj_target, sid_type, sid_title, r_distance, b_blip_in, l_thread) );
	thread( sys_blip_auto_object_title_offset_distance(player2, obj_target, sid_type, sid_title, r_distance, b_blip_in, l_thread) );
	thread( sys_blip_auto_object_title_offset_distance(player3, obj_target, sid_type, sid_title, r_distance, b_blip_in, l_thread) );
...
// SYSTEMS $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
script static void sys_blip_auto_object_title_offset_distance( player p_player, object obj_target, string_id sid_type, string_id sid_title, real r_distance, boolean b_blip_in, long l_thread )
	...
	if ( player_is_in_game(p_player) and IsThreadValid(l_thread) )then
		...
		repeat
			...
			// wait for change
			sleep_until( (b_blip != sys_blip_auto_object_title_offset_distance_blip(p_player, obj_target, r_distance, b_blip_in, l_thread)) or (not IsThreadValid(l_thread)) or (not player_is_in_game(p_player)), 1 );
	
			// store blip condition
			b_blip = sys_blip_auto_object_title_offset_distance_blip( p_player, obj_target, r_distance, b_blip_in, l_thread );
