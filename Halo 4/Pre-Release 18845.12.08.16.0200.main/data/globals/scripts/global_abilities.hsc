...
script static short f_ability_player_cnt( object_definition od_equipment )
local short s_cnt = 0;
	
	if ( unit_has_equipment(Player0, od_equipment) ) then
		s_cnt = s_cnt + 1;
	end
	if ( unit_has_equipment(Player1, od_equipment) ) then
		s_cnt = s_cnt + 1;
	end
	if ( unit_has_equipment(Player2, od_equipment) ) then
		s_cnt = s_cnt + 1;
	end
	if ( unit_has_equipment(Player3, od_equipment) ) then
		s_cnt = s_cnt + 1;
	end
