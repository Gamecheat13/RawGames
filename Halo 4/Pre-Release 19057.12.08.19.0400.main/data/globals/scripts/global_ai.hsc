...
script static long f_ai_garbage_erase( ai ai_squad, real r_distance_min, real r_see_degrees, long l_delay_squad, long l_delay_unit )
	f_ai_garbage( ai_squad, DEF_AI_CLEANUP_TYPE_ERASE(), r_distance_min, r_see_degrees, l_delay_squad, l_delay_unit, FALSE );
end
script static long f_ai_garbage_erase( ai ai_squad, real r_distance_min, real r_see_degrees )
	f_ai_garbage( ai_squad, DEF_AI_CLEANUP_TYPE_ERASE(), r_distance_min, r_see_degrees, -1, -1, FALSE );
end
script static long f_ai_garbage_erase( ai ai_squad, real r_distance_min )
	f_ai_garbage( ai_squad, DEF_AI_CLEANUP_TYPE_ERASE(), r_distance_min, -1.0, -1, -1, FALSE );
end
script static long f_ai_garbage_erase( ai ai_squad )
	f_ai_garbage( ai_squad, DEF_AI_CLEANUP_TYPE_ERASE(), -1.0, -1.0, -1, -1, FALSE );
end
...
script static long f_ai_garbage_kill( ai ai_squad, real r_distance_min, real r_see_degrees, long l_delay_squad, long l_delay_unit )
	f_ai_garbage( ai_squad, DEF_AI_CLEANUP_TYPE_KILL(), r_distance_min, r_see_degrees, l_delay_squad, l_delay_unit, FALSE );
end
script static long f_ai_garbage_kill( ai ai_squad, real r_distance_min, real r_see_degrees )
	f_ai_garbage( ai_squad, DEF_AI_CLEANUP_TYPE_KILL(), r_distance_min, r_see_degrees, -1, -1, FALSE );
end
script static long f_ai_garbage_kill( ai ai_squad, real r_distance_min )
	f_ai_garbage( ai_squad, DEF_AI_CLEANUP_TYPE_KILL(), r_distance_min, -1.0, -1, -1, FALSE );
end
script static long f_ai_garbage_kill( ai ai_squad )
	f_ai_garbage( ai_squad, DEF_AI_CLEANUP_TYPE_KILL(), -1.0, -1.0, -1, -1, FALSE );
end
...
local object obj_object = NONE;
	...
	repeat
		...
		if ( (obj_object != NONE) and (object_get_health(obj_object) > 0.0) and (objects_distance_to_object(Players(), obj_object) >= r_distance_min) and (not objects_can_see_object(Players(), obj_object, r_see_degrees)) and (not objects_can_see_player(obj_object, r_see_degrees)) ) then
