...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "M60_PLINTH_PROGRESS", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    						
						dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m60\plinth_progress_00101', FALSE, NONE, 0.0, "", "Cortana : These doors open into a cave system with a space large enough for an LZ." );
						dialog_line_cortana( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m60\plinth_progress_00102', FALSE, NONE, 0.0, "", "Cortana : Hold them off long enough for me to open them up." );
				 l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
end
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "M60_PLINTH_PROGRESS_03", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    						
					   dialog_line_chief( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m60\plinth_progress_00105', FALSE, NONE, 0.0, "", "Master Chief : Cortana? How close are we?" );
						dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m60\plinth_progress_00106', FALSE, NONE, 0.0, "", "Cortana : YOU DO YOUR JOB AND I’LL DO MINE, OK?!?" );
				 l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
end
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "M60_PLINTH_PROGRESS_02", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    						
					    dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m60\plinth_progress_00107', FALSE, NONE, 0.0, "", "Cortana :Got it! Passageway's unlocked - come and get me!" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					...
					hud_play_pip_from_tag( "bink\Campaign\M60_E_60" );
						//dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m60\rampancy_hall_00100', FALSE, NONE, 0.0, "", "Cortana : I’m... sorry about back there." );
						sleep_s(9);
						hud_rampancy_players_set( 0.50 );
						sleep_s(4);
					//	dialog_line_cortana( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m60\rampancy_hall_00101', FALSE, NONE, 0.0, "", "Cortana : That hatch’s security was more difficult than I expected." );
					//	dialog_line_chief( l_dialog_id, 2, TRUE, 'sound\dialog\mission\m60\rampancy_hall_00102', FALSE, NONE, 0.0, "", "Master Chief : It’s... alright." );
					//	dialog_line_cortana( l_dialog_id, 3, TRUE, 'sound\dialog\mission\m60\rampancy_hall_00103', FALSE, NONE, 0.0, "", "Cortana : It’s not alright. Nothing about it is alright." );
						hud_rampancy_players_set( 0.0 );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "M60_PELICAN_APPROACH_LASKY", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    											  
						...
						//dialog_line_npc( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m60\pelican_approach_lasky_00100', FALSE, NONE, 0.0, "", "Lasky : Roger that, Cortana.  I’ll-", TRUE);

						//dialog_line_npc( l_dialog_id, 2, TRUE, 'sound\dialog\mission\m60\pelican_approach_lasky_00101', FALSE, NONE, 0.0, "", "Del Rio : Mayday mayday.  Code Red! Hostile elements attempting to gain entrance to the Infinity bridge!", TRUE);
						sleep_s(31);
					//	end_radio_transmission();
						//start_radio_transmission( "bridgeofficer_transmission_name" );						
						//dialog_line_npc( l_dialog_id, 3, TRUE, 'sound\dialog\mission\m60\pelican_approach_lasky_00102', FALSE, NONE, 0.0, "", "Bridge Officer 1 : They're outside the hatch!", TRUE);
						//dialog_line_npc( l_dialog_id, 4, TRUE, 'sound\dialog\mission\m60\pelican_approach_lasky_00104', FALSE, NONE, 0.0, "", "Del Rio : All units return to Infinity immediately! That's an order!", TRUE);
						//start_radio_transmission( "bridgeofficer_transmission_name" );	
						//dialog_line_npc( l_dialog_id, 5, TRUE, 'sound\dialog\mission\m60\pelican_approach_lasky_00103', FALSE, NONE, 0.0, "", "Bridge Officer 1 : Doors breached! Doors breached!", TRUE);
						//end_radio_transmission();
						/*dialog_line_npc( l_dialog_id, 6, TRUE, 'sound\dialog\mission\m60\pelican_approach_lasky_00105', FALSE, NONE, 0.0, "", "Lasky : Chief, I’m directing the Spartan IVs to Rally Point Alpha Sierra Foxtrot!", TRUE);
						dialog_line_npc( l_dialog_id, 7, TRUE, 'sound\dialog\mission\m60\pelican_approach_lasky_00106', FALSE, NONE, 0.0, "", "Lasky : Until we catch up, you have tactical command of the forward assault force!", TRUE);
						dialog_line_npc( l_dialog_id, 8, TRUE, 'sound\dialog\mission\m60\pelican_approach_lasky_00107', FALSE, NONE, 0.0, "", "Lasky : Rendevous with those men and take back that ship!", TRUE);
						dialog_line_chief( l_dialog_id, 9, TRUE, 'sound\dialog\mission\m60\pelican_approach_lasky_00108', FALSE, NONE, 0.0, "", "Master Chief : Yes, sir." );
						dialog_line_npc( l_dialog_id, 10, TRUE, 'sound\dialog\mission\m60\pelican_approach_lasky_00109', FALSE, NONE, 0.0, "", "Lasky : Good luck, Chief. Lasky out.", TRUE);*/
						end_radio_transmission();
...
local long l_dlg_m60_infinityberth_tocauseway = DEF_DIALOG_ID_NONE();
					l_dlg_m60_infinityberth_tocauseway = dialog_start_foreground( "M60_INFINITYBERTH_TOCAUSEWAY", l_dlg_m60_infinityberth_tocauseway, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    						
			  		...
			  		start_radio_transmission( "delrio_transmission_name" );
					//	dialog_line_npc( l_dlg_m60_infinityberth_tocauseway, 0, TRUE, 'sound\dialog\mission\m60\infinityberth_tocauseway_00100', FALSE, NONE, 0.0, "", "Del Rio : Master Chief, this is Captain Del Rio.", TRUE);
					//	dialog_line_npc( l_dlg_m60_infinityberth_tocauseway, 0, TRUE, 'sound\dialog\mission\m60\infinityberth_tocauseway_00101', FALSE, NONE, 0.0, "", "Del Rio : Lasky just radioed - you picked a helluva time to rejoin us.", TRUE);
					//	dialog_line_chief( l_dlg_m60_infinityberth_tocauseway, 0, TRUE, 'sound\dialog\mission\m60\infinityberth_tocauseway_00102', FALSE, NONE, 0.0, "", "Master Chief : Sir, what’s our status?" );
					//	dialog_line_npc( l_dlg_m60_infinityberth_tocauseway, 0, TRUE, 'sound\dialog\mission\m60\infinityberth_tocauseway_00103', FALSE, NONE, 0.0, "", "Del Rio : That satellite took down the ship's defenses and is extracting data from the ship’s mainframes.", TRUE);
					//	dialog_line_chief( l_dlg_m60_infinityberth_tocauseway, 0, TRUE, 'sound\dialog\mission\m60\infinityberth_tocauseway_00104', FALSE, NONE, 0.0, "", "Master Chief : Can we break the connection?" );
					//	dialog_line_npc( l_dlg_m60_infinityberth_tocauseway, 0, TRUE, 'sound\dialog\mission\m60\infinityberth_tocauseway_00105', FALSE, NONE, 0.0, "", "Del Rio : Main point of contact’s on the upper hull.", TRUE);
					//	dialog_line_npc( l_dlg_m60_infinityberth_tocauseway, 0, TRUE, 'sound\dialog\mission\m60\infinityberth_tocauseway_00106', FALSE, NONE, 0.0, "", "Del Rio : The fastest route is through the maintenance causeway. ", TRUE);
					//	dialog_line_npc( l_dlg_m60_infinityberth_tocauseway, 0, TRUE, 'sound\dialog\mission\m60\infinityberth_tocauseway_00107', FALSE, NONE, 0.0, "", "Del Rio : There’s a Mantis docked inside the door - you’ll need the extra firepower.", TRUE);
					sleep_s(35);
						end_radio_transmission();
						hud_play_pip_from_tag( "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "M60_INFINITYBERTH_MECHDATA", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    						
							dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m60\infinityberth_premech_00100', FALSE, NONE, 0.0, "", "Cortana : That deployment console should open the Mantis bay." );
				 l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
end
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "M60_INFINITYBERTH_MECHDATA", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    						
						dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m60\infinityberth_mechdata_00103', FALSE, NONE, 0.0, "", "Cortana : The hatch is jammed." );
						dialog_line_cortana( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m60\infinityberth_mechdata_00104', FALSE, NONE, 0.0, "", "Cortana : Let’s do something about it." );
						dialog_line_cortana( l_dialog_id, 2, TRUE, 'sound\dialog\mission\m60\infinityberth_mechdata_00105', FALSE, NONE, 0.0, "", "Cortana : The captain promised you firepower." );
						dialog_line_cortana( l_dialog_id, 3, TRUE, 'sound\dialog\mission\m60\infinityberth_mechdata_00106', FALSE, NONE, 0.0, "", "Cortana : This sure seems like an appropriate use for it." );
						dialog_line_cortana( l_dialog_id, 4, TRUE, 'sound\dialog\mission\m60\infinityberth_mechdata_00107', FALSE, NONE, 0.0, "", "Cortana : Look for the Mantis controls." );
				 l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
end
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "M60_SHIP_PA_01", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    						
							dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m60\infinity_shippa_00100', FALSE, NONE, 0.0, "", "Ship PA : ALERT. HULL BREACH ON DECKS 13 SECTOR 5, DECK 25 SECTOR 12, DECK 131 SECTOR 7, DECK 270, DECK 895", TRUE);
				 l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
end
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "M60_SHIP_PA_02", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    						
							dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m60\infinity_shippa_00102', FALSE, NONE, 0.0, "", "Ship PA : INTRUSION ALERT. INTRUSION ALERT. SECURITY REQUESTED IN FORWARD WEAPON BATTERY, DECK 2, SECTOR 15.", TRUE);
				 l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
end
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "M60_SHIP_PA_03", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    						
							dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m60\infinity_shippa_00103', FALSE, NONE, 0.0, "", "Ship PA : MEDICAL EMERGENCY. ANY AVAILABLE MEDICAL STAFF TO REPORT TO SOUTH PROMENADE, MAIN KIOSK.", TRUE);
				 l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
end
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "M60_SHIP_PA_04", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    						
							dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m60\infinity_shippa_00104', FALSE, NONE, 0.0, "", "Ship PA : FIRE SUPPRESSION SYSTEMS FAILURE. MANUAL INTERVENTION REQUIRED. PLEASE CONTACT FIRE SAFETY WARDEN FOR YOUR SECTOR IMMEDIATELY.", TRUE);
				 l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
end
...
dprint("f_dialog_m60_inifinitycauseway_second_gun");
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "M60_SHIP_PA_05", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    						
					dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m60\infinity_shippa_00105', FALSE, NONE, 0.0, "", "Ship PA : WARNING - UNSC INFINITY HAS DESCENDED BELOW MINIMUM SAFE ALTITUDE. INTERNAL ATMOSPHERIC PRESSURE UNSTABLE.", TRUE);
				 l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
end
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "M60_SHIP_PA_06", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    						
					dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m60\infinity_shippa_00106', FALSE, NONE, 0.0, "", "Ship PA : ATTENTION, MASS DEPLOYMENT BAY VESSELS. EMERGENCY MOORING PROCEDURE INITIATED. BAY DOORS WILL NOT RESPOND TO TRAFFIC CONTROL REQUESTS.", TRUE);
				 l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
end
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "M60_SHIP_PA_07", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    						
					dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m60\infinity_shippa_00101', FALSE, NONE, 0.0, "", "Ship PA : CONDITION RED. ALL PERSONNEL TO EMERGENCY STATIONS. CONDITION RED -- ALL PERSONNEL TO EMERGENCY STATIONS.", TRUE);
				 l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
end
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "M60_INFINITY_SECONDARY_01", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    						
						dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m60\m60_secondary_00100', FALSE, secondary_attachment_01, 0.0, "", "Infinity System Voice : Access denied. Huragok population reserve accepts absolutely no personnel during category three emergency states and higher.", TRUE);
				 l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "M60_INFINITY_SECONDARY_02", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    						
						dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m60\m60_secondary_00101', FALSE, secondary_attachment_02, 0.0, "", "Infinity System Voice : Sub-vessel deployment bay is currently off limits to unauthorized personnel. Please see the local Deck Officer for further assistance.", TRUE);
				 l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "M60_INFINITY_SECONDARY_03", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    						
						dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m60\m60_secondary_00102', FALSE, secondary_attachment_03, 0.0, "", "Infinity System Voice : Maintenance requests concerning the Mark Ten Macedon Z-PROTOTYPE Forerunner engine cannot be processed at this time.", TRUE);
				 l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "M60_INFINITY_SECONDARY_04", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    						
						dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m60\m60_secondary_00103', FALSE, secondary_attachment_04, 0.0, "", "Infinity System Voice : Welcome to the Infinty Shipwide Waypoint Network. For information concerning--- I’m sorry. We are currently having difficulties processing your request due to the high volume of ---", TRUE);
				 l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "M60_INFINITY_SECONDARY_05", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    						
						dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m60\m60_secondary_00104', FALSE, secondary_attachment_05, 0.0, "", "Infinity System Voice : Infinity Shipwide Waypoint Network currently offline.", TRUE);
				 l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "M60_INFINITY_SECONDARY_06", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    						
						dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m60\m60_secondary_00105', FALSE, secondary_attachment_06, 0.0, "", "Infinity System Voice : All S-deck access is restricted until shipwide quarantine has been lifted.", TRUE);
				 l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "M60_INFINITY_SECONDARY_07", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    						
						dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m60\m60_secondary_00106', FALSE, secondary_attachment_07, 0.0, "", "Infinity System Voice : Cargo Unit, Lot 225. Destination: Ivanoff Station. Please consult the Manifest Director if you require immediate access.", TRUE);
				 l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
