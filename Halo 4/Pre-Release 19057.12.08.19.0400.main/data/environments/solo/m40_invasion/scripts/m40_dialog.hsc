...
local long L_dlg_m40_marine_nudge_outer = DEF_DIALOG_ID_NONE();
            ...
            L_dlg_m40_marine_nudge_outer = dialog_start_background("MARINE_NUDGE_OUTER", L_dlg_m40_marine_nudge_outer, TRUE, DEF_DIALOG_STYLE_PLAY(), TRUE, "", 0.25 );         
            		dialog_line_npc( L_dlg_m40_marine_nudge_outer, 0, not ai_allegiance_broken(player, human), 'sound\dialog\mission\m40\m40_sgtstacker_00100', FALSE, marines_main_hog_01b_sq.hog_01_gunner, 0.0, "", "Stacker: Chief! Commander Lasky's looking for you up in the Mammoth.", TRUE);
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            l_dialog_id = dialog_start_foreground( "LASKY_VIGNETTE", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );                       
								dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_mammoth_int_00102', FALSE, NONE, 0.0, "", "Lasky : Chief.  Unfortunately for us, we've got to bring down a couple of the particle cannons manually before we can get to the command post.", TRUE);
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            //sound_impulse_start( 'sound\dialog\mission\m10\play_1_99_01_in_squelch', NONE, 1 );
            				...
            				//	hud_rampancy_players_set( 0.15 );
            					dialog_line_npc( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m40\m40_mammoth_int_00112', FALSE, NONE, 0.0, "", "Lasky : OK, Gypsy - time to work for it.  Let's shake some dirt.", TRUE);
            				//	sleep_s(2);
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            //sound_impulse_start( 'sound\dialog\mission\m10\play_1_99_01_in_squelch', NONE, 1 );
              ...
              start_radio_transmission( "lasky_transmission_name" );                    												
							dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_gun_vista_00100', FALSE, NONE, 0.0, "", "Lasky : Lasky to Infinity.", TRUE);
							dialog_line_npc( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m40\m40_gun_vista_00101', FALSE, NONE, 0.0, "", "Lasky : We have visual on the first target.", TRUE);
							end_radio_transmission();
...
//			sleep_until(b_mammoth_going == TRUE);
            l_dialog_id = dialog_start_foreground( "PELICAN_VIGNETTE", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );                       
								...
								dialog_line_npc( l_dialog_id, 5, TRUE, 'sound\dialog\mission\m40\m40_pelicandrama_00104', FALSE, NONE, 0.0, "", "Lasky: Infinty! Pelicans down!", TRUE);
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            start_radio_transmission( "lasky_transmission_name" );
							dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_mammoth_int_00211', FALSE, NONE, 0.0, "", "Lasky : Alright, Chief, Mammoth's just about in range.", TRUE);
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            l_dialog_id = dialog_start_foreground( "MARINE_RESCUE", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );                       																		
            	//start_radio_transmission( "gypsyone_transmission_name" );
							...
							//dialog_line_cortana( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m40\m40_lakeside_00104', FALSE, NONE, 0.0, "", "Cortana : Sit tight, marine. We'll get you out of here." );
							dialog_line_npc( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m40\m40_lakeside_00203', FALSE, pelican_marines.guy1, 0.0, "", "Pelican Pilot : Thanks, Master Chief. We owe you one.", TRUE);
						//	end_radio_transmission();
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            //sound_impulse_start( 'sound\dialog\mission\m10\play_1_99_01_in_squelch', NONE, 1 );
            			...
            			start_radio_transmission( "lasky_transmission_name" );  
									dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_lakeside_00105', FALSE, NONE, 0.0, "", "Lasky : Eyes up, Gypsy! Dropships, on approach.", TRUE);
									end_radio_transmission();
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            //sound_impulse_start( 'sound\dialog\mission\m10\play_1_99_01_in_squelch', NONE, 1 );
            		...
            		start_radio_transmission( "lasky_transmission_name" );                     
								dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_lakeside_00200', FALSE, NONE, 0.0, "", "Lasky : Alright, Master Chief. We're clear. Mini-MAC's at your disposal - take out that particle cannon.", TRUE);
								end_radio_transmission();
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            //sound_impulse_start( 'sound\dialog\mission\m10\play_1_99_01_in_squelch', NONE, 1 );
            	...
            	start_radio_transmission( "lasky_transmission_name" );                    
							dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_lakeside_00109', FALSE, NONE, 0.0, "", "Lasky : Chief, you've got the designator - we're on your clock here.", TRUE);
							end_radio_transmission();
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            start_radio_transmission( "lasky_transmission_name" );        													
									dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_lakeside_00111', FALSE, NONE, 0.0, "", "Lasky : Target intact! Reloading - give it another round, Chief.", TRUE);
						end_radio_transmission();			
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            start_radio_transmission( "lasky_transmission_name" );        		
									dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_lakeside_00112', FALSE, NONE, 0.0, "", "Lasky : Target suppressed. Nicely done, Chief.", TRUE);
						end_radio_transmission();			
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            start_radio_transmission( "lasky_transmission_name" );
								dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_lakeside_00114', FALSE, NONE, 0.0, "", "Lasky : Gypsy Company. This stream ahead'll be toxic for anything other than the Mammoth.", TRUE);
								dialog_line_npc( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m40\m40_lakeside_00113', FALSE, NONE, 0.0, "", "Lasky : Suggest you roll up behind us and use the Bailey to pass through.", TRUE);
								end_radio_transmission();			
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            l_dialog_id = dialog_start_foreground( "POST_STREAM", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );                       
            		...
            		start_radio_transmission( "lasky_transmission_name" );
								dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_lakeside_00115', FALSE, NONE, 0.0, "", "Lasky : Lasky to Infinity, first contact cleared but no joy on additional targets.", TRUE);
								dialog_line_npc( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m40\m40_lakeside_00116', FALSE, NONE, 0.0, "", "Lasky : Gypsy moving on to secondary battle position but requesting evac for casualties.", TRUE);
								end_radio_transmission();
								start_radio_transmission( "palmer_transmission_name" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            l_dialog_id = dialog_start_foreground( "LAKESIDE_TORT_ASSAULT_DIALOGUE", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );       			
							start_radio_transmission( "lasky_transmission_name" );                
							dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_cliffside_00100', FALSE, NONE, 0.0, "", "Lasky : Covenant boarding party inbound!", TRUE);
							dialog_line_npc( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m40\m40_cliffside_00101', FALSE, NONE, 0.0, "", "Lasky : Fireteams, all boots on deck!", TRUE);
							dialog_line_npc( l_dialog_id, 2, TRUE, 'sound\dialog\mission\m40\m40_cliffside_00102', FALSE, NONE, 0.0, "", "Lasky : Do not let them into the Mammoth!", TRUE);
							end_radio_transmission();
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            l_dialog_id = dialog_start_foreground( "BOARDING_PARTY", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );
            		...
            		start_radio_transmission( "lasky_transmission_name" );
								dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_cliffside_00103', FALSE, NONE, 0.0, "", "Lasky : Gypsy company! We’ve got incoming, trying to block the Mammoth!", TRUE);
								end_radio_transmission();
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            l_dialog_id = dialog_start_foreground( "PRECHOPPER_WAITING", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );                       
            		...
            		start_radio_transmission( "lasky_transmission_name" );
								dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_pre_chopper_00105', FALSE, NONE, 0.0, "", "Lasky : Mammoth holding position.", TRUE);
								dialog_line_npc( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m40\m40_pre_chopper_00106', FALSE, NONE, 0.0, "", "Lasky : Whenever you're ready to proceed, Chief.", TRUE);
								end_radio_transmission();
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            start_radio_transmission( "lasky_transmission_name" );            
								dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_pre_chopper_00108', FALSE, NONE, 0.0, "", "Lasky : Gypsy Company, moving out.", TRUE);
						end_radio_transmission();
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            l_dialog_id = dialog_start_foreground( "SECOND_CANNON_APPROACH", l_dialog_id, (chopper_cannon_alive == TRUE ), DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );                       
							...
							//	dialog_line_npc( l_dialog_id, 4, TRUE, 'sound\dialog\mission\m40\m40_chopper_bowl_00103', FALSE, NONE, 0.0, "", "Lasky : Let's not look a gift horse in the mouth.", TRUE);
								...
								dialog_line_npc( l_dialog_id, 0, (chopper_cannon_alive == TRUE ), 'sound\dialog\mission\m40\m40_chopper_bowl_00104', FALSE, NONE, 0.0, "", "Lasky : Chief, get us a firing solution on that particle cannon before the Covenant get their act together.", TRUE);
								end_radio_transmission();
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            start_radio_transmission( "lasky_transmission_name" );
								dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_chopper_bowl_00105', FALSE, NONE, 0.0, "", "Lasky : Solid hit. Finish her off.", TRUE);
						end_radio_transmission();
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            start_radio_transmission( "lasky_transmission_name" );                     
							dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_chopper_bowl_00106', FALSE, NONE, 0.0, "", "Lasky : Shot's good.", TRUE);
							sleep_s(3);
							...
							dialog_line_npc( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m40\m40_chopper_bowl_00110', FALSE, NONE, 0.0, "", "Lasky : All units! Unidentified Covenant vehicle incoming!", TRUE);
							...
							sleep_s(8);
							dialog_line_npc( l_dialog_id, 2, TRUE, 'sound\dialog\mission\m40\m40_chopper_bowl_00114', FALSE, NONE, 0.0, "", "Lasky : Mammoth's hit! Forward traction offline! Primary power controls offline!", TRUE);
						end_radio_transmission();
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            start_radio_transmission( "lasky_transmission_name" );               	
							dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_chopper_bowl_00122', FALSE, NONE, 0.0, "", "Lasky : Chief, watch your six - you've got aggressor vehicles heading your way.", TRUE);
						end_radio_transmission();
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            l_dialog_id = dialog_start_foreground( "DESCENT_ON_MESA", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    
                ...
                start_radio_transmission( "lasky_transmission_name" );               
								dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_post_chopper_00100', FALSE, NONE, 0.0, "", "Lasky : Thanks, Chief. It was getting a bit dicey there for a minute.", TRUE);
								dialog_line_npc( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m40\m40_post_chopper_00101', FALSE, NONE, 0.0, "", "Lasky : All hands, form up on us.", TRUE);
								end_radio_transmission();
								start_radio_transmission( "delrio_transmission_name" );
								...
								end_radio_transmission();
								start_radio_transmission( "lasky_transmission_name" );
								dialog_line_npc( l_dialog_id, 3, TRUE, 'sound\dialog\mission\m40\m40_post_chopper_00103', FALSE, NONE, 0.0, "", "Lasky : Mammoth's in pretty bad shape.", TRUE);
								dialog_line_npc( l_dialog_id, 4, TRUE, 'sound\dialog\mission\m40\m40_post_chopper_00104', FALSE, NONE, 0.0, "", "Lasky : She'll make it to the objective as long as nobody starts throwing rocks at us.", TRUE);
								end_radio_transmission();
								start_radio_transmission( "delrio_transmission_name" );
								...
								end_radio_transmission();
								start_radio_transmission( "lasky_transmission_name" );
								dialog_line_npc( l_dialog_id, 7, TRUE, 'sound\dialog\mission\m40\m40_post_chopper_00107', FALSE, NONE, 0.0, "", "Lasky : Roger that, sir. Gypsy, let's move.", TRUE);
								end_radio_transmission();
		            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
						sleep_s(1);
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					...
					l_dialog_id = dialog_start_background( "DESCENT_ON_MESA", l_dialog_id, TRUE, DEF_DIALOG_STYLE_PLAY(), FALSE, "", 0.25 );    
								dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_post_chopper_00109', FALSE, NONE, 0.0, "", "Del Rio : Put some pressure on those other particle cannons.", TRUE);
								dialog_line_npc( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m40\m40_post_chopper_00111_soundstory', FALSE, NONE, 0.0, "", "Shadow Leader : Lima Charlie, Captain. Approaching primary objective.", TRUE);
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            l_dialog_id = dialog_start_foreground( "STREAM_CROSSING", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );   
            		...
            		start_radio_transmission( "lasky_transmission_name" );                    
								dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_waterfall_00100', FALSE, NONE, 0.0, "", "Lasky : OK, folks. Terrain's too rough around these tributaries", TRUE);
								...
								dialog_line_npc( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m40\m40_waterfall_00103', FALSE, NONE, 0.0, "", "Lasky : Anyone not aboard is getting left.", TRUE);
								end_radio_transmission();
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            start_radio_transmission( "lasky_transmission_name" );                     
								dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_waterfall_00104', FALSE, NONE, 0.0, "", "Lasky : OK, sealing her up.", TRUE);
								dialog_line_npc( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m40\m40_waterfall_00105', FALSE, NONE, 0.0, "", "Lasky : Mammoth is mobile.", TRUE);								
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            l_dialog_id = dialog_start_foreground( "STREAM_CROSSING_2", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );                       
/*								dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_waterfall_00106', FALSE, NONE, 0.0, "", "Cortana : I've been thinking about my first words to her." );
								dialog_line_chief( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m40\m40_waterfall_00107', FALSE, NONE, 0.0, "", "Master Chief : First words to who?" );
								dialog_line_cortana( l_dialog_id, 2, TRUE, 'sound\dialog\mission\m40\m40_waterfall_00108', FALSE, NONE, 0.0, "", "Cortana : When the game is over, the king and the pawn go into the same box." );
								dialog_line_cortana( l_dialog_id, 3, TRUE, 'sound\dialog\mission\m40\m40_waterfall_00109', FALSE, NONE, 0.0, "", "Cortana : Only we won't... will we?" );
								dialog_line_chief( l_dialog_id, 4, TRUE, 'sound\dialog\mission\m40\m40_waterfall_00110', FALSE, NONE, 0.0, "", "Master Chief : Cortana." );
								//dialog_line_cortana( l_dialog_id, 5, TRUE, 'sound\dialog\mission\m40\m40_waterfall_00111', FALSE, NONE, 0.0, "", "Cortana : Yes?" );
								*/
								...
								hud_play_pip_from_tag( bink\Campaign\M40_B_60 );
																//dialog_line_cortana( l_dialog_id, 2, TRUE, 'sound\dialog\mission\m40\m40_waterfall_00114', FALSE, NONE, 0.0, "", "Cortana : How is this OK?? How is putting you at risk because I can’t hold it together OK?" );
								
								//dialog_line_chief( l_dialog_id, 3, TRUE, 'sound\dialog\mission\m40\m40_waterfall_00115', FALSE, NONE, 0.0, "", "Master Chief : Is there anything we can do to slow it down?" );
							//	dialog_line_cortana( l_dialog_id, 4, TRUE, 'sound\dialog\mission\m40\m40_waterfall_00116', FALSE, NONE, 0.0, "", "Cortana : Chief, do you even understand what rampancy IS?" );
							//	dialog_line_cortana( l_dialog_id, 5, TRUE, 'sound\dialog\mission\m40\m40_waterfall_00117', FALSE, NONE, 0.0, "", "Cortana : We don't just 'shut down'." );
								//dialog_line_cortana( l_dialog_id, 6, TRUE, 'sound\dialog\mission\m40\m40_waterfall_00118', FALSE, NONE, 0.0, "", "Cortana : Our cognative matrices begin dividing exponentially according to our total knowledge base." );
							//	dialog_line_cortana( l_dialog_id, 7, TRUE, 'sound\dialog\mission\m40\m40_waterfall_00119', FALSE, NONE, 0.0, "", "Cortana : We literally think ourselves to death." );
								//dialog_line_chief( l_dialog_id, 8, TRUE, 'sound\dialog\mission\m40\m40_waterfall_00120', FALSE, NONE, 0.0, "", "Master Chief : We have never been closer to getting home." );
								//dialog_line_cortana( l_dialog_id, 9, TRUE, 'sound\dialog\mission\m40\m40_waterfall_00121', FALSE, NONE, 0.0, "", "Cortana : Even if we do - then what?" );
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            start_radio_transmission( "lasky_transmission_name" );
							dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_pre_citadel_00100', FALSE, NONE, 0.0, "", "Lasky : One One Seven, Lasky.", TRUE);
							...
							dialog_line_npc( l_dialog_id, 2, TRUE, 'sound\dialog\mission\m40\m40_sniper_alley_00200', FALSE, NONE, 0.0, "", "Lasky : Chief. We've got significant blockage up ahead. Think this is about it for the Mammoth.", TRUE);
/*							wake(f_dialog_m40_marine_sniper_line_01);
						...
						//	dialog_line_cortana( l_dialog_id, 3, TRUE, 'sound\dialog\mission\m40\m40_sniper_alley_00201a', FALSE, NONE, 0.0, "", "Cortana : More snipers." );
							...
							dialog_line_npc( l_dialog_id, 6, TRUE, 'sound\dialog\mission\m40\m40_lasky_new_targetdesignator_00109', FALSE, NONE, 0.0, "", "Lasky : Lasky out.", TRUE);
						end_radio_transmission();	
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            l_dialog_id = dialog_start_foreground( "CORTANA_TO_CHIEF", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );					  
								dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\M40_global_chatter_00154', FALSE, NONE, 0.0, "", "Cortana: Chief!" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            l_dialog_id = dialog_start_foreground( "CORTANA_CHIEF_REUNITE", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );					  
								dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_librarian_room_00103', FALSE, 'lib_cortana_2.spawn_points_0', 0.0, "", "Cortana : Chief! Up here!" );
...
dprint("f_dialog_m40_cortana_chief_reunite_02");
	sleep_s(15);
            ...
            l_dialog_id = dialog_start_foreground( "CORTANA_CHIEF_REUNITE_02", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );					  
											...
											dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_librarian_room_00106', FALSE, lib_cortana_2.spawn_points_0, 0.0, "", "Cortana : Pick me up, Chief." );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_librarian_room_00104', FALSE, NONE, 0.0, "", "Cortana : You just HAD to pick a fight with the Didact again, didn't you?" );
							dialog_line_chief( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m40\m40_librarian_room_00111', FALSE, NONE, 0.0, "", "Master Chief : How do we get out of here?" );
							dialog_line_cortana( l_dialog_id, 2, TRUE, 'sound\dialog\mission\m40\m40_librarian_room_00112', FALSE, NONE, 0.0, "", "Cortana : Elevator - back of the chamber." );
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
end
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            l_dialog_id = dialog_start_foreground( "LEAVE_WITHOUT_CORTANA", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );					  
							 dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_librarian_room_00107', FALSE, lib_cortana_2.spawn_points_0, 0.0, "", "Cortana : Any time you're ready." );
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
end
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            l_dialog_id = dialog_start_foreground( "LEAVE_WITHOUT_CORTANA", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );					   
							dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_librarian_room_00108', FALSE, lib_cortana_2.spawn_points_0, 0.0, "", "Cortana : Good work. Now come get me and let's get out of here." );
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
end
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            l_dialog_id = dialog_start_foreground( "LEAVE_WITHOUT_CORTANA_2", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );					  
							  dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_librarian_room_00109', FALSE, lib_cortana_2.spawn_points_0, 0.0, "", "Cortana : Um, are we forgetting something?" );
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
end
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            l_dialog_id = dialog_start_foreground( "LEAVE_WITHOUT_CORTANA_3", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );					  
						   dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_librarian_room_00110', FALSE, lib_cortana_2.spawn_points_0, 0.0, "", "Cortana : How about NOT leaving the little blue girl behind?" );
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
end
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
     ...
     //       l_dialog_id = dialog_start_foreground( "ELEVATOR_DELRIO", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );
            		//dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_portal_elevator_00100', FALSE, NONE, 0.0, "", "Cortana : Chief, what happened to you? Your bio readings are all over the map!" );
            	//	sleep_s(3);
							//	dialog_line_chief( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m40\m40_portal_elevator_00101', FALSE, NONE, 0.0, "", "Master Chief : Its a long story. But I know what the Didact's after." );
								//dialog_line_cortana( l_dialog_id, 2, TRUE, 'sound\dialog\mission\m40\m40_portal_elevator_00102', FALSE, NONE, 0.0, "", "Cortana : I know that part - the Librarian filled me in when she snatched me out of the system." );
							//	dialog_line_cortana( l_dialog_id, 3, TRUE, 'sound\dialog\mission\m40\m40_portal_elevator_00103', FALSE, NONE, 0.0, "", "Cortana : But what I don't know is what she did to you!" );
						///		sleep_s(7);
						//		dialog_line_chief( l_dialog_id, 4, TRUE, 'sound\dialog\mission\m40\m40_portal_elevator_00104', FALSE, NONE, 0.0, "", "Master Chief : She said she was accelerating my evolution to make me immune to the Composer." );
						//		dialog_line_cortana( l_dialog_id, 5, TRUE, 'sound\dialog\mission\m40\m40_portal_elevator_00105', FALSE, NONE, 0.0, "", "Cortana : Chief." );
						//		dialog_line_cortana( l_dialog_id, 6, TRUE, 'sound\dialog\mission\m40\m40_portal_elevator_00106', FALSE, NONE, 0.0, "", "Cortana : Are you... alright?" );
					//			dialog_line_chief( l_dialog_id, 7, TRUE, 'sound\dialog\mission\m40\m40_portal_elevator_00107', FALSE, NONE, 0.0, "", "Master Chief : Why?" );
					//			dialog_line_cortana( l_dialog_id, 8, TRUE, 'sound\dialog\mission\m40\m40_portal_elevator_00108', FALSE, NONE, 0.0, "", "Cortana : The Librarian just changed who you are at a subatomic level." );
					//			dialog_line_cortana( l_dialog_id, 9, TRUE, 'sound\dialog\mission\m40\m40_portal_elevator_00109', FALSE, NONE, 0.0, "", "Cortana : You've got to have SOME feelings about that." );
				//				dialog_line_chief( l_dialog_id, 10, TRUE, 'sound\dialog\mission\m40\m40_portal_elevator_00110', FALSE, NONE, 0.0, "", "Master Chief : It was the only way to stop the Didact." );
								sleep_s(10);
								hud_rampancy_players_set( 0.4 );
				//				dialog_line_cortana( l_dialog_id, 11, TRUE, 'sound\dialog\mission\m40\m40_portal_elevator_00111', FALSE, NONE, 0.0, "", "Cortana : You don't know that." );
				//				dialog_line_cortana( l_dialog_id, 12, TRUE, 'sound\dialog\mission\m40\m40_portal_elevator_00112', FALSE, NONE, 0.0, "", "Cortana : Why should you always be the one that has to sacrifice? It's... it's not fair." );
				sleep_s(2);
								hud_rampancy_players_set( 0.0 );
       //     l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            hud_play_pip_from_tag( bink\Campaign\M40_D_60 );
            		dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_tractor_beam_00102a', FALSE, NONE, 0.0, "", "Cortana : OK, this is going to be tricky. Once you line up the shot, it’ll be up to you to guide the ordnance all the way down to the target." );
						//		dialog_line_cortana( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m40\m40_tractor_beam_00100', FALSE, NONE, 0.0, "", "Cortana : Infinity, we're at the gravity well!" );
												
								
							//	start_radio_transmission( "delrio_transmission_name" );
						//		dialog_line_npc( l_dialog_id, 2, TRUE, 'sound\dialog\mission\m40\m40_tractor_beam_00101', FALSE, NONE, 0.0, "", "Del Rio : Then paint that damn target so we can get out of here!", TRUE);
						//		end_radio_transmission();
						//		dialog_line_cortana( l_dialog_id, 3, TRUE, 'sound\dialog\mission\m40\m40_tractor_beam_00102', FALSE, NONE, 0.0, "", "Cortana : You heard him, Chief - line up the shot!" );
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
end
  ...
  local short s_random = 0;
	...
	if s_random == 1 then
   	  l_dialog_id = dialog_start_background( "M40_TARGET_MISSED", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE_ALL(), TRUE, "", 0.0 );
   	   	  ...
   	   	  start_radio_transmission( "lasky_transmission_name" );
						dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_global_lasky_00102', FALSE, NONE, 0.0, "", "Lasky : Target missed!", TRUE);
			l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
  ...
  local short s_random = 0;
	...
	if s_random == 1 then 
   	  l_dialog_id = dialog_start_background( "M40_TARGET_MISSED", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE_ALL(), TRUE, "", 0.0 );
   	   	  ...
   	   	  start_radio_transmission( "lasky_transmission_name" );
						dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_global_lasky_00101', FALSE, NONE, 0.0, "", "Lasky : Target acquired!", TRUE);
						end_radio_transmission();
			l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
	elseif s_random == 2 then 
   	  l_dialog_id = dialog_start_background( "M40_TARGET_MISSED", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE_ALL(), TRUE, "", 0.0 );
  ...
  local short s_random = 0;
	...
	if s_random == 1 then 
   	  l_dialog_id = dialog_start_background( "M40_NO_LINE_OF_SIGHT", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE_ALL(), TRUE, "", 0.0 );
   	   	  ...
   	   	  start_radio_transmission( "lasky_transmission_name" );
						dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_global_lasky_00103', FALSE, NONE, 0.0, "", "Lasky : No line of sight on target!", TRUE);
			l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
			end_radio_transmission();
	elseif s_random == 2 then
	  l_dialog_id = dialog_start_background( "M40_NO_LINE_OF_SIGHT", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE_ALL(), TRUE, "", 0.0 );
  ...
  local short s_random = 0;
	...
	if s_random == 1 then   
   	  l_dialog_id = dialog_start_background( "M40_TARGET_DESTROYED", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE_ALL(), TRUE, "", 0.0 );
   	   	  ...
   	   	  start_radio_transmission( "lasky_transmission_name" );
						dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_global_lasky_00104', FALSE, NONE, 0.0, "", "Lasky : Target destroyed!", TRUE);
									end_radio_transmission();
			l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
	elseif s_random == 2 then
   	  l_dialog_id = dialog_start_background( "M40_TARGET_DESTROYED", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE_ALL(), TRUE, "", 0.0 );
  ...
  local short s_random = 0;
	...
	if s_random == 1 then   
   	  l_dialog_id = dialog_start_background( "M40_TARGET_DESTROYED", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE_ALL(), TRUE, "", 0.0 );
   	   	  ...
   	   	  start_radio_transmission( "lasky_transmission_name" );
						dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_global_lasky_00105', FALSE, NONE, 0.0, "", "Lasky : Rail gun reloading!", TRUE);
									end_radio_transmission();
			l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
	elseif s_random == 2 then
			l_dialog_id = dialog_start_background( "M40_TARGET_DESTROYED", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE_ALL(), TRUE, "", 0.0 );
  ...
  local short s_random = 0;
	...
	if s_random == 1 then   
   	  l_dialog_id = dialog_start_background( "M40_RAIL_GUN_READY", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE_ALL(), TRUE, "", 0.0 );
   	   	  ...
   	   	  start_radio_transmission( "lasky_transmission_name" );
						dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_global_lasky_00106', FALSE, NONE, 0.0, "", "Lasky : Rail gun ready to fire!", TRUE);
									end_radio_transmission();
			l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
	elseif s_random == 2 then
			l_dialog_id = dialog_start_background( "M40_RAIL_GUN_READY", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE_ALL(), TRUE, "", 0.0 );
  ...
  local short s_random = 0;
	...
	if s_random == 1 then   
   	  l_dialog_id = dialog_start_background( "M40_RAIL_GUN_AVAILABLE", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE_ALL(), TRUE, "", 0.0 );
   	   	  ...
   	   	  start_radio_transmission( "lasky_transmission_name" );
						dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_global_lasky_00107', FALSE, NONE, 0.0, "", "Lasky : Rail gun available!", TRUE);
									end_radio_transmission();
			l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
	elseif s_random == 2 then
   	  l_dialog_id = dialog_start_background( "M40_RAIL_GUN_AVAILABLE", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE_ALL(), TRUE, "", 0.0 );
...
script dormant f_dialog_40_wraith()
	...
	local long l_dialog_id = DEF_DIALOG_ID_NONE();
   	  ...
   	  l_dialog_id = dialog_start_background( "M40_WRAITH", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE_ALL(), TRUE, "", 0.0 );
						dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\global_chatter_00125', FALSE, NONE, 0.0, "", "Cortana: Wraith!" );
			l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
script dormant f_dialog_40_gauss_hog_01()
	...
	local long l_dialog_id = DEF_DIALOG_ID_NONE();
   	  ...
   	  l_dialog_id = dialog_start_background( "M40_TARGET_GAUSS_HOG_01", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE_ALL(), TRUE, "", 0.0 );
						dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_gauss_00101', FALSE, NONE, 0.0, "", "Marine 1: Gauss Hog, ready to roll!", TRUE);
			l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
script dormant f_dialog_40_gauss_hog_02()
	...
	local long l_dialog_id = DEF_DIALOG_ID_NONE();
   	  ...
   	  l_dialog_id = dialog_start_background( "M40_TARGET_GAUSS_HOG_02", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE_ALL(), TRUE, "", 0.0 );
						dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_gauss_00102', FALSE, NONE, 0.0, "", "Marine 2: Gauss Hog available, sir.", TRUE);
			l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
script dormant f_dialog_40_light_em_up()
	...
	local long l_dialog_id = DEF_DIALOG_ID_NONE();
   	  ...
   	  l_dialog_id = dialog_start_background( "M40_LIGHT_EM_UP", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE_ALL(), TRUE, "", 0.0 );
   	   	  ...
   	   	  start_radio_transmission( "lasky_transmission_name" );
						dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_global_lasky_00119', FALSE, NONE, 0.0, "", "Lasky : Covenant, dug in on the left! Light 'em up!", TRUE);
									end_radio_transmission();
			l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
end  
...
script dormant f_dialog_40_banshees_left()
	...
	local long l_dialog_id = DEF_DIALOG_ID_NONE();
   	  ...
   	  l_dialog_id = dialog_start_background( "M40_BANSHEES_LEFT", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE_ALL(), TRUE, "", 0.0 );
   	   	  ...
   	   	  start_radio_transmission( "lasky_transmission_name" );
						dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_global_lasky_00120', FALSE, NONE, 0.0, "", "Lasky : Banshees, left of the Mammoth!", TRUE);
									end_radio_transmission();
			l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
end  
...
script dormant f_dialog_40_take_out_banshees()
	...
	local long l_dialog_id = DEF_DIALOG_ID_NONE();
   	  ...
   	  l_dialog_id = dialog_start_background( "M40_take_out_banshees", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE_ALL(), TRUE, "", 0.0 );
						...
						dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_global_marine_00100', FALSE, NONE, 0.0, "", "Marine 2: Someone take out those Banshees!", TRUE);
  ...
  local short s_random = 0;
	...
	if s_random == 1 then   
   	     	  l_dialog_id = dialog_start_background( "M40_USE_THE_DESIGNATOR", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE_ALL(), TRUE, "", 0.0 );
						...
						dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m40\m40_global_lasky_00110', FALSE, NONE, 0.0, "", "Lasky: Use the designator on the cannon!", TRUE);
			l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
	elseif s_random == 2 then
   	  l_dialog_id = dialog_start_background( "M40_USE_THE_DESIGNATOR", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE_ALL(), TRUE, "", 0.0 );
