...
script static void f_sfx_elevator_start()
	//dprint( "f_sfx_elevator_start" );
	
	music_set_state( 'Play_mus_m80_v34_atrium_destruction' );
	sound_impulse_start( 'sound\environments\solo\m080\amb_m80_device_machines_specifics\ambience\events\amb_m80_elevator_loop_in.sound', NONE, 1.0 );
	sound_impulse_start( 'sound\environments\solo\m080\amb_m80_device_machines_specifics\amb_m80_elevator_crane_shift_crash.sound', mrk_atrium_destruction, 1.0 );
	//sound_impulse_start_marker (sound tag, object, marker name, scale);
	
end

script static void f_sfx_elevator_restart()
	//dprint( "f_sfx_elevator_restart" );
...
script static void f_sfx_elevator_stop()
	//dprint( "f_sfx_elevator_stop" );
	
	sound_impulse_start( 'sound\environments\solo\m080\amb_m80_device_machines_specifics\ambience\events\amb_m80_elevator_loop_out.sound', NONE, 1.0 );
