...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            l_dialog_id = dialog_start_background( "DROPPING_LEAP_OF_FAITH", l_dialog_id, TRUE, DEF_DIALOG_STYLE_PLAY(), TRUE, "", 0.25 );                       
							dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m90\m90_rampancy_00125_WHISPER', FALSE, NONE, 0.0, "", "Cortana : [WHISPER] I'll always take care of you." );
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
					 								hud_set_rampancy_intensity(player0, 0);
				  			hud_set_rampancy_intensity(player1, 0);
				  			hud_set_rampancy_intensity(player2, 0);
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            l_dialog_id = dialog_start_foreground( "DIDACT_PORTAL_CONSOLE_INSERTION", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), TRUE, "", 0.25 );                       							
							...
							dialog_line_cortana( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m90\m90_didactship_portals_00102', FALSE, NONE, 0.0, "", "Cortana : Didact knows I'm/we're in the system - hurry, go!" );
								end_radio_transmission();
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            start_radio_transmission( "cortana_transmission_name" );	                 							
							dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m90\m90_didactship_portals_00103', FALSE, NONE, 0.0, "", "Cortana : I'll find you on the other side. Just go!" );
							end_radio_transmission();
            l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
//local long l_walls_hold_off = DEF_DIALOG_ID_NONE();
					...
					start_radio_transmission( "cortana_transmission_name" );	
						dialog_line_cortana( l_walls_hold_off, 0, TRUE, 'sound\dialog\mission\m90\m90_didactship_portals_defend_00105', FALSE, NONE, 0.0, "", "Cortana : Reinforcements!" );
						dialog_line_cortana( l_walls_hold_off, 1, TRUE, 'sound\dialog\mission\m90\m90_didactship_portals_defend_00106', FALSE, NONE, 0.0, "", "Cortana : Hold them off while I locate the Composer." );
						end_radio_transmission();
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					...
					start_radio_transmission( "cortana_transmission_name" );	
					  dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m90\m90_turrets_00102', FALSE, NONE, 0.0, "", "Cortana : I've taken control of the local defense turrets." );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					...
					start_radio_transmission( "cortana_transmission_name" );	
					 ...
					 dialog_line_cortana( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m90\m90_didactship_portals_defend_00109', FALSE, NONE, 0.0, "", "Cortana : Far end of the catwalk!" );
					 end_radio_transmission();
          l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "PORTAL_ROOM_3_TURRETS", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), TRUE, "", 0.25 );     
						...
						start_radio_transmission( "cortana_transmission_name" );	
					 dialog_line_cortana( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m90\m90_didactship_portals_defend_00120', FALSE, NONE, 0.0, "", "Cortana : SURRENDER THE COMPOSER, DAMN YOU!" );
					 end_radio_transmission();
          l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					...
					start_radio_transmission( "cortana_transmission_name" );	
					 dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m90\m90_didactship_portals_defend_00118', FALSE, NONE, 0.0, "", "Cortana : I can feel him clawing at me in the system. Attempting to separate me (beat) from what is mine..." );
					 dialog_line_cortana( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m90\m90_didactship_portals_defend_00119', FALSE, NONE, 0.0, "", "Cortana : GIVE ME THE COMPOSER!" );
					 end_radio_transmission();
          l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					...
					start_radio_transmission( "cortana_transmission_name" );	
					 dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m90\m90_didactship_portals_defend_00111', FALSE, NONE, 0.0, "", "Cortana : Chief, behind you!" );
					 end_radio_transmission();
          l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					...
					start_radio_transmission( "cortana_transmission_name" );	
					 dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m90\m90_didactship_portals_defend_00110', FALSE, NONE, 0.0, "", "Cortana : On the walls!" );
					 end_radio_transmission();
          l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "ON_THE_WALLS", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), TRUE, "", 0.25 );     
					start_radio_transmission( "cortana_transmission_name" );	
					 dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m90\m90_didactship_portals_defend_00114', FALSE, NONE, 0.0, "", "Cortana : Coming from above!" );
					 end_radio_transmission();
          l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					...
					start_radio_transmission( "cortana_transmission_name" );	
					 dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m90\m90_didactship_portals_defend_00115', FALSE, NONE, 0.0, "", "Cortana : Turn around!" );
					 end_radio_transmission();
          l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "TURN_AROUND", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), TRUE, "", 0.25 );     
					start_radio_transmission( "cortana_transmission_name" );	
					 dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m90\m90_didactship_portals_defend_00116', FALSE, NONE, 0.0, "", "Cortana : The way you came in." );
					 end_radio_transmission();
          l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					...
					start_radio_transmission( "cortana_transmission_name" );	
					 dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m90\m90_didactship_portals_defend_nudge_00100', FALSE, NONE, 0.0, "", "Cortana : Wait. Chief. I need you to get me. I can't go on my own." );
					 end_radio_transmission();
          l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "FLANKING_US", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), TRUE, "", 0.25 );     
					start_radio_transmission( "cortana_transmission_name" );	
					dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m90\m90_didactship_portals_defend_nudge_00105', FALSE, NONE, 0.0, "", "Cortana : Come back." );
					 dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m90\m90_didactship_portals_defend_nudge_00101', FALSE, NONE, 0.0, "", "Cortana : Please don't leave me!" );
					 end_radio_transmission();
          l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "FLANKING_US", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), TRUE, "", 0.25 );     
					start_radio_transmission( "cortana_transmission_name" );	
					 dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m90\m90_didactship_portals_defend_nudge_00104', FALSE, NONE, 0.0, "", "Cortana : You think I'll just let you go off all by yourself?" );
					 end_radio_transmission();
          l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "FINAL_ROOM_PORTAL", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), TRUE, "", 0.25 );                       																	
					wake(f_dialog_m90_final_room_portal_rampancy);
					start_radio_transmission( "cortana_transmission_name" );	
						dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m90\m90_didactship_portals_defend_00122', FALSE, NONE, 0.0, "", "Cortana : I got it." );
						dialog_line_cortana( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m90\m90_didactship_portals_defend_00123', FALSE, NONE, 0.0, "", "Cortana : I've locked him out of the system but I don't know for how long." );
						end_radio_transmission();
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "SPLINTERING_ICS", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), TRUE, "", 0.25 );                       														
							...
							dialog_line_cortana( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m90\m90_eye_00102', FALSE, NONE, 0.0, "", "Cortana : I've got to do something you're not going to like." );
							dialog_line_chief( l_dialog_id, 2, TRUE, 'sound\dialog\mission\m90\m90_eye_00103', FALSE, NONE, 0.0, "", "Master Chief : What?" );
							dialog_line_cortana( l_dialog_id, 3, TRUE, 'sound\dialog\mission\m90\m90_eye_00104', FALSE, NONE, 0.0, "", "Cortana : AAARHRHH!" );
							dialog_line_cortana( l_dialog_id, 4, TRUE, 'sound\dialog\mission\m90\m90_eye_00105', FALSE, NONE, 0.0, "", "Cortana : DOOOONNN'TTT…" );
							dialog_line_cortana( l_dialog_id, 5, TRUE, 'sound\dialog\mission\m90\m90_eye_00106', FALSE, NONE, 0.0, "", "Cortana : I've been holding on to these pieces of myself so tightly-" );
							
							thread(f_music_m90_v05_rampancy_solution());
							dialog_line_cortana( l_dialog_id, 6, TRUE, 'sound\dialog\mission\m90\m90_eye_00108', FALSE, NONE, 0.0, "", "Cortana : unaware that rampancy was never our problem, but our solution" );
							dialog_line_cortana( l_dialog_id, 7, TRUE, 'sound\dialog\mission\m90\m90_eye_00133', FALSE, NONE, 0.0, "", "Cortana : I don't know about you, but I'm ready for this to be over." );
          l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "TRANSITION_PLATFORM", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), TRUE, "", 0.25 );                       														
						...
						dialog_line_didact( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m90\m90_eye_00122', FALSE, NONE, 0.0, "", "Didact : A final illustration that you are too dangerous to be free." );
						dialog_line_cortana( l_dialog_id, 2, TRUE, 'sound\dialog\mission\m90\m90_eye_00123', FALSE, NONE, 0.0, "", "Cortana : Chief, his ship's in range! Once the barrier's down, you need to get the nuke in there fast!" );
          l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" )	;
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
				...
				//		dialog_line_chief( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m90\m90_eye_00131', FALSE, NONE, 0.0, "", "Master Chief : Cortana?!?" );
						...
						dialog_line_cortana( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m90\m90_rampancy_00120_WHISPER', FALSE, NONE, 0.0, "", "Cortana : Save them! Destroy the Composer!" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_background( "MAELSTROM_VIGNETTE_BACKGROUND_01", l_dialog_id, TRUE, DEF_DIALOG_STYLE_PLAY(), TRUE, "", 0.25 );                       														
						dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m90\m90_rampancy_00130_WHISPER', FALSE, NONE, 0.0, "", "Cortana:	We're here." );
          l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" )	;
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_background( "MAELSTROM_VIGNETTE_BACKGROUND_02", l_dialog_id, TRUE, DEF_DIALOG_STYLE_PLAY(), TRUE, "", 0.25 );                       														
						dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m90\m90_rampancy_00100_WHISPER', FALSE, NONE, 0.0, "", "Cortana:	Get to the Core." );
          l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" )	;
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_background( "MAELSTROM_VIGNETTE_BACKGROUND_03", l_dialog_id, TRUE, DEF_DIALOG_STYLE_PLAY(), TRUE, "", 0.25 );                       														
						dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m90\m90_rampancy_00100_WHISPER', FALSE, NONE, 0.0, "", "Cortana:	Destroy it." );
          l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" )	;
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					...
					sleep_s(.1);
						dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m90\m90_rampancy_00100', FALSE, NONE, 0.0, "", "Cortana:	You can stop him." );
          l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" )	;
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_background( "GRAV_LIFT_BACKGROUND_02", l_dialog_id, TRUE, DEF_DIALOG_STYLE_PLAY(), TRUE, "", 0.25 );                       														
						dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m90\m90_rampancy_00119_WHISPER', FALSE, NONE, 0.0, "", "Cortana:	Place the bomb in the core." );
          l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" )	;
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_background( "RAMPANCY_BACKGROUND_01", l_dialog_id, TRUE, DEF_DIALOG_STYLE_PLAY(), TRUE, "", 0.25 );                       														
						dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m90\m90_rampancy_00113_NORMAL', FALSE, NONE, 0.0, "", "Cortana: Save them. Destroy the Composer." );
          l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" )	;
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_background( "RAMPANCY_BACKGROUND_02", l_dialog_id, TRUE, DEF_DIALOG_STYLE_PLAY(), TRUE, "", 0.25 );                       														
						dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m90\m90_rampancy_00170_WHISPER', FALSE, NONE, 0.0, "", "Cortana: We don't want to leave you." );
          l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" )	;
