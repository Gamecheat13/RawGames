...
script dormant f_walls_setup_portal()
	...
	device_animate_position(  dm_walls_exit_portal , 0 , 0.1, 0.1, 0.0, TRUE );
	//device_set_position_track( dm_walls_exit_false, 'stop_idle', 0.0 );	
	//device_animate_position(  dm_walls_exit_false , 0 , 0.1, 0.1, 0.0, TRUE );
	device_set_position_track( dm_walls_enter, 'stop_idle', 0.0 );	
	//device_animate_position(  dm_walls_enter , 1 , 0.1, 0.1, 0.0, TRUE );	
end
...
script static void f_walls_raise_turrets()
	...
	sound_impulse_start_marker('sound\environments\solo\m090\amb_m90_device_machines\add_on_machine_tags\machine_m90_for_pillar_crate_rise', cr_walls_turret_tower_a, audio_marker_top, 1);
	...
	// raise turret pillar out of the floor
	sound_impulse_start_marker('sound\environments\solo\m090\amb_m90_device_machines\add_on_machine_tags\machine_m90_for_pillar_crate_rise', cr_walls_turret_tower_b, audio_marker_top, 1);
