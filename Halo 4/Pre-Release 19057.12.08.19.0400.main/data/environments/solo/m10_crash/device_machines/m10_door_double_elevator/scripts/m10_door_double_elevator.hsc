...
script startup instanced init()
	...
	// The elevator doors are not animated using global_door scripts :( :( :(
	// sound_open_set( 'sound\environments\solo\m010\device_machines\doors\m10_double_door_elevator' ); 
	// sound_close_set( 'sound\environments\solo\m010\device_machines\doors\m10_double_door_elevator' );
