...
script dormant f_maintenance_destruction_action()
	...
	*/
	...
	sleep_until( f_maintenance_destruction_ramp01_destroyed() and f_maintenance_destruction_ramp02_destroyed() and dialog_id_played_check(L_dialog_ShipVO_Maintenance), 1 );
