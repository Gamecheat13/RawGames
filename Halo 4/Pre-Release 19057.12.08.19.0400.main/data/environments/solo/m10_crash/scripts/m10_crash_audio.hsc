...
script static void f_music_observatory_doors_opening()
	...
	sound_impulse_start('sound\environments\solo\m010\music_vignettes\mus_m10_v06_observation_deck', NONE, 1);
end
...
script static void sfx_vehiclebay_blackout()
	dprint( "sfx_vehiclebay_blackout" );
	
	f_screenshake_event_very_high( -0.925, -1, -3.0, sound\environments\solo\m010\scripted\events\m10_exp_alley_blackout );
