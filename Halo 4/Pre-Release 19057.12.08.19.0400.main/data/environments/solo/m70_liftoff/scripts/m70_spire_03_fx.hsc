...
script static void f_sp03_fx_grav_lift_disable()
	...
	effect_kill_from_flag(environments\solo\m70_liftoff\fx\energy\gravlift_tube.effect , fx_14_gravlift_1_start);
	effect_kill_from_flag(environments\solo\m70_liftoff\fx\energy\gravlift_tube.effect , fx_14_gravlift_1_end);
end
...
script static void f_sp03_fx_grav_lift_02()
		...
		thread(f_grav_lift_effect_on_player(tv_sp03_grav_lift_02, player0));
		thread(f_grav_lift_effect_on_player(tv_sp03_grav_lift_02, player1));
		thread(f_grav_lift_effect_on_player(tv_sp03_grav_lift_02, player2));
		thread(f_grav_lift_effect_on_player(tv_sp03_grav_lift_02, player3));
end
