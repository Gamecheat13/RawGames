...
// EXTERNAL FUNCTIONS
	//f_activate( short start_pos, real transition_delay, real anim_time_open, real anim_time_close) :: located in m70_spire01_tower_shield.hsc

//SPIRE 01 encounter
// gondola logic
//device machines loop go
//ai spawning
//platform switches
//end switch
//jump pad logic
...
//combat
//take the platform == small cov encounter or platform clear
//platform 1 covenant occupied /w knight reinforcements
//
/*SET OBJECTIVE STATES

 GONDOLA LOGIC
 DEF stops  as variables
 write a boolean that checks for these varibale true
...
script dormant f_spire_01_main()
	...
	thread(f_audio_gondola_idle_start()); // gondola audio
...
/*
	...
	*/
	...
	// GONDOLA RIDE 1
	thread(f_audio_gondola_idle_stop()); // gondola audio
...
script static void f_sp01_end_left_behind_01()
	if volume_test_players_all(tv_gondola_path) then
