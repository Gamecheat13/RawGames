...
static long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            if ( not dialog_background_id_active_check(l_dialog_id) ) then
                        ...
                        l_dialog_id = dialog_start_background( "INFINITY_DOCK_PA_01", l_dialog_id, TRUE, DEF_DIALOG_STYLE_PLAY(), TRUE, "", 0.0 );
														dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m70\m70_infinity_dock_pa_00100', FALSE, NONE, 0.0, "", "Infinity System Voice : ATTENTION FLIGHT CREWS. PLEASE ENSURE ALL CRAFT RATED GRADE 7 AND HIGHER HAVE BEEN SECURED FOR TRANSIT.", TRUE);
...
static long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            if ( not dialog_background_id_active_check(l_dialog_id) ) then
                        ...
                        l_dialog_id = dialog_start_background( "INFINITY_DOCK_PA_03", l_dialog_id, TRUE, DEF_DIALOG_STYLE_PLAY(), TRUE, "", 0.0 );
														dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m70\m70_infinity_dock_pa_00102', FALSE, NONE, 0.0, "", "Infinity System Voice : INFINITY'S ORBITAL DEPARTURE STATUS 'BLUE'. ALL ACTIVE DUTY PERSONNEL MUST REPORT TO DUTY STATIONS IMMEDIATELY.", TRUE);
                        l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
static long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            if ( not dialog_background_id_active_check(l_dialog_id) ) then
                        ...
                        l_dialog_id = dialog_start_background( "INFINITY_DOCK_PA_04", l_dialog_id, TRUE, DEF_DIALOG_STYLE_PLAY(), TRUE, "", 0.0 );
														dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m70\m70_infinity_dock_pa_00103', FALSE, NONE, 0.0, "", "Infinity System Voice : ALL NON-ESSENTIAL PERSONNEL ARE ASKED TO PLEASE RESTRICT INTERDECK TRANSIT UNTIL PLANETARY DEPARTURE IS COMPLETE.", TRUE);
                        l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
static long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            if ( not dialog_background_id_active_check(l_dialog_id) ) then
                        ...
                        l_dialog_id = dialog_start_background( "INFINITY_DOCK_PA_05", l_dialog_id, TRUE, DEF_DIALOG_STYLE_PLAY(), TRUE, "", 0.0 );
														dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m70\m70_infinity_dock_pa_00104', FALSE, NONE, 0.0, "", "Infinity System Voice : ALL PRE-FLIGHT TEAMS: HULL PRESSURIZATION PROTOCOLS ARE NOW IN EFFECT. ALL PERSONNEL ARE ORDERED TO RETURN TO INFINITY.", TRUE);
                        l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
static long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            if ( not dialog_background_id_active_check(l_dialog_id) ) then
                        ...
                        l_dialog_id = dialog_start_background( "INFINITY_DOCK_PA_06", l_dialog_id, TRUE, DEF_DIALOG_STYLE_PLAY(), TRUE, "", 0.0 );
														dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m70\m70_infinity_dock_pa_00105', FALSE, NONE, 0.0, "", "Infinity System Voice : STANDBY FOR TIME CHECK. ON SIGNAL, SHIP TIME WILL BE 19 HOURS 30 MINUTES. STANDBY... MARK.", TRUE);
                        l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
static long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            if ( not dialog_background_id_active_check(l_dialog_id) ) then
                        ...
                        l_dialog_id = dialog_start_background( "INFINITY_DOCK_PA_07", l_dialog_id, TRUE, DEF_DIALOG_STYLE_PLAY(), TRUE, "", 0.0 );
														dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m70\m70_infinity_dock_pa_00106', FALSE, NONE, 0.0, "", "Infinity System Voice : A SIGMA-LEVEL ANOMALY HAS BEEN REPORTED IN MATERIAL DEPLOYMENT BAY F959.", TRUE);
                        l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
static long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            if ( not dialog_background_id_active_check(l_dialog_id) ) then
                        ...
                        l_dialog_id = dialog_start_background( "INFINITY_DOCK_PA_08", l_dialog_id, TRUE, DEF_DIALOG_STYLE_PLAY(), TRUE, "", 0.0 );
														dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m70\m70_infinity_dock_pa_00107', FALSE, NONE, 0.0, "", "Infinity PA : RESPONSE CREWS ARE EN ROUTE. PLEASE AVOID MDB F959 UNTIL FURTHER NOTICE.", TRUE);
                        l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
static long l_dialog_id = DEF_DIALOG_ID_NONE();
	...
	if ( not dialog_background_id_active_check(l_dialog_id) ) then
		...
		l_dialog_id = dialog_start_background( "INFINITY_COMP_INTERCOM", l_dialog_id, TRUE, DEF_DIALOG_STYLE_PLAY(), TRUE, "", 0.0 );
			dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m70\m70_infinity_dock_00111', FALSE, NONE, 0.0, "", "Del Rio : All hands, this is the Captain. Infinity is preparing to depart Requiem and return to UNSC space.", TRUE);
			dialog_line_npc( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m70\m70_infinity_dock_00112', FALSE, NONE, 0.0, "", "Del Rio : We mourn the fallen comrades we leave behind, but any victory requires sacrifice. Discipline.", TRUE);
			dialog_line_npc( l_dialog_id, 2, TRUE, 'sound\dialog\mission\m70\m70_infinity_dock_00113', FALSE, NONE, 0.0, "", "Del Rio : Most of all, victory requires patience. We have already won the most important battle - we now know the face of the enemy.", TRUE);
			dialog_line_npc( l_dialog_id, 3, TRUE, 'sound\dialog\mission\m70\m70_infinity_dock_00114', FALSE, NONE, 0.0, "", "Del Rio : When we meet them again, they will know ours. Del Rio out.", TRUE);
		l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
	...
	l_dialog_id = dialog_start_foreground( "CARRIER_WAVE_GENERATOR_02b", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.0 );
		...
		//xxxx
			...
			sleep_s(0.5);
			dialog_line_cortana( l_dialog_id, 5, TRUE, 'sound\dialog\mission\m70\m70_spire1_gondolas_00121', FALSE, NONE, 0.0, "", "Cortana : I'm not picking up anything, Chief." );
			dialog_line_chief( l_dialog_id, 6, TRUE, 'sound\dialog\mission\m70\m70_spire1_gondolas_00133', FALSE, NONE, 0.0, "", "Master Chief : He's there. Keep trying." );
	...
	l_dialog_id = dialog_start_foreground( "CORES_06	", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.0 );
			...
			dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m70\m70_rev_comm_spire1_cores_00102', FALSE, NONE, 0.0, "", "Cortana : Great, the increased signal traffic is almost entirely blocking out the satellite communications. Only one more target left." );
				...
				if volume_test_objects (tv_nar_fx_didact_scan_2a, players()) then
					f_fx_interior_scan( fx_didact_scan_spire2a );	
				end		
				
				if volume_test_objects (tv_nar_fx_didact_scan_2b, players()) then
					f_fx_interior_scan( fx_didact_scan_spire2b );
				end
				
				if volume_test_objects (tv_nar_fx_didact_scan_2c, players()) then
					f_fx_interior_scan( fx_didact_scan_spire2c );
				end			
...
script dormant f_dlg_spire_03_outro_01()
	...
	L_dlg_spire_03_outro_01 = dialog_start_foreground( "SPIRE03_OUTRO01", L_dlg_spire_03_outro_01, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.0 );
			dialog_line_cortana( L_dlg_spire_03_outro_01, 0, TRUE, 'sound\dialog\mission\m70\m70_lichjump_00101', FALSE, NONE, 0.0, "", "Cortana : I'll cue you, but time your jumps carefully." );
			sleep_s(3);
