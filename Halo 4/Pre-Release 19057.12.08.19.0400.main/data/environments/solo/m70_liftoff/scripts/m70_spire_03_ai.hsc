...
script dormant f_spire_03_AI_deinit()
	...
	sleep_forever( f_sp03_ai_bottom_spawn_start );
	sleep_forever( f_sp03_ai_bottom_spawn_back );
...
script dormant f_sp03_ai_bottom()
	...
	wake( f_sp03_ai_bottom_spawn_start );
	wake( f_sp03_ai_bottom_spawn_back );
end
	
script dormant f_sp03_ai_bottom_spawn_start()
	dprint("f_sp03_ai_bottom_spawn_start");
...
//	ai_place(sq_sp03_bot_mid_left_01);
//	ai_place(sq_sp03_bot_mid_left_02);
//	ai_place(sq_sp03_bot_mid_left_03);

	//wake(f_sp03_ai_bottom_turrets_left);
	//wake(f_sp03_ai_bottom_turrets_right);
	//wake(f_sp03_ai_bottom_fallback);
end

script dormant f_sp03_ai_bottom_spawn_back()
	dprint("f_sp03_ai_bottom_spawn_second");
	sleep_until(volume_test_players(tv_spire_03_bottom_mid), 1);
//	ai_place(sq_sp03_bot_reinforce_01);
//	ai_place(sq_sp03_bot_reinforce_02);
//	ai_place(sq_sp03_bot_back_elite_boss);
//	ai_place(sq_sp03_bot_back);
	
	//ai_place(sq_sp03_bot_back_elite_01);
