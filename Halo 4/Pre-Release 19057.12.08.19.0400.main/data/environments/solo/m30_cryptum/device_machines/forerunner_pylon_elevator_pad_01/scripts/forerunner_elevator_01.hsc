...
script startup instanced f_init()
 	print ("pylon elevator has been set up");
...
//	print ("pylon elevator going up");
//	device_set_position_track(	this, 'any:idle', 1 );

	sound_looping_start ("sound\environments\solo\m030\amb_m30_beta\amb_m30_machines\ambience\amb_m30_machine_forerunner_elevator_moving_energy_loop_st", this, 1 );
	device_animate_position (this, 1, 30.0, 0.1, 0.1, TRUE);
	
	sleep_until(device_get_position(this) == 1, 1); // wait for the elevator to get to the top
	sound_looping_stop ("sound\environments\solo\m030\amb_m30_beta\amb_m30_machines\ambience\amb_m30_machine_forerunner_elevator_moving_energy_loop_st");
end
