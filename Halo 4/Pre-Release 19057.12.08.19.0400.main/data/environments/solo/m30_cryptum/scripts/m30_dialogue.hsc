...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "M30_INSERT_INTO", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    
                dialog_line_cortana( l_dialog_id, 0, TRUE, 'sound\dialog\mission\global\global_chatter_00195', FALSE, NONE, 0.0, "", "Cortana : Put me in the console!" );
				 l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					...
					l_dialog_id = dialog_start_foreground( "M30_CANYONS_1_ROCK_HALLWAY", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    
									...
									dialog_line_npc( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m30\m30_delrio_transmission_full_00100_pip', FALSE, NONE, 0.0, "", "Del Rio : Del Rio to Fleetcom. Coordinates provided by Ivanoff have led to ", TRUE);
									hud_play_pip_from_tag( "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
				 ...
				 l_dialog_id = dialog_start_foreground( "M30_PYLONONE_CORE_CLOSE", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
				 ...
				 l_dialog_id = dialog_start_foreground( "M30_PYLONONE_CORE_ONE", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
				 ...
				 l_dialog_id = dialog_start_foreground( "M30_PYLONONE_CORE_TWO", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    	
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					...
					l_dialog_id = dialog_start_foreground( "M30_PYLONONE_NOCORES_DOWN_3", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    
							dialog_line_cortana( l_dialog_id, 0, TRUE, 'ound\dialog\mission\m30\M30_pylonone_bridgetoelevator_00102', FALSE, NONE, 0.0, "", "Cortana : This shield's not going anywhere until those power cores are all offline." );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					...
					l_dialog_id = dialog_start_foreground( "M30_START_RAMP_ENTER", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    
						...
						end_radio_transmission();
						dialog_line_cortana( l_dialog_id, 2, TRUE, 'sound\dialog\mission\m30\m30_pylonone_core_three_00106', FALSE, NONE, 0.0, "", "Cortana : That’s Requiem." );
						dialog_line_cortana( l_dialog_id, 3, TRUE, 'sound\dialog\mission\m30\m30_pylonone_core_three_00107', FALSE, NONE, 0.0, "", "Cortana : They’re not inside at all - they’re moving into orbit." );
						hud_play_pip_from_tag( "" );
