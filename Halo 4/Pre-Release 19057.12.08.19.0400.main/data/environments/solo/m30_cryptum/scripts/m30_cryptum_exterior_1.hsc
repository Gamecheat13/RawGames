...
script static void ext1_front_cleanup()
	...
	f_ai_garbage_erase (sq_ext1_knight_1, 5, -1, -1, -1, TRUE);
	f_ai_garbage_erase (sq_ext1_knight_2, 5, -1, -1, -1, TRUE);
	f_ai_garbage_erase (sq_ext1_knight_3, 5, -1, -1, -1, TRUE);
	f_ai_garbage_erase (sq_ext1_bishop_3, 5, -1, -1, -1, TRUE);
	f_ai_garbage_erase (sq_ext1_pawns_3, 5, -1, -1, -1, TRUE);
	f_ai_garbage_erase (sq_ext1_pawns_3_v2, 5, -1, -1, -1, TRUE);
	f_ai_garbage_erase (sq_ext1_pawns_3_v3, 5, -1, -1, -1, TRUE);
	f_ai_garbage_erase (sq_ext1_pawns_3_v4, 5, -1, -1, -1, TRUE);
	f_ai_garbage_erase (sq_ext1_knight_4, 5, -1, -1, -1, TRUE);
	f_ai_garbage_erase (sq_ext1_bishop_4, 5, -1, -1, -1, TRUE);
	f_ai_garbage_erase (sq_ext1_pawns_4, 5, -1, -1, -1, TRUE);
	f_ai_garbage_erase (sq_ext1_pawns_4v2, 5, -1, -1, -1, TRUE);
	f_ai_garbage_erase (sq_ext1_pawns_4v3, 5, -1, -1, -1, TRUE);
	f_ai_garbage_erase (sq_ext1_bishop_4v2, 5, -1, -1, -1, TRUE);
	f_ai_garbage_erase (sq_ext1_right_knight_1, 5, -1, -1, -1, TRUE);
end
