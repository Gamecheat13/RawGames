...
script static void strong_camera_shake(player p_player)
	camera_shake_player	(p_player, 1, 1, 2, 2);
end

script static void weak_camera_shake(player p_player)
	camera_shake_player	(p_player, 1, 1, 1, 1);
end
...
script static void rock_raise_1()
	thread (weak_camera_shake(player0));
	thread (weak_camera_shake(player1));
	thread (weak_camera_shake(player2));
	thread (weak_camera_shake(player3));
