...
script static void f_door_hallway_1_in_close()
	sleep_until (volume_test_players (tv_door_1_close) and not volume_test_players (tv_door_1_open), 1);

	door_hallway_1_in->close_fast();
...
script static void f_door_hallway_2_in_close()
	sleep_until (volume_test_players (tv_door_3_upper_close) and not volume_test_players (tv_door_3_upper_open), 1);
...
script static void f_door_hallway_3_in_close()
	sleep_until (volume_test_players (tv_door_5_close) and not volume_test_players (tv_door_5_open), 1);
//	object_move_by_offset (door_5, 1, 0, 0, -3);
