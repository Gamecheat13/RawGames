...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
			...
			sleep_s(2);
					l_dialog_id = dialog_start_foreground( "M20_COVENANT_SIGNAL", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), TRUE, "", 0.25 );    
									dialog_line_cortana( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m20\m20_crater_explore_terminal_2_00116', FALSE, NONE, 0.0, "", "Cortana : What is that? Chief, see if that terminal is still active." );
				 l_dialog_id = dialog_end( l_dialog_id, TRUE, TRUE, "" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "M20_EXPLOREABLE_TERMINAL_02", l_dialog_id, TRUE, DEF_DIALOG_STYLE_INTERRUPT(), FALSE, "", 0.25 );    
...
dprint("f_dialog_m20_exploreable_terminal_03_pre");
					...
					l_dlg_exploreable_terminal_03_pre = dialog_start_foreground( "M20_EXPLOREABLE_TERMINAL_03_PRE", l_dlg_exploreable_terminal_03_pre, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    
...
static long l_dialog_id = DEF_DIALOG_ID_NONE();
            ...
            if ( not dialog_background_id_active_check(l_dialog_id) ) then
                        ...
                        l_dialog_id = dialog_start_background( "M20_EXPLOREABLE_TERMINAL_03_0a", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE_ALL(), TRUE, "", 0.0 );
                        sleep_s(5);
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					l_dialog_id = dialog_start_foreground( "M20_EXPLOREABLE_TERMINAL_03_0b", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					...
					l_dialog_id = dialog_start_foreground( "M20_MAP_BUTTON_03", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    
								dialog_line_chief( l_dialog_id, 0, TRUE, 'sound\dialog\mission\m20\m20_cathedral_mantle_00100', FALSE, NONE, 0.0, "", "Master Chief : What does it say?" );
								dialog_line_cortana( l_dialog_id, 1, TRUE, 'sound\dialog\mission\m20\m20_cathedral_mantle_00101', FALSE, NONE, 0.0, "", "Cortana : Guardianship for all living things lies with those whose evolution is most complete." );		
								dialog_line_cortana( l_dialog_id, 2, TRUE, 'sound\dialog\mission\m20\m20_cathedral_mantle_00102', FALSE, NONE, 0.0, "", "Cortana : The Mantle of responsibility shelters all." );
								dialog_line_cortana( l_dialog_id, 3, TRUE, 'sound\dialog\mission\m20\m20_cathedral_mantle_00103', FALSE, NONE, 0.0, "", "Cortana : Very interesting." );
						dialog_line_chief( l_dialog_id, 4, TRUE, 'sound\dialog\mission\m20\m20_cathedral_mantle_00104', FALSE, NONE, 0.0, "", "Master Chief : Maybe... but it won't get us home." );
...
dprint("f_dialog_m20_Cathedral_Librarian_terminal");
					...
					l_dlg_cathedral_Librarian_terminal = dialog_start_foreground( "CATHEDRAL_LIBRARIAN_TERMINAL", l_dlg_cathedral_Librarian_terminal, TRUE, DEF_DIALOG_STYLE_QUEUE(), TRUE, "", 0.25 );    
						dialog_line_cortana( l_dlg_cathedral_Librarian_terminal, 1, TRUE, 'sound\dialog\mission\m20\m20_cathedral_librarian_00109', TRUE, NONE, 0.0, "", "Cortana : It's alright." );
						dialog_line_cortana( l_dlg_cathedral_Librarian_terminal, 2, TRUE, 'sound\dialog\mission\m20\m20_cathedral_librarian_00110', TRUE, NONE, 0.0, "", "Cortana : This energy is actually a ferroelectic datafield." );
						dialog_line_cortana( l_dlg_cathedral_Librarian_terminal, 3, TRUE, 'sound\dialog\mission\m20\m20_cathedral_librarian_00111', TRUE, NONE, 0.0, "", "Cortana : Your shields are just cycling in response to the chamber's charge." );
						dialog_line_chief( l_dlg_cathedral_Librarian_terminal, 4, TRUE, 'sound\dialog\mission\m20\m20_cathedral_librarian_00112', TRUE, NONE, 0.0, "", "Master Chief : Will it get the cartographer back online?" );
						dialog_line_cortana( l_dlg_cathedral_Librarian_terminal, 5, TRUE, 'sound\dialog\mission\m20\m20_cathedral_librarian_00113', TRUE, NONE, 0.0, "", "Cortana : Partially." );
						dialog_line_cortana( l_dlg_cathedral_Librarian_terminal, 6, TRUE, 'sound\dialog\mission\m20\m20_cathedral_librarian_00114', TRUE, NONE, 0.0, "", "Cortana : This type of processing system usually works in parallel." );
						dialog_line_cortana( l_dlg_cathedral_Librarian_terminal, 7, TRUE, 'sound\dialog\mission\m20\m20_cathedral_librarian_00115', TRUE, NONE, 0.0, "", "Cortana : We'll have to locate its twin." );
						dialog_line_chief( l_dlg_cathedral_Librarian_terminal, 8, TRUE, 'sound\dialog\mission\m20\m20_cathedral_librarian_00116', TRUE, NONE, 0.0, "", "Master Chief : What was that?" );
						dialog_line_cortana( l_dlg_cathedral_Librarian_terminal, 9, TRUE, 'sound\dialog\mission\m20\m20_cathedral_librarian_00117', TRUE, NONE, 0.0, "", "Cortana : Your guess is as good as mine." );				 
						dialog_line_cortana( l_dlg_cathedral_Librarian_terminal, 10, TRUE, 'sound\dialog\mission\m20\m20_cathedral_covenant_00100', TRUE, NONE, 0.0, "", "Cortana : The Covenant. They found a way inside." );
...
static long l_dialog_id = DEF_DIALOG_ID_NONE();
                ...
                l_dialog_id = dialog_start_background( "MARINES_BUNKER_01", l_dialog_id, TRUE, DEF_DIALOG_STYLE_INTERRUPT(), TRUE, "", 0.0 );
                start_radio_transmission( "unidentified_transmission_name" );
...
local long l_dialog_id = DEF_DIALOG_ID_NONE();
					...
					sleep_s(2);
					l_dialog_id = dialog_start_foreground( "M20_CATHEDRAL_DIDACT_TERMINAL", l_dialog_id, TRUE, DEF_DIALOG_STYLE_QUEUE(), FALSE, "", 0.25 );    
