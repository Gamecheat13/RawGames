...
script startup instanced fill_narrative_drop_content_m40( )
		static real distance = 0.922;
		static boolean end_narrative_device = 0;
 	 	
 	 	static real length = 7.2;
 	 	static string content = "Wars are not fought for territory, but for words. Unngoy's deadliest weapon is language. He is as susceptible to being hypnotized by slogans as he is to infectious diseases. And where there is an epidemic, the group-mind takes over. - Flipyap McFlappyTap";
