...
script static void marine_jump_test_2()
	print  ("jump marines2!");
	ai_place (marine_jumpers_2, 1);
	cs_run_command_script (marine_jumpers_2, cs_jump_test_2);
end
...
script static void spawn_pawns()
	...
	ai_place_with_shards(spawning_pawns, 3);
end
script static void spawn_pawn()
	print("here come the pawns");
	ai_place_with_shards(spawning_pawns, 1);
end
script static void tight_fit()
	print("tight fit");
	ai_place(see_section, 1);
	ai_place(see_bishop, 1);
end
...
script command_script cs_jump_test_2()
	...
	print  ("moving while facing destination");
	cs_go_to (jump_test_2.p0, 0.3);
	cs_go_to (jump_test_2.p1, 0.3);
...
script static void test_thing()
	print("BLEH");
	test_thing( 1 );
end

script static void test_thing( long l_val )
	print("LONG");
	test_thing( 1.0,2.0 );
end

script static void test_thing( real r_val, real r_val2 )
	print("REAL2");
end
script command_script cs_secondary_trigger()
	print("wait");
	sleep(150);
	print("shoot");
