...
script command_script cs_e3_m1_tower1_grunt1()
	ai_vehicle_enter(chokepoint_guards.grunt_1, (object_get_turret(e3_m1_base1_pod, 2)));
end

script command_script cs_e3_m1_tower2_grunt1()
	ai_vehicle_enter(chokepoint_guards.grunt_2, (object_get_turret(e3_m1_base2_pod, 1)));
end

script command_script cs_e3_m1_tower3_grunt1()
	ai_vehicle_enter(back_tower_guards.grunt_1, (object_get_turret(e3_m1_base3_pod, 2)));
end

script command_script cs_e3_m1_tower4_grunt1()
	ai_vehicle_enter(front_tower_guards.grunt_1, (object_get_turret(e3_m1_base4_pod, 1)));
end
