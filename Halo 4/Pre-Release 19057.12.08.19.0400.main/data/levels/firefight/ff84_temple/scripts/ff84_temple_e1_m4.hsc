...
script static void f_e1_m4_map_room_spawn
	...
	if ai_living_count(gr_ff_all) <= 9 then
		ai_place(sq_maprm_wave_1);
		sleep_s(1);
		ai_place(sq_maprm_wave_2);
		sleep_s(1);
		ai_place(sq_maprm_wave_3);
		sleep_s(1);
		ai_place(sq_maprm_wave_4);
		sleep_s(1);
		ai_place(sq_maprm_wave_5);
	end
end

script static void f_e1_m4_intro_the_knight
	if b_e1m4_intro_the_knight == true then
