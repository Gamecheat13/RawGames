...
//		device_set_position_track(e2m1_forerunner_portal, "any:idle", 0.0 );
//		device_animate_position(e2m1_forerunner_portal, 1, 5.0, 1.0, 1.0, TRUE );
//		object_create_anew(e2m1_portal_fx);
...
script static void e2m1_vo_callback_bothpylonsdown
	...
	b_e2m1_conch = false;
	b_end_player_goal = TRUE;							//advance objectives
	thread(f_new_objective(e2m1_objective_04)); // "Invesitgate the Slipspace Disruption"
...
script static void e2m1_knights_presage
	...
	// INITIATE CONDITIONAL RESPAWN AT TOP TIER (Bishop + shardspawns)
