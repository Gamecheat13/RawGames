...
//effect_new_on_object_marker (cinematics\070la2_carter_death\fx\explosion\covenant_explosion_huge.effect, this, fx_impact);
  ...
  effect_new_on_object_marker_loop( objects\vehicles\covenant\storm_drop_pod_small\fx\drop_pod_small_trail.effect, this, fx_contrail);
	object_hide(this, FALSE);
	...
	effect_stop_object_marker( objects\vehicles\covenant\storm_drop_pod_small\fx\drop_pod_small_trail.effect, this, fx_contrail);
	//object_move_to_point <object name> <time> <target point>
	sound_impulse_start (sound\environments\solo\m030\amb_m30_beta\drop_pod_elite_impact, this, 1); //AUDIO!
...
script static instanced void f_spawn_guys(ai ai_squad)
	unit_open (this);
	sound_impulse_start_marker ( 'sound\storm\vehicles\drop_pod\vehicle_35_storm_drop_pod_small_door_open', this, cov_p1, 1 ); //AUDIO!
	sleep (2);
...
//	sound_impulse_start_marker( 'sound\environments\solo\m030\amb_m30_beta\drop_pod_elite_impact', this, fx_impact, 1 ); //AUDIO!
	effect_new_on_object_marker( objects\vehicles\covenant\storm_drop_pod_small\fx\dp_small_impact.effect, this, fx_impact);
end
