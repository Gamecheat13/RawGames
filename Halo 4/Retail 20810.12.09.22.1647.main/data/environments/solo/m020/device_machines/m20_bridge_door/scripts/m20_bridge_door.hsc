...
script startup instanced init()
	...
	// position_close_start( 0.1 );
	// position_open_start( 0.9 );
	...
	sound_engage_close_setup( 'sound\environments\solo\m020\amb_m20_machines\amb_m20_machine_door_a_close_set' );
