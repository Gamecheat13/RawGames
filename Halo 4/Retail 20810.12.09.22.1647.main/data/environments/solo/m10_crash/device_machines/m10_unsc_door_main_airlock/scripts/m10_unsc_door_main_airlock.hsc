...
script startup instanced init()
	...
	sound_open_set( 'sound\environments\solo\m010\device_machines\doors\m10_airlock_door_open' );
	sound_close_set( 'sound\environments\solo\m010\device_machines\doors\m10_airlock_door_open' ); //REPLACE CLOSING SOUND - TEMP USE ONLY
