...
//	dprint ("start door opening noise");	
	sound_impulse_start('sound\environments\solo\m030\amb_m30_beta\amb_m30_machines\amb_m30_forerunner_small_tunnel_door_opening', this, 1 ); //start door opening noise
	...
	device_animate_position (this, 1.0, 2.5, 0.1, 0.1, TRUE);
	sleep_until (device_get_position (this) >= 0.9, 1);
	...
	sound_impulse_start('sound\environments\solo\m030\amb_m30_beta\amb_m30_machines\amb_m30_forerunner_small_tunnel_door_opened', this, 1 ); //stop door opening noise	
end

script static instanced void open_fast()
//	dprint ("forerunner_small_tunnel_door_in open_fast");	
	device_animate_position (this, 1.0, 1.0, 0.1, 0.1, TRUE);
	
end

script static instanced void open_slow()

	device_animate_position (this, 1.0, 4.0, 0.1, 0.1, TRUE);
	
end

script static instanced void close_default()
	sound_impulse_start('sound\environments\solo\m030\amb_m30_beta\amb_m30_machines\amb_m30_forerunner_small_tunnel_door_closing', this, 1 ); //start door closing noise
	sound_looping_start ("sound\environments\solo\m030\amb_m30_beta\amb_m30_machines\ambience\amb_m30_forerunner_small_tunnel_door_close", this, 1.0);
	
	device_animate_position (this, 0, 2.5, 0.1, 0.1, TRUE);
	sleep_until (device_get_position (this) <= 0.1, 1);

	sound_looping_stop ("sound\environments\solo\m030\amb_m30_beta\amb_m30_machines\ambience\amb_m30_forerunner_small_tunnel_door_close");
	sound_impulse_start('sound\environments\solo\m030\amb_m30_beta\amb_m30_machines\amb_m30_forerunner_small_tunnel_door_closed', this, 1 ); //start door closed noise	
end

script static instanced void close_fast()

	device_animate_position (this, 0, 1.0, 0.1, 0.1, TRUE);
	
end

script static instanced void close_slow()

	device_animate_position (this, 0, 4.0, 0.1, 0.1, TRUE);
...
// jitter variables
global real r_jitter_open_min = 0.1;
global real r_jitter_open_max = 0.33;
