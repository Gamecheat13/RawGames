...
script startup instanced f_init()
 	print ("set EC4 base overlay animation to 'any:idle'");
...
//	device_set_position_track(	this, 'any:idle', 1 );
	device_animate_position (this, 0.20, 1.5, 0.1, 0.1, TRUE);
	
	sleep_until (device_get_position (this) >= 0.20);
	
		device_animate_position (this, 1, 16.0, 0.1, 0.1, TRUE);
