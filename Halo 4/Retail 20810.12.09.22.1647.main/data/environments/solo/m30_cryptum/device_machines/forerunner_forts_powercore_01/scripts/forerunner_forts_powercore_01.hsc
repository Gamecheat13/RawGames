...
script startup instanced f_init()
 	print ("forerunner_forts_powercore_1 set up");
...
script static instanced void f_animate()
	...
	device_animate_position (this, 1.0, 5.0, 0.1, 0.1, TRUE);
	
end

script static instanced void f_animate_stop()
	
	print ("stopping animation");
	
	device_set_position_track(this, 'any:idle', (device_get_position (this)));
