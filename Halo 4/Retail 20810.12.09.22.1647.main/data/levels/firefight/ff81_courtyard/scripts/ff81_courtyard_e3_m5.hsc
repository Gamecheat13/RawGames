...
global boolean b_e3m5_halt_replacers = FALSE;					// Prevents replacement of phantoms
...
script command_script e3m5_phantom_huntship_init 
	...
	ai_dont_do_avoidance(ai_current_actor,true); // Disable avoidance
	...
	cs_fly_to_and_face (phtm_orbit_pts.hunt1, phtm_orbit_pts.huntlook1);
...
//dropoff
	...
	sleep (30 * 2.5);
	cs_fly_to_and_face (phtm_orbit_pts.hunt1, phtm_orbit_pts.p0);
	cs_fly_to_and_face (phtm_orbit_pts.hunt1, phtm_orbit_pts.board1);
//	cs_fly_to_and_face (phtm_orbit_pts.board4, phtm_orbit_pts.p8);
...
script static void f_e3m5_gunship1_replacer
	...
	print ("gunship down");
	sleep(30 * 12);
	if(b_e3m5_halt_replacers == false)then
		if(ai_living_count(e3m5_all_foes) < 19)then
