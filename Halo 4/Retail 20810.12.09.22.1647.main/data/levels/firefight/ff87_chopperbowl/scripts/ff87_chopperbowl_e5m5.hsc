...
script static void e5m5_ordnancedrop()
	...
	if	(e5m5_rvb_is_on == TRUE)	then
		...
		sleep_until (player_in_vehicle (e5m5_wraith01) == TRUE, 1);
		f_unblip_object_cui (e5m5_wraith01);
	else
		sleep (30 * 4);
		...
		sleep (30 * 1);
		navpoint_track_flag_named (fl_e5m5_droparea01, "navpoint_goto");
		navpoint_track_flag_named (fl_e5m5_droparea02, "navpoint_goto");
		navpoint_track_flag_named (fl_e5m5_droparea03, "navpoint_goto");
		f_blip_object_cui (e5m5_wraith01, "navpoint_driver");
		sleep_until (player_in_vehicle (e5m5_wraith01) == TRUE, 1);
		f_unblip_object_cui (e5m5_wraith01);
	end
...
script static void e5m5_immortal_players()
