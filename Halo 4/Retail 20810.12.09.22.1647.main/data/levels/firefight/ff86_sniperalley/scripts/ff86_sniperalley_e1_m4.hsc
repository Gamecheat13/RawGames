...
script static void f_start_all_events_e1_m2
	...
	thread(f_e1_m2_activate_console_1());
	thread(f_e1_m2_activate_console_2());
	thread(f_e1_m2_activate_console_3());
...
script static void f_e1_m2_activate_console_1
	sleep_until (LevelEventStatus ("e1_m2_console1"), 1);
	print("---------------------------console 1 activated======================================");
	device_set_position_track( dm_e1_m2_panel_1, 'device:position', 0 );
	sleep(10);
	device_animate_position ( dm_e1_m2_panel_1, 1, 2, 1, 0, 0);									// big to little (1 == small)
end

script static void f_e1_m2_activate_console_2
	sleep_until (LevelEventStatus ("e1_m2_console2"), 1);
	print("---------------------------console 2 activated======================================");
	device_set_position_track( dm_e1_m2_panel_2, 'device:position', 0 );
	sleep(10);
	device_animate_position ( dm_e1_m2_panel_2, 1, 2, 1, 0, 0);									// big to little (1 == small)
end

script static void f_e1_m2_activate_console_3
	sleep_until (LevelEventStatus ("e1_m2_console3"), 1);
	print("---------------------------console 3 activated======================================");
	device_set_position_track( dm_e1_m2_panel_3, 'device:position', 0 );
	sleep(10);
	device_animate_position ( dm_e1_m2_panel_3, 1, 2, 1, 0, 0);									// big to little (1 == small)
end
...
script static void f_cov_switch_activate (object control, unit player)
	...
	elseif control == dc_e1_m2_switch_2 then
		if(ai_living_count(gr_e1_m2_second_shield) == 0)then
				print ("play button 2 puppetshow");
				pup_play_show (ppt_e1m2_button2);
		else
			NotifyLevel("e1_m2_console2");
		end
