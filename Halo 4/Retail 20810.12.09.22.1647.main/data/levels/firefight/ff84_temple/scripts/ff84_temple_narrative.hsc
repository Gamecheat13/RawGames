...
script static void pip_e1m4_1_subtitles()
	sleep_s (2.18);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_01_mission_04\e1m4_playstart_00100');
end
...
script static void pip_e1m4_2_subtitles()
	sleep_s (1.08);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_01_mission_04\e1m4_backtoevac_00200');
end
...
script static void pip_e1m4_3_subtitles()
	sleep_s (1.08);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_01_mission_04\e1m4_missionover_00200');
end
...
script static void pip_e5m2_1_subtitles()
	//sleep_s (1.05);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_05_mission_02\e5m2_afterstart_00300');
end
...
script static void pip_e5m2_2_subtitles()
	//sleep_s (1.05);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_05_mission_02\e5m2_blowitup_00100');
end
...
script static void pip_e5m2_3_subtitles()
	//sleep_s (1.05);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_05_mission_02\e5m2_ifallclear_00100');
end
...
script static void pip_e5m3_1_subtitles()
	//sleep_s (1.05);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_05_mission_03\e5m3_pelican_00200');
end
