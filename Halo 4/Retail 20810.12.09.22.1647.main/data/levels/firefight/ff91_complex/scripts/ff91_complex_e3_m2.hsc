...
script static void f_e3_m2_kill_banshees
	if object_get_health (sq_e3_m2_banshee_01.driver) > 0 then
		print ("banshee 1 is alive, kill him dead");
		unit_kill(ai_vehicle_get(sq_e3_m2_banshee_01.driver));
	else
		print ("banshee 1 is already dead, don't kill him");
	end
	
	if object_get_health (sq_e3_m2_banshee_01.driver2) > 0 then
		print ("banshee 2 is alive, kill him dead");
		unit_kill(ai_vehicle_get(sq_e3_m2_banshee_01.driver2));
	else
		print ("banshee 2 is already dead, don't kill him");
	end
...
script static void f_e3_m2_end_mission
	...
	ai_braindead (gr_e3_m2_allies_2, true);
