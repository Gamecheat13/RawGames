...
script dormant e3m3_vo_topelican()
	...
	sound_impulse_start ('sound\dialog\storm_multiplayer\pve\ep_03_mission_03\e3m3_topelican_00100_soundstory', NONE, 1);
	sleep (sound_max_time('sound\dialog\storm_multiplayer\pve\ep_03_mission_03\e3m3_topelican_00100'));
	...
	sleep (sound_max_time('sound\dialog\storm_multiplayer\pve\ep_03_mission_03\e3m3_topelican_00200'));
...
script static void pip_e3m3_1_subtitles()
	sleep_s (1.28);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_03_mission_03\e3m3_halsey_00600');
end
...
script static void pip_e3m3_2_subtitles()
	sleep_s (1.01);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_03_mission_03\e3m3_activatetech_00600');
end
...
script static void pip_e3m3_3_subtitles()
	sleep_s (1.14);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_03_mission_03\e3m3_lightshow_00800');
end
...
script static void pip_e3m4_1_subtitles()
	sleep_s (1.29);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_03_mission_04\e3m4_wrapup_00400');
end
...
script static void pip_e4m2_1_subtitles()
	//sleep_s (1.29);
	dialog_play_subtitle('sound\dialog\storm_multiplayer\pve\ep_04_mission_02\e4m2_getinthere_00400');
end

script static void f_shake_test
	f_screenshake_event_med(1, 1, .1, None);
end