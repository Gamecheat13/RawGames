...
local boolean b_p0 = volume_test_object(tv_volume, player_get(0));
local boolean b_p1 = volume_test_object(tv_volume, player_get(1));
local boolean b_p2 = volume_test_object(tv_volume, player_get(2));
local boolean b_p3 = volume_test_object(tv_volume, player_get(3));

	sleep_until( ((volume_test_object(tv_volume, player_get(0)) != b_p0) or (volume_test_object(tv_volume, player_get(1)) != b_p1) or (volume_test_object(tv_volume, player_get(2)) != b_p2) or (volume_test_object(tv_volume, player_get(3)) != b_p3)) or ((l_time_out != -1) and (l_time_out < game_tick_get())), s_rate );
...
script static void sys_screenshake_trigger_sustain( trigger_volume tv_volume, real r_intensity_in, real r_intensity_out, long l_time_end, sound snd_sound )
	...
	repeat
		...
		volume_test_players_change( tv_volume, volume_test_object(tv_volume, player_get(0)), volume_test_object(tv_volume, player_get(1)), volume_test_object(tv_volume, player_get(2)), volume_test_object(tv_volume, player_get(3)), l_time_end );
...
script static void sys_screenshake_player_p0_rumble_volume( long l_ID, trigger_volume tv_volume, real r_intensity, short s_use_cnt, sound snd_sound )
	...
	repeat
		...
		sys_screenshake_player_any_rumble_volume_enable( player_get(0), l_ID, tv_volume, r_intensity, snd_sound );
...
static real r_trigger_intensity = 0.0;
	...
	r_trigger_intensity = if_else_r( volume_test_object(tv_volume, player_get(0)), r_intensity_in, r_intensity_out );
	sys_screenshake_player0_intensity_set( r_trigger_intensity, r_trigger_intensity );
	
	r_trigger_intensity = if_else_r( volume_test_object(tv_volume, player_get(1)), r_intensity_in, r_intensity_out );
	sys_screenshake_player1_intensity_set( r_trigger_intensity, r_trigger_intensity );
	
	r_trigger_intensity = if_else_r( volume_test_object(tv_volume, player_get(2)), r_intensity_in, r_intensity_out );
	sys_screenshake_player2_intensity_set( r_trigger_intensity, r_trigger_intensity );
	
	r_trigger_intensity = if_else_r( volume_test_object(tv_volume, player_get(3)), r_intensity_in, r_intensity_out );
...
script static void sys_screenshake_player_all_apply( real r_general_intensity )
	...
	sys_screenshake_player_any_apply( player_get(0), r_general_intensity, R_screenshake_intensity_p0_l, R_screenshake_intensity_p0_r );
	sys_screenshake_player_any_apply( player_get(1), r_general_intensity, R_screenshake_intensity_p1_l, R_screenshake_intensity_p1_r );
	sys_screenshake_player_any_apply( player_get(2), r_general_intensity, R_screenshake_intensity_p2_l, R_screenshake_intensity_p2_r );
	sys_screenshake_player_any_apply( player_get(3), r_general_intensity, R_screenshake_intensity_p3_l, R_screenshake_intensity_p3_r );
...
static real r_intensity_max = 0.0;
	...
	if ( object_get_health(p_player) > 0 ) then
		...
		r_intensity_l = greater_r( r_intensity_r * R_screenshake_general_mod, r_general_intensity );
