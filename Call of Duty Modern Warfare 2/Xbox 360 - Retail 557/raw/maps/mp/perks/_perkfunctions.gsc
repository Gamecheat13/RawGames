...
selectOneManArmyClass()
{
	...
	if ( menu != game["menu_onemanarmy"] &&
	   ( isDefined( game["menu_onemanarmy_defaults_splitscreen"] ) && menu != game["menu_onemanarmy_defaults_splitscreen"] ) &&
	   ( isDefined( game["menu_onemanarmy_custom_splitscreen"] ) && menu != game["menu_onemanarmy_custom_splitscreen"] ) ||
	   className == "back" )
	{
