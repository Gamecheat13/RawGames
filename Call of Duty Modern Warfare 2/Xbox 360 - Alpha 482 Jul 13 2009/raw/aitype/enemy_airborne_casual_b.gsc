...
/*QUAKED actor_enemy_airborne_casual_b (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE PERFECTENEMYINFO DONTSHAREENEMYINFO
...
main()
{
	...
	character\character_airborne_casual_b::main();
}
...
precache()
{
	character\character_airborne_casual_b::precache();
