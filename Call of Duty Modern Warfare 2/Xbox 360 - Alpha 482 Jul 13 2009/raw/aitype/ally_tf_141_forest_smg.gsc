...
/*QUAKED actor_ally_tf_141_forest_SMG (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE PERFECTENEMYINFO DONTSHAREENEMYINFO
...
main()
{
	...
	character\character_tf_141_forest_smg::main();
}
...
precache()
{
	character\character_tf_141_forest_smg::precache();
