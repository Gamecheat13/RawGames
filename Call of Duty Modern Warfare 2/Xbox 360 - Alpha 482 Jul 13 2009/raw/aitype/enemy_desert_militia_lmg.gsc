...
/*QUAKED actor_enemy_desert_militia_LMG (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE PERFECTENEMYINFO DONTSHAREENEMYINFO
...
main()
{
	...
	character\character_opforce_afghan_lmg::main();
}
...
precache()
{
	character\character_opforce_afghan_lmg::precache();
