...
/*QUAKED actor_enemy_desert_nvg_elite_SMG (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE PERFECTENEMYINFO DONTSHAREENEMYINFO
...
main()
{
	...
	character\character_shadow_co_nvg_smg::main();
}
...
precache()
{
	character\character_shadow_co_nvg_smg::precache();
