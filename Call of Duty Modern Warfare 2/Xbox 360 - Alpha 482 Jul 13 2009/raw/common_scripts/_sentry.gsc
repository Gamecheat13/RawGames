...
main()
{
	...
	level._effect[ "sentry_turret_overheat_smoke" ]			 = loadfx( "smoke/sentry_turret_overheat_smoke" );
...
sentry_init( team, sentryType, owner )
{
	...
	if ( getdvar( "money_enable" ) == "1" && self.team == "axis" )
	{
...
sentry_steam()
{
	...
	{
		playfxOnTag( getfx( "sentry_turret_overheat_smoke" ), self, "tag_flash" );
		playfxOnTag( getfx( "sentry_turret_overheat_smoke" ), self, "tag_aim" ); // temp double fx
		wait .1;
		if ( getTime() - startTime > timeToSteam )
			break;
	}
