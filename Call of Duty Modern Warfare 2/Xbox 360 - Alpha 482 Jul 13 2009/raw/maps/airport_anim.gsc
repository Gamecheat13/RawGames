...
//	addNotetrack_customFunction( "generic", "bodyfall large", :: allowdeath_on, "melee_f_awin_defend" );
	...
	level.scr_anim[ "crawl_death_1" ][ "blood_fx_rate" ]		= .65;
	...
	level.scr_anim[ "makarov" ][ "end_alt" ]	 				= %airport_ending_shoot_makarov;
...
linebook()
{
	...
	level.scr_sound[ "shotgun" ][ "airport_at1_nosurv" ] 		= "airport_at1_nosurv";	
	//Remember - no Russian.
