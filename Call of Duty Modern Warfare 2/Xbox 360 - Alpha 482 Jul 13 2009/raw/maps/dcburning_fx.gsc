...
main()
{
	...
	level._effect[ "cheap_mack_truck_explosion" ] 	 = loadfx( "explosions/tanker_explosion" );
	...
	LITTLEBIRD CRASH
	-------------------------*/	
	level._effect[ "crash_main_01" ] 		= loadfx( "explosions/large_vehicle_explosion" );
	level._effect[ "crash_main_02" ] 		= loadfx( "explosions/fuel_med_explosion" );
	level._effect[ "crash_end_01" ] 	 	= loadfx( "explosions/belltower_explosion" );
	level._effect[ "crash_end_02" ] 	 	= loadfx( "explosions/helicopter_explosion_hind_woodland" );
	level._effect[ "crash_end_03" ] 	 	= loadfx( "explosions/water_collector_explosion" );
