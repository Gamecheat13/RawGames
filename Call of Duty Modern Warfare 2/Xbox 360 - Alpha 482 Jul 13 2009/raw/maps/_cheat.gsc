...
gamespeed_slowmo()
{
	...
	//setslowmotionview( self.speed_norm, self.speed_slow, self.lerp_time_in );	//changed  for slomo breach
}
...
gamespeed_reset()
{
	...
	//setslowmotionview( self.speed_slow, self.speed_norm, self.lerp_time_out ); //changed  for slomo breach
}
