...
//	level.scr_radio[ "yyy" ] = "yyy";
	...
	level.scr_radio[ "byard_pri_donttrust" ]				 = "byard_pri_donttrust";
	...
	level.scr_radio[ "byard_nkl_peanuts" ]					 = "byard_nkl_peanuts";

	// Rook
	level.scr_sound[ "rook" ][ "byard_rok_hangon" ]					 = "byard_rok_hangon";

	// Redshirts
	level.scr_sound[ "generic" ][ "byard_sld_soldusout" ]	 = "byard_sld_soldusout";
	level.scr_sound[ "generic" ][ "byard_rdc_stowit" ]		 = "byard_rdc_stowit";
	level.scr_sound[ "generic" ][ "byard_jkb_goodtogo" ]	 = "byard_jkb_goodtogo";
}
