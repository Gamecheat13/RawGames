...
// ***********************************************************
	...
	set_reverb_drylevel( "af_chase_exit", 		0.9 );
	set_reverb_wetlevel( "af_chase_exit", 		0.3 );
	...
	set_reverb_drylevel( "af_chase_rapids", 		0.9 );
	set_reverb_wetlevel( "af_chase_rapids", 		0.3 );
	...
	set_reverb_drylevel( "af_chase_river", 		0.9 );
	set_reverb_wetlevel( "af_chase_river", 		0.3 );
	...
	set_reverb_drylevel( "af_chase_ext", 		0.9 );
	set_reverb_wetlevel( "af_chase_ext", 		0.3 );
	...
	set_reverb_drylevel( "arcadia_ext1", 			0.9 );
	...
	set_reverb_drylevel( "arcadia_ext3", 			0.9 );
	...
	set_reverb_roomtype( "dcemp_dry", 			"city" );
	set_reverb_drylevel( "dcemp_dry", 			0.9 );
	set_reverb_wetlevel( "dcemp_dry", 			0.15 );
	set_reverb_fadetime( "dcemp_dry", 			6 );
	...
	set_reverb_drylevel( "dcemp_heavy_rain_tunnel", 			0.85 );
	set_reverb_wetlevel( "dcemp_heavy_rain_tunnel", 			0.35 );
	...
	set_reverb_drylevel( "exterior_level2", 			0.9 );
	set_reverb_wetlevel( "exterior_level2", 			0.2 );
	set_reverb_fadetime( "exterior_level2", 			3 );
...
//	add_channel_to_filter( "ac130", 		"effects1" );
	...
	set_filter_freq( "dcemp_heavy_rain_int", 0, 			5200 );
	...
	set_filter_freq( "dcemp_heavy_rain_tunnel", 0, 			4000 );
	set_filter_gain( "dcemp_heavy_rain_tunnel", 0, 			 - 18 );
