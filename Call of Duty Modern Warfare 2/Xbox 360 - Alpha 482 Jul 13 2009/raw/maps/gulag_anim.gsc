...
/*
	F15_pilot_idle
	 - Must be played off "body_animate_jnt" on the F15

Added to scripted.gdt & generic_human.atr


New notetracks, "missile_fx" for the missile exhast.
	*/
...
gulag_vo()
{
	...
	// Go! Go! Go!	
	level.scr_radio[ "gulag_rpt_gogogo" ] = "gulag_rpt_gogogo";
