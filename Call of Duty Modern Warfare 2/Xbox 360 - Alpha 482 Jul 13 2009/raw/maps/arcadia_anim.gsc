...
generic_human()
{
	...
	level.scr_anim[ "zpu_gunner" ][ "death" ]					 = %zpu_gunner_deathslouch;
	...
	level.scr_anim[ "ending_enemy_0" ][ "ending" ]				 = %arcadia_ending_sceneA_enemy1;
	level.scr_anim[ "ending_enemy_0" ][ "deathA" ]				 = %arcadia_ending_sceneA_enemy1_deathA;
	level.scr_anim[ "ending_enemy_0" ][ "deathB" ]				 = %arcadia_ending_sceneA_enemy1_deathB;
	
	level.scr_anim[ "ending_enemy_1" ][ "ending" ]				 = %arcadia_ending_sceneA_enemy2;
	level.scr_anim[ "ending_enemy_1" ][ "deathA" ]				 = %arcadia_ending_sceneA_enemy2_deathA;
	level.scr_anim[ "ending_enemy_1" ][ "deathB" ]				 = %arcadia_ending_sceneA_enemy2_deathB;
	level.scr_anim[ "ending_enemy_1" ][ "deathC" ]				 = %arcadia_ending_sceneA_enemy2_deathC;
	
	level.scr_anim[ "foley" ][ "ending" ]						 = %arcadia_ending_sceneB_guy1;
...
vehicles()
{
	...
	addNotetrack_sound( "zpu_turret", "fire_1", "fire_a", "zpu_fire1" );
	addNotetrack_sound( "zpu_turret", "fire_2", "fire_a", "zpu_fire2" );
	addNotetrack_sound( "zpu_turret", "fire_1", "fire_b", "zpu_fire1" );
	addNotetrack_sound( "zpu_turret", "fire_2", "fire_b", "zpu_fire2" );
...
dialog()
{
	...
	// Clear up!
	level.scr_sound[ "dunn" ][ "arcadia_cpd_clearup" ]			= "arcadia_cpd_clearup";
	
	// Clear down!
	level.scr_sound[ "generic" ][ "arcadia_ar1_cleardown" ]		= "arcadia_ar1_cleardown";
	
	// Ramirez, grab the briefcase.
	level.scr_sound[ "foley" ][ "arcadia_fly_grabbriefcase" ]	= "arcadia_fly_grabbriefcase";
	...
	level.scr_sound[ "foley" ][ "arcadia_fly_securedhvo" ]		= "arcadia_fly_securedhvo";
	
	// Copy that. Get that intel back to the CP. Overlord out.
	level.scr_radio[ "arcadia_hqr_getinteltocp" ] 				= "arcadia_hqr_getinteltocp";
	
	// All right, break's over! Let's get the hell outta here.
	level.scr_sound[ "foley" ][ "arcadia_fly_breaksover" ]		= "arcadia_fly_breaksover";
	...
	level.scr_radio[ "arcadia_fly_headingto4677" ] 				= "arcadia_fly_headingto4677";
	
	// Interrogative - what exactly are we looking for, over?
	level.scr_radio[ "arcadia_fly_lookingfor" ] 				= "arcadia_fly_lookingfor";
	
	// You are to search the house for a 'panic room' and retrieve an HVO.
	level.scr_radio[ "arcadia_hqr_panicroom" ] 					= "arcadia_hqr_panicroom";
	
	// One silver briefcase, serial number - #27515-3.
	level.scr_radio[ "arcadia_hqr_silverbriefcase" ] 			= "arcadia_hqr_needtoknow";
	
	// Everything else is need-to-know. Just bring it back for G-2 to analyze. Overlord out.
	level.scr_radio[ "arcadia_hqr_needtoknow" ] 				= "arcadia_hqr_silverbriefcase";
	...
	//79	Stryker Gunner	3	13	Badger One engaging enemies at the yellow house	arcadia_str_engyellowhouse	player designates a valid target		temp rec'd	armored vehicle headset	7/6/2009
	//80	Stryker Gunner	3	14	Copy. Targeting enemies at the grey house	arcadia_str_targgreyhouse	player designates a valid target		temp rec'd	armored vehicle headset	7/6/2009
	//81	Stryker Gunner	3	15	Roger, engaging targets near the fire truck	arcadia_str_engfiretruck	player designates a valid target		temp rec'd	armored vehicle headset	7/6/2009
	//82	Stryker Gunner	3	16	Confirmed, suppressing enemies near the police car	arcadia_str_confpolicecar	player designates a valid target		temp rec'd	armored vehicle headset	7/6/2009
	//83	Stryker Gunner	3	17	Roger. Engaging enemy chopper	arcadia_str_engchopper	player designates a valid target		temp rec'd	armored vehicle headset	7/6/2009
