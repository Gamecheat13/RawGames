...
anims()
{
	...
	level.scr_anim[ "generic" ][ "execution_shield_hostage_idle" ][ 0 ] = %hostage_stand_idle;
...
dialogue()
{
	...
	level.scr_radio[ "oilrig_nsl_copythat" ] = "oilrig_nsl_copythat";

	//"Seal Leader: Control, all hostages in stronghold secured..."
	//radio_dialogue( "oilrig_nsl_strongholdsec" );
	level.scr_radio[ "oilrig_nsl_strongholdsec" ] = "oilrig_nsl_strongholdsec";
	...
	level.scr_radio[ "oilrig_nsl_goingloud" ] = "oilrig_nsl_goingloud";
	...
	level.scr_radio[ "oilrig_ns2_fireat4_02" ] = "oilrig_ns3_firemissile2";

	//I can't get a clear shot.	
	level.scr_radio[ "oilrig_ns2_fireat4_03" ] = "oilrig_ns2_clearshot";
...
player_anims()
{
	...
	addNotetrack_customFunction( "player_rig", "drips_left", maps\oilrig_fx::playerDrips_left );
