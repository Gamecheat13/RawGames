...
dialogue_crash_site()
{
	...
	thread radio_dialogue( "dcburn_hqr_doyoureadme" );
	...
	level.teamleader dialogue_queue( "dcburn_mcy_defendthispos" );
}
...
macey_last_mag_dialogue()
{
	...
	level.teamleader thread dialogue_queue( "dcburn_mcy_lastone" );
	thread flag_set_delayed( "macey_clip_to_player", 2.3 ); 	//xxxx needs to be triggered from notetrack
}
...
open_player_fov( ePlayer_rig )
{
	...
	level.player PlayerLinkToDelta( ePlayer_rig, "tag_player", 1, 25, 25, 20, 15, true );
}
