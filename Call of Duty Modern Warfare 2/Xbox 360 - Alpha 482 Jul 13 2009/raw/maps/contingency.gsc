...
handle_base()
{
	...
	foreach( guy in start_of_base_redshirt )
		guy spawn_ai();
...
launch_nuke()
{
	...
	earthquake( 0.1, 8, icbm_missile01.origin, 8000 );
...
setup_base_idling_vehicles()
{
	...
	level.base_heli thread maps\_vehicle::damage_hints();
...
monitor_distance_player_vs_price()
{
	...
	while( 1 )
	{
		level.player waittill_entity_out_of_range( level.price, 700 );
...
//	
//	price_path_first_contact_hide_node = getnode( "price_path_first_contact_hide_node", "targetname" );
//	level.price setgoalnode( price_path_first_contact_hide_node );
//	
//	//level.price.ignoreall = true;
//	
//	level endon( "_stealth_spotted" );
//	
//	flag_wait_or_timeout( "first_contact_out_of_sight", 20 );
//
//	
//	//Let's follow them quietly, and pick off any stragglers.	
//	thread radio_dialogue( "cont_pri_pickoffstragglers" );
//
...
//	//level.price enable_dynamic_run_speed();
//	
//	price_path_first_contact = getent( "price_path_first_contact", "targetname" );
//	level.price thread follow_path( price_path_first_contact );
//	//level.price.ignoreall = false;
//}
...
dialog_btr_incoming()
{
	wait 2.8;
//Incoming! Look out! 	
	level.price dialogue_queue( "cont_pri_incoming" );
	//level.price radio_dialogue( "cont_pri_incoming" );
	
	//wait .5;
	
	//level.price  waittill( "attach rocket" );//notetrack
	
//Get down!
	//level.price radio_dialogue( "cont_pri_getdown2" );
...
dialog_intro()
{
	...
	//if( !flag( "price_goes_to_road" ) )
	//{
	//	price_intro_talk_pos2 = getnode( "price_intro_talk_pos2", "script_noteworthy" );
	//	level.price setgoalnode( price_intro_talk_pos2 );
	//}
