...
//PLAZA	
	...
	//Are they friendly			
	level.scr_sound[ "dunn" ][ "dcemp_cpd_aretheyfriedly" ]		= "dcemp_cpd_aretheyfriedly";	
	//I don't know…Star!			
...
mi28()
{
	level.scr_anim[ "emp_heli_spotlight" ][ "crash" ] 	= %cobra_crash;	
...
{	
	//Colonel Marshall's assembling a task force at the Whiskey Hotel. You guys need to keep heading north.	
	level.runner dialogue_queue( "dcemp_ar3_whiskeyhotel" );
...
{
	//So where are you goin'?	
	level.dunn dialogue_queue( "dcemp_cpd_wheregoin" );
	//To tell everyone else! Get to the Whiskey Hotel! Go!		
