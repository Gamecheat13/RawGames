...
endlog_run_anims()
{
	...
	level.scr_anim[ "price" ][ "price_rescue" ] 				= %gulag_rescueB_Price_reshoot;
	level.scr_anim[ "soap" ][ "price_rescue" ] 					= %gulag_rescueB_soldier1_reshoot;
	level.scr_anim[ "redshirt" ][ "price_rescue" ] 				= %gulag_rescueB_soldier2_reshoot;
...
endlog_player_animations()
{
	...
	level.scr_anim[ "player_rig" ][ "price_rescue" ] 		= %gulag_rescueB_player_reshoot;
...
endlog_scrip_model_animations()
{
	...
	level.scr_anim[ "1911" ][ "price_rescue" ]			= %gulag_rescueB_pistol_reshoot;
