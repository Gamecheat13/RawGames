...
setup_anims()
{
	...
	level.scr_sound[ "generic" ][ "favela_run_and_wave" ] = "favesc_pe4_killthemall";
...
setup_dialogue()
{
	...
	// "Jump for it!!!"
	level.scr_radio[ "favesc_cmt_jump" ] = "favesc_cmt_jump";
