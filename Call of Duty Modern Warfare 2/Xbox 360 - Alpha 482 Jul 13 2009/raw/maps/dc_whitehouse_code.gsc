...
//	friendlies = get_ai_group_ai( "whitehouse_approach_friendlies" );
//	array_thread( friendlies, ::random_delayed_kill, 10, 30);
...
foley_flare_fx_start( guy )
{
	...
	flare thread play_flare_fx();
	guy thread play_flare_fx();
