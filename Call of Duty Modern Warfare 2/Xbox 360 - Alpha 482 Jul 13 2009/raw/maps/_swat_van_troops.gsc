...
main( model, type )
{
	...
	build_deathfx( "fire/firelp_med_pm", 					"wheel_back_right_animate_jnt"/* right_wheel_02_jnt */, 	undefined, 							undefined, 			undefined, 		true, 			0 );
	build_deathfx( "fire/firelp_med_pm", 					"tag_driver"/* tag_headlight_left */, 			"fire_metal_medium", 				undefined, 			undefined, 		true, 			0 );
