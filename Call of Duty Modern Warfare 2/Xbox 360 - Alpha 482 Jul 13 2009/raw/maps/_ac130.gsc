...
overlay()
{
	...
	if ( getdvar( "ac130_hud_text_misc" ) == "1" )
	{
	...
	if ( getdvar( "ac130_hud_text_thermal" ) == "1" )
	{
	...
	if ( getdvar( "ac130_hud_text_weapons" ) == "1" )
	{
	...
	if ( getdvar( "ac130_thermal_enabled" ) == "1" )
	{
...
playAliasOverRadio( soundAlias )
{
	...
	level.ac130player playLocalSound( soundAlias, "playSoundOverRadio_done" );
