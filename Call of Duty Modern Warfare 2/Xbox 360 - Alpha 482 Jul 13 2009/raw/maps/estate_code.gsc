...
{	
	...
	SoundSetTimeScaleFactor( "Voice", 1.0 );
	SoundSetTimeScaleFactor( "Effects1", 0 );
	SoundSetTimeScaleFactor( "Effects2", 0.8 );
	SoundSetTimeScaleFactor( "Announcer", 1.0 );
	
	slomoLerpTime_in = 2.5;		//1.5
...
bouncing_betty_activate()
{
	...
	playerMine thread bouncing_betty_fx( 1 );
...
bouncing_betty_fx( specialPlayerCase, gameplayOn )
{
...
strike_component_solarfield_smokerush()
{
...
strike_component_rpg_team_toolshed()
{
...
download_progress()
{
	...
	{
		level.hudelem = maps\_hud_util::get_countdown_hud( -265 );
		...
		level.hudelem_status = maps\_hud_util::get_countdown_hud( -170 );
	...
	*/
	...
	level.hudelem_status = maps\_hud_util::get_download_state_hud( -42 );
	level.hudelem_status SetPulseFX( 30, 900000, 700 );// something, decay start, decay duration
	level.hudelem_status setvalue( 0 );
	
	level.hudelem_status_total = maps\_hud_util::get_countdown_hud( -42 );
	...
	level.hudelem_dltimer_value = maps\_hud_util::get_countdown_hud( -112, 120 );
	...
	level.hudelem_dltimer_units = maps\_hud_util::get_countdown_hud( -106, 120 );
	...
	level.hudelem_dlrate_heading = maps\_hud_util::get_countdown_hud( -71, 120 );
	...
	level.hudelem_dlrate_value = maps\_hud_util::get_countdown_hud( -24, 120 );
	...
	level.hudelem_dlrate_units = maps\_hud_util::get_countdown_hud( -21, 120 );
