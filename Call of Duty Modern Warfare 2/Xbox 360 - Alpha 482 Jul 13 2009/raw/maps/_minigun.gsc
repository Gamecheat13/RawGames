...
minigun_think()
{
	...
	for ( ;; )
	{
		...
		wait( 0.05 );
		self stop_loop_sound_on_entity( "minigun_gatling_fire" );
		self notify( "stop sound" + "minigun_gatling_fire" );
...
minigun_fire_loop()
{
	...
	self thread play_loop_sound_on_entity( "minigun_gatling_fire" );
}
