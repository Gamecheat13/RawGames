...
//	level.soap forceUseWeapon( "usp_silencer", "sidearm" );
//	level.soa
	...
	// Who's Soap?	
	level.redshirt delaythread( 7.2, ::generic_dialogue_queue, "gulag_wrm_whosoap" );
	level.redshirt delaythread( 12.25, ::generic_dialogue_queue, "gulag_wrm_whosoap" );
...
gulag_objectives()
{
	...
	switch( level.start_point )
	{
		...
		case "armory":
			...
			Objective_OnEntity( 3, level.soap, (0, 0, 70) );
			Objective_Current( 3 );
			flag_wait( "leaving_cellblock" );
...
//			objective_position( 1, breach_rescue_org() );
			flag_wait( "player_approaches_rescue_breach" );
			// Plant the breaching charge.
			Objective_Add( 5, "current", &"GULAG_BREACH_THE_BATHROOM", breach_rescue_org() );
			Objective_OnEntity( 2, level.soap, (0, 0, 70) );
			Objective_Current( 5 );
