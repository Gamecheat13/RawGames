...
main()
{
	...
	level._effect[ "nates_roof_balcony_blaster_sparks_b" ]			 = LoadFX( "explosions/sparks_a" );
	...
	level._effect[ "nates_super_explosion" ]						 = LoadFX( "explosions/vehicle_explosion_mig29" );
...
//	light thread maps\_lights::burning_trash_fire();
	light thread maps\_lights::strobeLight( 2, 4, .5 );
