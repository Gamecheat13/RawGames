...
//	addNotetrack_customFunction( "foley", "bang", ::intro_explosion, "roadkill_intro_orders" );
	...
	level.scr_anim[ "shepherd" ][ "shepherd_cover" ][0] 			= %roadkill_cover_active_soldier1;
...
shepherd_points_at_player()
{
	...
	for ( ;; )
	{
		...
		else
		{
			...
			weight = degrees / range;
			self SetAnim( left_anim, 2, 0.2, 1 );
...
roadkill_player_anims()
{
	level.scr_anim[ "player_hummer_getin" ][ "player_getin" ] 					= %roadkill_hummer_player_getin;
	level.scr_animtree[ "player_hummer_getin" ] 								= #animtree;
	level.scr_model[ "player_hummer_getin" ] 									= "viewhands_player_us_army";
...
//school_convert_color_trigger
	...
	// Hunter 2-1, this is Hunter 2-3, gimme a sitrep over!	
	level.scr_radio[ "roadkill_ar2_sitrep" ] = "roadkill_ar2_sitrep";
	
	// Hunter 2-1 copies, we're almost there! Hit a bump in the road, over!	
	level.scr_sound[ "generic" ][ "roadkill_fly_bumpintheroad" ] = "roadkill_fly_bumpintheroad";
	
	// Copy that Hunter 2-1! Let me know when you can see the school! We'll keep it suppressed so you can slip in under their noses, over!	
	level.scr_radio[ "roadkill_ar2_undertheirnoses" ] = "roadkill_ar2_undertheirnoses";
	
	// Solid copy Hunter 2-3, will do!	
	level.scr_sound[ "generic" ][ "roadkill_fly_willdo" ] = "roadkill_fly_willdo";
	...
	// Copy Hunter 2-1! Providing suppressing fire now! Go for it! Hunter 2-3 out!	
	level.scr_radio[ "roadkill_ar2_suppressingfire" ] = "roadkill_ar2_suppressingfire";
