...
init()
{
	...
	*/
	...
	//precacheShader( "skull_black_top" );
	precacheShader( "skull_black_full" );
	precacheShader( "skull_black_plain" );
	//precacheShader( "skull_crosshair" );
	precacheShader( "skull_crosshair_white" );
	//precacheShader( "hud_overlay_gear" );
	//precacheShader( "hud_overlay_money" );
	precacheShader( "hud_overlay_random" );
