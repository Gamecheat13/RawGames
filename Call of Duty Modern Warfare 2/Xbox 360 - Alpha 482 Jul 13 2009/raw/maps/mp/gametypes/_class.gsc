...
init()
{
	...
	precacheShader( "specialty_c4_death" );
...
giveLoadout( team, class, loadoutRefresh )
{
	self takeAllWeapons();
	...
	if ( isDefined( self.pers["copyCatLoadout"] ) && self.pers["copyCatLoadout"]["inUse"] )
	{
	...
	if ( !isDefined( loadoutRefresh ) || !loadoutRefresh )
