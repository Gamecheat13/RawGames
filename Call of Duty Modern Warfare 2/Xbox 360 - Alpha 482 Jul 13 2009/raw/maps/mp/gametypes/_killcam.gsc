	...
	*/
	...
	if ( timeUntilRespawn )
	{
		if ( timeUntilRespawn > 0 )
			setLowerMessage( "spawn_info", game["strings"]["waiting_to_spawn"], timeUntilRespawn );
...
waitCopyCatButton( attacker )
{
	...
	self.kc_icon setShader( "specialty_copycat", 32, 32 );
...
initKCElements()
{
	...
	if ( !isDefined( self.kc_othertext ) )
	{
		...
		self.kc_othertext.x = 0;
		self.kc_othertext.alignX = "center";
		self.kc_othertext.alignY = "top";
		self.kc_othertext.horzAlign = "center_safearea";
		self.kc_othertext.vertAlign = "top_adjustable";
		self.kc_othertext.sort = 1; // force to draw after the bars
	...
	if ( !isDefined( self.kc_icon ) )
	{
		...
		self.kc_icon.x = 0;
		self.kc_icon.alignX = "center";
		self.kc_icon.alignY = "top";
		self.kc_icon.horzAlign = "center_safearea";
		self.kc_icon.vertAlign = "top_adjustable";
