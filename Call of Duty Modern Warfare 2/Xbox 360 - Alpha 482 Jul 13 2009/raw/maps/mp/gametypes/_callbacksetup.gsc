...
SetupDamageFlags()
{
	...
	level.iDFLAGS_SHIELD_EXPLOSIVE_SPLASH	= 64;	// explosive splash, somewhat deflected by the victim's shield

	// script-defined:
	level.iDFLAGS_NO_TEAM_PROTECTION		= 128;
	level.iDFLAGS_NO_PROTECTION				= 256;
	level.iDFLAGS_PASSTHRU					= 512;
}
