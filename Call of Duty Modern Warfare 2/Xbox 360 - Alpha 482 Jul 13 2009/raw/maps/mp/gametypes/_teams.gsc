...
updatePlayedTime()
{
	...
	{
		self maps\mp\gametypes\_persistence::statAdd( "timePlayedAllies", self.timePlayed["allies"] );
		self maps\mp\gametypes\_persistence::statAdd( "timePlayedTotal", self.timePlayed["allies"] );
		self maps\mp\gametypes\_persistence::statAddChild( "round", "timePlayed", self.timePlayed["allies"] );
	}

	if ( self.timePlayed["axis"] )
	{
		self maps\mp\gametypes\_persistence::statAdd( "timePlayedOpfor", self.timePlayed["axis"] );
		self maps\mp\gametypes\_persistence::statAdd( "timePlayedTotal", self.timePlayed["axis"] );
		self maps\mp\gametypes\_persistence::statAddChild( "round", "timePlayed", self.timePlayed["axis"] );
	}

	if ( self.timePlayed["other"] )
	{
		self maps\mp\gametypes\_persistence::statAdd( "timePlayedOther", self.timePlayed["other"] );
		self maps\mp\gametypes\_persistence::statAdd( "timePlayedTotal", self.timePlayed["other"] );
		self maps\mp\gametypes\_persistence::statAddChild( "round", "timePlayed", self.timePlayed["other"] );
	}
...
setTeamModels( team, charSet )
{
	switch ( charSet )
	{
		case "seals_udt":
			...
			game[team + "_model"]["RIOT"] = mptype\mptype_seal_udt_smg::main;
		...
		case "opforce_arctic":
			...
			game[team + "_model"]["RIOT"] = mptype\mptype_opforce_arctic_smg::main;
		...
		case "opforce_airborne":
			...
			game[team + "_model"]["RIOT"] = mptype\mptype_opforce_airborne_smg::main;
		...
		case "militia":
			...
			game[team + "_model"]["RIOT"] = mptype\mptype_opforce_militia_smg::main;
