...
setTeamHeadIcon( team, offset ) // "allies", "axis", "all", "none"
{
	...
	self thread destroyHeadIconsOnHide();
}
...
setPlayerHeadIcon( player, offset ) // "allies", "axis", "all", "none"
{
	...
	self thread keepIconPositioned();
	self thread destroyHeadIconsOnDeath();
	self thread destroyHeadIconsOnDisconnect( player );
	self thread destroyHeadIconsOnHide();
}
...
destroyHeadIconsOnDisconnect( player )
{
	self endon( "turnedoff" );
	self endon( "death" );
	player waittill ( "disconnect" );

	player.entityHeadIcon destroy();
}

destroyHeadIconsOnHide()
{
	self endon( "turnedoff" );
	self waittill ( "hide" );
