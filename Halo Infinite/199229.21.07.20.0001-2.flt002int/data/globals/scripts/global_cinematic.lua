...
function CinematicPlay (cinematic_name:string, forceplay)
	...
	elseif not editor_mode() or forceplay then
		...
		SoundImpulseStartServer(TAG('sound\031_states\031_st_cinematic\set_031_st_campaign_cinematic_black_screen_off.sound'), nil, 1);
...
-- This function is redefined in TestTools during composition captures. DO NOT REMOVE.
function CinematicRecordingInProgress():boolean
	return false;
end

-- This function is redefined in TestTools during composition captures. DO NOT REMOVE.
function CinematicRecordingIsRealtime():boolean
	return false;
end
