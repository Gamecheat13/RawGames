...
PixelOutput ps_main( const PixelInput pixel )
{
	...
	sunlightDiffuse = sunlightVisibility * Phong_DoubleSidedDiffuseLighting( pixel, worldNormal, lightPosition0 );
