...
/*QUAKED actor_ally_ranger_wet_nrmdy_rescuer (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE NOENEMYINFO
...
main()
{
	...
	character\american_ranger_normandy_rescuer_wet::main();
}
...
precache()
{
	character\american_ranger_normandy_rescuer_wet::precache();
