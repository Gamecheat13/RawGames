...
/*QUAKED actor_ally_ranger_nrmdy_30calportable (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE NOENEMYINFO
...
main()
{
	...
	character\american_30cal_normandy::main();
}
...
precache()
{
	character\american_30cal_normandy::precache();
