...
/*QUAKED actor_axis_snow_wehr_reg_mg42portable (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE NOENEMYINFO
...
main()
{
	...
	character\mg42_portable_snow::main();
}
...
precache()
{
	character\mg42_portable_snow::precache();
