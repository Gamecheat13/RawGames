...
placeWeaponOn( weapon, position, activeWeapon )
{
	...
	{
		// if detaching "none" for a weapon, make sure it's position is "none".
		//   BS-6426: You can get into a bad situation when AI characters are using sidearms but don't have any equipped (like in a melee grapple). 
		//   They "equip" a "none" weapon in a real position which can cause another assert to trigger later if this does not make sure to reset it.
		if ( IsDefined( self.weaponInfo[ "none" ] ) )
		{
