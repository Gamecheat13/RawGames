...
init_battleChatter()
{
	...
	if ( is_xslice() )
	{
		...
		{
			level.bcs_maxTalkingDistFromPlayer = 3500;
		}
		if ( !IsDefined( level.bcs_maxThreatDistFromPlayer ) )
		{
			level.bcs_maxThreatDistFromPlayer = 4500;
		}
	}
	else
	{
	...
	{
		// RPG/exposed
		anim.threatCallouts[ "rpg" ] 						 = 0;// "RPG!"
		anim.threatCallouts[ "exposed" ] 					 = 25;// "Got a tango in the open!"
	
		// "obvious" callouts
		anim.threatCallouts[ "player_distance" ] 			 = 0;// "Player! Contact 10 yards!( for 12 o'clock threats )
		anim.threatCallouts[ "player_obvious" ] 			 = 0;// "Player! Light 'em up!"( for 12 o'clock threats )
	
		// player-relative callouts
		// anim.threatCallouts[ "player_yourclock" ] 			 = 30;// "Player! Contact at your 10 o'clock!"
		anim.threatCallouts[ "player_contact_clock" ] 		 = 65;// "Player! Contact at 10 o'clock!"
		anim.threatCallouts[ "player_target_clock" ] 		 = 0;// "Player! Target, 10 o'clock!"
		anim.threatCallouts[ "player_target_clock_high" ] 		 = 40;// "Player! Target, 10 o'clock high!"
		anim.threatCallouts[ "player_cardinal" ] 			 = 0;// "Player! Contact, northwest!"
	
		// "catch-all" callouts
		// anim.threatCallouts[ "ai_yourclock" ] 				 = 25;// "Peas! Contact at your 10 o'clock!"
		anim.threatCallouts[ "ai_distance" ] 			 = 0;// "Peas! Light 'em up!"( for 12 o'clock threats )
		anim.threatCallouts[ "ai_obvious" ] 			 = 0;// "Peas! Contact 10 yards!"( for 12 o'clock threats )
		...
		*/
		...
		anim.threatCallouts[ "player_location" ]			 = 100;// ( Player - relative ) "Contact! 2nd floor window on the left!"
