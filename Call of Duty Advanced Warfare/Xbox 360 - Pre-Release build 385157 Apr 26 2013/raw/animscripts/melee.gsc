...
KNIFE_ATTACK_FX_PATH	=	"vfx/weaponimpact/flesh_impact_knife";
  ...
  while ( Isdefined( self.melee.target ) )
	{
		...
		self setflaggedanimknoballrestart( "meleeanim", self lookupAnim( "melee", "standard" ), %body, 1, .2, 1 );
...
Melee_Standard_GetInPosition()
{
	...
	if ( enemyDistanceSq <= MELEE_RANGE_SQ )
	{
		...
		self SetFlaggedAnimKnobAll( "readyanim", self lookupAnim( "melee", "standard_stand_to_melee" ), %body, 1, .3, 1 );
