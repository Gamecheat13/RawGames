...
main()
{
	...
	if ( self.a.pose == "stand" )
	{
		...
		self setFlaggedAnimKnobAllRestart( "cowerstart", self lookupAnim( "grenade", "cower_squat" ), %body, 1, 0.2 );
		self animscripts\shared::DoNoteTracks( "cowerstart" );
	}
	self.a.pose = "crouch";
	self.a.movement = "stop";

	self setFlaggedAnimKnobAllRestart( "cower", self lookupAnim( "grenade", "cower_squat_idle" ), %body, 1, 0.2 );
...
TryDive( grenadeAngle )
{
	...
	{
		// grenade behind us
		diveAnim = self lookupAnim( "grenade", "cower_dive_back" );
	}
	else
	{
		// grenade in front of us
		diveAnim = self lookupAnim( "grenade", "cower_dive_front" );
	}
