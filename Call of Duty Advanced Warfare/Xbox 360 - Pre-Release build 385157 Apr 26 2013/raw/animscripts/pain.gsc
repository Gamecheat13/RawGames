...
init_animset_pain()
{
	...
	animset["smg_cover_stand_aim"] = [ %smg_coverstand_pain_aim_2_hide_01, %smg_coverstand_pain_aim_2_hide_02 ];
...
specialPain( anim_special )
{
	...
	*/
	...
	case "smg_cover_stand_aim":
		painArray = self lookupAnim( "pain", anim_special );
		DoPainFromArray( painArray );
		handled = true;
		break;
...
CornerRightGrenadeDeath()
{
	...
	self setFlaggedAnimKnobAllRestart( "corner_grenade_pain", self lookupAnim( "corner_grenade_death", "pain" ), %body, 1, .1 );
	...
	self setFlaggedAnimKnobAllRestart( "corner_grenade_idle", self lookupAnim( "corner_grenade_death", "pain" ), %body, 1, .2 );
