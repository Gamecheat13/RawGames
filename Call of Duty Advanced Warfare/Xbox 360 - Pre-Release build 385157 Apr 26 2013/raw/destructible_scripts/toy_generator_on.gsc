...
main()
{
	...
	//---------------------------------------------------------------------
	destructible_create( "toy_generator_on", "tag_bounce", 0, undefined, 32, "no_melee" );
		destructible_splash_damage_scaler( 15 );
			destructible_loopfx( "tag_fx2", "fx/smoke/generator_exhaust", 0.4 );
			destructible_anim( %generator_vibration, #animtree, "setanimknob", undefined, undefined, "generator_vibration" );
		...
		destructible_state( "tag_origin", "machinery_generator", 150 );
			...
			destructible_state( undefined, undefined, 400, undefined, 5, "no_melee" );
				destructible_fx( "tag_fx", "fx/explosions/generator_explosion", false );
				destructible_fx( "tag_fx", "fx/fire/generator_des_fire" );
				...
				destructible_anim( %generator_explode, #animtree, "setanimknob", undefined, 0, "generator_explode" );
				destructible_anim( %generator_explode_02, #animtree, "setanimknob", undefined, 0, "generator_explode_02" );
				destructible_anim( %generator_explode_03, #animtree, "setanimknob", undefined, 0, "generator_explode_03" );
