...
handle_audio()
{
	...
	audio_on		= false;
	dist_threshold	= 800 * 12;
	
	self vehicle_scripts\_mi17_aud::snd_init_mi17();
	...
	while ( 1 )
	{
		if(!IsDefined(self.snd_disable_vehicle_system) || !self.snd_disable_vehicle_system)
		{
			...
			{
				self vehicle_scripts\_mi17_aud::snd_stop_mi17(1.0);
				audio_on = false;
				wait(0.1);
			...
			{
				self vehicle_scripts\_mi17_aud::snd_start_mi17();
				audio_on = true;
			}
		}
		else if (audio_on)
