...
setup_names()
{
	...
	nationalities[ nationalities.size ] = "xslice";
	...
	//Overwriting delta names for fusion
	//Giving new team name for XSLICE so that BC system acutally works. -jgavazza
