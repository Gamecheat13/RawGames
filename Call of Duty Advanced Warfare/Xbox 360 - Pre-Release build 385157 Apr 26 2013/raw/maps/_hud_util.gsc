...
=============
///ScriptDocBegin
"Name: fade_in( <fade_time>, <shader_name> )"
"Summary: Use this to easily fade in"
"Module: Hud"
"MandatoryArg: <fade_time>: Time to fade, defaults to 0.3 seconds."
"MandatoryArg: <shader_name>: Name of the shader precached that you want to have displayed, defaults to black"
"CallOn: A player"
"Example: player fade_in( 0.1, "white" );"
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
...
get_optional_overlay( shader )
{
	if ( !IsDefined( shader ) )
		shader = "black";
	return self get_overlay( shader );
}

/*
=============
///ScriptDocBegin
"Name: fade_out( <fade_time>, <shader_name> )"
"Summary: Use this to easily fade out"
"Module: Hud"
"MandatoryArg: <fade_time>: Time to fade, defaults to 0.3 seconds."
"MandatoryArg: <shader_name>: Name of the shader precached that you want to have displayed, defaults to black"
"CallOn: A player"
"Example: player fade_out( 0.1, "white" );"
"SPMP: singleplayer"
///ScriptDocEnd
=============
*/
...
=============
///ScriptDocBegin
"Name: start_overlay( <shader> )"
"Summary: Use when you want to initiate an overlay that can be used by fade_in and fade_out"
"Module: Entity"
"CallOn: An entity"
"MandatoryArg: <shader>: "
"Example: "
...
get_overlay( shader )
{
	...
	guy.overlay[ shader ].foreground	= true;
