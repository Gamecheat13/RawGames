...
StingerUsageLoop()
{
	...
	for( ;; )
	{
		...
		//assert( !IsValidLockonWeapon( weapon ) || !HasLockonSupport( weapon ) );
		//assert( !HasLockonSupport( weapon ) || !RequiresLockonToFire( weapon ) );
		if ( weapon != "stinger_mp" && weapon != "at4_mp" && weapon != "iw5_smaw_mp" && weapon != "iw5_lsr_mp" && weapon != "iw5_stingerm7_mp" )
		{
			ResetStingerLocking();
			continue;
		}
