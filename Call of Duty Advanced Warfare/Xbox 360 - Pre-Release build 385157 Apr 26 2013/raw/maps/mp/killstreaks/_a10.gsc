...
init()
{
	...
	level.a10_fx[ "wingtip_light_green" ] = LoadFX( "vfx/lights/aircraft_light_wingtip_green" );
	level.a10_fx[ "wingtip_light_red" ] = LoadFX( "vfx/lights/aircraft_light_wingtip_red" );
