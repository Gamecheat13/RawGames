...
init()
{
	...
	level.uav_fx[ "explode" ] = loadFx( "fx/explosions/uav_advanced_death" );	
	level.uav_fx[ "trail" ] = loadFx( "fx/smoke/advanced_uav_contrail" );
	...
	level._effect[ "laserTarget" ] 	 = loadfx("vfx/lights/laser_glow");
...
#/
	...
	UAVModel  maps\mp\_threatdetection::showInThreatDetection();
	...
	for ( ;; )
	{
		...
		if( IsDefined( weapon ) )
		{
			...
			case "sam_projectile_mp":
				...
				break;
			case "sky_laser_projectile_mp":		//laser in mp_laser map
				self.largeProjectileDamage = true;		
				mult = 0.25;
				if( isAdvanced )
					mult = 0.15;
