...
init()
{
	...
	level._effect[ "remote_tank_explode" ]			= LoadFX( "vfx/explosion/bouncing_betty_explosion" );
	level._effect[ "remote_tank_spark" ]			= LoadFX( "vfx/weaponimpact/large_paintedmetal_1" );
	level._effect[ "remote_tank_antenna_light_mp" ]	= LoadFX( "vfx/lights/aircraft_light_red_blink" );
	level._effect[ "remote_tank_camera_light_mp" ]	= LoadFX( "vfx/lights/aircraft_light_wingtip_green" );
