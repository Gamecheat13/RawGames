...
initSpawns()
{
	...
	maps\mp\gametypes\_spawnlogic::addStartSpawnPoints( "mp_ctf_pro_spawn_attackers_start" );
	maps\mp\gametypes\_spawnlogic::addStartSpawnPoints( "mp_ctf_pro_spawn_defenders_start" );	
...
getSpawnPoint()
{
	if ( level.inGracePeriod )
	{
		...
		spawnPoints = maps\mp\gametypes\_spawnlogic::getSpawnpointArray( "mp_ctf_pro_spawn_" + label + "_start" );	
