...
onStartGameType()
{
	...
	level.respawnOldJugg_fx = loadfx( "vfx/explosion/bouncing_betty_explosion" );
...
{	
	...
	if ( sMeansOfDeath == "MOD_SUICIDE" && sWeapon == "none" && isDefined( self.wasSwitchingTeamsForOnPlayerKilled ) )
		return;
...
setSpecialLoadouts()
{
	...
	else
	{
		...
		level.tjugg_loadouts["axis"]["loadoutPerks"] = maps\mp\perks\_perks::getEmptyPerks();
