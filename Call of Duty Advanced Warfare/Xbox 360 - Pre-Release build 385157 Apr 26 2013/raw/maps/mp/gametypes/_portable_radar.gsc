...
portableRadarUseListener( owner )
{
	...
	self setHintString( &"KILLSTREAK_PATCH_PICKUP_PORTABLE_RADAR" );
	...
	for ( ;; )
	{
		...
		//using clip size since the player can have more than 1
		currentClipAmmo = player GetWeaponAmmoClip( "portable_radar_mp" );
		player SetWeaponAmmoClip( "portable_radar_mp", currentClipAmmo + 1);
