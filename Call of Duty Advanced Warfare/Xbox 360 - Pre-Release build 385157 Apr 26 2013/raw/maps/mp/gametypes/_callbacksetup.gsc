...
/#
/*================
Debug callback to give a killstreak to a client
Called from the debug menu
================*/
CodeCallback_GiveKillstreak( entity, streakName )
{
	if ( isDefined( level.killstreakFuncs[streakName] ) && tableLookup( "mp/killstreakTable.csv", 1, streakName, 0 ) != "" )
	{
		foreach ( player in level.players )
		{
			...
			if ( player == entity && player.team != "spectator" )
