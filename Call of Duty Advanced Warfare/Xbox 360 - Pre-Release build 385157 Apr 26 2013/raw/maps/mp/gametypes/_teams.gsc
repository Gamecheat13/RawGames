	...
	switch ( env )
	{
		case "desert":
			...
			if( level.multiTeamBased )
			{
				...
				{
					string_ref = level.teamNameList[i] + "_model";
...
setTeamModels( team, charSet )
{
	switch ( charSet )
	{
		...
		case "sentinel":
			//mptype\mptype_sentinel_assault::precache();
			//mptype\mptype_sentinel_lmg::precache();
			//mptype\mptype_sentinel_shotgun::precache();
			//mptype\mptype_sentinel_smg::precache();
			//mptype\mptype_sentinel_sniper::precache();
			//mptype\mptype_sentinel_riot::precache();
			//mptype\mptype_sentinel_juggernaut::precache();

			game[team + "_model"]["SNIPER"] = mptype\mptype_sentinel_sniper::main;
			game[team + "_model"]["LMG"] = mptype\mptype_sentinel_sniper::main;
			game[team + "_model"]["ASSAULT"] = mptype\mptype_sentinel_sniper::main;
			game[team + "_model"]["SHOTGUN"] = mptype\mptype_sentinel_sniper::main;
			game[team + "_model"]["SMG"] = mptype\mptype_sentinel_sniper::main;
			game[team + "_model"]["RIOT"] = mptype\mptype_sentinel_sniper::main;//temp
			game[team + "_model"]["JUGGERNAUT"] = mptype\mptype_sentinel_sniper::main;

			break;

		case "atlas":
			//mptype\mptype_atlas_assault::precache();
			//mptype\mptype_atlas_lmg::precache();
			//mptype\mptype_atlas_shotgun::precache();
			//mptype\mptype_atlas_smg::precache();
			//mptype\mptype_atlas_sniper::precache();
			//mptype\mptype_atlas_riot::precache();
			//mptype\mptype_atlas_juggernaut::precache();

			game[team + "_model"]["SNIPER"] = mptype\mptype_atlas_smg::main;
			game[team + "_model"]["LMG"] = mptype\mptype_atlas_smg::main;
			game[team + "_model"]["ASSAULT"] = mptype\mptype_atlas_smg::main;
			game[team + "_model"]["SHOTGUN"] = mptype\mptype_atlas_smg::main;
			game[team + "_model"]["SMG"] = mptype\mptype_atlas_smg::main;
			game[team + "_model"]["RIOT"] = mptype\mptype_atlas_smg::main;//temp
			game[team + "_model"]["JUGGERNAUT"] = mptype\mptype_atlas_smg::main;
...
setPlayerModels()
{
	...
	//mptype\mptype_cloak_test::precache();
}
...
playerModelForWeapon( weapon, secondary )
{
	...
	/#
	Print( "playerModelForWeapon(): The player model is " );
	Print( self GetModelFromEntity() );
	Print( ", the head model is " );
	Print( self.headModel );
	Print( ", and the view model is " );
	Print( self GetViewModel() );
	Print( "\n" );
	#/
	assert( IsDefined( self.headModel ) );
