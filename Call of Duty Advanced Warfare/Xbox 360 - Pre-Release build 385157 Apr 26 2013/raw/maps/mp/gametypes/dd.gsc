...
main()
{
	...
	SetDvar( "ui_bombtimer_a", -1 );
	SetDvar( "ui_bombtimer_b", -1 );
...
initializeMatchRules()
{
	...
	level.dd_addTime = GetMatchRulesData( "demData", "extraTime" );
	SetDynamicDvar( "scr_dd_addtime", level.dd_addTime );
...
{	
	...
	level._effect["bombexplosion"] = loadfx("fx/explosions/tanker_explosion");
...
{	
	...
	if ( destType == "explode" )
	{
		...
		if ( !inOvertime() && level.bombExploded < 2 && level.dd_addTime )
		{
