...
DAMB_start_preset(name, label_, prob_scale_, linked_dambs_)
{
	...
	DAMBx_start_preset("free", name, label_, prob_scale_, undefined, undefined, undefined, linked_dambs_);
}
...
DAMB_start_preset_at_point(preset_name, point, label_, max_distance_, fadeoutmaxdistance_, linked_dambs_)  // DAMB_start_preset_at_point("example", (3, 401, 219));
{
	...
	if (IsDefined(max_distance_)) 
		...
		DAMBx_start_preset("free", preset_name, label_, undefined, point, undefined, undefined, linked_dambs_);
...
{	
	...
	while(true)
	{
		...
		if (dist < max_distance)
		{
			...
			{
				is_stopped = false;
				DAMBx_start_preset("free", name, label_, undefined, point, undefined, undefined, linked_dambs_);
			}
		}
		else
		{
...
DAMBx_get_loop_def_from_string_table(loop_name, checklevel)
{
	...
	level_stringtable =  soundscripts\_audio::get_damb_loops_stringtable();
	preset = [];
...
DAMBx_get_component_from_string_table(component_name, checklevel)
{
	...
	level_stringtable = soundscripts\_audio::get_damb_component_stringtable();
...
DAMBx_get_preset_from_string_table(presetname, checklevel)
{
	...
	level_stringtable = soundscripts\_audio::get_damb_stringtable();	
