...
/*QUAKED actor_axis_wehrmacht_soldier_mg42 (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE NOENEMYINFO
...
main()
{
	...
	character\wehrmacht_soldier_mg42::main();
}

precache()
{
	character\wehrmacht_soldier_mg42::precache();
