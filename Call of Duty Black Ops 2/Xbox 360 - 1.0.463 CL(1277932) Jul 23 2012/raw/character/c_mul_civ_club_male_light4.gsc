...
main()
{
	codescripts\character::setModelFromArray(xmodelalias\c_mul_civ_club_male_lt8_als::main());
...
precache()
{
	codescripts\character::precacheModelArray(xmodelalias\c_mul_civ_club_male_lt8_als::main());
