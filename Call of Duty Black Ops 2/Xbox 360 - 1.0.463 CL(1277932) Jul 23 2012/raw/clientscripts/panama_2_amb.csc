...
main()
{
	...
	//SLUMS	
		...
		//Slums interior: partially open
		declareAmbientRoom( "slums_interior_open" );
		setAmbientRoomTone ("slums_interior_open","blk_panama_battle_bg", .5, .5);
		...
		//Slums outdoor : small ally ways in between buildings
		declareAmbientRoom( "slums_ally" );
		setAmbientRoomTone ("slums_ally","blk_panama_battle_bg", .5, .5);
	...
	//DOCKS	
		//Docks Outdoor: Main package for the outdoor ambience of the docks section, big battles going on, etc
