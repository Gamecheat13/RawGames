...
init()
{
	...
	//if ( !clientscripts\mp\zombies\_zm_weapons::is_weapon_included( "tazer_knuckles_zm" ) && !(isdefined( level.uses_tesla_powerup ) && level.uses_tesla_powerup) )
	{
		return;
	}
...
tesla_fx_rail( localclientnum )
{
	...
	for( ;; )
	{
		...
		if ( currentweapon != "tazer_knuckles_zm" && currentweapon != "tazer_knuckles_upgraded_zm" )
		{
			continue;
		}
		...
		if ( currentweapon == "tazer_knuckles_upgraded_zm" )
		{
