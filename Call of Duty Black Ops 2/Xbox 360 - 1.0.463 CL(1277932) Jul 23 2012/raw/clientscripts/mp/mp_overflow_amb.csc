...
/*	
 * 
 	- Not added in radiant yet.  Use on the open mini-ammys that lead to the back alleys
 	
	declareAmbientRoom("NEW" );
		setAmbientRoomReverb( "NEW", "overflow_alley_entr_opn", 1, 1 );
		setAmbientRoomContext( "NEW", "ringoff_plr", "outdoor" );	
...
snd_play_loopers()
{
	...
	//soundloopemitter( "amb_air_dank_c", (362, 243, 188) );
	...
	//soundloopemitter( "amb_air_high", (-1810, 1904, 1168) );
...
snd_start_autofx_audio()
{
	...
	snd_play_auto_fx ( "fx_mp_water_drip_light_shrt", "amb_water_drip_shrt", 0, 0, 0, true );
	snd_play_auto_fx ( "fx_mp_water_drip_light_long", "amb_water_drip_lng", 0, 0, 0, true );
    snd_play_auto_fx ( "fx_mp_steam_pipe_md", "dst_steam_pipe_lp", 0, 0, 0, false );
	snd_play_auto_fx ( "fx_mp_steam_gas_pipe_md", "dst_gas_pipe_lp", 0, 0, 0, false );    
	snd_play_auto_fx ( "fx_water_pipe_spill_md", "amb_sewer_flow", 0, 0, 0, false );
	snd_play_auto_fx ( "fx_water_pipe_spray_splash", "amb_sewer_splash", 0, 0, 0, true );
	snd_play_auto_fx ( "fx_insects_swarm_lg_light", "amb_sml_flies", 0, 0, 0, false );
	snd_play_auto_fx ( "fx_insects_swarm_md_light", "amb_lrg_flies", 0, 0, 0, false );
	snd_play_auto_fx ( "fx_insects_fly_sngl_parent", "amb_sml_flies", 0, 0, 0, false );
	snd_play_auto_fx ( "fx_light_flour_glow_cool_sngl_shrt", "amb_flour_light", 0, 0, 0, false );
	snd_play_auto_fx ( "fx_fire_sm", "amb_car_fire_sml", 0, 0, 0, false );
	snd_play_auto_fx ( "fx_fire_detail", "amb_fire_med", 0, 0, 0, false ); 
