...
//	loadTreadFx("snow");
	...
	// vehicle flags	
	level._client_flag_callbacks["vehicle"][CLIENT_FLAG_STUNNED] = clientscripts\mp\_callbacks::stunned_callback;
	level._client_flag_callbacks["vehicle"][CLIENT_FLAG_COUNTDOWN] = ::start_blink;
	level._client_flag_callbacks["vehicle"][CLIENT_FLAG_TIMEOUT] = ::final_blink;
...
//	return "snow_dust";
	...
	// we do not have snow levels in bo2
