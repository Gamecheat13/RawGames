...
human()
{
	...
	stair_anims[2] =	animArray("staircase_up_8x16_2", movement, false);	// 2 stairs
	stair_anims[4] =	animArray("staircase_up_8x16_4", movement, false);	// 4 stairs
	stair_anims[6] =	animArray("staircase_up_8x16_6", movement, false);	// 6 stairs
	stair_anims[8] =	animArray("staircase_up_8x16_8", movement, false);	// 8 stairs
	stair_anims[10] =	animArray("staircase_up_8x16_10", movement, false);	// 10 stairs
