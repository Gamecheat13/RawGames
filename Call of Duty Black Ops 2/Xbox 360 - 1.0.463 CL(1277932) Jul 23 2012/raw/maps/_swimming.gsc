...
/*-----------------------------------------------------------------------------------
Swimming utility functions:
-----------------------------------------------------------------------------------*/
/@
"Name: enable_swimming()"
"Summary: Enable swimming script. If attempting to initialize swimming, call _swimming::main first. "
"Module: Swimming"
...
on_player_connect()
{
	...
	wait_network_frame();  // let client catch up
	SetSavedDvar( "phys_buoyancy", 1 );  // this will enable swimming; code won't look for water otherwise
