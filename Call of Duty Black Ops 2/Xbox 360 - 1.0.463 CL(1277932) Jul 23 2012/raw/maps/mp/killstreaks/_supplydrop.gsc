...
//	LoadFX ("vehicle/props/fx_seaknight_rear_blade_full");
	...
	registerCrateType( "supplydrop_mp", "killstreak", "inventory_minigun_mp", 4, &"KILLSTREAK_MINIGUN_CRATE", &"PLATFORM_MINIGUN_GAMBLER", "share_package_death_machine", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "inventory_m32_mp", 4, &"KILLSTREAK_M32_CRATE", &"PLATFORM_M32_GAMBLER", "share_package_multiple_grenade_launcher", ::giveCrateKillstreak );
	...
	registerCrateType( "inventory_supplydrop_mp", "killstreak", "inventory_minigun_mp", 4, &"KILLSTREAK_MINIGUN_CRATE", &"PLATFORM_MINIGUN_GAMBLER", "share_package_death_machine", ::giveCrateKillstreak );
	registerCrateType( "inventory_supplydrop_mp", "killstreak", "inventory_m32_mp", 4, &"KILLSTREAK_M32_CRATE", &"PLATFORM_M32_GAMBLER", "share_package_multiple_grenade_launcher", ::giveCrateKillstreak );
	...
	registerCrateType( "gambler_mp", "killstreak", "inventory_minigun_mp", 6, &"KILLSTREAK_MINIGUN_CRATE", undefined, "share_package_death_machine", ::giveCrateKillstreak );
	registerCrateType( "gambler_mp", "killstreak", "inventory_m32_mp", 5, &"KILLSTREAK_M32_CRATE", undefined, "share_package_multiple_grenade_launcher", ::giveCrateKillstreak );
