...
init()
{
	...
	maps\mp\killstreaks\_killstreaks::registerKillstreak("inventory_minigun_mp", "inventory_minigun_mp", "killstreak_minigun", "minigun_used", ::useCarriedKillstreakWeapon, false, true, "MINIGUN_USED" );
	...
	maps\mp\killstreaks\_killstreaks::registerKillstreakDialog("inventory_minigun_mp", "mpl_killstreak_minigun", "kls_weapon_used", "","kls_weapon_enemy", "", "kls_weapon_ready");
	...
	maps\mp\killstreaks\_killstreaks::registerKillstreak("inventory_m32_mp", "inventory_m32_mp", "killstreak_m32", "m32_used", ::useCarriedKillstreakWeapon, false, true, "M32_USED" );
	...
	maps\mp\killstreaks\_killstreaks::registerKillstreakDialog("inventory_m32_mp", "mpl_killstreak_m32", "kls_weapon_used", "","kls_weapon_enemy", "", "kls_weapon_ready");
	...
	/*registerKillstreak( "m32_drop_mp", "m32_drop_mp", "killstreak_m32", "m32_drop_used", maps\mp\killstreaks\_supplydrop::useKillstreakSupplyDrop, undefined, true );
...
watchKillstreakWeaponSwitch( killstreakWeapon, killstreak_id, isFromInventory )
{
	...
	while(1)
	{
		...
		{	
			self TakeWeapon( killstreakWeapon );
			self removeUsedKillstreak( killstreakWeapon );
...
watchKillstreakWeaponDeath( hardpointType, killstreak_id, isFromInventory )
{
	...
	if( self.lastNonKillstreakWeapon == hardpointType )
	{
		...
		newAmmo = int( currentAmmo - maxAmmo / 2 );
		if( newAmmo < 0 )
		{
	...
	{	
		...
		self removeUsedKillstreak( hardpointType );
		self maps\mp\killstreaks\_killstreaks::activateNextKillstreak();
	}
	return;
}
