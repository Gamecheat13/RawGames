...
//	{
//		self DoDamage( level.incendiaryFireDamage, self.origin, attacker, attacker, "none", mod, 0, "incendiary_grenade_mp" );
//
//		wait(1);
//		duration += 1;
...
//		{
//			self DoDamage( incendiaryFireDamage, self.origin, attacker, inflictor, "none", mod, 0, "incendiary_grenade_mp"   );
//			if ( isplayer( self ) )
//				self setburn( 1.1 );
//			wait(1);
//			waittime = waittime - 1;
