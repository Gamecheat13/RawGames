...
// CreateFX entities placed: 112
     	...
     	ent = maps\mp\_utility::createOneshotEffect( "wire_sparks" );
     	...
     	ent = maps\mp\_utility::createOneshotEffect( "fire_window" );
     	...
     	ent = maps\mp\_utility::createOneshotEffect( "ash_and_embers_hall" );
