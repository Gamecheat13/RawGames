...
//		case "emp_grenade_sp":
//			grenade.originalOwner=self;
//			grenade thread watch_emp_grenade_stage1();
//			break;
		}
	}
}

//watch_emp_grenade_stage1()
//{
//	//emp is a jumping grenade - when it goes off, fire the emp stage 2 grenade, which actually does the damage
//	level endon("death");
//	self waittill("explode",position);
//	
//	if( IsDefined( self.originalOwner ) )
//		self.originalOwner MagicGrenadeType("emp_grenade_stage2_sp",position+(0,0,1),(0,0,700),1);	
//}
//
...
// sWeapon = string specifying the weapon used (e.g. "mine_shoebox_sp")
