...
guy_twitch( guy, pos )
{
	...
	if( isdefined( animpos.vehicle_idle_twitchin ) )
		self thread setanimrestart_once( animpos.vehicle_idle_twitchin, false );
...
guy_twitch_idle( guy, pos )
{
	...
	while( 1 )
	{
		theanim = RandomInt( animpos.idle_twitch.size ); //randomoccurrance( guy, animpos.duckidleoccurrence );	
