...
init_model_anims()
{
	...
	level.scr_anim["fxanim_props"]["laundromat_wall2"] = %fxanim_panama_laundromat_wall2_anim;
...
{
	self play_fx( "fx_civ_smallwagon_light", self.origin, undefined, "break", true, "tag_origin" );
}