...
say_dialog( str_vo_line, n_delay, b_fake_ent = false )
{    
	self endon( "death" );
...
queue_dialog( str_line, n_delay = 0, start_flags, cancel_flags, b_only_once = true, b_priority = false, str_team )
{
	...
	if ( IsDefined( str_team ) )
	{
		e_talker = get_array_of_closest( level.player.origin, GetAIArray( str_team ), level.hero_list );
		if ( IsAlive( e_talker ) )
		{
			e_talker thread _queue_dialog_on_cancel( str_line, n_id, cancel_flags, b_priority );
			e_talker thread _queue_dialog_on_death( str_line, n_id, b_priority );
...
queue_dialog_enemy( str_line, n_delay, start_flags, cancel_flags, b_only_once )
{
	queue_dialog( str_line, n_delay, start_flags, cancel_flags, b_only_once, false, "axis" );
}

queue_dialog_ally( str_line, n_delay, start_flags, cancel_flags, b_only_once )
{
	queue_dialog( str_line, n_delay, start_flags, cancel_flags, b_only_once, false, "allies" );
}

priority_dialog( str_line, n_delay, start_flags, cancel_flags, b_only_once, str_team )
{
	queue_dialog( str_line, n_delay, start_flags, cancel_flags, b_only_once, true, str_team );
}

priority_dialog_enemy( str_line, n_delay, start_flags, cancel_flags, b_only_once, str_team )
{
	queue_dialog( str_line, n_delay, start_flags, cancel_flags, b_only_once, true, "axis" );
}

priority_dialog_ally( str_line, n_delay, start_flags, cancel_flags, b_only_once, str_team )
{
	queue_dialog( str_line, n_delay, start_flags, cancel_flags, b_only_once, true, "allies" );
}
