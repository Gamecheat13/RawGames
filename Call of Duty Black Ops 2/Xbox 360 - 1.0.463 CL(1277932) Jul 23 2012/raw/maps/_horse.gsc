...
main() // self == horse
{
	...
	{
		if( IsSubStr( self.vehicletype, "low" ) )
		{
...
set_horse_in_combat( is_combat )
{
	...
	if ( is_combat )
	{
		...
		level.vehicle_aianims[ "horse_low" ][0].getin = %generic_human::ai_horse_rider_get_on_combat_leftside;
		level.vehicle_aianims[ "horse_low" ][0].getout = %generic_human::ai_horse_rider_get_off_combat_leftside;
		level.vehicle_aianims[ "horse_player_low" ][0].getin = %generic_human::ai_horse_rider_get_on_combat_leftside;
		level.vehicle_aianims[ "horse_player_low" ][0].getout = %generic_human::ai_horse_rider_get_off_combat_leftside;
	}
	else
	{
		...
		level.vehicle_aianims[ "horse_low" ][0].getin = %generic_human::ai_horse_rider_get_on_leftside;
		level.vehicle_aianims[ "horse_low" ][0].getout = %generic_human::ai_horse_rider_get_off_leftside;
		level.vehicle_aianims[ "horse_player_low" ][0].getin = %generic_human::ai_horse_rider_get_on_leftside;
		level.vehicle_aianims[ "horse_player_low" ][0].getout = %generic_human::ai_horse_rider_get_off_leftside;
	}
}
