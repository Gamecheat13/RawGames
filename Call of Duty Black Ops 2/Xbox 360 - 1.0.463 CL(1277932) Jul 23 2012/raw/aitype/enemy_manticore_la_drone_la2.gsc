...
/*QUAKED actor_Enemy_Manticore_LA_Drone_LA2 (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_mul_pmc_drone_1::main();
...
precache(ai_index)
{
	character\c_mul_pmc_drone_1::precache();
