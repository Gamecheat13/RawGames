...
/*QUAKED actor_Ally_Navy_Blackout_Wounded_Woman (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_usa_captain_anderson_fb"
...
main()
{
	...
	character\c_usa_captain_anderson::main();
...
precache(ai_index)
{
	character\c_usa_captain_anderson::precache();
