...
/*QUAKED actor_So_Ally_Heavy_Base (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	self setEngagementMaxDist( 600.000000, 800.000000 );

	character\c_usa_secserv_heavy::main();
...
precache(ai_index)
{
	character\c_usa_secserv_heavy::precache();
