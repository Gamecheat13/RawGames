...
/*QUAKED actor_Hero_Noriega_Panama_Cap (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_pan_noriega_casual_cap::main();
...
precache(ai_index)
{
	character\c_pan_noriega_casual_cap::precache();
