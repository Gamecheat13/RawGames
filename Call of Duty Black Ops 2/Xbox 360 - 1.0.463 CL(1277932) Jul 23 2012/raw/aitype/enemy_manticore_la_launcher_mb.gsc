...
/*QUAKED actor_Enemy_Manticore_LA_Launcher_MB (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	self.team = "axis";
	self.type = "human";
	self.weapon = "usrpg_magic_bullet_sp";
