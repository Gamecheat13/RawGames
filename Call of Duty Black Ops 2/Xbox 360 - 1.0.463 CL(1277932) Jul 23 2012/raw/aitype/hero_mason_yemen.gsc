...
/*QUAKED actor_Hero_Mason_Yemen (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_usa_cia_combat_masonjr_fb"
...
main()
{
	...
	character\c_usa_cia_combat_masonjr::main();
...
precache(ai_index)
{
	character\c_usa_cia_combat_masonjr::precache();
