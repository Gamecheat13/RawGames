...
/*QUAKED actor_Hero_Hillary_LA (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_usa_hillaryclinton_g20_cin_fb"
...
main()
{
	...
	character\c_usa_hillaryclinton_g20_cin::main();
...
precache(ai_index)
{
	character\c_usa_hillaryclinton_g20_cin::precache();
