...
/*QUAKED actor_Hero_Farid_Yemen (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_mul_farid_yemen::main();
...
precache(ai_index)
{
	character\c_mul_farid_yemen::precache();
