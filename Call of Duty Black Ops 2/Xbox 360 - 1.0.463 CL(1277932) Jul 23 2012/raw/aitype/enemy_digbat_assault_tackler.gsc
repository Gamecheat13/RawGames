...
/*QUAKED actor_Enemy_Digbat_Assault_Tackler (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_pan_dingbats_hero::main();
...
precache(ai_index)
{
	character\c_pan_dingbats_hero::precache();
