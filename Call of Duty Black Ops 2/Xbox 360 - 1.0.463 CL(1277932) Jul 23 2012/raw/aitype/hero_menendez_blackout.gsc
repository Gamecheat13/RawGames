...
/*QUAKED actor_Hero_Menendez_Blackout (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_mul_menendez_suit_bleed_fb"
...
main()
{
	...
	character\c_mul_menendez_suit_bleed::main();
...
precache(ai_index)
{
	character\c_mul_menendez_suit_bleed::precache();
