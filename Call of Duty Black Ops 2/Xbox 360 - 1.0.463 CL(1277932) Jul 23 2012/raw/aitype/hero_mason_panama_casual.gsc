...
/*QUAKED actor_Hero_Mason_Panama_Casual (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_usa_milcas_mason::main();
...
precache(ai_index)
{
	character\c_usa_milcas_mason::precache();
