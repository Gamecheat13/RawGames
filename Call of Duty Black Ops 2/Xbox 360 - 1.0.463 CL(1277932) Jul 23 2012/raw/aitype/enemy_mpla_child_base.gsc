...
/*QUAKED actor_Enemy_MPLA_Child_Base (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_afr_childsoldier_1::main();
...
precache(ai_index)
{
	character\c_afr_childsoldier_1::precache();
