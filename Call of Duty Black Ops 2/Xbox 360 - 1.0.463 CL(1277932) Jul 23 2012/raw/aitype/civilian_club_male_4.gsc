...
/*QUAKED actor_Civilian_Club_Male_4 (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	{
		case 0:
			character\c_mul_civ_club_male_ls::main();
			break;
		case 1:
			character\c_mul_civ_club_male_ls_vst::main();
			break;
	}
...
precache(ai_index)
{
	character\c_mul_civ_club_male_ls::precache();
	character\c_mul_civ_club_male_ls_vst::precache();
