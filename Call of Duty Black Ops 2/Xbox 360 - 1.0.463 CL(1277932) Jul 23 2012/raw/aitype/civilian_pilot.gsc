...
/*QUAKED actor_Civilian_Pilot (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_mul_jinan_captain::main();
...
precache(ai_index)
{
	character\c_mul_jinan_captain::precache();
