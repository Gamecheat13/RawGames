...
/*QUAKED actor_Hero_Woods_Angola (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_usa_jungmar_barnes_ks_fb"
...
main()
{
	...
	character\c_usa_jungmar_banres_khesanh::main();
...
precache(ai_index)
{
	character\c_usa_jungmar_banres_khesanh::precache();
