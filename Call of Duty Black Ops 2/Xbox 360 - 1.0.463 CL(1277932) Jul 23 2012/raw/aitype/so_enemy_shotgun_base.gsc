...
/*QUAKED actor_So_Enemy_Shotgun_Base (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	self.team = "axis";
	self.type = "human";
	self.weapon = "type95_sp";

	self setEngagementMinDist( 150.000000, 0.000000 );
	self setEngagementMaxDist( 500.000000, 700.000000 );
	...
	{
		case 0:
			character\c_mul_pmc_shotgun::main();
			break;
		case 1:
			character\c_mul_pmc_shotgun_2::main();
			break;
		case 2:
			character\c_mul_pmc_shotgun_3::main();
			break;
	}
...
precache(ai_index)
{
	character\c_mul_pmc_shotgun::precache();
	character\c_mul_pmc_shotgun_2::precache();
	character\c_mul_pmc_shotgun_3::precache();
