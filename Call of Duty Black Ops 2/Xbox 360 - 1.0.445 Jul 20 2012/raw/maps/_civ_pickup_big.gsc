...
set_50cal_vehicle_anims( positions )
{
	...
	positions[ 3 ].vehicle_getoutanim = %v_crew_future_truck_right_backdoor_open;  // passenger 1
	positions[ 4 ].vehicle_getoutanim = %v_crew_future_truck_left_backdoor_open;  // passenger 2
