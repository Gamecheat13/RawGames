...
setEntityHeadIcon(team, owner, offset, icon, constant_size, off) // "allies", "axis", "all", "none"
{
...
updateEntityHeadTeamIcon(entity, team, icon, constant_size, off )
{
	...
	if ( isDefined(off)  )
	{
		headicon setwaypoint( constant_size,"",0, off ); // false = uniform size in 3D instead of uniform size in 2D
	}
	else
	{
