...
ownsAndUsingPerk( specialty )
{
	...
	{
		if ( isDefined(level.specialtyToPerkIndex) && isDefined( level.specialtyToPerkIndex[ specialty ] ) )
		{
...
proPerkkills( data, time )
{
	...
	{
		if ( data.sWeapon == "claymore_mp" || data.sWeapon == "satchel_charge_mp" || data.sWeapon == "bouncingbetty_mp" )
