...
combatIdle()
{
	...
	idleAnims = [];
	idleAnims[ 0 ] = "zm_combat_attackidle";
	idleAnims[ 1 ] = "zm_combat_attackidle_bark";
	idleAnims[ 2 ] = "zm_combat_attackidle_growl";
...
/*
/#
	if ( maps\mp\killstreaks\_dogs::dog_get_dvar_int( "debug_dog_attack","0" )  )
	{
		teleported = "";
		if ( distance_ok && !use_low_attack() )
		{
