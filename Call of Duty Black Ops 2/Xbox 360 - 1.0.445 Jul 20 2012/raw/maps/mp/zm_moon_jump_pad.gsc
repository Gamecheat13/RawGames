...
/* t6todo	level.scr_anim["zombie"]["low_g_super_sprint"] = %ai_zombie_supersprint_lowg;
...
moon_biodome_powerup_temptation( struct_array )
{
	...
	{		
		// make sure this powerup has all the correct settings
