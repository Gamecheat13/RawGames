...
init()
{
	...
	maps\mp\killstreaks\_killstreaks::registerKillstreakDialog("minigun_mp", "mpl_killstreak_minigun", "kls_weapon_used", "","kls_weapon_enemy", "", "kls_weapon_ready");

	registerKillstreak( "inventory_minigun_drop_mp", "inventory_minigun_drop_mp", "killstreak_minigun", "minigun_used", maps\mp\killstreaks\_supplydrop::useKillstreakSupplyDrop, undefined, true );
	registerKillstreakStrings( "inventory_minigun_drop_mp", &"KILLSTREAK_EARNED_MINIGUN", &"KILLSTREAK_MINIGUN_NOT_AVAILABLE" );
	registerKillstreakDialog( "inventory_minigun_drop_mp", "mpl_killstreak_minigun", "kls_weapon_used", "","kls_weapon_enemy", "", "kls_weapon_ready" );
	registerKillstreakDevDvar( "inventory_minigun_drop_mp", "scr_giveminigun_drop" );

	registerKillstreak( "minigun_drop_mp", "minigun_drop_mp", "killstreak_minigun_drop", "minigun_drop_used", maps\mp\killstreaks\_supplydrop::useKillstreakSupplyDrop, undefined, true );
	registerKillstreakStrings( "minigun_drop_mp", &"KILLSTREAK_EARNED_MINIGUN", &"KILLSTREAK_MINIGUN_NOT_AVAILABLE" );
	registerKillstreakDialog( "minigun_drop_mp", "mpl_killstreak_minigun", "kls_weapon_used", "","kls_weapon_enemy", "", "kls_weapon_ready" );


	maps\mp\killstreaks\_killstreaks::registerKillstreak("m32_mp", "m32_mp", "killstreak_m32", "m32_used", ::useCarriedKillstreakWeapon, false, true, "M32_USED" );
	...
	maps\mp\killstreaks\_killstreaks::registerKillstreakDialog("m32_mp", "mpl_killstreak_m32", "kls_weapon_used", "","kls_weapon_enemy", "", "kls_weapon_ready");


	registerKillstreak( "inventory_m32_drop_mp", "inventory_m32_drop_mp", "killstreak_m32", "m32_used", maps\mp\killstreaks\_supplydrop::useKillstreakSupplyDrop, undefined, true );
	registerKillstreakStrings( "inventory_m32_drop_mp", &"KILLSTREAK_EARNED_M32", &"KILLSTREAK_M32_NOT_AVAILABLE" );
	registerKillstreakDialog( "inventory_m32_drop_mp", "mpl_killstreak_m32", "kls_weapon_used", "","kls_weapon_enemy", "", "kls_weapon_ready" );
	registerKillstreakDevDvar( "inventory_m32_drop_mp", "scr_givem32_drop" );

	registerKillstreak( "m32_drop_mp", "m32_drop_mp", "killstreak_m32_drop", "m32_drop_used", maps\mp\killstreaks\_supplydrop::useKillstreakSupplyDrop, undefined, true );
	registerKillstreakStrings( "m32_drop_mp", &"KILLSTREAK_EARNED_M32", &"KILLSTREAK_M32_NOT_AVAILABLE" );
	registerKillstreakDialog( "m32_drop_mp", "mpl_killstreak_m32", "kls_weapon_used", "","kls_weapon_enemy", "", "kls_weapon_ready" );
...
useCarriedKillstreakWeapon( hardpointType )
{
	...
	killstreak_id = self maps\mp\killstreaks\_killstreakrules::killstreakStart( hardpointType, self.team, false, false );
	...
	self thread watchKillstreakWeaponSwitch( hardpointType, killstreak_id );
	self thread watchKillstreakWeaponDeath( hardpointType, killstreak_id );
...
watchKillstreakWeaponSwitch( killstreakWeapon, killstreak_id )
{
	self endon( "disconnect" );
	self endon( "death" );
...
watchKillstreakWeaponDeath( hardpointType, killstreak_id )
{
	self endon( "disconnect" );
...
checkIfSwitchableWeapon( currentWeapon, newWeapon, killstreakWeapon, currentKillstreakId )
{
	...
	else if( isHeldKillstreakWeapon( newWeapon ) && isHeldKillstreakWeapon( currentWeapon ) && (!isDefined(currentKillstreakID) || currentKillstreakId != killstreakId) )//new held killstreak weapon
		switchableWeapon = true;
