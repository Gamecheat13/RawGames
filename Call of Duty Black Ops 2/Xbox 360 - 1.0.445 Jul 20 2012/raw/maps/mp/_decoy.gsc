...
//	level.decoyWeapons["fullauto"][level.decoyWeapons["fullauto"].size] = "ak47_mp";
//	level.decoyWeapons["fullauto"][level.decoyWeapons["fullauto"].size] = "aug_mp";
//	level.decoyWeapons["fullauto"][level.decoyWeapons["fullauto"].size] = "commando_mp";
//	level.decoyWeapons["fullauto"][level.decoyWeapons["fullauto"].size] = "enfield_mp";
	level.decoyWeapons["fullauto"][level.decoyWeapons["fullauto"].size] = "uzi_mp";
//	level.decoyWeapons["fullauto"][level.decoyWeapons["fullauto"].size] = "kiparis_mp";
//	level.decoyWeapons["fullauto"][level.decoyWeapons["fullauto"].size] = "rpk_mp";
//	level.decoyWeapons["fullauto"][level.decoyWeapons["fullauto"].size] = "stoner63_mp";
...
//	if( IsDefined( owner.lastdroppableweapon ) )
//	{
//		weapon = owner.lastdroppableweapon;
//	}
//	else
//	{
//		weapon = owner.pers["primaryWeapon"] + "_mp";
//	}
