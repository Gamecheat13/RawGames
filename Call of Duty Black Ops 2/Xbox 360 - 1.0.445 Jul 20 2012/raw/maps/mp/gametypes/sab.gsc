...
onDeadEvent( team )
{
	...
	else if ( level.bombPlanted )
	{
		...
		otherTeam = getOtherTeam( level.bombPlantedBy )
		maps\mp\gametypes\_globallogic_score::giveTeamScoreForObjective( level.bombPlantedBy, 1 );
	...
	else
	{
		...
		maps\mp\gametypes\_globallogic_score::giveTeamScoreForObjective( otherTeam, 1 );
...
//		player playSound( "mpl_sab_bomb_plant" );
		...
		// Play Action music
		maps\mp\gametypes\_globallogic_audio::set_music_on_team( "ACTION", "both", true );			
