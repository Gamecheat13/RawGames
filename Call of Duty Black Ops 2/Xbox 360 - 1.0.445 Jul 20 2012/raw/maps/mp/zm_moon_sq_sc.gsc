...
sam_reveal_richtofen_vox()
{
	...
	for(i=0;i<players.size;i++)
	{
		...
		if( index == 3 )
		{
			players[i] thread maps\mp\zombies\_zm_audio::create_and_play_dialog( "eggs", "quest4", undefined, 3, true );
		}
	}
}
...
//t6todo	s thread fake_use("placed_cvg", ::place_qualifier);
...
play_sam_then_response_line()
{
	...
	player[randomintrange(0,player.size)] thread maps\mp\zombies\_zm_audio::create_and_play_dialog( "eggs", "quest6", undefined, 13, true );
}