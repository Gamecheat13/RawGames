...
useHoldThinkLoop( player, lastWeapon )
{
	...
	const maxWaitTime = 1.5; // must be greater than the putaway timer for all weapons
...
shouldShowCompassDueToRadar( team )
{
	...
	// VSTODO: do we need this?
	return true;
	//return maps\mp\_radar::teamHasRadar( team );
}
...
/*
=============
Creates and returns a distance object.
Used for conveying distance to a player when they have to get to a location.
=============
*/
createDistanceObject( ownerTeam, trigger, offset, wholeTeamHasToReach, descriptionAllies, descriptionAxis )
{
	...
	distanceObject.objPoints["allies"] = maps\gametypes\_objpoints::createTeamObjpoint( "objpoint_allies_" + distanceObject.entNum, distanceObject.curOrigin + offset, "allies", undefined, undefined, undefined, true );
	distanceObject.objPoints["axis"] = maps\gametypes\_objpoints::createTeamObjpoint( "objpoint_axis_" + distanceObject.entNum, distanceObject.curOrigin + offset, "axis", undefined, undefined, undefined, true );
	
	distanceObject.objPoints["allies"].alpha = 0;
	distanceObject.objPoints["axis"].alpha = 0;
	
	// misc
	distanceObject.interactTeam = "none"; // "none", "any", "friendly", "enemy";
	
	// 3d world icons
	distanceObject.worldIcons = [];
	distanceObject.visibleTeam = "none"; // "none", "any", "friendly", "enemy";
...
/*
=============
Think function for distance game objects that require only one person to reach the trigger
=============
*/
distanceObjectThink()
{
	...
	while ( true )
	{
		...
		if ( isDefined( self.keyObject ) )
		{
			...
			{
				// Player can't reach because the key object is needed.
				wasReached = false;
...
/*
=============
Think function for distance game objects that require the whole team to reach the trigger
=============
*/
...
/*
=============
While the player is touching the trigger
=============
*/
