...
assign_weapon_init()
{
	...
	switch ( level.script )
	{
		...
		case "angola_2":
			...
			add_weapons_to_class_and_faction( "unita",		"assault",	array( "ak47", "fnfal" ) );
			add_weapons_to_class_and_faction( "unita", 		"smg",		array( "ak74u" ) );
			add_weapons_to_class_and_faction( "unita", 		"lmg",		array( "rpd" ) );
			add_weapons_to_class_and_faction( "unita", 		"sniper",	array( "dragunov" ) );
			add_weapons_to_class_and_faction( "unita", 		"launcher",	array( "rpg" ) );
			
			add_weapons_to_class_and_faction( "cuban", 		"assault",	array( "ak47", "fnfal" ) );
			add_weapons_to_class_and_faction( "cuban", 		"smg",		array( "ak74u" ) );
			add_weapons_to_class_and_faction( "cuban", 		"lmg",		array( "rpd" ) );
			add_weapons_to_class_and_faction( "cuban", 		"sniper",	array( "dragunov" ) );
			add_weapons_to_class_and_faction( "cuban", 		"launcher",	array( "rpg" ) );
			
			add_weapons_to_class_and_faction( "mpla", 		"assault",	array( "ak47", "fnfal" ) );
			add_weapons_to_class_and_faction( "mpla", 		"smg",		array( "ak74u" ) );
			add_weapons_to_class_and_faction( "mpla", 		"lmg",		array( "rpd" ) );
			add_weapons_to_class_and_faction( "mpla", 		"sniper",	array( "dragunov" ) );
			add_weapons_to_class_and_faction( "mpla", 		"launcher",	array( "rpg" ) );
			
			add_weapons_to_class_and_faction( "mplachild",	"assault",	array( "ak47", "fnfal" ) );
			add_weapons_to_class_and_faction( "mplachild", 	"smg",		array( "ak74u" ) );
			add_weapons_to_class_and_faction( "mplachild", 	"lmg",		array( "rpd" ) );
			add_weapons_to_class_and_faction( "mplachild", 	"sniper",	array( "dragunov" ) );
		...
		case "monsoon":
			...
			add_weapons_to_class_and_faction( "pmc",	"assault", 	array( "saritch", "an94" ) );
			add_weapons_to_class_and_faction( "pmc",	"smg",		array( "evoskorpion", "qcw05" ) );
		...
		case "haiti":
			...
			// Friendly SEALs
			add_weapons_to_class_and_faction( "seal",	"assault",	array( "hk416c" ) );
			add_weapons_to_class_and_faction( "seal",	"lmg",		array( "mk48" ) );
			add_weapons_to_class_and_faction( "seal",	"smg",		array( "pdw57" ) );
			add_weapons_to_class_and_faction( "seal",	"launcher",	array( "usrpg" ) );
			// Allied SCO
			add_weapons_to_class_and_faction( "sco",	"assault",	array( "type95" ) );
			add_weapons_to_class_and_faction( "sco",	"lmg",		array( "qbb95" ) );
			add_weapons_to_class_and_faction( "sco",	"smg",		array( "qcw05" ) );
			add_weapons_to_class_and_faction( "sco",	"launcher",	array( "usrpg" ) );
			// Enemy PMCs
			add_weapons_to_class_and_faction( "pmc",	"assault",	array( "an94", "type95", "hk416c" ) );
			add_weapons_to_class_and_faction( "pmc",	"lmg",		array( "hamr", "qbb95", "mk48" ) );
			add_weapons_to_class_and_faction( "pmc",	"smg",		array( "evoskorpion", "qcw05", "pdw57" ) );
			add_weapons_to_class_and_faction( "pmc",	"sniper",	array( "dsr50" ) );
			add_weapons_to_class_and_faction( "pmc",	"shotgun",	array( "srm1216", "saiga12" ) );
		...
		case "karma_2":
			...
			add_weapons_to_class_and_faction( "security", "assault",	array( "sa58" ) );
			add_weapons_to_class_and_faction( "security", "smg",		array( "insas" ) );
			add_weapons_to_class_and_faction( "security", "sniper",		array( "dsr50" ) );
			add_weapons_to_class_and_faction( "security", "shotgun",	array( "ksg" ) );
			add_weapons_to_class_and_faction( "security", "pistol",		array( "fiveseven" ) );
			add_weapons_to_class_and_faction( "security", "launcher",	array( "usrpg" ) );
						
			add_weapons_to_class_and_faction( "enemy", "assault",	array( "sa58_silencer", "tar21_silencer" ) );
			add_weapons_to_class_and_faction( "enemy", "smg",		array( "insas_silencer", "qcw05_silencer" ) );
			add_weapons_to_class_and_faction( "enemy", "lmg",		array( "qbb95_silencer" ) );
			add_weapons_to_class_and_faction( "enemy", "sniper",	array( "dsr50_silencer", "svu_silencer" ) );
			add_weapons_to_class_and_faction( "enemy", "shotgun",	array( "ksg_silencer", "saiga12_silencer" ) );
			add_weapons_to_class_and_faction( "enemy", "pistol",	array( "fiveseven_silencer", "beretta93r_silencer" ) );
			add_weapons_to_class_and_faction( "enemy", "launcher",	array( "usrpg_silencer" ) );
		...
		case "la_1b":
			...
			add_weapons_to_class_and_faction( "ally", "assault",	array( "scar", "hk416", "xm8" ) );
			...
			add_weapons_to_class_and_faction( "ally", "pistol",		array( "kard_semiauto" ) );
			add_weapons_to_class_and_faction( "ally", "launcher",	array( "usrpg" ) );
			
			add_weapons_to_class_and_faction( "manticore", "assault",	array( "sig556", "type95", "sa58" ) );
			add_weapons_to_class_and_faction( "manticore", "smg",		array( "vector", "qcw05" ) );
			//add_weapons_to_class_and_faction( "manticore", "lmg",		array( "m60" ) );
			add_weapons_to_class_and_faction( "manticore", "sniper",	array( "ballista" ) );
			add_weapons_to_class_and_faction( "manticore", "shotgun",	array( "ksg" ) );
			add_weapons_to_class_and_faction( "manticore", "pistol",	array( "kard_semiauto" ) );
		...
		case "pakistan_3":
			...
			add_weapons_to_class_and_faction( "seal", "assault",	array( "scar", "hk416" ) );
			add_weapons_to_class_and_faction( "seal", "smg",		array( "vector" ) );
			add_weapons_to_class_and_faction( "seal", "pistol",		array( "fnp45" ) );
			add_weapons_to_class_and_faction( "seal", "launcher",	array( "m32" ) );
			
			add_weapons_to_class_and_faction( "isi", "assault",		array( "tar21" ) );
			add_weapons_to_class_and_faction( "isi", "smg",			array( "insas" ) );
			add_weapons_to_class_and_faction( "isi", "pistol",		array( "beretta93r" ) );
			add_weapons_to_class_and_faction( "isi", "launcher",	array( "usrpg" ) );
			
			add_weapons_to_class_and_faction( "let", "assault",		array( "sa58" ) );
			add_weapons_to_class_and_faction( "let", "lmg",			array( "qbb95" ) );
			add_weapons_to_class_and_faction( "let", "shotgun",		array( "saiga12" ) );
			add_weapons_to_class_and_faction( "let", "pistol",		array( "beretta93r" ) );
		...
		case "panama_3":	
			...
			add_weapons_to_class_and_faction( "ally", "assault",	array( "m16") );
			add_weapons_to_class_and_faction( "ally", "smg",		array( "mp7", "vector", "pdw57" ) );
			add_weapons_to_class_and_faction( "ally", "lmg",		array( "mk48" ) );
		...
		case "yemen":
			...
			add_weapons_to_class_and_faction( "terrorist", "sniper",	array( "svu" ) );
			// add_weapons_to_class_and_faction( "terrorist", "shotgun",	array( "spas", "rottweil72" ) );
			add_weapons_to_class_and_faction( "terrorist", "pistol",	array( "beretta93r" ) );
		...
		case "so_rts_mp_dockside":
			...
			add_weapons_to_class_and_faction( "enemy", 	"assault",	array( "type95" ) );
			add_weapons_to_class_and_faction( "enemy", 	"smg",		array( "qcw05" ) );
			add_weapons_to_class_and_faction( "enemy", 	"sniper",	array( "svu" ) );
			add_weapons_to_class_and_faction( "enemy", 	"heavy",	array( "lsat" ) );
...
get_weapon_with_attachments( str_weapon )
{
	...
	if ( str_current_key == "alt_weapon" )
	{
		...
		{
			ArrayRemoveValue( a_attachment_keys, "alt_weapon" );
			str_current_key = select_attachment_at_random( a_attachment_keys, str_faction );
		}
		else 
		{
...
get_faction_for_attachments( str_classname )
{
	...
	{
		if ( IsInArray( a_factions, str_token ) )
		{
...
{	
	...
	//smg
	else if( IsSubstr( _classname,"skorpion") || IsSubstr( _classname,"pm63") || IsSubstr( _classname,"kiparis") ||IsSubstr( _classname,"spectre")|| isSubstr(_classname,"uzi") || isSubstr(_classname,"ppsh") || IsSubstr( _classname,"mp40") || IsSubstr( _classname,"sten") || IsSubstr( _classname,"mp44")|| IsSubstr( _classname,"mac11") || IsSubstr( _classname,"vector") || IsSubstr( _classname,"pdw57") )
	{
		return "smg";
	}
	...
	if ( isdefined( anim._assignable_weapons ) )
	{
		...
		{		
			...
			if ( isdefined( str_class ) )
			{
				...
				foreach ( str_token in a_string_tokens )
				{
					if ( IsInArray( a_weapons, str_token ) )
					{
...
{
	ArrayRemoveIndex( anim._assignable_attachments[ str_weapon ][ str_attachment_type ], str_attachment );
	
	if( anim._assignable_attachments[ str_weapon ][ str_attachment_type ].size == 0 )
	{
		ArrayRemoveIndex( anim._assignable_attachments[ str_weapon ], str_attachment_type, true );
	}
	
	if( anim._assignable_attachments[ str_weapon ].size == 0 )
	{
		ArrayRemoveIndex( anim._assignable_attachments, str_weapon, true );
	}
}
