...
/*QUAKED actor_Enemy_Manticore_LA_Drone (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	{
		case 0:
			character\c_mul_gangla_drone_light::main();
			break;
		case 1:
			character\c_mul_gangla_drone_heavy::main();
			break;
	}
...
precache(ai_index)
{
	character\c_mul_gangla_drone_light::precache();
	character\c_mul_gangla_drone_heavy::precache();
