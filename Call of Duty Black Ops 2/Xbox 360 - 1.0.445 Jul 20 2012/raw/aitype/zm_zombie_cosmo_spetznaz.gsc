...
/*QUAKED actor_zm_zombie_cosmo_spetznaz (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_zom_cosmo_spetznaz::main();
...
precache(ai_index)
{
	...
	character\c_zom_cosmo_spetznaz::precache();
