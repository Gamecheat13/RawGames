...
/*QUAKED actor_Ally_Navy_Blackout_Sniper_Base (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	switch( randChar )
	{
		case 0:
			...
			break;
		case 1:
			character\c_mul_jinan_guard_1::main();
			break;
		case 2:
			character\c_mul_jinan_guard_2::main();
			break;
		case 3:
...
precache(ai_index)
{
	...
	character\c_mul_jinan_guard_1::precache();
	character\c_mul_jinan_guard_2::precache();
	character\c_mul_jinan_guard_3::precache();

	precacheItem("as50_sp");
