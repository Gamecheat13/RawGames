...
main()
{
	...
	{
		case 0:
			character\c_mul_civ_rich_female_1::main();
			break;
		case 1:
			character\c_mul_civ_rich_female_2::main();
			break;
		case 2:
			character\c_mul_civ_rich_female_3::main();
			break;
		case 3:
			character\c_mul_civ_rich_female_4::main();
			break;
		case 4:
			character\c_mul_civ_rich_female_5::main();
			break;
	}
...
precache(ai_index)
{
	character\c_mul_civ_rich_female_1::precache();
	character\c_mul_civ_rich_female_2::precache();
	character\c_mul_civ_rich_female_3::precache();
	character\c_mul_civ_rich_female_4::precache();
	character\c_mul_civ_rich_female_5::precache();
