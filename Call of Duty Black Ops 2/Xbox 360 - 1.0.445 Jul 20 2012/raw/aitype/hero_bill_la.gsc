...
/*QUAKED actor_Hero_Bill_LA (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_usa_secserv_sam_cin::main();
...
precache(ai_index)
{
	character\c_usa_secserv_sam_cin::precache();
