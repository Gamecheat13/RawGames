...
/*QUAKED actor_Enemy_MPLA_Drone_Base_Low (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_vtn_nva1_fb_drone"
...
main()
{
	...
	character\c_afr_mpla_rigid_drone::main();
...
precache(ai_index)
{
	character\c_afr_mpla_rigid_drone::precache();
