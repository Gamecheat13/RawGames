...
/*QUAKED actor_Ally_UNITA_Angola_Drone_Base (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_afr_mpla_drone::main();
...
precache(ai_index)
{
	character\c_afr_mpla_drone::precache();
