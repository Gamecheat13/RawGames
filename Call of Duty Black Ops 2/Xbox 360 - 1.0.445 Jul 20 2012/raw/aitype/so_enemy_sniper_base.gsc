...
/*QUAKED actor_So_Enemy_Sniper_Base (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	{
		case 0:
			character\c_mul_pmc_smg::main();
			break;
		case 1:
			character\c_mul_pmc_smg_2::main();
			break;
		case 2:
			character\c_mul_pmc_smg_3::main();
			break;
	}
...
precache(ai_index)
{
	character\c_mul_pmc_smg::precache();
	character\c_mul_pmc_smg_2::precache();
	character\c_mul_pmc_smg_3::precache();
