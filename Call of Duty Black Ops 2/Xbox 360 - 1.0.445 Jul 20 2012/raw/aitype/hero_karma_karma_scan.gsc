...
/*QUAKED actor_Hero_Karma_Karma_Scan (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_usa_chloe_lynch_organs_fb"
...
main()
{
	...
	character\c_usa_chloe_lynch_organs::main();
...
precache(ai_index)
{
	character\c_usa_chloe_lynch_organs::precache();
