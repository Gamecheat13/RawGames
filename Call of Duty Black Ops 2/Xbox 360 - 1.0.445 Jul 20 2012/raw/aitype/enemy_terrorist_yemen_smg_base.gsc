...
/*QUAKED actor_Enemy_Terrorist_Yemen_SMG_Base (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	{
		case 0:
			character\c_yem_houthis_light::main();
			break;
		case 1:
...
precache(ai_index)
{
	character\c_yem_houthis_light::precache();
