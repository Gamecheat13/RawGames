...
/*QUAKED actor_Hero_Zhao_Pakistan (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_chn_afghan_zhao_cin::main();
...
precache(ai_index)
{
	character\c_chn_afghan_zhao_cin::precache();
