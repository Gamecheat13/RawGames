...
/*QUAKED actor_Ally_LAPD_Medic_Base (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_usa_lapd_medic::main();
...
precache(ai_index)
{
	character\c_usa_lapd_medic::precache();
