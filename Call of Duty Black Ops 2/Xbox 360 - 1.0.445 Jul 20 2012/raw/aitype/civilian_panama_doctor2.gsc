...
/*QUAKED actor_Civilian_Panama_Doctor2 (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_mul_redcross_doctor2::main();
...
precache(ai_index)
{
	character\c_mul_redcross_doctor2::precache();
