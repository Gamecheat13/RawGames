...
/*QUAKED actor_Civilian_Worker_Office (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_mul_jinan_genworker::main();
...
precache(ai_index)
{
	character\c_mul_jinan_genworker::precache();
