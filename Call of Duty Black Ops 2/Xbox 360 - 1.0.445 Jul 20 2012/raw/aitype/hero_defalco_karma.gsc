...
/*QUAKED actor_Hero_Defalco_Karma (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_mul_defalco_karma_cin::main();
...
precache(ai_index)
{
	character\c_mul_defalco_karma_cin::precache();
