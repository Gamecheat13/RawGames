...
{	
	...
	level._client_flag_callbacks["missile"][CLIENT_FLAG_STUNNED] = clientscripts\mp\_callbacks::stunned_callback;
	level._client_flag_callbacks["missile"][CLIENT_FLAG_EMP] = clientscripts\mp\_callbacks::emp_callback;
	level._client_flag_callbacks["missile"][CLIENT_FLAG_PROXIMITY] = clientscripts\mp\_callbacks::proximity_callback;

//	level._client_flag_callbacks["scriptmover"][CLIENT_FLAG_WARN_TARGETED] = ::warnMissileLocking;
//	level._client_flag_callbacks["scriptmover"][CLIENT_FLAG_WARN_LOCKED] = ::warnMissileLocked;
//	level._client_flag_callbacks["scriptmover"][CLIENT_FLAG_WARN_FIRED] = ::warnMissileFired;
	level._client_flag_callbacks["scriptmover"][CLIENT_FLAG_STUNNED] = clientscripts\mp\_callbacks::stunned_callback;
	level._client_flag_callbacks["scriptmover"][CLIENT_FLAG_EMP] = clientscripts\mp\_callbacks::emp_callback;
}
...
main()
{
	...
	if( !SessionModeIsZombiesGame() )
	{
		...
		level thread clientscripts\mp\_multi_extracam::init();
	}
	else
	{
		//level thread clientscripts\mp\_dogs::init();
