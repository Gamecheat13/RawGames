...
{	
	...
	level._client_flag_callbacks["missile"][CLIENT_FLAG_SCRAMBLER] = ::spawnedScrambler;

	level._client_flag_callbacks["scriptmover"][CLIENT_FLAG_COUNTERUAV] = ::spawnedGlobalScramber;
