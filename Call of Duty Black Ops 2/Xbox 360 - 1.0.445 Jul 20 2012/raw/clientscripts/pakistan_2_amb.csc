//
// file: pakistan_2_amb.csc
// description: clientside ambient script for pakistan_2: setup ambient sounds, etc.
...
//************************************************************************************************
	...
	declaremusicstate ("PAK_ANTHEM");
		musicAliasloop ("mus_anthem_loop", 0, 1);
	//	musicStinger ("mus_bus_stg", 6, true);
	

	declareMusicState ("PAK_INT_ESCAPE_REFERENCE");
		musicAliasloop ("mus_sog_intescape", 0, 6);
	
	declareMusicState ("PAK_MILLIBAR");
		musicAlias ("mus_surveillance_stg", 0);
	
	declareMusicState ("PAK_ESCAPE_ANTHEM");
		musicAliasloop ("mus_anthem_escape", 0, 1);
		
	declareMusicState ("PAK_CLAWS");
		musicAliasloop ("mus_claw_battles", 0, 1);
