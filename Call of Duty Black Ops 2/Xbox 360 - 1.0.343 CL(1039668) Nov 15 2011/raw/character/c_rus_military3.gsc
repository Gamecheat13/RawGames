...
main()
{
	...
	self.headModel = "c_rus_military_head3";
	self attach(self.headModel, "", true);
	self.gearModel = "c_rus_military_body3_gear1";
...
precache()
{
	...
	precacheModel("c_rus_military_head3");
	precacheModel("c_rus_military_body3_gear1");
