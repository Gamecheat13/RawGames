...
main()
{
	self setModel("c_rus_spetznaz_body1_char");
	self.headModel = "c_rus_spetznaz_body1_head1_char";
	self attach(self.headModel, "", true);
	self.gearModel = "c_rus_spetznaz_body1_gear1_char";
...
precache()
{
	precacheModel("c_rus_spetznaz_body1_char");
	precacheModel("c_rus_spetznaz_body1_head1_char");
	precacheModel("c_rus_spetznaz_body1_gear1_char");
