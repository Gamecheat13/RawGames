...
main()
{
	self setModel("c_vtn_nva1_body");
	self.headModel = "c_vtn_nva1_head";
	self attach(self.headModel, "", true);
	self.gearModel = "c_vtn_nva1_gear";
...
precache()
{
	precacheModel("c_vtn_nva1_body");
	precacheModel("c_vtn_nva1_head");
	precacheModel("c_vtn_nva1_gear");
