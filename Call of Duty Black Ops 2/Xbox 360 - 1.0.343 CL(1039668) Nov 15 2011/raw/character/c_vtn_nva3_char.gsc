...
main()
{
	self setModel("c_vtn_nva3_body_char");
	self.headModel = "c_vtn_nva3_head_char";
	self attach(self.headModel, "", true);
	self.gearModel = "c_vtn_nva3_gear_char";
	self attach(self.gearModel, "", true);
	self.voice = "vietnamese";
	self.skeleton = "base";
	self.torsoDmg1 = "c_vtn_nva1_body_g_upclean";
	self.torsoDmg2 = "c_vtn_nva1_body_g_rarmoff";
	self.torsoDmg3 = "c_vtn_nva1_body_g_larmoff";
	self.torsoDmg4 = "c_vtn_nva1_body_g_torso";
...
precache()
{
	precacheModel("c_vtn_nva3_body_char");
	precacheModel("c_vtn_nva3_head_char");
	precacheModel("c_vtn_nva3_gear_char");
	precacheModel("c_vtn_nva1_body_g_upclean");
	precacheModel("c_vtn_nva1_body_g_rarmoff");
	precacheModel("c_vtn_nva1_body_g_larmoff");
