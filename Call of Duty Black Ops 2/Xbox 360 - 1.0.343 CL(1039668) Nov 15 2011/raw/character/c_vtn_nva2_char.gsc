...
main()
{
	self setModel("c_vtn_nva2_body_char");
	self.headModel = "c_vtn_nva2_head_char";
	self attach(self.headModel, "", true);
	self.gearModel = "c_vtn_nva2_gear_char";
...
precache()
{
	precacheModel("c_vtn_nva2_body_char");
	precacheModel("c_vtn_nva2_head_char");
	precacheModel("c_vtn_nva2_gear_char");
