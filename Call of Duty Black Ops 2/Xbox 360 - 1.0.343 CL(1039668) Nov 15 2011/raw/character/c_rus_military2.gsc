...
main()
{
	self setModel("c_rus_military_body2");
	self.headModel = "c_rus_military_head2";
	self attach(self.headModel, "", true);
	self.gearModel = "c_rus_military_body1_gear1";
...
precache()
{
	precacheModel("c_rus_military_body2");
	precacheModel("c_rus_military_head2");
	precacheModel("c_rus_military_body1_gear1");
