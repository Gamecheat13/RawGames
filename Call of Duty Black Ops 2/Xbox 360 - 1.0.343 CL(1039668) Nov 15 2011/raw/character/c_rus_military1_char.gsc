...
main()
{
	self setModel("c_rus_military_body1_char");
	self.headModel = "c_rus_military_head1_char";
	self attach(self.headModel, "", true);
	self.gearModel = "c_rus_military_body1_gear1_char";
	self attach(self.gearModel, "", true);
	self.voice = "russian";
	self.skeleton = "base";
	self.torsoDmg1 = "c_rus_military_body1_g_upclean";
	self.torsoDmg2 = "c_rus_military_body1_g_rarmoff";
	self.torsoDmg3 = "c_rus_military_body1_g_larmoff";
	self.torsoDmg4 = "c_rus_military_body1_g_torso";
...
precache()
{
	precacheModel("c_rus_military_body1_char");
	precacheModel("c_rus_military_head1_char");
	precacheModel("c_rus_military_body1_gear1_char");
	precacheModel("c_rus_military_body1_g_upclean");
	precacheModel("c_rus_military_body1_g_rarmoff");
	precacheModel("c_rus_military_body1_g_larmoff");
	precacheModel("c_rus_military_body1_g_torso");
