...
#/
	...
	if ( level.bot_offline )
	{
		...
		bot_friends = GetLocalProfileInt( "splitscreen_botFriends" );
		bot_enemies = GetLocalProfileInt( "splitscreen_botEnemies" );
	}
	else
	{
...
basic_training_auto_assign()
{
	...
	if ( level.bot_offline )
	{
		friends = GetLocalProfileInt( "splitscreen_botFriends" ) - player_counts[ host_team ];
	}
	else
	{
