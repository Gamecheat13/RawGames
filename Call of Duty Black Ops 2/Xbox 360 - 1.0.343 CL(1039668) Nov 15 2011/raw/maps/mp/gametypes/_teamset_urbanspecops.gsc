...
level_init()
{
	...
	game["defenders"] = "axis";
	game["allies_soldiertype"] = "urbanspecops";
	game["axis_soldiertype"] = "urbanspecops";
	...
	// armor
	game["cac_faction_allies"] = "usa_cia";
	game["cac_faction_axis"] = "rus_spet";
	...
	SetDvar("g_FactionName_Allies", "usa_cia" );
	...
	SetDvar("g_FactionName_Axis", "rus_spet" );
...
allies()
{
	...
	{
		content_type = keys[i];
		[[level.cac_functions[ "precache" ][content_type]]]( "usa_cia" );
	}
}
...
axis()
{
	...
	{
		content_type = keys[i];
		[[level.cac_functions[ "precache" ][content_type]]]( "rus_spet" );
	}
}
