...
onStartGameType()
{
	maps\mp\gametypes\_globallogic_ui::setObjectiveText( "allies", &"OBJECTIVES_SUR" );
	maps\mp\gametypes\_globallogic_ui::setObjectiveText( "axis", &"OBJECTIVES_SUR" );
	
	if ( level.splitscreen )
	{
		maps\mp\gametypes\_globallogic_ui::setObjectiveScoreText( "allies", &"OBJECTIVES_SUR" );
		maps\mp\gametypes\_globallogic_ui::setObjectiveScoreText( "axis", &"OBJECTIVES_SUR" );
	}
	else
	{
		maps\mp\gametypes\_globallogic_ui::setObjectiveScoreText( "allies", &"OBJECTIVES_SUR_SCORE" );
		maps\mp\gametypes\_globallogic_ui::setObjectiveScoreText( "axis", &"OBJECTIVES_SUR_SCORE" );
	}
...
spawnSafeZone()
{
	...
	//maps\mp\gametypes\_globallogic_audio::leaderDialog( "safezone_located" );
	...
	playSoundOnPlayers( "mpl_killstreak_radar" );
...
onSpawnPlayer()
{
	...
	self spawn( spawnpoint.origin, spawnpoint.angles, "sur" );
}
	...
	if ( self.touchTriggers.size )
	{
		...
		if ( ownerTeam != "neutral" )
		{
			...
			if ( team == ownerTeam )
			{
				...
				if ( ( !isdefined( sWeapon ) || !maps\mp\killstreaks\_killstreaks::isKillstreakWeapon( sWeapon ) ) &&  medalGiven == false )
				{
