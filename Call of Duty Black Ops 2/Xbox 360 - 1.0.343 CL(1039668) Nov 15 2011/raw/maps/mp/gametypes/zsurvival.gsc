...
menu_init()
{
	...
	game["menu_class_allies"] = "class_zombies";
...
menuAlliesZombies()
{
	...
	if(self.pers["team"] != "allies")
	{
		...
		self SetClientScriptMainMenu( game["menu_class_marines"] );
...
GlobalLogic_SetupCallbacks_Zombies()
{
	...
	level._setTeamScore = ::blank;// = maps\mp\gametypes\_globallogic_score::_setTeamScore;
...
main()
{
	...
	maps\mp\gametypes\_globallogic_utils::registerRoundLimitDvar( "zsurvival", 1, 1, 1 );
	
	//registerTimeLimitDvar( dvarString, defaultValue, minValue, maxValue )
	maps\mp\gametypes\_globallogic_utils::registerTimeLimitDvar( "zsurvival", 0, 0, 0 );
	
	//registerScoreLimitDvar( dvarString, defaultValue, minValue, maxValue )
	maps\mp\gametypes\_globallogic_utils::registerScoreLimitDvar( "zsurvival", 0, 0, 0 );
	
	//registerRoundWinLimitDvar( dvarString, defaultValue, minValue, maxValue )
	maps\mp\gametypes\_globallogic_utils::registerRoundWinLimitDvar( "zsurvival", 0, 0, 0 );
	
	//registerNumLivesDvar( dvarString, defaultValue, minValue, maxValue )
	maps\mp\gametypes\_globallogic_utils::registerNumLivesDvar( "zsurvival", 1, 1, 1 );
	...
	//Hardcore set for zombies
	//SetDvar( "scr_hardcore", 1 );
	
	//DISABLE CREATE A CLASS
...
//	self thread onPlayerDisconnect(); 
	...
	self.score = self  maps\mp\gametypes\_globallogic_score::getPersStat( "zscore" ); 
	//self.pers["lives"] = 1;

	self.pers["participation"] = 0;
	
	/*
		self.suicides = self  maps\mp\gametypes\_globallogic_score::getPersStat( "zscore" );
		self.suicides = self  maps\mp\gametypes\_globallogic_score::getPersStat( "zteam" );
	*/
