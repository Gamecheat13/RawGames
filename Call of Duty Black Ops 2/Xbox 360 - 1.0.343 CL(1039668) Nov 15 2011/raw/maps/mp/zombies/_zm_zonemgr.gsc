...
manage_zones( initial_zone )
{
	...
	{
		PrintLn( "ZM >> Iterate through the active zones and see if we need to activate spawners" );
...
{
	PrintLn( "ZM >> create_spawner_list a " );
...
//	level.enemy_dog_spawns = [];
	...
	PrintLn( "ZM >> create_spawner_list b = " + zkeys.size );
	PrintLn( "ZM >> create_spawner_list c = " + level.zones.size );
	...
	PrintLn( "ZM >> create_spawner_list d " );
}
