...
init()
{
	...
	if ( maps\mp\gametypes\_tweakables::getTweakableValue( "killstreak", "allowhelicopter_player_firstperson" ) )
	{
		...
		maps\mp\killstreaks\_killstreaks::registerKillstreakDialog("helicopter_player_firstperson_mp", "mpl_killstreak_heli", "kls_attackheli_used", "","kls_attackheli_enemy", "", "kls_attackheli_ready");
...
//		maps\mp\killstreaks\_killstreaks::setRemoveWeaponWhenUsed("helicopter_player_mp", false);
	...
	{
		maps\mp\killstreaks\_killstreaks::registerKillstreak("helicopter_gunner_mp", "helicopter_gunner_mp", "killstreak_helicopter_gunner", "helicopter_used", ::useKillstreakHelicopterGunner, true);
		maps\mp\killstreaks\_killstreaks::registerKillstreakStrings("helicopter_gunner_mp", &"KILLSTREAK_EARNED_HELICOPTER_GUNNER", &"KILLSTREAK_HELICOPTER_GUNNER_NOT_AVAILABLE", &"KILLSTREAK_HELICOPTER_GUNNER_INBOUND");
		maps\mp\killstreaks\_killstreaks::registerKillstreakDialog("helicopter_gunner_mp", "mpl_killstreak_heli", "kls_huey_used", "","kls_huey_enemy", "", "kls_huey_ready");
		maps\mp\killstreaks\_killstreaks::registerKillstreakDevDvar("helicopter_gunner_mp", "scr_givehelicoptergunner");
		
		maps\mp\killstreaks\_killstreaks::registerKillstreakAltWeapon("helicopter_gunner_mp", "hind_rockets_mp" );
		maps\mp\killstreaks\_killstreaks::registerKillstreakAltWeapon("helicopter_gunner_mp", "hind_minigun_pilot_mp" );
		maps\mp\killstreaks\_killstreaks::registerKillstreakAltWeapon("helicopter_gunner_mp", "hind_minigun_pilot_2_mp" );
		maps\mp\killstreaks\_killstreaks::registerKillstreakAltWeapon("helicopter_gunner_mp", "huey_minigun_gunner_mp" );
...
//	self.heli.maxlifetime = 240*1000;								// 60 secs
	...
	self.heli thread maps\mp\_helicopter::heli_damage_monitor( hardpointtype );		// monitors damage
	self.heli thread maps\mp\_helicopter::heli_kill_monitor( hardpointtype );		// monitors damage
	self.heli thread heli_lock_monitor( self );				// monitors missle lock-ons
	self.heli thread maps\mp\_helicopter::heli_missile_incoming();			// fires chaff if needed
