...
init()
{
	...
	level.crateModelTank = "p6_crate48x48";
...
//	maps\mp\killstreaks\_killstreaks::setRemoveWeaponWhenUsed("supply_drop_mp", false);hud_ks_m202
	...
	registerCrateType( "supplydrop_mp", "ammo", "ammo", 10, &"KILLSTREAK_AMMO_CRATE", &"PLATFORM_AMMO_CRATE_GAMBLER", "MEDAL_SHARE_PACKAGE_AMMO", ::giveCrateAmmo );
	registerCrateType( "supplydrop_mp", "killstreak", "radar_mp", 8, &"KILLSTREAK_RADAR_CRATE", &"PLATFORM_RADAR_GAMBLER", "MEDAL_SHARE_PACKAGE_RECON", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "counteruav_mp", 6, &"KILLSTREAK_COUNTERU2_CRATE", &"PLATFORM_COUNTERU2_GAMBLER", "MEDAL_SHARE_PACKAGE_COUNTERU2", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "rcbomb_mp", 8, &"KILLSTREAK_RCBOMB_CRATE", &"PLATFORM_RCBOMB_GAMBLER", "MEDAL_SHARE_PACKAGE_RCBOMB", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "remote_missile_mp", 6, &"KILLSTREAK_REMOTE_MISSILE_CRATE", &"PLATFORM_REMOTE_MISSILE_GAMBLER", "MEDAL_SHARE_PACKAGE_REMOTE_MISSILE", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "planemortar_mp", 6, &"KILLSTREAK_PLANE_MORTAR_CRATE", &"PLATFORM_PLANE_MORTAR_GAMBLER", "MEDAL_SHARE_PACKAGE_PLANE_MORTAR", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "autoturret_mp", 6, &"KILLSTREAK_AUTO_TURRET_CRATE", &"PLATFORM_AUTO_TURRET_GAMBLER", "MEDAL_SHARE_PACKAGE_AUTO_TURRET", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "microwaveturret_mp", 6, &"KILLSTREAK_MICROWAVE_TURRET_CRATE", &"PLATFORM_MICROWAVE_TURRET_GAMBLER", "MEDAL_SHARE_PACKAGE_MICROWAVE_TURRET", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "remote_mortar_mp", 2, &"KILLSTREAK_REMOTE_MORTAR_CRATE", &"PLATFORM_REMOTE_MORTAR_GAMBLER", "MEDAL_SHARE_PACKAGE_REMOTE_MORTAR", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "helicopter_guard_mp", 2, &"KILLSTREAK_HELICOPTER_GUARD_CRATE", &"PLATFORM_HELICOPTER_GUARD_GAMBLER", "MEDAL_SHARE_PACKAGE_HELICOPTER_GUARD", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "radardirection_mp", 2, &"KILLSTREAK_SATELLITE_CRATE", &"PLATFORM_SATELLITE_GAMBLER", "MEDAL_SHARE_PACKAGE_SATELLITE", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "helicopter_comlink_mp", 4, &"KILLSTREAK_HELICOPTER_CRATE", &"PLATFORM_HELICOPTER_GAMBLER", "MEDAL_SHARE_PACKAGE_HELICOPTER_COMLINK", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "emp_mp", 2, &"KILLSTREAK_EMP_CRATE", &"PLATFORM_EMP_GAMBLER", "MEDAL_SHARE_PACKAGE_EMP", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "helicopter_player_gunner_mp", 2, &"KILLSTREAK_HELICOPTER_GUNNER_CRATE", &"PLATFORM_HELICOPTER_GUNNER_GAMBLER", "MEDAL_SHARE_PACKAGE_HELICOPTER_GUNNER", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "dogs_mp", 4, &"KILLSTREAK_DOGS_CRATE", &"PLATFORM_DOGS_GAMBLER", "MEDAL_SHARE_PACKAGE_DOGS", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "straferun_mp", 2, &"KILLSTREAK_STRAFERUN_CRATE", &"PLATFORM_STRAFERUN_GAMBLER", "MEDAL_SHARE_PACKAGE_STRAFERUN", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "missile_swarm_mp", 1, &"KILLSTREAK_MISSILE_SWARM_CRATE", &"PLATFORM_MISSILE_SWARM_GAMBLER", "MEDAL_SHARE_PACKAGE_MISSILE_SWARM", ::giveCrateKillstreak );
	registerCrateType( "supplydrop_mp", "killstreak", "qrdrone_mp", 3, &"KILLSTREAK_QRDRONE_CRATE", &"PLATFORM_QRDRONE_GAMBLER", "MEDAL_SHARE_PACKAGE_QRDRONE", ::giveCrateKillstreak );
	
	
	// for the gambler perk, have its own crate types with a greater chance to get good stuff
	// right now this is at a perfect 100, so the percentages are easy to understand
	registerCrateType( "gambler_mp", "ammo", "ammo", 20, &"KILLSTREAK_AMMO_CRATE", undefined, "MEDAL_SHARE_PACKAGE_AMMO", ::giveCrateAmmo );
	...
	registerCrateType( "gambler_mp", "killstreak", "remote_missile_mp", 9, &"KILLSTREAK_REMOTE_MISSILE_CRATE", undefined, "MEDAL_SHARE_PACKAGE_REMOTE_MISSILE", ::giveCrateKillstreak );
	registerCrateType( "gambler_mp", "killstreak", "planemortar_mp", 9, &"KILLSTREAK_PLANE_MORTAR_CRATE", undefined, "MEDAL_SHARE_PACKAGE_PLANE_MORTAR", ::giveCrateKillstreak );
	...
	registerCrateType( "gambler_mp", "killstreak", "remote_mortar_mp", 1, &"KILLSTREAK_REMOTE_MORTAR_CRATE", undefined, "MEDAL_SHARE_PACKAGE_REMOTE_MORTAR", ::giveCrateKillstreak );
	registerCrateType( "gambler_mp", "killstreak", "helicopter_guard_mp", 1, &"KILLSTREAK_HELICOPTER_GUARD_CRATE", undefined, "MEDAL_SHARE_PACKAGE_HELICOPTER_GUARD", ::giveCrateKillstreak );
	registerCrateType( "gambler_mp", "killstreak", "radardirection_mp", 1, &"KILLSTREAK_SATELLITE_CRATE", undefined, "MEDAL_SHARE_PACKAGE_SATELLITE", ::giveCrateKillstreak );
	registerCrateType( "gambler_mp", "killstreak", "helicopter_comlink_mp", 1, &"KILLSTREAK_HELICOPTER_CRATE", undefined, "MEDAL_SHARE_PACKAGE_HELICOPTER_COMLINK", ::giveCrateKillstreak );
	registerCrateType( "gambler_mp", "killstreak", "emp_mp", 1, &"KILLSTREAK_EMP_CRATE", undefined, "MEDAL_SHARE_PACKAGE_EMP", ::giveCrateKillstreak );
	registerCrateType( "gambler_mp", "killstreak", "helicopter_player_gunner_mp", 1, &"KILLSTREAK_HELICOPTER_GUNNER_CRATE", undefined, "MEDAL_SHARE_PACKAGE_HELICOPTER_GUNNER", ::giveCrateKillstreak );
	registerCrateType( "gambler_mp", "killstreak", "dogs_mp", 9, &"KILLSTREAK_DOGS_CRATE", undefined, "MEDAL_SHARE_PACKAGE_DOGS", ::giveCrateKillstreak );
	registerCrateType( "gambler_mp", "killstreak", "qrdrone_mp", 9, &"KILLSTREAK_QRDRONE_CRATE", undefined, "MEDAL_SHARE_PACKAGE_QRDRONE", ::giveCrateKillstreak );
...
useSupplyDropMarker()
{
	...
	if ( IsDefined( level.usingMomentum ) && level.usingMomentum && !self HasWeapon( supplyDropWeapon ) )
		self GiveWeapon( supplyDropWeapon );
...
crateDeactivate( )
{
	...
	//self maps\mp\_entityheadicons::setEntityHeadIcon( self.team, self.owner, 0, "none" );
}
...
crateSpawn( weaponname, owner, team, drop_origin, drop_angle )
{
	...
	case "ai_tank_drop_mp":
		crate.crateType = level.crateTypes[ weaponname ][ "ai_tank_mp" ];
		break;	
	default:
...
dropCrate( origin, angle, weaponname, owner, team, killcamEnt )
{
	...
	{
		[[crate.crateType.landFunctionOverride]]( crate, weaponname, owner, team );
	}
	else
	{
		crate crateActivate();
...
is_touching_crate() // self == crate
{
	...
	for( i = 0; i < players.size; i++ )
	{
		...
		{
			players[i] DoDamage( players[i].health + 1, players[i].origin, self.owner, self, "none", "MOD_HIT_BY_OBJECT", 0, "supplydrop_mp" );
