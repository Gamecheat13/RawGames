...
useKillstreakRadar(hardpointType)
{
	...
	return self maps\mp\killstreaks\_spyplane::callspyplane( hardpointType, false );
}
...
useKillstreakCounterUAV(hardpointType)
{
	...
	return self maps\mp\killstreaks\_spyplane::callcounteruav( hardpointType, false );
}
...
useKillstreakSatellite(hardpointType)
{
	...
	return self maps\mp\killstreaks\_spyplane::callsatellite( hardpointType, false );
}
