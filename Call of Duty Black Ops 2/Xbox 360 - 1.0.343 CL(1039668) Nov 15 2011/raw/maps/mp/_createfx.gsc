...
createFxLogic()
{
	...
	if ( !isMP() )
	{
		...
		//TW - commented this out because it doesn't do anything with the argument and the getplayers() builtin isn't implemented for MP (yet)
...
{
	rate = 1;		// DLM - 12/16/2010 - Changed rotational rate from 2 to 1 for more fine tuned control
