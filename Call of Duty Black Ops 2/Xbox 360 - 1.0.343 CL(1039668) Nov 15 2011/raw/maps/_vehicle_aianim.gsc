...
// AE 2-18-09: created this for faster getin and getout anims
// TODO: have the original guy_runtovehicle function do this, like the wait anim special case
//guy_runtovehicle_fast( guy, vehicle, bGoddriver )
//{
//	if(!isdefined(bGoddriver))
//		bGoddriver = false;
...
//	bIsgettin = false;
//	for( i = 0;i < vehicleanim.size;i ++ )
//		if( isdefined( vehicleanim[ i ].getin_fast ) )
//			bIsgettin = true;
//
//	if( !bIsgettin )
//	{
//		guy notify( "enteredvehicle" );
//		guy enter_vehicle(  vehicle );
//		return;
//	}
//
//	while( vehicle getspeedmph() > 1 )
...
//		if( bGoddriver )
//		{
//			assert( !isdefined(guy.magic_bullet_shield), "magic_bullet_shield guy told to god mode drive a vehicle, you should simply load_ai without the god function for this guy");
//			guy thread magic_bullet_shield();
//			thread remove_magic_bullet_shield_from_guy_on_unload_or_death( guy );
//		}
//	}
//	// Alex Liu (12-2-08): Fix a bug so the AIs will use pre-defined starting positions when running to vehicle
//	else if( isdefined( guy.script_startingposition ) )
//	{
//		position_valid = -1;
//		for( i = 0; i < positions.availablepositions.size; i++ )
//		{	
//			if( positions.availablepositions[i].pos == guy.script_startingposition )
//			{
//				position_valid = i;
//			}
//		}
...
//		return; // nothing available
//
//	origin = chosenorg.origin;// + VectorScale( vectornormalize( chosenorg.origin - vehicle.origin ), 15 );// move the origin out a bit sometimes the start position of the animation is just inside the colision
...
//		//			animatemodel thread play_sound_on_entity( vehicleanim[ chosenorg.pos ].vehicle_getinsound );
//		//		}
//		vehicle animontag( guy, vehicleanim[ chosenorg.pos ].sittag, vehicleanim[ chosenorg.pos ].getin_fast );
//	}
//	guy notify( "enteredvehicle" );
//	guy enter_vehicle(  vehicle );
//}
...
// SCRIPTER_MOD: dguzzo: 3-9-09 : need this anymore?
//copy_cat()
//{
