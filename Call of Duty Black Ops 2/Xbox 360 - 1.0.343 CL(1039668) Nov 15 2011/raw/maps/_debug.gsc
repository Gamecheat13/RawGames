...
//	thread debug_character_count();
	...
	for( ;; )
	{
		...
		{
			anim.defaultException = get_overloaded_func( "animscripts\init", "infiniteLoop" );
			noAnimscripts = true;
		}
...
/#
	...
	colors = [];
	colors[ "axis" ] = ( 1.0, 0.0, 0.0 );
	colors[ "allies" ] = ( 0.0, 1.0, 0.0 );
	colors[ "team3" ] = ( 1.0, 1.0, 0.0 );

	for( i = 0; i < guys.size; i++ )
	{		
		RecordEntText( string( guys[i].maxvisibledist ), guys[i], colors[ guys[i].team ], "Animscript" );		
	}
	
	RecordEntText( string( level.player.maxvisibledist ), level.player, colors[ "allies" ], "Animscript" );		
#/	
}
...
/#
	...
	for( i = 0; i < guys.size; i++ )
	{		
		RecordEntText( string( guys[i].health ), guys[i], colors[ guys[i].team ], "Animscript" );		
	}
	...
	for( i = 0; i < vehicles.size; i++ )
	{		
		RecordEntText( string( vehicles[i].health ), vehicles[i], colors[ vehicles[i].vteam ], "Animscript" );		
	}
	
	RecordEntText( string( level.player.health ), level.player, colors[ "allies" ], "Animscript" );		
#/	
}
...
/#
	...
	{		
		...
		RecordEntText( distString, guys[i], colors[ guys[i].team ], "Animscript" );		
	}
