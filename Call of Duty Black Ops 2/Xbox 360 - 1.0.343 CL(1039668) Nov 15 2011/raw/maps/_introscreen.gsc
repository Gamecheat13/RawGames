...
//-------------------//
		...
		case "yemen":
			introscreen_delay( &"YEMEN_INTROSCREEN_TITLE", &"YEMEN_INTROSCREEN_PLACE", &"YEMEN_INTROSCREEN_TARGET", &"YEMEN_INTROSCREEN_TEAM" );
			break;
...
//	#/
	...
	if( IsDefined( string1 ) )
	{
		...
		// We are using the extrabig1(pixelheight 30) font as scaling is disabled. Without scaling it was using bigFont with pixel height of 48 and the intro screen string was looking big.  
		level thread introscreen_create_redacted_line( string1, redacted_line_time, start_rubout_time, rubout_time, color, undefined, undefined, "extrabig1" ); 
	...
	if( IsDefined( string2 ) )
	{
		...
		level thread introscreen_create_redacted_line( string2, redacted_line_time, start_rubout_time, rubout_time, color, undefined, undefined, "extrabig1" ); 
	...
	if( IsDefined( string3 ) )
	{
		...
		level thread introscreen_create_redacted_line( string3, redacted_line_time,  start_rubout_time, rubout_time, color, undefined, undefined, "extrabig1" ); 
	...
	if( IsDefined( string4 ) )
	{
		...
		level thread introscreen_create_redacted_line( string4, redacted_line_time, start_rubout_time, rubout_time, color, undefined, undefined, "extrabig1" ); 
	...
	if( IsDefined( string5 ) )
	{
		...
		level thread introscreen_create_redacted_line( string5, redacted_line_time, start_rubout_time, rubout_time, color, undefined, undefined, "extrabig1" ); 
