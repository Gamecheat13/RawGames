...
main()
{
	...
	level array_ent_thread(getentarray("wire","targetname"), ::wireWander);
	level array_ent_thread(getentarray("awning","targetname"), ::awningWander);
	level array_ent_thread(getentarray("palm","targetname"), ::palmTrees);
	...
	for (;;)
	{
		level array_ent_thread(leftShutters, ::shutterWanderLeft, windDirection);
		level array_ent_thread(rightShutters, ::shutterWanderRight, windDirection);
