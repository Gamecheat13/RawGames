...
entity_connect_nodes()
{
	...
	foreach ( nd_dynamic in self.a_dynamic_nodes )
	{
		...
		{		
			...
			if ( is_in_array( self.a_dynamic_nodes, nd_test ) )
			{
				reject = 1;
			}
			...
			if ( is_in_array( nd_dynamic.a_linked_nodes, nd_test ) )
			{
				reject = 1;
			}
			
//			if ( isdefined( nd_test.a_linked_nodes ) && is_in_array( nd_test.a_linked_nodes, nd_dynamic ) )
//			{
//				reject = 1;
//			}
