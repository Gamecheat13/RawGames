...
/#
	...
	const shader_width = 150;
	const shader_height = 80;
	const x = 0;
	y = 300;
...
/#
	...
	const shader_width = 75;
	const shader_height = 380;
	x = 640 - shader_width;
	y = 480 - shader_height;
...
/#
	...
	level thread universal_input_loop( "edit_shot_track", "disable edit_shot_track", undefined, undefined );
#/
}
...
/#
	...
	assert( file != -1, "File not writeable (maybe you should check it out): " + fullpath_file );
...
//	attrib = level.cam_scene_attributes;
	...
	assert( saved == 1, "File not saved (see above message?): " + fullpath_file );
