...
inc_challenge_stat( str_stat_name )
{
	...
	self AddDStat( "PlayerSaveStats", "challenges", "difficulty_"+GetDifficulty(), "counter", level._challenge_lookup[str_stat_name], 1 );
}
...
get_challenge_stat( str_stat_name )
{
	...
	return self GetDStat( "PlayerSaveStats", "challenges", "difficulty_"+GetDifficulty(), "counter", level._challenge_lookup[str_stat_name] );
}
...
is_challenge_stat_complete( str_stat_name )
{
	...
	{
		iprintln( str_stat_name + " challenge complete." ); //TODO: replace with a proper notification of challenge completion, once one has been designed
