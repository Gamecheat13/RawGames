...
stealth_init( enviroment )
{
	...
	// ABalanon (02/03/2011)threads clipbrush logic when placed. Use the indicated targetname to enable logic for that model.	
...
system_init()
{
	...
	level._stealth.environment[0] = "default"; // default environment
