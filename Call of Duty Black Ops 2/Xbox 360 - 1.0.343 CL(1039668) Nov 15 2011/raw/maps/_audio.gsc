...
fadeinSound()
{
	...
	//get_players()[0] playsound("uin_transition_01");
...
missile_audio_watcher()	// self == player or ai
{
...
/*		if(IsAI(self))
		{
			IPrintLnBold("AI fired " + weap);
		}
		else
		{
			IPrintLnBold("Player fired " + weap);
		} */

		switch(weap)
		{
/*		case "china_lake_sp":
			break; */							// China lake is a projectile launcher, not a missile launcher.
		case "m202_flash_sp":
			break;
		case "m47_dragon_sp":
			break;
