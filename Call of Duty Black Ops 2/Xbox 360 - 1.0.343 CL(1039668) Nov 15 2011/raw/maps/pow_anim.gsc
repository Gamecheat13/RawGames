...
init_compound_anims()
{
	...
	add_scene( "pacing", "struct_endfight", false, false, true );
	add_actor_anim( "kravchenko", %generic_human::ch_pow_b04_kravchenko_pacing, true, false, false, true );
...
{
	SetTimeScale(0.2);
	playsoundatposition ("evt_krav_woods_struggle", (0,0,0));
}
...
init_traverse_anims()
{
	...
	add_scene( "drop_down", undefined, false, true );
	add_actor_anim( "generic", %generic_human::ch_pow_b02_vc_tunnel_jump_down );
}
...
init_tunnel_anims()
{
	...
	add_scene( "escape", "struct_align_spetz_escape" );
	add_actor_anim( "spetsnaz", %generic_human::ch_pow_b02_end_spetz_escape, true, false, false, true );
	
	add_scene( "escape_death_1", "struct_align_spetz_escape" );
	add_actor_anim( "spetsnaz", %generic_human::ch_pow_b02_end_spetz_escape_death_1, true, false, false, true );
	
	add_scene( "escape_death_2", "struct_align_spetz_escape" );
	add_actor_anim( "spetsnaz", %generic_human::ch_pow_b02_end_spetz_escape_death_2, true, false, false, true );
	...
	*/
	...
	add_scene( "to_climb_up", "struct_align_spetz_escape", true );
	add_actor_anim( "barnes", %generic_human::ch_pow_b02_end_barnes_run2wait );
	
	add_scene( "wait_climb_up", "struct_align_spetz_escape", false, false, true );
	add_actor_anim( "barnes", %generic_human::ch_pow_b02_end_barnes_wait );
	
	add_scene( "climb_up", "struct_align_spetz_escape" );
	add_actor_anim( "barnes", %generic_human::ch_pow_b02_end_barnes_climb );
	add_player_anim( "player_hands", %player::int_pow_b02_end_climb, true );
	add_notetrack_custom_function( "barnes", "door_start_open", ::open_tunnel_door );
...
init_strafe_tunnel()
{
	add_scene( "strafe_tunnel", "struct_strafe_guy", false, true );
	
	add_actor_anim( "generic", %generic_human::ch_creek_b04_vc_tunnel_strafe );
}

init_relaxed_signal()
{
	add_scene( "relaxed_signal", undefined, false, true, false, true );
	
	add_actor_anim( "generic", %generic_human::ch_cuba_b02_troops_signal_4 );
}

init_pulldown_table()
{
	add_scene( "pulldown_table", "struct_table_pulldown", true, true );
	
	add_actor_anim( "generic", %generic_human::ch_flaspoint_e11_rack_of_tapes );
}

init_attack_crouch_through()
{
	add_scene( "attack_crouch_through", "struct_attack_crouch", false, true );
	
	add_actor_anim( "generic", %generic_human::ch_hue_b01_ib_entry3_nva1 );
}

init_machete_over()
{
	add_scene( "machete_over", "struct_machete_over", false, true );
	
	add_actor_anim( "generic", %generic_human::ai_covercrouch_hide_2_mantle_36 );
}

init_leap_off_ledge()
{
	add_scene( "leap_off_ledge", "struct_leap_off_point", true, true );
	
	add_actor_anim( "generic", %generic_human::ch_kowloon_136_dropdown_run2run_leap );
}

init_flame_over()
{
	add_scene( "flame_over", "struct_flame_guy_jumpover", false, true );
	
	add_actor_anim( "generic", %generic_human::ai_covercrouch_hide_2_mantle_36 );
}

init_sit_guard_react()
{
	add_scene( "sit_guard_react", "struct_guard_sitting", false, true );
	
	add_actor_anim( "generic", %generic_human::ch_wmd_b01_chairbreach_guards_grd01 );
}

init_stand_guard_idle()
{
	add_scene( "stand_guard_idle", "struct_aloof_guard", false, true, true );
	
	add_actor_anim( "generic", %generic_human::ch_pow_b03_clearing_spetz_guard1 );
}

init_rpg_rollout()
{
	add_scene( "rpg_rollout", "struct_rpg_rollout", false, true );
	
	add_actor_anim( "generic", %generic_human::ai_spets_run_2_stand_cover_hide_6 );
}

init_mantle_on_box()
{
	add_scene( "mantle_on_box", "struct_mantle_on_box", false, true );
	
	add_actor_anim( "generic", %generic_human::ai_mantle_on_56 );
}
...
init_russian_roulette()
{
	init_russian_roulette_1a_1();
	init_russian_roulette_1a_2();
	init_russian_roulette_1a_3();
	init_russian_roulette_1b();
	init_russian_roulette_1b2();
	init_russian_roulette_1c();
	init_russian_roulette_1d();
}

init_russian_roulette_1a_1()
{
	add_scene( "rr_1a_1", "rr_sync_a_struct" );
	
	add_actor_anim( "barnes", %generic_human::ch_pow_b01_1a_1_barnes, true );
	add_actor_anim( "vc2", %generic_human::ch_pow_b01_1a_1_vc2 );
	add_actor_anim( "vc3", %generic_human::ch_pow_b01_1a_1_vc3 );
	
	add_player_anim( "player_hands", %player::int_pow_b01_1a_1 );
...
init_russian_roulette_1a_2()
{
	add_scene( "rr_1a_2", "rr_sync_a_struct" );

	add_actor_anim( "vc2", %generic_human::ch_pow_b01_1a_2_vc2 );
	add_actor_anim( "vc3", %generic_human::ch_pow_b01_1a_2_vc3 );
	
	add_prop_anim( "rr_cage_lid", %animated_props::o_pow_b01_1a_2_cage_lid, "p_pow_cage_lid", true );
	
	add_player_anim( "player_hands", %player::int_pow_b01_1a_2 );
...
init_russian_roulette_1a_3()
{
	add_scene( "rr_1a_3", "rr_sync_a_struct" );
	
	add_actor_anim( "vc2", %generic_human::ch_pow_b01_1a_3_vc2 );
	add_actor_anim( "vc3", %generic_human::ch_pow_b01_1a_3_vc3 );
	
	add_player_anim( "player_hands", %player::int_pow_b01_1a_3 );
...
init_russian_roulette_1b()
{
	add_scene( "rr_1b", "rr_sync_struct" );
	
	add_actor_anim( "barnes",  %generic_human::ch_pow_b01_1b_barnes, true );
	add_actor_anim( "bookie",  %generic_human::ch_pow_b01_1b_bookie, true );
	add_actor_anim( "spetsnaz",  %generic_human::ch_pow_b01_1b_spetz, true, false, false, true );
	add_actor_anim( "vc1",  %generic_human::ch_pow_b01_1b_vc1 );
	add_actor_anim( "vc2",  %generic_human::ch_pow_b01_1b_vc2 );
	add_actor_anim( "vc3",  %generic_human::ch_pow_b01_1b_vc3 );
	add_actor_anim( "vc5",  %generic_human::ch_pow_b01_1b_vc5 );
	add_actor_anim( "vc6",  %generic_human::ch_pow_b01_1b_vc6 );
	
	add_actor_model_anim( "bowman", %generic_human::ch_pow_b01_1b_lewis );
	
	add_prop_anim( "rr_cleaver", %animated_props::o_pow_b01_1b_cleaver, "anim_jun_cleaver" );
	add_prop_anim( "rr_otherchair", %animated_props::o_pow_b01_1b_otherchair, "anim_jun_chair_01" );
	add_prop_anim( "rr_playerchair", %animated_props::o_pow_b01_1b_playerchair, "anim_jun_chair_01" );
	add_prop_anim( "rr_roulettegun", %animated_props::o_pow_b01_1b_roulettegun, "t5_weapon_coltpython_pow" );
	add_prop_anim( "rr_shovel", %animated_props::o_pow_b01_1b_pipe, "anim_jun_pipe_weapon" );
	add_prop_anim( "rr_table", %animated_props::o_pow_b01_1b_table, "anim_jun_folding_table" );
	
	add_player_anim( "player_hands", %player::int_pow_b01_1b );
	
	add_notetrack_fx_on_tag( "bowman", "spit", "bowman_spit", "j_head" );
}

init_russian_roulette_1b2()
{
	add_scene( "rr_1b2", "rr_sync_struct" );
	
	add_actor_anim( "barnes",  %generic_human::ch_pow_b01_1b2_barnes, true );
	add_actor_anim( "bookie",  %generic_human::ch_pow_b01_1b2_bookie, true );
	add_actor_anim( "spetsnaz",  %generic_human::ch_pow_b01_1b2_spetz, true, false, false, true );
	add_actor_anim( "vc1",  %generic_human::ch_pow_b01_1b2_vc1 );
	add_actor_anim( "vc2",  %generic_human::ch_pow_b01_1b2_vc2 );
	add_actor_anim( "vc3",  %generic_human::ch_pow_b01_1b2_vc3 );
	add_actor_anim( "vc5",  %generic_human::ch_pow_b01_1b2_vc5 );
	add_actor_anim( "vc6",  %generic_human::ch_pow_b01_1b2_vc6 );
	
	add_actor_model_anim( "bowman", %generic_human::ch_pow_b01_1b2_lewis );
	
	add_prop_anim( "rr_cleaver", %animated_props::o_pow_b01_1b2_cleaver );
	add_prop_anim( "rr_otherchair", %animated_props::o_pow_b01_1b2_otherchair );
	add_prop_anim( "rr_playerchair", %animated_props::o_pow_b01_1b2_playerchair );
	add_prop_anim( "rr_roulettegun", %animated_props::o_pow_b01_1b2_roulettegun );
	add_prop_anim( "rr_shovel", %animated_props::o_pow_b01_1b2_pipe );
	add_prop_anim( "rr_table", %animated_props::o_pow_b01_1b2_table );
	
	add_player_anim( "player_hands", %player::int_pow_b01_1b2 );
	
	add_notetrack_fx_on_tag( "bowman", "hit", "bowman_head_hit", "j_head" );
	add_notetrack_custom_function( "bowman", "hit", ::bowman_head_bleed_start );
}

init_russian_roulette_1c()
{
	add_scene( "rr_1c", "rr_sync_struct" );
	
	add_actor_anim( "barnes",  %generic_human::ch_pow_b01_1c_barnes, true, true );
	add_actor_anim( "bookie",  %generic_human::ch_pow_b01_1c_bookie, true );
	add_actor_anim( "spetsnaz",  %generic_human::ch_pow_b01_1c_spetz, true, false, false, true );
	add_actor_anim( "vc1",  %generic_human::ch_pow_b01_1c_vc1 );
	add_actor_anim( "vc2",  %generic_human::ch_pow_b01_1c_vc2 );
	add_actor_anim( "vc3",  %generic_human::ch_pow_b01_1c_vc3 );
	add_actor_anim( "vc5",  %generic_human::ch_pow_b01_1c_vc5 );
	add_actor_anim( "vc6",  %generic_human::ch_pow_b01_1c_vc6 );
	
	add_prop_anim( "rr_cleaver", %animated_props::o_pow_b01_1c_cleaver, "anim_jun_cleaver" );
	add_prop_anim( "rr_otherchair", %animated_props::o_pow_b01_1c_otherchair, "anim_jun_chair_01" );
	add_prop_anim( "rr_playerchair", %animated_props::o_pow_b01_1c_playerchair, "anim_jun_chair_01" );
	add_prop_anim( "rr_roulettegun", %animated_props::o_pow_b01_1c_roulettegun, "t5_weapon_coltpython_pow", true );
	add_prop_anim( "rr_shovel", %animated_props::o_pow_b01_1c_pipe, "anim_jun_pipe_weapon" );
	add_prop_anim( "rr_table", %animated_props::o_pow_b01_1c_table, "anim_jun_folding_table" );
	
	add_player_anim( "player_hands", %player::int_pow_b01_1c, true );
}

init_russian_roulette_1d()
{
	add_scene( "rr_1d", "rr_sync_struct" );
	
	add_actor_anim( "barnes",  %generic_human::ch_pow_b01_1d_barnes );
	add_actor_anim( "bookie",  %generic_human::ch_pow_b01_1d_bookie, true );
	add_actor_anim( "spetsnaz",  %generic_human::ch_pow_b01_1d_spetz, true, false, false, true );
	add_actor_anim( "vc2",  %generic_human::ch_pow_b01_1d_vc2, true );
	add_actor_anim( "vc3",  %generic_human::ch_pow_b01_1d_vc3, true );
	add_actor_anim( "vc5",  %generic_human::ch_pow_b01_1d_vc5 );
	add_actor_anim( "vc6",  %generic_human::ch_pow_b01_1d_vc6 );
	
	add_prop_anim( "rr_cleaver", %animated_props::o_pow_b01_1d_cleaver, "anim_jun_cleaver", true );
	add_prop_anim( "rr_otherchair", %animated_props::o_pow_b01_1d_otherchair, "anim_jun_chair_01" );
	add_prop_anim( "rr_playerchair", %animated_props::o_pow_b01_1d_playerchair, "anim_jun_chair_01" );
	add_prop_anim( "rr_shovel", %animated_props::o_pow_b01_1d_pipe, "anim_jun_pipe_weapon" );
	add_prop_anim( "rr_table", %animated_props::o_pow_b01_1d_table, "anim_jun_folding_table" );
}

init_rescue_pows()
{
	add_scene( "reznov_rescue", "pow_align_struct" );
	
	add_actor_anim( "reznov", %generic_human::ch_pow_b04_cells_rescue_reznov );
	
	add_player_anim( "player_hands", %player::int_pow_b04_cells_rescue_reznov, true );
	
	add_notetrack_custom_function( "reznov", "woods", ::play_woods_wtf_line );
	add_notetrack_custom_function( "player_hands", "door1_start", ::open_pow_door1 );
	add_notetrack_custom_function( "player_hands", "door2_start", ::open_pow_door2 );
	add_notetrack_custom_function( "player_hands", "door_reznov_start", ::open_pow_door3 );
	add_notetrack_custom_function( "player_hands", "rolling_door_start", maps\pow_compound::animate_rolling_door_open );
}

init_end_fight()
{
	init_end_fight_enter();
	init_end_fight_first_attack();
	init_end_fight_gun_draw();
	init_end_fight_kick_block();
	init_end_fight_gun_grab();
	init_end_fight_shoot();
	init_morph();
}
...
init_russian_roulette_prop_anims()
{
	...
	*/
	...
	//level.scr_anim[ "rr_shovel" ][ "rr_1a" ] = %o_pow_b01_1a_entrenchingtool; // already commented out
...
init_end_fight_enter()
{
	add_scene( "endfight_enter", "struct_endfight" );

	add_actor_anim( "kravchenko", %generic_human::ch_pow_b04_endfight_krav_enter, true );
	add_actor_anim( "barnes", %generic_human::ch_pow_b04_endfight_woods_enter, true );
	
	add_prop_anim( "krav_chair", %animated_props::o_pow_b04_endfight_chair_enter, "anim_jun_chair_01" );
}

init_end_fight_first_attack()
{
	add_scene( "endfight_firstattack", "struct_endfight" );
	
	add_actor_anim( "kravchenko", %generic_human::ch_pow_b04_endfight_krav_firstattack, true );
	add_actor_anim( "barnes", %generic_human::ch_pow_b04_endfight_woods_firstattack, true );
	
	add_prop_anim( "krav_chair", %animated_props::o_pow_b04_endfight_chair_firstattack );
	add_prop_anim( "krav_gun", %animated_props::o_pow_b04_endfight_pistol_firstattack, "anim_cz75_world" );
}

init_end_fight_gun_draw()
{
	add_scene( "endfight_gundraw", "struct_endfight" );
	
	add_actor_anim( "kravchenko", %generic_human::ch_pow_b04_endfight_krav_gundraw, true );
	add_actor_anim( "barnes", %generic_human::ch_pow_b04_endfight_woods_gundraw, true );
	
	add_prop_anim( "krav_gun", %animated_props::o_pow_b04_endfight_pistol_gundraw );
}

init_end_fight_kick_block()
{
	add_scene( "endfight_kickblock", "struct_endfight" );
	
	add_actor_anim( "kravchenko", %generic_human::ch_pow_b04_endfight_krav_kickblock, true );
	add_actor_anim( "barnes", %generic_human::ch_pow_b04_endfight_woods_kickblock, true );
	
	add_prop_anim( "krav_gun", %animated_props::o_pow_b04_endfight_pistol_kickblock );
	
	add_notetrack_custom_function( "kravchenko", "damage", ::damage_and_blur_player );
}

init_end_fight_gun_grab()
{
	add_scene( "endfight_gungrab", "struct_endfight" );
	
	add_actor_anim( "kravchenko", %generic_human::ch_pow_b04_endfight_krav_gungrab, true );
	add_actor_anim( "barnes", %generic_human::ch_pow_b04_endfight_woods_gungrab, true );

	add_prop_anim( "krav_gun", %animated_props::o_pow_b04_endfight_pistol_gungrab );
	add_prop_anim( "krav_knife", %animated_props::o_pow_b04_endfight_knife_gungrab, "t5_knife_animate" );
	
	add_notetrack_custom_function( "kravchenko", "damage", ::damage_and_blur_player );
	add_notetrack_custom_function( "barnes", "blood", ::krav_blood );
	add_notetrack_custom_function( "barnes", "slo_start", ::start_slo_mo );
	add_notetrack_custom_function( "barnes", "slo_end", ::end_slo_mo );
}

init_end_fight_shoot()
{
	add_scene( "endfight_shoot", "struct_endfight" );
	
	add_actor_anim( "kravchenko", %generic_human::ch_pow_b04_endfight_krav_shoot, true, false, true );
	add_actor_anim( "barnes", %generic_human::ch_pow_b04_endfight_woods_shoot, true );

	add_prop_anim( "krav_gun", %animated_props::o_pow_b04_endfight_pistol_shoot, undefined, true );
	add_prop_anim( "krav_knife", %animated_props::o_pow_b04_endfight_knife_shoot, undefined, true );
}

init_morph()
{
	add_scene( "morph", "struct_endfight" );
	
	add_actor_anim( "barnes", %generic_human::ch_pow_b04_morph, true );
	
	add_player_anim( "player_hands", %player::int_pow_b04_morph );
	
	add_notetrack_custom_function( "player_hands", "blur", ::swap_to_reznov );
	add_notetrack_custom_function( "player_hands", "swap", ::notify_swap_to_reznov );
	add_notetrack_custom_function( "player_hands", "at_table", maps\createart\pow_art::set_vision_endtable );
	add_notetrack_custom_function( "player_hands", "play_other_lines", maps\pow_compound::play_extra_lines_and_end );
}
...
init_VO()
{
  ...
  */
  ...
  level.scr_sound["generic"]["wakeup"] = "vox_pow1_s03_505A_wood"; //Wake the fuck up, Mason!
