...
init_dds_countryIDs( voice, dds_label )
{
	...
	//enum { "american", "british", "german", "russian", "vietnamese", "civilian", "mp" } voice
	level.dds.countryIDs = [];
	add_dds_countryID( "american",			"us",	5 ); //us0-us4
	add_dds_countryID( "russian",			"ru",	4 ); //ru0-ru3
	add_dds_countryID( "vietnamese",		"vc",	4 ); //vc0-vc3
	add_dds_countryID( "cuban",				"cb",	4 ); //cb0-cb3
	add_dds_countryID( "german",			"ge",	3 ); //ge0-ge2
	add_dds_countryID( "british",			"br",	2 ); //br0-br1
	add_dds_countryID( "russian_english",	"rn",	3 ); //rn0-rn2
}
