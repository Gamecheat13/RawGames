...
/*QUAKED actor_Enemy_Manticore_LA_Pistol_Dualwield (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	self.accuracy = 1;
	self.animTree = "";
	self.csvInclude = "subclass_dualwield.csv";
	self.grenadeAmmo = 0;
