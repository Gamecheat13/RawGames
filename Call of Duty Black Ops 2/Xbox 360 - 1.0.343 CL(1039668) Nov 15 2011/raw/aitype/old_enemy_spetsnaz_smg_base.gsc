...
/*QUAKED actor_OLD_Enemy_Spetsnaz_SMG_Base (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_rus_spetznaz_cqb_fb"
...
main()
{
	...
	{
	case 0:
		character\c_rus_spetznaz_1_char::main();
		break;
	case 1:
		character\c_rus_spetznaz_2_char::main();
		break;
	}
}
...
precache()
{
	character\c_rus_spetznaz_1_char::precache();
	character\c_rus_spetznaz_2_char::precache();
