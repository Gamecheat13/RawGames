...
/*QUAKED actor_Civilian_Club_Male_3 (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	{
	case 0:
		character\c_mul_civ_club_male_jckt_ts::main();
		break;
	case 1:
		character\c_mul_civ_club_male_jckt_ts_vst::main();
		break;
	}
}
...
precache()
{
	character\c_mul_civ_club_male_jckt_ts::precache();
	character\c_mul_civ_club_male_jckt_ts_vst::precache();
