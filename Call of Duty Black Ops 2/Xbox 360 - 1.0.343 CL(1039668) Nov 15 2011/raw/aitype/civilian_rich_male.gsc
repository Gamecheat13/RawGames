...
/*QUAKED actor_Civilian_Rich_Male (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	case 1:
		...
		break;
	case 2:
		character\c_mul_civ_generic_male_3::main();
		break;
	case 3:
		character\c_mul_civ_generic_male_4::main();
		break;
	case 4:
		character\c_mul_civ_generic_male_5::main();
		break;
	case 5:
		character\c_mul_civ_generic_male_6::main();
		break;
	case 6:
		character\c_mul_civ_generic_male_7::main();
		break;
	case 7:
		character\c_mul_civ_generic_male_8::main();
		break;
	}
}
...
precache()
{
	...
	character\c_mul_civ_generic_male_3::precache();
	character\c_mul_civ_generic_male_4::precache();
	character\c_mul_civ_generic_male_5::precache();
	character\c_mul_civ_generic_male_6::precache();
	character\c_mul_civ_generic_male_7::precache();
	character\c_mul_civ_generic_male_8::precache();
