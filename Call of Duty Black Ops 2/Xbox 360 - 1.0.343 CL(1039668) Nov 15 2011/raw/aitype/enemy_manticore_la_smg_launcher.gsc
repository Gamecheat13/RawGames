...
/*QUAKED actor_Enemy_Manticore_LA_SMG_Launcher (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	self.health = 150;
	self.precacheScript = "";
	self.secondaryweapon = "rpg_sp";
	self.sidearm = "makarov_sp";
	self.team = "axis";
	self.type = "human";
	self.weapon = "kriss_sp";
