...
/*QUAKED actor_OLD_Unique_KheSanh_sergeant (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_usa_jungmar_sarge2::main();
}
...
precache()
{
	character\c_usa_jungmar_sarge2::precache();
