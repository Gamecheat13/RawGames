...
/*QUAKED actor_Hero_Mason_Panama_Captured (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_usa_captured_mason_dead_fb"
...
main()
{
	...
	character\c_usa_captured_mason_dead::main();
}
...
precache()
{
	character\c_usa_captured_mason_dead::precache();
