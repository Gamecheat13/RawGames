...
/*QUAKED actor_Civilian_Club_Male_2 (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	{
	case 0:
		character\c_mul_civ_club_male_jckt_rld_drsh::main();
		break;
	case 1:
		character\c_mul_civ_club_male_jckt_rld_ts::main();
		break;
	}
}
...
precache()
{
	character\c_mul_civ_club_male_jckt_rld_drsh::precache();
	character\c_mul_civ_club_male_jckt_rld_ts::precache();
