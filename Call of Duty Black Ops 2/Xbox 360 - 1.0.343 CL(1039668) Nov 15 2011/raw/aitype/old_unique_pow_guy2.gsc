...
/*QUAKED actor_OLD_Unique_Pow_Guy2 (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_vtn_vc_pow_guy2::main();
}
...
precache()
{
	character\c_vtn_vc_pow_guy2::precache();
