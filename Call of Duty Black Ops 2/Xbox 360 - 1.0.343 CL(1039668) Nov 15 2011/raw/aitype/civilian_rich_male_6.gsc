...
/*QUAKED actor_Civilian_Rich_Male_6 (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	{
	case 0:
		character\c_mul_civ_generic_male_11::main();
		break;
	case 1:
		character\c_mul_civ_generic_male_12::main();
		break;
	}
}
...
precache()
{
	character\c_mul_civ_generic_male_11::precache();
	character\c_mul_civ_generic_male_12::precache();
