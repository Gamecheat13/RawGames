...
/*QUAKED actor_Civilian_Club_Male_Light_2 (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	case 0:
		...
		break;
	case 1:
		character\c_mul_civ_club_male_light8::main();
		break;
	}
}
...
precache()
{
	...
	character\c_mul_civ_club_male_light8::precache();
