...
/*QUAKED actor_mp_op40_armor (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_cub_rebels_mp_body_armor_demo"
...
precache()
{
	character\c_cub_armor::precache();
