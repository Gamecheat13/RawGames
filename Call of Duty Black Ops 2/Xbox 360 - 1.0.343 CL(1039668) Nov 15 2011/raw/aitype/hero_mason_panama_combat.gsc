...
/*QUAKED actor_Hero_Mason_Panama_Combat (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_usa_seal80s_mason::main();
}
...
precache()
{
	character\c_usa_seal80s_mason::precache();
