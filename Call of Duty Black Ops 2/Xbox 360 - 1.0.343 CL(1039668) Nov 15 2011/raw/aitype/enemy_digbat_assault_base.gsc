...
/*QUAKED actor_Enemy_Digbat_Assault_Base (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	{
	case 0:
		character\c_pan_dingbats_1::main();
		break;
	case 1:
		character\c_pan_dingbats_2::main();
		break;
	case 2:
		character\c_pan_dingbats_3::main();
		break;
	}
}
...
precache()
{
	character\c_pan_dingbats_1::precache();
	character\c_pan_dingbats_2::precache();
	character\c_pan_dingbats_3::precache();
