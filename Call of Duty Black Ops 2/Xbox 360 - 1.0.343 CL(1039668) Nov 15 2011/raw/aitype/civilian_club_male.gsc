...
/*QUAKED actor_Civilian_Club_Male (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_usa_pent_male_worker::main();
}
...
precache()
{
	character\c_usa_pent_male_worker::precache();
