...
/*QUAKED actor_OLD_Hero_Woods_Pow (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_usa_jungmar_barnes_pris_fb"
...
main()
{
	...
	self setEngagementMaxDist( 1000.000000, 1000.000000 );

	character\c_usa_jungmar_pow_barnes::main();
}
...
precache()
{
	character\c_usa_jungmar_pow_barnes::precache();
