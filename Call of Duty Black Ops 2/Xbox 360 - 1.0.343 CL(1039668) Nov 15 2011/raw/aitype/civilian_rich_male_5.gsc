...
/*QUAKED actor_Civilian_Rich_Male_5 (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	{
	case 0:
		character\c_mul_civ_generic_male_9::main();
		break;
	case 1:
		character\c_mul_civ_generic_male_10::main();
		break;
	}
}
...
precache()
{
	character\c_mul_civ_generic_male_9::precache();
	character\c_mul_civ_generic_male_10::precache();
