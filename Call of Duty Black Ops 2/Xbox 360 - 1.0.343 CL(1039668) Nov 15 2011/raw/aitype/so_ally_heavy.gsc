...
/*QUAKED actor_So_Ally_Heavy (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	self.health = 100;
	self.precacheScript = "";
	self.secondaryweapon = "stinger_sp";
