...
/*QUAKED actor_Hero_Zhao_Afghan (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_usa_jungmar_bowman_fb"
...
main()
{
	...
	character\c_usa_jungmar_pow_bowman::main();
}
...
precache()
{
	character\c_usa_jungmar_pow_bowman::precache();
