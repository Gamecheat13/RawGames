...
/*QUAKED actor_Civilian_Club_Female_1 (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	{
	case 0:
		character\c_mul_civ_club_bra_pants::main();
		break;
	case 1:
...
precache()
{
	character\c_mul_civ_club_bra_pants::precache();
