...
/*QUAKED actor_Ally_SSsuit_SMG_Base (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_usa_gov_presstaff2::main();
}
...
precache()
{
	character\c_usa_gov_presstaff2::precache();
