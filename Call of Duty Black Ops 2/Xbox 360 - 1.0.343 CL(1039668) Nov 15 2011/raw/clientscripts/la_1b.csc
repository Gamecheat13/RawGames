...
main()
{
	level.CLIENT_FLAG_MOVER_EXTRA_CAM = 1;
	
	level.CLIENT_FLAG_VEHICLE_REFLECTION_BLUR = 13;
...
//	clientscripts\_apc_cougar_ride::init();
	...
	register_clientflag_callback( "vehicle", level.CLIENT_FLAG_VEHICLE_REFLECTION_BLUR, ::window_reflection_blur );
	register_clientflag_callback( "scriptmover", level.CLIENT_FLAG_MOVER_EXTRA_CAM, ::toggle_extra_cam );
