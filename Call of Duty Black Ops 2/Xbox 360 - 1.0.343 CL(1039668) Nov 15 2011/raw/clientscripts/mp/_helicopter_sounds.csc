...
{
	// ******* qrdrone **************
	self thread heli_idle_run_transition( "qrdrone", "turbine_idle", 0.1 );		 
	self thread heli_idle_run_transition( "qrdrone", "turbine_moving", 0.1 );		 
}
...
// *************************************************
heli_idle_run_transition( heli_type, heli_part, wait_time )
{
