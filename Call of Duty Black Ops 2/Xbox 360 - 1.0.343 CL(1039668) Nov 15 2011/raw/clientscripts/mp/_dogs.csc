...
playDogstep(client_num, dog, pos, ground_type, on_fire)
{
	...
	{
		sound_alias = "aml_dogstep_run_" + ground_type; 
	}
	else
	{
		sound_alias = "aml_dogstep_run_dirt";
	}
	...
	{
		dog playSound( client_num, "aml_dog_run_gear_enemy", pos );	
	}
	else
	{
		dog playSound( client_num, "aml_dog_run_gear", pos );	
	}
