...
cheatAmmoIfNecessary()
{
	...
	if( call_overloaded_func( "animscripts\run", "ShouldTacticalWalk" ) )
	{
...
{
	self waittill_any( "shoot_behavior_change", "stopShooting", "killanimscript" );
...
getGrenadeThrowOffset( throwAnim )
{
	...
	if ( IsDefined( throwAnim ) )
	{
		...
		else if ( throwAnim == %ai_pillar2_stand_idle_grenade_throw_l_01 ) offset = (-15.8651, 3.9711, 27.7689);
		else if ( throwAnim == %ai_pillar2_stand_idle_grenade_throw_l_02 ) offset = (-19.0896, 10.0284, 16.3724);
		else if ( throwAnim == %ai_pillar2_stand_idle_grenade_throw_r_01 ) offset = (13.938, 9.60158, 36.9268);
		else if ( throwAnim == %ai_pillar2_stand_idle_grenade_throw_r_02 ) offset = (-0.140676, -1.76803, 21.88);
		else if ( throwAnim == %ai_pillar2_crouch_idle_grenade_throw_r_01 ) offset = (13.3738, -22.7841, 44.6094);
		else if ( throwAnim == %ai_pillar2_crouch_idle_grenade_throw_r_02 ) offset = (19.3524, -16.1327, 18.6373);
		else if ( throwAnim == %ai_pillar2_crouch_idle_grenade_throw_l_01 ) offset = (18.614, 19.1907, 15.9741);
		else if ( throwAnim == %ai_pillar2_crouch_idle_grenade_throw_l_02 ) offset = (18.614, 19.1907, 15.9741);
		else if ( throwAnim == %ai_militia_corner_standl_grenade ) offset = (19.1753, -18.9954, 49.3355) ;
		else if ( throwAnim == %ai_militia_corner_standr_grenade ) offset = (52.4535, 10.107, 64.2898);
		else if ( throwAnim == %ai_militia_cover_crouch_grenadefireA ) offset = (4.53614, -10.4574, 59.7186);
		else if ( throwAnim == %ai_militia_cover_stand_grenadefireA ) offset = (6.66898, -0.135193, 72.117);
	}
