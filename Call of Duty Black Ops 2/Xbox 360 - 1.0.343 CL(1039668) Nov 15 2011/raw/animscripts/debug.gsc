...
drawDebugInfo(debugLevel)
{
	...
	drawDebugEntText( "(" + self getEntityNumber() + ") : " + self.a.pose + " (" + allowedStancesStr + ") : " + self.a.movement + " : " + self.movemode + " : " + self.goalradius + " : " + self.pathEnemyFightDist, self, level.color_debug["cyan"], "Animscript" );
