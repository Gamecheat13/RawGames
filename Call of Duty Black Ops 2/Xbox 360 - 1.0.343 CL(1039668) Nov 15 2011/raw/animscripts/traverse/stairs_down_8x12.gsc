...
human()
{
	...
	stair_anims[2] =	animArray("staircase_down_8x12_2", movement, false);	// 2 stairs
	stair_anims[4] =	animArray("staircase_down_8x12_4", movement, false);	// 4 stairs
	stair_anims[6] =	animArray("staircase_down_8x12_6", movement, false);	// 6 stairs
	stair_anims[8] =	animArray("staircase_down_8x12_8", movement, false);	// 8 stairs
	stair_anims[10] =	animArray("staircase_down_8x12_10", movement, false);	// 10 stairs
