...
main()
{
	...
	//Print3d(self.origin, "Going to cover",(1.0,0.8,0.5),1,1,60);
...
startCornerApproachConditions( approachPoint, approachType, approachNumber, approachFinalYaw )
{
	...
	if ( self.a.pose != "stand" || ( self.a.movement != "run" && !( self isCQB() ) ) )
	{
...
doLastMinuteExposedApproachConditions( animDist, allowedError )
{
	...
	if( ( !self.faceMotion ) || abs( self getMotionAngle() ) > 45 )
	{
...
startMoveTransitionPreConditions()
{
	...
	{
		if ( isValidEnemy( self.enemy ) && !animscripts\run::ShouldFullSprint() )
		{
...
startMoveTransitionConditions( exitNode, exittype )
{
...
startMoveTransition()
{
	...
	if( !startMoveTransitionConditions( exitNode, exittype ) )
		return;
