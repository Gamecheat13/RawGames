...
//
// WORK IN PROGRESS: No functionality yet, waiting on animations before
// 	integrating IW scripts.

// TODO: Set up vehicle animations
...
main( model, type )
{
	...
	// Everything else
  PrecacheModel( "com_trashbasg" ); 
	
	level.flak88_shell_model = "com_trashbag";
	level.flak88_bomb_model = "com_trashbag";
	level.flak88_bomb_model_obj = "com_trashbag";
...
{	
	//Leader - Officer
	level.scr_anim["leader"]["fire"]			= %ai_88antitank_leader_loadfire;
...
//	self.weapon = self.oldweapon;
	...
	// SCRIPTER_MOD: JesseS (5/8/07): TODO put this back in
