...
/#
	...
	fprintln( file, tab + tab + "<td class=\"header\">Start: </td>" );
...
/#
    ...
    fprintln( file, tab + tab + "<a name=\"gantt\" id=\"gantt\">" + type + " " + "Gantt Chart</a>" );
    fprintln( file, tab + "</h2>" );
...
/#
	...
	fprintln( file, tab + " */" );
	fprintln( file, tab + "div.gantt-empty-begin, div.gantt-empty-end, div.gantt-complete-done, div.gantt-complete-notdone, div.gantt-summary" );
	fprintln( file, tab + "{" );
	...
	fprintln( file, tab + "{" );
	fprintln( file, tab + tab + "background-color: #495f6b;" );
	fprintln( file, tab + tab + "height: 0.75em;" );
	fprintln( file, tab + tab + "margin-top: 0;" );
	fprintln( file, tab + tab + "margin-bottom: 0;" );
	fprintln( file, tab + "}" );
	fprintln( file, tab + "" );
