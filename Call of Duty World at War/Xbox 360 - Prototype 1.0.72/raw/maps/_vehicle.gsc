...
init_vehicles()
{
	...
	level.heli_default_decel = 65; // will likely go back to 10 in the near future
...
trigger_process( trigger, vehicles )
{
	...
	// JesseS (05/08/07): flak88 added
	script_flak88 = 								isdefined( trigger.script_flak88 );
...
vehicle_init( vehicle )
{
 ...
 // 	vehicle thread vehicle_compasshandle();
	...
	// CODE_MOD added funnction to test vehicle usability
