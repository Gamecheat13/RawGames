...
vehicle_80s_sedan1( color )
{
	...
	destructible_create( "vehicle_80s_sedan1_" + color, 300, undefined, 32, "no_melee" );
			...
			destructible_state( undefined, "vehicle_80s_sedan1_" + color + "_destructible_mp", 400, undefined, 32, "no_melee" );
				destructible_fx( "tag_death_fx", "explosions/large_vehicle_explosion", false );
...
//			destructible_sound( "veh_tire_deflate", "bullet" );
		destructible_part( "tag_wheel_front_right", "vehicle_80s_sedan1_" + color + "_wheel_LF", 99, undefined, undefined, "no_melee", undefined, 0.7 );
//			destructible_anim( %vehicle_80s_sedan1_flattire_RF, #animtree, "setanim" );
//			destructible_sound( "veh_tire_deflate", "bullet" );
		destructible_part( "tag_wheel_back_right", "vehicle_80s_sedan1_" + color + "_wheel_LF", 99, undefined, undefined, "no_melee", undefined, 0.7 );
...
//			destructible_sound( "veh_tire_deflate", "bullet" );
		...
		destructible_part( tag, "vehicle_80s_sedan1_glass_F", 99 );
			destructible_state( tag+"_d", "vehicle_80s_sedan1_glass_F_dam", 200 );
		...
		destructible_part( tag, "vehicle_80s_sedan1_glass_B", 99 );
			destructible_state( tag+"_d", "vehicle_80s_sedan1_glass_B_dam", 200 );
			destructible_fx( "tag_glass_back_fx", "props/car_glass_large" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Left Front )
		tag = "tag_glass_left_front";
		destructible_part( tag, "vehicle_80s_sedan1_glass_LF", 99, undefined );
			destructible_state( tag+"_d", "vehicle_80s_sedan1_glass_LF_dam", 200, "vehicle_80s_sedan1_" + color + "_door_LF" );
			destructible_fx( "tag_glass_left_front_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Right Front )
		tag = "tag_glass_right_front";
		destructible_part( tag, "vehicle_80s_sedan1_glass_RF", 99, undefined );
			destructible_state( tag+"_d", "vehicle_80s_sedan1_glass_RF_dam", 200, "vehicle_80s_sedan1_" + color + "_door_RF" );
			destructible_fx( "tag_glass_right_front_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Left Back )
		tag = "tag_glass_left_back";
		destructible_part( tag, "vehicle_80s_sedan1_glass_LB", 99, undefined );
			destructible_state( tag+"_d", "vehicle_80s_sedan1_glass_LB_dam", 200, "vehicle_80s_sedan1_" + color + "_door_LB" );
			destructible_fx( "tag_glass_left_back_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Right Back )
		tag = "tag_glass_right_back";
		destructible_part( tag, "vehicle_80s_sedan1_glass_RB", 99, undefined );
			destructible_state( tag+"_d", "vehicle_80s_sedan1_glass_RB_dam", 200, "vehicle_80s_sedan1_" + color + "_door_RB" );
		...
		// Side Mirrors
		destructible_part( "tag_mirror_left", "vehicle_80s_sedan1_" + color + "_mirror_L", 99, undefined, undefined, undefined, undefined, 1.0 );
...
//			destructible_state( tag, "vehicle_small_hatch_" + color + "_hood_dam" );
		...
		*/
		...
		destructible_part( tag, "vehicle_small_hatch_glass_F", 99 );
			destructible_state( tag+"_d", "vehicle_small_hatch_glass_F_dam", 200 );
			destructible_fx( "tag_glass_front_fx", "props/car_glass_large" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Back )
		...
		destructible_part( tag, "vehicle_small_hatch_glass_B", 99 );
			destructible_state( tag+"_d", "vehicle_small_hatch_glass_B_dam", 200 );
			destructible_fx( "tag_glass_back_fx", "props/car_glass_large" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Left Front )
		...
		destructible_part( tag, "vehicle_small_hatch_glass_LF", 99 );
			destructible_state( tag+"_d", "vehicle_small_hatch_glass_LF_dam", 200 );
			destructible_fx( "tag_glass_left_front_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Right Front )
		...
		destructible_part( tag, "vehicle_small_hatch_glass_RF", 99 );
			destructible_state( tag+"_d", "vehicle_small_hatch_glass_RF_dam", 200 );
			destructible_fx( "tag_glass_right_front_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Left Back )
		...
		destructible_part( tag, "vehicle_small_hatch_glass_LB", 99 );
			destructible_state( tag+"_d", "vehicle_small_hatch_glass_LB_dam", 200 );
			destructible_fx( "tag_glass_left_back_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Right Back )
		...
		destructible_part( tag, "vehicle_small_hatch_glass_RB", 99 );
			destructible_state( tag+"_d", "vehicle_small_hatch_glass_RB_dam", 200 );
			destructible_fx( "tag_glass_right_back_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Head Light ( Left )
		...
		destructible_part( tag, "vehicle_small_hatch_" + color + "_light_LF", 99, undefined, undefined, undefined, 0.5 );
			destructible_fx( tag+"_d", "props/car_glass_headlight" );
			destructible_sound( "veh_glass_break_small" );
		...
		destructible_part( tag, "vehicle_small_hatch_" + color + "_light_LB", 99, undefined, undefined, undefined, 0.5 );
			destructible_fx( tag+"_d", "props/car_glass_brakelight" );
			destructible_sound( "veh_glass_break_small" );
...
//			destructible_state( tag, "vehicle_80s_hatch2_" + color + "_hood_dam" );
		...
		*/
		...
		destructible_part( tag, "vehicle_80s_hatch2_glass_F", 99 );
			destructible_state( tag+"_d", "vehicle_80s_hatch2_glass_F_dam", 200 );
			destructible_fx( "tag_glass_front_fx", "props/car_glass_large" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Back )
		...
		destructible_part( tag, "vehicle_80s_hatch2_glass_B", 99 );
			destructible_state( tag+"_d", "vehicle_80s_hatch2_glass_B_dam", 200 );
			destructible_fx( "tag_glass_back_fx", "props/car_glass_large" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Left Front )
		...
		destructible_part( tag, "vehicle_80s_hatch2_glass_LF", 99 );
			destructible_state( tag+"_d", "vehicle_80s_hatch2_glass_LF_dam", 200 );
			destructible_fx( "tag_glass_left_front_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Right Front )
		...
		destructible_part( tag, "vehicle_80s_hatch2_glass_RF", 99 );
			destructible_state( tag+"_d", "vehicle_80s_hatch2_glass_RF_dam", 200 );
			destructible_fx( "tag_glass_right_front_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Left Back )
		...
		destructible_part( tag, "vehicle_80s_hatch2_glass_LB", 99 );
			destructible_state( tag+"_d", "vehicle_80s_hatch2_glass_LB_dam", 200 );
			destructible_fx( "tag_glass_left_back_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Right Back )
		...
		destructible_part( tag, "vehicle_80s_hatch2_glass_RB", 99 );
			destructible_state( tag+"_d", "vehicle_80s_hatch2_glass_RB_dam", 200 );
			destructible_fx( "tag_glass_right_back_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Head Light ( Left )
