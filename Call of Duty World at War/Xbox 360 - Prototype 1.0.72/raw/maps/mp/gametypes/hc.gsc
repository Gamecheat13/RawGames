...
//	setDvar( "scr_player_numlives", 1 );
	...
	maps\mp\gametypes\_globallogic::registerTimeLimitDvar( "hc", 5, 0, 1440 );
	maps\mp\gametypes\_globallogic::registerScoreLimitDvar( "hc", 250, 0, 5000 );
	maps\mp\gametypes\_globallogic::registerRoundLimitDvar( "hc", 1, 0, 10 );
}
