...
//	setDvar( "scr_player_numlives", 1 );
	...
	maps\mp\gametypes\_globallogic::registerTimeLimitDvar( "thc", 5, 0, 1440 );
	maps\mp\gametypes\_globallogic::registerScoreLimitDvar( "thc", 750, 0, 5000 );
	maps\mp\gametypes\_globallogic::registerRoundLimitDvar( "thc", 1, 0, 10 );
