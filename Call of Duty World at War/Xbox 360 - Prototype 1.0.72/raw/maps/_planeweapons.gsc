...
attach_bombs()
{
	...
	for( i = 0; i < self.bomb_count; i++ )
	{
		...
		if( i == 0 )
		{
			self.bomb[i] LinkTo( self, "tag_smallbomb01" + "Left", ( 0, 0, -4 ), ( -10, 0, 0 ) );
		}
		else if( i == 1 )
		{
			self.bomb[i] LinkTo( self, "tag_smallbomb01" + "Right", ( 0, 0, -4 ), ( -10, 0, 0 ) );
		}
		else if( i == 2 )
		{
			self.bomb[i] LinkTo( self, "tag_smallbomb02" + "Left", ( 0, 0, -4 ), ( -10, 0, 0 ) );
		}
		else if( i == 3 )
		{
			self.bomb[i] LinkTo( self, "tag_smallbomb02" + "Right", ( 0, 0, -4 ), ( -10, 0, 0 ) );
		}
		else
		{
			self.bomb[i] LinkTo( self, "tag_BIGbomb", ( 0, 0, -4 ), ( -10, 0, 0 ) );
		}
	}
}
/*
