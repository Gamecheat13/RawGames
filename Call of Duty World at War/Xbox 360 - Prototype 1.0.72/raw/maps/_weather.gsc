...
{
	// SCRIPTER_MOD
	// JesseS (3/20/2007): changed getent("player","classname") to players[0]
	// TODO: Make player only see hes his FX and not everyone elses
	players = get_players();
...
// SCRIPTER_MOD
// JesseS (3/20/2007): added function so each player can have one
// TODO: All players should be affected differently since they might be in different parts of the map
player_weather_loop()
{
	self endon("death");
...
thunder()
{
	...
	// SCRIPTER_MOD
	// JesseS (3/20/2007): changed level.player to self, we're going to assume this gets threaded
	// on the player at some point
