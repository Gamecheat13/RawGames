...
main(model,type)
{
	...
	switch(model)	
	{
		case "vehicle_american_sherman":
			precachemodel("vehicle_american_sherman");
			precachemodel("vehicle_american_sherman_d");					
			level.vehicle_deathmodel[model] = "vehicle_american_sherman_d";
			break;
	}
