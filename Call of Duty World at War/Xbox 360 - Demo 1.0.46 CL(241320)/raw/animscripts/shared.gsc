...
detachAllWeaponModels()
{
	...
	for ( index = 0; index < positions.size; index++ )
	{
		...
		// Alex Liu 8-28-08 Fix a crash when calling this on an AI with weapon already detached.
		if ( self.weapon == "none" )
			continue;
...
{
	// SCRIPTER_MOD: JesseS (10/7/2007): added since playing anim_loop_solo on a spawned in
