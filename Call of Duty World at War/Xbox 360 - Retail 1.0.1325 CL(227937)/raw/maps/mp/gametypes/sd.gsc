...
onUsePlantObject( player )
{
	...
	if ( !self maps\mp\gametypes\_gameobjects::isFriendlyTeam( player.pers["team"] ) )
	{
		...
		if( isDefined( squadID ) )
			maps\mp\gametypes\_globallogic::leaderDialog( "bomb_planted", player.pers["team"], undefined, undefined, "squad_plant", squadID );
		else
			maps\mp\gametypes\_globallogic::leaderDialog( "bomb_planted", player.pers["team"] );
...
onPickup( player )
{
	...
	if ( !level.bombDefused )
	{
		...
		thread playSoundOnPlayers( "mx_SD_pickup"+"_"+level.teamPrefix[player.pers["team"]] );

		//check if we want to do the squad line
		squadID = getplayersquadid( player );
		if( isDefined( squadID ) )
			maps\mp\gametypes\_globallogic::leaderDialog( "bomb_taken", player.pers["team"], undefined, undefined, "squad_bomb", squadID );
		else
