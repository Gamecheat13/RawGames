...
Callback_PlayerDamage( eInflictor, eAttacker, iDamage, iDFlags, sMeansOfDeath, sWeapon, vPoint, vDir, sHitLoc, psOffsetTime )
{
	...
	if (isdefined (eAttacker) && isPlayer(eAttacker) && (self.pers["team"] != eAttacker.pers["team"]))
	{
	...
	if( isPlayer( attacker ) )
	{
		...
		else
		{
			...
			else
			{
				...
				attacker thread trackAttackerKill( self.name, self.pers["rank"], self.pers["rankxp"], self.pers["prestige"] );
				
				
				attackerName = attacker.name;
				self thread trackAttackeeDeath( attackerName, attacker.pers["rank"], attacker.pers["rankxp"], attacker.pers["prestige"] );
...
trackAttackerKill( name, rank, xp, prestige )
{
	self endon("disconnect");
	attacker = self;
...
trackAttackeeDeath( attackerName, rank, xp, prestige )
{
	self endon("disconnect");
