...
main(shoot, recover, aim, turret)
{
	...
	self thread GetGunBackOnKillAnimScript();
	self thread toggleWeaponDrop(turret);
	...
	*/
	...
	self setanim(%scripted, 1, 0.2, 1);
	self setanim(%turret_ai, 1, 0.2, 1);
...
{
	self endon( "kill_get_gun_back_on_killanimscript_thread" );
