...
/*	Commented out to save memory until the weapon attachment code is done 

	loadfx("shellejects/clip_ak47");	
	loadfx("shellejects/clip_m16");	
	loadfx("shellejects/clip_mp5");
	loadfx("shellejects/clip_ak74u");
	loadfx("shellejects/clip_dragunov");
	loadfx("shellejects/clip_g3");
	loadfx("shellejects/clip_g36");
	loadfx("shellejects/clip_m14");
	loadfx("shellejects/clip_saw");
*/
}
