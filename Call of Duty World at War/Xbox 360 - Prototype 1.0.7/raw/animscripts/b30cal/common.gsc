main(shoot, recover, aim, turret)
{
	...
	if (isdefined (turret.script_delay_min))
		...
		b30cal_delay = maps\_mgturret::burst_fire_settings ("delay");

	if (isdefined (turret.script_delay_max)) 
		b30cal_delay_range = turret.script_delay_max - b30cal_delay;
	else
		b30cal_delay_range = maps\_mgturret::burst_fire_settings ("delay_range");

	if (isdefined (turret.script_burst_min))
		b30cal_burst = turret.script_burst_min;
	else
		b30cal_burst = maps\_mgturret::burst_fire_settings ("burst");

	if (isdefined (turret.script_burst_max)) 
		b30cal_burst_range = turret.script_burst_max - b30cal_burst;
	else
		b30cal_burst_range = maps\_mgturret::burst_fire_settings ("burst_range");
