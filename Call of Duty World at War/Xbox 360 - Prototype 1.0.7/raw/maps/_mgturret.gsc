...
main()
{
	...
	for (i=0;i<other_mg42s.size;i++)
 	...
 	maps\_utility::array_thread(mg42s, ::_spawner_mg42_think);
 	*/
...
{
	spot_types = [];
	spot_types[ "mg42_bipod_stand" ] = 			level.mg_animmg[ "bipod_stand_setup" ];
	spot_types[ "mg42_bipod_stand_distant" ] = 	level.mg_animmg[ "bipod_stand_setup" ];
	spot_types[ "mg42_bipod_duck" ] = 			level.mg_animmg[ "bipod_stand_setup" ];
	spot_types[ "30cal_stand" ] = 				level.mg_animmg[ "bipod_stand_setup" ];
	spot_types[ "mg42_bipod_prone" ] = 			level.mg_animmg[ "bipod_prone_setup" ];
...
run_to_new_spot_and_setup_gun( spot )
{
	...
	spot_types[ "mg42_bipod_duck" ] = 			level.mg_animmg[ "bipod_stand_setup" ];
	spot_types[ "30cal_stand" ] = 				level.mg_animmg[ "bipod_stand_setup" ];
	spot_types[ "mg_bipod_prone" ] = 			level.mg_animmg[ "bipod_prone_setup" ];
