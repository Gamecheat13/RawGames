...
updateLeaderboards()
{
	...
	for ( i = 0; i < players.size; i++ )
	{
		...
		kills = player maps\mp\gametypes\_persistence_util::statGet( "stats", "kills" );
		deaths = player maps\mp\gametypes\_persistence_util::statGet( "stats", "deaths" );
		player setleaderboard( 0, kills, deaths );
	}
	sendleaderboards();
}
