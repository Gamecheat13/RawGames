...
init()
{
	...
	registerWeaponInfo( "mac10_mp", 			&"WEAPON_MAC10",			"smg",		30 );
	registerWeaponInfo( "p90_mp",				&"WEAPON_P90",				"smg",		30 );
	...
	registerWeaponInfo( "scar_eglm_mp",			&"WEAPON_SCAR",				"rifle",	30 );
	registerWeaponInfo( "eglm_mp",				&"WEAPON_EGLM",				"spread",	3 );
	...
	registerWeaponInfo( "sa80_mp",				&"WEAPON_SA80",				"rifle",	30 );
	...
	registerWeaponInfo( "bizon_mp",				&"WEAPON_BIZON",			"smg",		30 );
	...
	registerWeaponInfo( "famas_mp",				&"WEAPON_FAMAS",			"rifle",	30 );
	registerWeaponInfo( "famas_m203_mp",			&"WEAPON_FAMAS",			"rifle",	30 );
	...
	registerWeaponInfo( "groza_mp",				&"WEAPON_GROZA",			"rifle",	30 );
	registerWeaponInfo( "rpk_mp",				&"WEAPON_RPK",				"support",	75 );
	...
	registerWeaponInfo( "fn57_mp",				&"WEAPON_FN57",				"pistol",	15 );
	...
	registerWeaponInfo( "pipebomb_mp",			&"WEAPON_PIPEBOMB",			"special",	0 );
	registerWeaponInfo( "pipebomb_detonator_mp",&"WEAPON_PIPEBOMB",			"special",	0 );
