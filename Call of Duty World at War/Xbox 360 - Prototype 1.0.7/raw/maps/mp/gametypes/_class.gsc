...
init()
{
	...
	level.classWeapons["allies"]["CLASS_CLOSEQUARTERS"][1] = "mac10_mp"; 
	level.classWeapons["allies"]["CLASS_CLOSEQUARTERS"][2] = "p90_mp";
	level.classWeapons["allies"]["CLASS_ASSAULT"][0] = "m16_m203_mp";
	level.classWeapons["allies"]["CLASS_ASSAULT"][1] = "g36c_ag36_mp";
	level.classWeapons["allies"]["CLASS_ASSAULT"][2] = "scar_eglm_mp";
	level.classWeapons["allies"]["CLASS_SNIPER"][0] = "m14_scoped_mp";
	level.classWeapons["allies"]["CLASS_SNIPER"][1] = "m40a3_mp";
	level.classWeapons["allies"]["CLASS_SNIPER"][2] = "barrett_mp";
	level.classWeapons["allies"]["CLASS_ENGINEER"][0] = "winchester1200_mp";
	level.classWeapons["allies"]["CLASS_ENGINEER"][1] = "m1014_mp";
	level.classWeapons["allies"]["CLASS_ANTIARMOR"][0] = "m4_mp";
	level.classWeapons["allies"]["CLASS_ANTIARMOR"][1] = "sa80_mp";
	level.classWeapons["allies"]["CLASS_SUPPORT"][0] = "saw_mp";
	level.classWeapons["allies"]["CLASS_SUPPORT"][1] = "m60e4_mp";
	
	level.classWeapons["axis"]["CLASS_CLOSEQUARTERS"][1] = "skorpion_mp";
	level.classWeapons["axis"]["CLASS_CLOSEQUARTERS"][0] = "mp5_mp"; //"uzi_mp"; // TODO: switch back
	level.classWeapons["axis"]["CLASS_CLOSEQUARTERS"][2] = "bizon_mp";
	level.classWeapons["axis"]["CLASS_ASSAULT"][0] = "ak47_gp25_mp";
	level.classWeapons["axis"]["CLASS_ASSAULT"][1] = "g3_hk79_mp";
	level.classWeapons["axis"]["CLASS_ASSAULT"][2] = "famas_m203_mp";
	level.classWeapons["axis"]["CLASS_SNIPER"][0] = "dragunov_mp";
	level.classWeapons["axis"]["CLASS_SNIPER"][1] = "remington700_mp";
	level.classWeapons["axis"]["CLASS_SNIPER"][2] = "aw50_mp";
	level.classWeapons["axis"]["CLASS_ENGINEER"][0] = "winchester1200_mp";
	level.classWeapons["axis"]["CLASS_ENGINEER"][1] = "m1014_mp";
	level.classWeapons["axis"]["CLASS_ANTIARMOR"][0] = "ak74u_mp";
	level.classWeapons["axis"]["CLASS_ANTIARMOR"][1] = "groza_mp";
	level.classWeapons["axis"]["CLASS_SUPPORT"][0] = "m60e4_mp";
	level.classWeapons["axis"]["CLASS_SUPPORT"][1] = "rpd_mp";
	...
	level.classSidearm["axis"]["CLASS_CLOSEQUARTERS"]	= "usp_mp";
	level.classSidearm["axis"]["CLASS_ASSAULT"]			= "usp_mp";
	level.classSidearm["axis"]["CLASS_SNIPER"]			= "usp_mp";
	level.classSidearm["axis"]["CLASS_ENGINEER"]		= "usp_mp";
	level.classSidearm["axis"]["CLASS_ANTIARMOR"]		= "usp_mp";
	level.classSidearm["axis"]["CLASS_SUPPORT"]			= "usp_mp";
	...
	level.classGrenades["CLASS_CLOSEQUARTERS"]	["secondary"]	["count"]	= 2;
	...
	level.classGrenades["CLASS_SNIPER"]			["secondary"]	["count"]	= 2;
	...
	level.classGrenades["CLASS_ENGINEER"]		["secondary"]	["count"]	= 2;
	...
	level.classGrenades["CLASS_ANTIARMOR"]		["secondary"]	["count"]	= 2;
	...
	level.classItem["allies"]	["CLASS_CLOSEQUARTERS"]["count"]	= 1;
	...
	level.classItem["allies"]	["CLASS_SUPPORT"]["count"]			= 1;
	
	level.classItem["axis"]		["CLASS_CLOSEQUARTERS"]["type"]		= level.weapons["c4"];
	level.classItem["axis"]		["CLASS_CLOSEQUARTERS"]["count"]	= 1;
...
//CODE_MOD: Austin (3/15/07) Reenable when new weapons come online
...
/*
	...
	if ( secondaryWeapon != "" )
	{
		...
		self SetActionSlot( 4, "weapon", secondaryWeapon );
	}
	else
	{
