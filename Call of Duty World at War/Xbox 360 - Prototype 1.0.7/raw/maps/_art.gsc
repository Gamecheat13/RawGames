...
updateDoF()
{
	...
	{
//		if ( within_fov( level.player getEye(), level.player getPlayerAngles(), enemies[index].origin, 0.965 ) )
		if ( within_fov( level.player getEye(), level.player getPlayerAngles(), enemies[index].origin, 0.923 ) ) // 45 degrees
		{
