...
main(model,type)
{
	...
	switch(model)	
	{
		case "vehicle_m1a1_abrams":
			...
			level.vehicle_deathmodel[model] = "vehicle_m1a1_abrams_dmg";
...
//	effects = maps\_vehicle::build_deathfx(effects,deathfx,undefined,"explo_metal_rand");
...
//	level.vehicletypefancy[type] = &"VEHICLENAME_CRUSADER_TANK";
	...
	turrets = maps\_vehicle::build_turret( undefined, "m1a1_coaxial_mg", "tag_coax_mg", "vehicle_m1a1_abrams_PKT_Coaxial_MG", false );
