...
_nextmission()
{
	...
	//CODER _MOD : Sumeet - If this is coop in epd build then we dont want to go back to the main menu, else finishing pel2 in SP should
	// go back to the main menu. 
	if ( ( IsCoopEPD() && !is_coop() ) || ( IsCoopEPD() && IsSplitScreen() ) )
	{
		ChangeLevel("");
		return;
	}
