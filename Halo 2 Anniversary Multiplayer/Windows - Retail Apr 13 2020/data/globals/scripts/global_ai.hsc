...
script static long f_ai_garbage( ai ai_squad, short s_type, real r_distance_min, real r_see_degrees, long l_delay_squad, long l_delay_unit, boolean b_garbage_squad, boolean b_check_player_los, boolean b_check_ai_los )
	...
	thread( sys_ai_garbage(ai_squad, s_type, r_distance_min, r_see_degrees, l_delay_squad, l_delay_unit, b_garbage_squad, b_check_player_los, b_check_ai_los) );
	
end

script static long f_ai_garbage_erase( ai ai_squad, real r_distance_min, real r_see_degrees, long l_delay_squad, long l_delay_unit, boolean b_garbage_squad, boolean b_check_player_los, boolean b_check_ai_los )
	f_ai_garbage( ai_squad, DEF_AI_CLEANUP_TYPE_ERASE(), r_distance_min, r_see_degrees, l_delay_squad, l_delay_unit, b_garbage_squad, b_check_player_los, b_check_ai_los );
end
...
script static long f_ai_garbage_kill( ai ai_squad, real r_distance_min, real r_see_degrees, long l_delay_squad, long l_delay_unit, boolean b_garbage_squad, boolean b_check_player_los, boolean b_check_ai_los )
	f_ai_garbage( ai_squad, DEF_AI_CLEANUP_TYPE_KILL(), r_distance_min, r_see_degrees, l_delay_squad, l_delay_unit, b_garbage_squad, b_check_player_los, b_check_ai_los );
end
script static long f_ai_garbage_kill( ai ai_squad, real r_distance_min, real r_see_degrees, long l_delay_squad, long l_delay_unit, boolean b_garbage_squad )
	f_ai_garbage( ai_squad, DEF_AI_CLEANUP_TYPE_KILL(), r_distance_min, r_see_degrees, l_delay_squad, l_delay_unit, b_garbage_squad, TRUE, TRUE );
end
script static long f_ai_garbage_kill( ai ai_squad, real r_distance_min, real r_see_degrees, long l_delay_squad, long l_delay_unit )
	f_ai_garbage( ai_squad, DEF_AI_CLEANUP_TYPE_KILL(), r_distance_min, r_see_degrees, l_delay_squad, l_delay_unit, FALSE, TRUE, TRUE );
end
script static long f_ai_garbage_kill( ai ai_squad, real r_distance_min, real r_see_degrees )
	f_ai_garbage( ai_squad, DEF_AI_CLEANUP_TYPE_KILL(), r_distance_min, r_see_degrees, -1, -1, FALSE, TRUE, TRUE );
end
script static long f_ai_garbage_kill( ai ai_squad, real r_distance_min )
	f_ai_garbage( ai_squad, DEF_AI_CLEANUP_TYPE_KILL(), r_distance_min, -1.0, -1, -1, FALSE, TRUE, TRUE );
end
script static long f_ai_garbage_kill( ai ai_squad )
	f_ai_garbage( ai_squad, DEF_AI_CLEANUP_TYPE_KILL(), -1.0, -1.0, -1, -1, FALSE, TRUE, TRUE );
end

// === sys_ai_garbage: Manages f_ai_garbage
//			NOTE: DO NOT USE!!!
script static void sys_ai_garbage( ai ai_squad, short s_type, real r_distance_min, real r_see_degrees, long l_delay_squad, long l_delay_unit, boolean b_garbage_squad, boolean b_check_player_los, boolean b_check_ai_los )
...
//			NOTE: DO NOT USE!!!
script static void sys_ai_garbage_objlist( object_list ol_list, short s_type, real r_distance_min, real r_see_degrees, long l_delay_unit, boolean b_check_player_los, boolean b_check_ai_los )
...
local object obj_object = NONE;
	...
	repeat
		...
		if ( (obj_object != NONE) and (object_get_health(obj_object) > 0.0) and (objects_distance_to_object(Players(), obj_object) >= r_distance_min) and ((not b_check_player_los) or (not objects_can_see_object(Players(), obj_object, r_see_degrees))) and ((not b_check_ai_los) or (not objects_can_see_player(obj_object, r_see_degrees))) ) then
...
script static void f_ai_spawn_delay_start( short s_delay )
	...
	// set the timer
	L_ai_spawn_timer = game_tick_get() + s_delay*game_tick_rate_scalar_get();
