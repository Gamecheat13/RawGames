...
--## CLIENT
function PlayInfectionEffect(thePlayer:player)
	effect_new_on_object_marker(TAG('objects\multi\flood\flood_screen\fx_flood_screen.effect'), player_get_unit(thePlayer), "fx_shield_core");
end