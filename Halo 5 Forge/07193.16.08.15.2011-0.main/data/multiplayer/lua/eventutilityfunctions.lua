...
-- Scoring switch for player arcade scoring in MP
...
-- returns all the players that are currently winning
-- if the game is tied, returns nil since nobody is winning
