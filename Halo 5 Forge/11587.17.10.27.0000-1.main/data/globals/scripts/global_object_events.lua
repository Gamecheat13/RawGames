...
function global_object_event_died(deadObject:object, killerObject:object, aiSquad:object, damageModifier:number, damageSource:ui64, damageType:ui64, bucketType:campaign_metagame_bucket_type):void

	CallEvent(g_deathEvent, deadObject, deadObject, killerObject, aiSquad, damageModifier, damageSource, damageType, bucketType);
