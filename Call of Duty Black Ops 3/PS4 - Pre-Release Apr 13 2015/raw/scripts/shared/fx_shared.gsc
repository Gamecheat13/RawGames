...
=============
*/
function create_carry_object( ownerTeam, trigger, visuals, offset, objectiveName )
{
...
function set_picked_up( player )
{
	...
	{
		self.visuals[index] thread hide_object();
	}
...
function destroy_object( deleteTrigger, forceHide )
{
...
function create_pack_object( ownerTeam, trigger, visuals, offset, objectiveName )
{
	...
	packObject.ownerTeam = ownerTeam;
