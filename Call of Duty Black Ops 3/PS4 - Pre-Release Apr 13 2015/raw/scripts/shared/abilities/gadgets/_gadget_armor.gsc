...
function armor_damage_type_multiplier( sMeansOfDeath )
{
    switch(sMeansOfDeath)
    {
        ...
        case "MOD_PROJECTILE":
            return GetDvarFloat( "scr_armor_mod_proj_mult" );
            
        case "MOD_MELEE":
        case "MOD_MELEE_WEAPON_BUTT":
            return GetDvarFloat( "scr_armor_mod_melee_mult" );
            break;
        ...
        case "MOD_GRENADE_SPLASH":
            return GetDvarFloat( "scr_armor_mod_expl_mult" );
            break;
        
        case "MOD_PISTOL_BULLET":
        case "MOD_RIFLE_BULLET":
            return GetDvarFloat( "scr_armor_mod_bullet_mult" );
            break;
        ...
        default:
            return GetDvarFloat( "scr_armor_mod_misc_mult" );
    }
}
...
function armor_player_damage( eInflictor, eAttacker, iDamage, iDFlags, sMeansOfDeath, weapon, vPoint, vDir, sHitLoc, modelIndex, psOffsetTime )
{
	...
	if ( isdefined( self._gadget_armor_slot ) )
	{
