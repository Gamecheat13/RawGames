...
function __init__()
{
	ability_player::register_gadget_activation_callbacks( 33, &gadget_immolation_on, &gadget_immolation_off );
	ability_player::register_gadget_possession_callbacks( 33, &gadget_immolation_on_give, &gadget_immolation_on_take );
	ability_player::register_gadget_flicker_callbacks( 33, &gadget_immolation_on_flicker );
	ability_player::register_gadget_is_inuse_callbacks( 33, &gadget_immolation_is_inuse );
	ability_player::register_gadget_is_flickering_callbacks( 33, &gadget_immolation_is_flickering );
	ability_player::register_gadget_primed_callbacks( 33, &gadget_immolation_is_primed );
