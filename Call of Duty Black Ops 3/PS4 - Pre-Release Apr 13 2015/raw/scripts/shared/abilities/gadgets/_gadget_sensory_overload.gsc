...
function __init__()
{
	ability_player::register_gadget_activation_callbacks( 31, &gadget_sensory_overload_on, &gadget_sensory_overload_off );
	ability_player::register_gadget_possession_callbacks( 31, &gadget_sensory_overload_on_give, &gadget_sensory_overload_on_take );
	ability_player::register_gadget_flicker_callbacks( 31, &gadget_sensory_overload_on_flicker );
	ability_player::register_gadget_is_inuse_callbacks( 31, &gadget_sensory_overload_is_inuse );
	ability_player::register_gadget_is_flickering_callbacks( 31, &gadget_sensory_overload_is_flickering );
	ability_player::register_gadget_primed_callbacks( 31, &gadget_sensory_overload_is_primed );
