...
function coop_damage_and_accuracy_scaling( difficulty_func )
{
	...
	if ( SessionModeIsCampaignGame() )
	{
		setsaveddvar( "player_damageMultiplier", 100 / ( get_player_difficulty_health() * coop_healthscalar) );
	}
	coop_invuln_remover = get_coop_player_death_invulnerable_time_modifier();
	setsaveddvar( "player_deathInvulnerableTime", int( get_player_death_invulnerable_time() * coop_invuln_remover) );
}
...
function getCoopValue( msg, numplayers )
{
	if (numplayers <= 0)
	{
		numplayers = 1;
	...
	assert( IsDefined( level.difficultySettings[ msg ][ GetDvarString( "currentDifficulty" ) ][numplayers - 1] ) );
	return( level.difficultySettings[ msg ][ GetDvarString( "currentDifficulty" ) ][numplayers - 1]);
}
...
// controls player health regeneration and invulnerability time
...
function get_player_threat_bias()
{
	...
	diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].threatbias;
...
function get_health_overlay_cutoff()
{
	...
	diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].healthOverlayCutoff;
...
{
	gameskill::setdiffstructarrays();
	diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].enemyPainChance;
...
{
	gameskill::setdiffstructarrays();
	diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].player_deathInvulnerableTime;
...
{
	gameskill::setdiffstructarrays();
	diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].base_enemy_accuracy;
...
{
	gameskill::setdiffstructarrays();
	diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].playerDifficultyHealth;
...
{
	gameskill::setdiffstructarrays();
	diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].playerHitInvulnTime;
...
{
	gameskill::setdiffstructarrays();
	diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].missTimeConstant;
...
{
	gameskill::setdiffstructarrays();
	diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].missTimeResetDelay;
...
{
	gameskill::setdiffstructarrays();
	diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].missTimeDistanceFactor;
...
{
	gameskill::setdiffstructarrays();
	diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].dog_health;
...
{
	gameskill::setdiffstructarrays();
	diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].dog_presstime;
...
{
	gameskill::setdiffstructarrays();
	diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].dog_hits_before_kill;
...
{
	gameskill::setdiffstructarrays();
	diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].longRegenTime;
...
{
	gameskill::setdiffstructarrays();
	diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].playerHealth_RegularRegenDelay;
...
{
	gameskill::setdiffstructarrays();
	diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].worthyDamageRatio;
...
function get_coop_enemy_accuracy_modifier()
{
	...
	{
		case 1:
			diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].one_player_coopEnemyAccuracyScalar;
		...
		case 2:
			diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].two_player_coopEnemyAccuracyScalar;
		...
		case 3:
			diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].three_player_coopEnemyAccuracyScalar;
		...
		case 4:
			diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].four_player_coopEnemyAccuracyScalar;
...
function get_coop_friendly_accuracy_modifier()
{
	...
	{
		case 1:
			diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].one_player_coopFriendlyAccuracyScalar;
		...
		case 2:
			diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].two_player_coopFriendlyAccuracyScalar;
		...
		case 3:
			diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].three_player_coopFriendlyAccuracyScalar;
		...
		case 4:
			diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].four_player_coopFriendlyAccuracyScalar;
...
function get_coop_friendly_threat_bias_scalar()
{
	...
	{
		case 1:
			diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].one_player_coopFriendlyThreatBiasScalar;
		...
		case 2:
			diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].two_player_coopFriendlyThreatBiasScalar;
		...
		case 3:
			diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].three_player_coopFriendlyThreatBiasScalar;
		...
		case 4:
			diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].four_player_coopFriendlyThreatBiasScalar;
...
function get_coop_player_health_modifier()
{
	...
	{
		case 1:
			diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].one_player_coopPlayerDifficultyHealth;
		...
		case 2:
			diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].two_player_coopPlayerDifficultyHealth;
		...
		case 3:
			diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].three_player_coopPlayerDifficultyHealth;
		...
		case 4:
			diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].four_player_coopPlayerDifficultyHealth;
...
function get_coop_player_death_invulnerable_time_modifier()
{
	...
	{
		case 1:
			diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].one_player_deathInvulnerableTimeModifier;
		...
		case 2:
			diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].two_player_deathInvulnerableTimeModifier;
		...
		case 3:
			diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].three_player_deathInvulnerableTimeModifier;
		...
		case 4:
			diff_struct_value = level.s_game_difficulty[ GetLocalProfileInt( "g_gameskill" ) ].four_player_deathInvulnerableTimeModifier;
