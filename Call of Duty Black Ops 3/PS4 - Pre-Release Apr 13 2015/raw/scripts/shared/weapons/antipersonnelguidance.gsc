...
#namespace singlelockap_guidance;
	...
	//this number corresponds to a code define

function autoexec __init__sytem__() {     system::register("singlelockap_guidance",&__init__,undefined,undefined);    }
...
{
	radius = (self getLockOnLossRadius());	//maintaining lock is slightly larger to avoid edge case of oscillation between lock and nolock
	return target_isincircle( target, self, 65, radius );
}
