...
{
	//fire fx
	level._effect["fire_j_elbow_le_loop"]		= "fire/fx_fire_ai_human_arm_left_loop";	// hand and forearm fires
	level._effect["fire_j_elbow_ri_loop"]		= "fire/fx_fire_ai_human_arm_right_loop";
	level._effect["fire_j_shoulder_le_loop"]	= "fire/fx_fire_ai_human_arm_left_loop";	// upper arm fires
	level._effect["fire_j_shoulder_ri_loop"]		= "fire/fx_fire_ai_human_arm_right_loop";
	level._effect["fire_j_spine4_loop"]		= "fire/fx_fire_ai_human_torso_loop";		// upper torso fires
//	level._effect["fire_j_spinelower_loop"]	= "fire/fx_fire_ai_human_waist_loop";		// lower torso fires
	level._effect["fire_j_hip_le_loop"]		= "fire/fx_fire_ai_human_hip_left_loop";	// thigh fires
	level._effect["fire_j_hip_ri_loop"]		= "fire/fx_fire_ai_human_hip_right_loop";
	level._effect["fire_j_knee_le_loop"]		= "fire/fx_fire_ai_human_leg_left_loop";	// shin fires
	level._effect["fire_j_knee_ri_loop"]				= "fire/fx_fire_ai_human_leg_right_loop";
	level._effect["fire_j_head_loop"] 			= "fire/fx_fire_ai_human_head_loop";		// head fire

	level._effect["fire_j_elbow_le_os"]		= "fire/fx_fire_ai_human_arm_left_os";		// hand and forearm fires
	level._effect["fire_j_elbow_ri_os"]		= "fire/fx_fire_ai_human_arm_right_os";
	level._effect["fire_j_shoulder_le_os"]		= "fire/fx_fire_ai_human_arm_left_os";		// upper arm fires
	level._effect["fire_j_shoulder_ri_os"]		= "fire/fx_fire_ai_human_arm_right_os";
	level._effect["fire_j_spine4_os"]			= "fire/fx_fire_ai_human_torso_os";		// upper torso fires
//	level._effect["fire_j_spinelower_os"]		= "fire/fx_fire_ai_human_waist_os";		// lower torso fires
	level._effect["fire_j_hip_le_os"]			= "fire/fx_fire_ai_human_hip_left_os";		// thigh fire
	level._effect["fire_j_hip_ri_os"]			= "fire/fx_fire_ai_human_hip_right_os";
	level._effect["fire_j_knee_le_os"]			= "fire/fx_fire_ai_human_leg_left_os";		// shin fires
	level._effect["fire_j_knee_ri_os"]				= "fire/fx_fire_ai_human_leg_right_os";
	level._effect["fire_j_head_os"] 			= "fire/fx_fire_ai_human_head_os";			// head fire
	


	// robot-specific fires
	level._effect["fire_j_elbow_le_rot_loop"]		= "fire/fx_fire_ai_robot_arm_left_loop";	// hand and forearm fires
	level._effect["fire_j_elbow_ri_rot_loop"]		= "fire/fx_fire_ai_robot_arm_right_loop";
	level._effect["fire_j_shoulder_le_rot_loop"]	= "fire/fx_fire_ai_robot_arm_left_loop";	// upper arm fires
	level._effect["fire_j_shoulder_ri_rot_loop"]	= "fire/fx_fire_ai_robot_arm_right_loop";
	level._effect["fire_j_spine4_rot_loop"]			= "fire/fx_fire_ai_robot_torso_loop";		// upper torso fires
	level._effect["fire_j_knee_le_rot_loop"]		= "fire/fx_fire_ai_robot_leg_left_loop";	// shin fires
	level._effect["fire_j_knee_ri_rot_loop"]		= "fire/fx_fire_ai_robot_leg_right_loop";
	level._effect["fire_j_head_rot_loop"] 			= "fire/fx_fire_ai_robot_head_loop";		// head fire
//	level._effect["fire_j_spinelower_rot_loop"]		= "fire/fx_fire_ai_robot_torso_loop";		// lower torso fires
	level._effect["fire_j_elbow_le_rot_os"]			= "fire/fx_fire_ai_robot_arm_left_os";	// hand and forearm fires
	level._effect["fire_j_elbow_ri_rot_os"]			= "fire/fx_fire_ai_robot_arm_right_os";
	level._effect["fire_j_shoulder_le_rot_os"]		= "fire/fx_fire_ai_robot_arm_left_os";	// upper arm fires
	level._effect["fire_j_shoulder_ri_rot_os"]		= "fire/fx_fire_ai_robot_arm_right_os";
	level._effect["fire_j_spine4_rot_os"]			= "fire/fx_fire_ai_robot_torso_os";		// upper torso fires
	level._effect["fire_j_knee_le_rot_os"]			= "fire/fx_fire_ai_robot_leg_left_os";	// shin fires
	level._effect["fire_j_knee_ri_rot_os"]			= "fire/fx_fire_ai_robot_leg_right_os";
	level._effect["fire_j_head_rot_os"] 			= "fire/fx_fire_ai_robot_head_os";		// head fire
//	level._effect["fire_j_spinelower_rot_os"]		= "fire/fx_fire_ai_robot_torso_os";		// lower torso fires
}
...
function private _burnBody(localClientNum)
{
	...
	sndEnt = spawnfakeent(0);
	setfakeentorg(0, sndEnt, self.origin);
	playloopsound( 0, sndEnt, "gdt_firefly_burn_loop", .2);
	self thread sndStopBurnLoop(sndEnt);
...
//	stage3BurnTags	= array("j_spine4", "j_spinelower"+boneModifier, "null");
...
function sndStopBurnLoop(sndEnt)
{
	self util::waittill_any_timeout(10, "entityshutdown" );
	if(isDefined(sndEnt))
		DeleteFakeEnt(0,sndEnt);
}
