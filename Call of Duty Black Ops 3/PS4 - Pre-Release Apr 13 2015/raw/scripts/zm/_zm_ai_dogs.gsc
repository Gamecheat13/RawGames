...
function dog_spawn_sumpf_logic( dog_array, favorite_enemy)
{

	assert( dog_array.size > 0, "Dog Spawner array is empty." );
	dog_array = array::randomize( dog_array );
...
//	
function dog_spawn_factory_logic( dog_array, favorite_enemy)
{
	dog_locs = array::randomize( level.enemy_dog_locations );
...
function special_dog_spawn( spawners, num_to_spawn )
{
