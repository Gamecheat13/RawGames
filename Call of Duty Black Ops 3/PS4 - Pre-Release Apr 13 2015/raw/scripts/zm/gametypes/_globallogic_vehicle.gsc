...
{
	// create a class specialty checks; CAC:bulletdamage, CAC:armorvest
	iDamage = 0;//_class::cac_modified_vehicle_damage( self, eAttacker, iDamage, sMeansOfDeath, weapon, eInflictor );
	fInnerDamage = 0;//_class::cac_modified_vehicle_damage( self, eAttacker, fInnerDamage, sMeansOfDeath, weapon, eInflictor );
	fOuterDamage =0;// _class::cac_modified_vehicle_damage( self, eAttacker, fOuterDamage, sMeansOfDeath, weapon, eInflictor );
	self.iDFlags = iDFlags;
	self.iDFlagsTime = getTime();
	...
	//	occupant_team = self _vehicles::vehicle_get_occupant_team();
