...
#precache( "material","waypoint_target_a" );
#precache( "material","waypoint_target_b" );
...
#precache( "material","waypoint_defuse_a" );
#precache( "material","waypoint_defuse_b" );
...
function onSpawnPlayer(predictedSpawn)
{
	...
	spawnPoints = spawnlogic::get_spawnpoint_array( spawnPointName );
	...
	if ( spawnResurrect )
	{
		if ( predictedSpawn )
		{
			self predictSpawnPoint( self.resurrect_origin, self.resurrect_angles );
		}
		else
		{
			self spawn( self.resurrect_origin, self.resurrect_angles );
		}
	}
	else 
	{
...
function giveLastAttackerWarning( team )
{
	...
	self globallogic_audio::leader_dialog_on_player( "last_one" );
...
//		player playSound( "mpl_sd_bomb_plant" );
		...
		globallogic_audio::leader_dialog( "bomb_planted" );
...
function onDrop( player )
{
	if ( !level.bombPlanted )
	{
		globallogic_audio::leader_dialog( "bomb_lost", game["attackers"] );
		/#
		if ( isdefined( player ) )
		 	print( "bomb dropped" );
		else
...
function onPickup( player )
{
	...
	if ( !level.bombDefused )
	{
		...
		globallogic_audio::leader_dialog( "bomb_acquired", game["attackers"] );
		/#print( "bomb taken" );#/
	}		
