...
function main()
{
	...
	globallogic_audio::set_leader_gametype_dialog ( 1, 16, 50, 49 );
...
function giveLastAttackerWarning()
{
	...
	self globallogic_audio::leader_dialog_on_player( 46 );
}
...
//		player playSound( "mpl_sd_bomb_plant" );
		...
		globallogic_audio::leader_dialog( 87 );
	}
	else
	{
		...
		globallogic_audio::leader_dialog( 86 );
	}
}
...
function onDrop( player )
{
	if ( !level.bombPlanted )
	{
		globallogic_audio::leader_dialog( 88, player.pers["team"] );
		/#
		if ( isdefined( player ) )
		 	print( "bomb dropped" );
		 else
...
function onPickup( player )
{
	...
	{			
		...
		globallogic_audio::leader_dialog( 89, player.pers["team"] );
		/#print( "bomb taken" );#/
	}		
