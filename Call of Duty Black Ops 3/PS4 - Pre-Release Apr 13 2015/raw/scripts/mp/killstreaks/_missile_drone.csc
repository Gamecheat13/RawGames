...
{	
	...
	killstreaks::register( "inventory_missile_drone", "inventory_missile_drone", "killstreak_missile_drone", "missile_drone_used",&missile_drone_killstreak, true, undefined, false );
