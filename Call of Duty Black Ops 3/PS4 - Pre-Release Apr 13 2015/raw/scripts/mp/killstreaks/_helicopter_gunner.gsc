...
function init()
{
	killstreaks::register("inventory_minigun", "inventory_minigun", "killstreak_minigun", "minigun_used",&useCarriedKillstreakWeapon, false, true, "MINIGUN_USED", false );
	...
	killstreaks::register("inventory_m32", "inventory_m32", "killstreak_m32", "m32_used",&useCarriedKillstreakWeapon, false, true, "M32_USED", false );
