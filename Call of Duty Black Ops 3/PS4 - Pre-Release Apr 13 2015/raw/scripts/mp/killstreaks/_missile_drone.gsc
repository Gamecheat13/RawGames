...
#precache( "client_fx", "killstreaks/fx_hrpy_swrm_exhaust_trail_close" );
...
function __init__()
{
	level._effect["swarm_tail"] = "killstreaks/fx_hrpy_swrm_exhaust_trail_close";
...
function swarm_start( localClientNum, oldVal, newVal, bNewEnt, bInitialSnap, fieldName, bWasDemoJump )
{
	...
	{
		player thread swarm_think( localClientNum, getmapcenter() );
	}
	else if ( !newVal )
	{
