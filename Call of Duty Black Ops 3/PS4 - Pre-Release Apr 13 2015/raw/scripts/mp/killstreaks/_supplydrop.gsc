...
#precache( "material", "hud_ks_minigun_drop" );
#precache( "material", "hud_ks_m32" );
#precache( "material", "hud_ks_m32_drop" );
#precache( "material", "hud_ks_m202" );
#precache( "material", "hud_ks_m202_drop" );
#precache( "material", "hud_ammo_refill" );
#precache( "material", "hud_ammo_refill_drop" );
#precache( "material", "hud_ks_ai_tank_drop" );
...
#precache( "triggerstring", "KILLSTREAK_STRAFERUN_CRATE" );
#precache( "triggerstring", "PLATFORM_STRAFERUN_GAMBLER" );
...
function init()
{
	level.crateModelFriendly = "veh_t7_mil_carepackage";
	level.crateModelEnemy = "veh_t7_mil_carepackage";	
	level.crateModelHacker = "veh_t7_mil_carepackage";
	level.crateModelTank = "t6_wpn_drop_box";
	level.crateModelBoobyTrapped = "veh_t7_mil_carepackage";
	level.supplyDropHelicopterFriendly = "veh_t6_drone_supply";
	level.supplyDropHelicopterEnemy = "veh_t6_drone_supply_alt";
	level.suppyDropHelicopterVehicleInfo = "vtol_supplydrop_mp";
	level.vtolDropHelicopterFriendly = "veh_t7_mil_vtol_dropship_mp_light";
	level.vtolDropHelicopterEnemy = "veh_t7_mil_vtol_dropship_mp_dark";
	...
	killstreaks::register_dialog("inventory_supply_drop", "mpl_killstreak_supply", 1, undefined, 92, 110, 92 );
	killstreaks::register_alt_weapon("inventory_supply_drop", "mp40_blinged" );
	killstreaks::allow_assists("inventory_supply_drop", true);	
	killstreaks::devgui_scorestreak_command( "inventory_supply_drop", "Random", "set scr_supply_drop_gui random; set scr_inventory_supply_drop_give 1");
	killstreaks::devgui_scorestreak_command( "inventory_supply_drop", "Random Ally Crate", "set scr_supply_drop_gui random; set scr_givetestsupplydrop 1");
	killstreaks::devgui_scorestreak_command( "inventory_supply_drop", "Random Enemy Crate", "set scr_supply_drop_gui random; set scr_givetestsupplydrop 2");
	
	killstreaks::register("supply_drop", "supplydrop", "killstreak_supply_drop", "supply_drop_used",&useKillstreakSupplyDrop, undefined, true, undefined, false );
	...
	killstreaks::register_dialog("supply_drop", "mpl_killstreak_supply", 1, undefined, 92, 110, 92 );
	...
	registerCrateType( "ai_tank_drop", "killstreak", "ai_tank", 1, &"KILLSTREAK_AI_TANK_CRATE", undefined, undefined, &ai_tank::crateLand );
	registerCrateType( "inventory_ai_tank_drop", "killstreak", "ai_tank", 1, &"KILLSTREAK_AI_TANK_CRATE", undefined, undefined, &ai_tank::crateLand );
	
//	registerCrateType( "minigun_drop", "killstreak", "minigun", 1, &"KILLSTREAK_MINIGUN_CRATE", &"PLATFORM_MINIGUN_GAMBLER",&giveCrateWeapon );
//	registerCrateType( "inventory_minigun_drop", "killstreak", "minigun", 1, &"KILLSTREAK_MINIGUN_CRATE", &"PLATFORM_MINIGUN_GAMBLER",,&giveCrateWeapon );
	
//	registerCrateType( "m32_drop", "killstreak", "m32", 1, &"KILLSTREAK_M32_CRATE", &"PLATFORM_M32_GAMBLER", &giveCrateWeapon );
//	registerCrateType( "inventory_m32_drop", "killstreak", "m32", 1, &"KILLSTREAK_M32_CRATE", &"PLATFORM_M32_GAMBLER", &giveCrateWeapon );
	...
	registerCrateType( "supplydrop", "killstreak", "uav", 250, &"KILLSTREAK_RADAR_CRATE", &"PLATFORM_RADAR_GAMBLER", &giveCrateKillstreak );
	registerCrateType( "supplydrop", "killstreak", "rcbomb", 0, &"KILLSTREAK_RCBOMB_CRATE", &"PLATFORM_RCBOMB_GAMBLER", &giveCrateKillstreak );
	registerCrateType( "supplydrop", "killstreak", "counteruav", 225, &"KILLSTREAK_COUNTERU2_CRATE", &"PLATFORM_COUNTERU2_GAMBLER", &giveCrateKillstreak );
	registerCrateType( "supplydrop", "killstreak", "remote_missile", 50, &"KILLSTREAK_REMOTE_MISSILE_CRATE", &"PLATFORM_REMOTE_MISSILE_GAMBLER", &giveCrateKillstreak );
	registerCrateType( "supplydrop", "killstreak", "planemortar", 100, &"KILLSTREAK_PLANE_MORTAR_CRATE", &"PLATFORM_PLANE_MORTAR_GAMBLER", &giveCrateKillstreak );
	registerCrateType( "supplydrop", "killstreak", "autoturret", 75, &"KILLSTREAK_AUTO_TURRET_CRATE", &"PLATFORM_AUTO_TURRET_GAMBLER", &giveCrateKillstreak );
//	registerCrateType( "supplydrop", "killstreak", "microwave_turret", 100, &"KILLSTREAK_MICROWAVE_TURRET_CRATE", &"PLATFORM_MICROWAVE_TURRET_GAMBLER", &giveCrateKillstreak );
	registerCrateType( "supplydrop", "killstreak", "satellite", 25, &"KILLSTREAK_SATELLITE_CRATE", &"PLATFORM_SATELLITE_GAMBLER", &giveCrateKillstreak );
	registerCrateType( "supplydrop", "killstreak", "inventory_ai_tank_drop", 25, &"KILLSTREAK_AI_TANK_CRATE", &"PLATFORM_AI_TANK_GAMBLER", &giveCrateKillstreak );
	registerCrateType( "supplydrop", "killstreak", "helicopter_comlink", 50, &"KILLSTREAK_HELICOPTER_CRATE", &"PLATFORM_HELICOPTER_GAMBLER", &giveCrateKillstreak );
	registerCrateType( "supplydrop", "killstreak", "emp", 25, &"KILLSTREAK_EMP_CRATE", &"PLATFORM_EMP_GAMBLER", &giveCrateKillstreak );
//	registerCrateType( "supplydrop", "killstreak", "helicopter_player_gunner", 2, &"KILLSTREAK_HELICOPTER_GUNNER_CRATE", &"PLATFORM_HELICOPTER_GUNNER_GAMBLER",&giveCrateKillstreak );
	registerCrateType( "supplydrop", "killstreak", "raps", 25, &"KILLSTREAK_RAPS_CRATE", &"PLATFORM_RAPS_GAMBLER", &giveCrateKillstreak );
//	registerCrateType( "supplydrop", "killstreak", "dart", 0, &"KILLSTREAK_DART_CRATE", &"PLATFORM_DART_GAMBLER", &giveCrateKillstreak );
	registerCrateType( "supplydrop", "killstreak", "sentinel", 50, &"KILLSTREAK_SENTINEL_CRATE", &"PLATFORM_SENTINEL_GAMBLER", &giveCrateKillstreak );
	registerCrateType( "supplydrop", "killstreak", "combat_robot", 0, &"KILLSTREAK_COMBAT_ROBOT_CRATE", &"PLATFORM_COMBAT_ROBOT_GAMBLER", &giveCrateKillstreak );
	
	//registerCrateType( "inventory_supplydrop", "ammo", "ammo", 0, &"KILLSTREAK_AMMO_CRATE", &"PLATFORM_AMMO_CRATE_GAMBLER", &giveCrateAmmo );
	registerCrateType( "inventory_supplydrop", "killstreak", "uav", 250, &"KILLSTREAK_RADAR_CRATE", &"PLATFORM_RADAR_GAMBLER", &giveCrateKillstreak );
	registerCrateType( "inventory_supplydrop", "killstreak", "counteruav", 225, &"KILLSTREAK_COUNTERU2_CRATE", &"PLATFORM_COUNTERU2_GAMBLER", &giveCrateKillstreak );
	registerCrateType( "inventory_supplydrop", "killstreak", "rcbomb", 0, &"KILLSTREAK_RCBOMB_CRATE", &"PLATFORM_RCBOMB_GAMBLER", &giveCrateKillstreak );
	registerCrateType( "inventory_supplydrop", "killstreak", "remote_missile", 50, &"KILLSTREAK_REMOTE_MISSILE_CRATE", &"PLATFORM_REMOTE_MISSILE_GAMBLER", &giveCrateKillstreak );
	registerCrateType( "inventory_supplydrop", "killstreak", "planemortar", 100, &"KILLSTREAK_PLANE_MORTAR_CRATE", &"PLATFORM_PLANE_MORTAR_GAMBLER", &giveCrateKillstreak );
	registerCrateType( "inventory_supplydrop", "killstreak", "autoturret", 75, &"KILLSTREAK_AUTO_TURRET_CRATE", &"PLATFORM_AUTO_TURRET_GAMBLER", &giveCrateKillstreak );
//	registerCrateType( "inventory_supplydrop", "killstreak", "microwave_turret", 100, &"KILLSTREAK_MICROWAVE_TURRET_CRATE", &"PLATFORM_MICROWAVE_TURRET_GAMBLER", &giveCrateKillstreak );
	registerCrateType( "inventory_supplydrop", "killstreak", "satellite", 25, &"KILLSTREAK_SATELLITE_CRATE", &"PLATFORM_SATELLITE_GAMBLER", &giveCrateKillstreak );
	registerCrateType( "inventory_supplydrop", "killstreak", "inventory_ai_tank_drop", 25, &"KILLSTREAK_AI_TANK_CRATE", &"PLATFORM_AI_TANK_GAMBLER", &giveCrateKillstreak );
	registerCrateType( "inventory_supplydrop", "killstreak", "helicopter_comlink", 50, &"KILLSTREAK_HELICOPTER_CRATE", &"PLATFORM_HELICOPTER_GAMBLER", &giveCrateKillstreak );
	registerCrateType( "inventory_supplydrop", "killstreak", "emp", 0, &"KILLSTREAK_EMP_CRATE", &"PLATFORM_EMP_GAMBLER", &giveCrateKillstreak );
//	registerCrateType( "inventory_supplydrop", "killstreak", "helicopter_player_gunner", 2, &"KILLSTREAK_HELICOPTER_GUNNER_CRATE", &"PLATFORM_HELICOPTER_GUNNER_GAMBLER", &giveCrateKillstreak );
	registerCrateType( "inventory_supplydrop", "killstreak", "raps", 25, &"KILLSTREAK_RAPS_CRATE", &"PLATFORM_RAPS_GAMBLER", &giveCrateKillstreak );
//	registerCrateType( "inventory_supplydrop", "killstreak", "dart", 0, &"KILLSTREAK_DART_CRATE", &"PLATFORM_DART_GAMBLER", &giveCrateKillstreak );
	registerCrateType( "inventory_supplydrop", "killstreak", "sentinel", 50, &"KILLSTREAK_SENTINEL_CRATE", &"PLATFORM_SENTINEL_GAMBLER", &giveCrateKillstreak );
	registerCrateType( "inventory_supplydrop", "killstreak", "combat_robot", 0, &"KILLSTREAK_COMBAT_ROBOT_CRATE", &"PLATFORM_COMBAT_ROBOT_GAMBLER", &giveCrateKillstreak );
	...
	registerCrateType( "gambler", "killstreak", "uav", 250, &"KILLSTREAK_RADAR_CRATE", undefined, &giveCrateKillstreak );
	registerCrateType( "gambler", "killstreak", "counteruav", 225, &"KILLSTREAK_COUNTERU2_CRATE", undefined, &giveCrateKillstreak );
	registerCrateType( "gambler", "killstreak", "rcbomb", 0, &"KILLSTREAK_RCBOMB_CRATE", undefined, &giveCrateKillstreak );
//	registerCrateType( "gambler", "killstreak", "microwave_turret", 100, &"KILLSTREAK_MICROWAVE_TURRET_CRATE", undefined, &giveCrateKillstreak );
	registerCrateType( "gambler", "killstreak", "remote_missile", 50, &"KILLSTREAK_REMOTE_MISSILE_CRATE", undefined, &giveCrateKillstreak );
	registerCrateType( "gambler", "killstreak", "planemortar", 100, &"KILLSTREAK_PLANE_MORTAR_CRATE", undefined, &giveCrateKillstreak );
	registerCrateType( "gambler", "killstreak", "autoturret", 75, &"KILLSTREAK_AUTO_TURRET_CRATE", undefined, &giveCrateKillstreak );
	registerCrateType( "gambler", "killstreak", "helicopter_guard", 0, &"KILLSTREAK_HELICOPTER_GUARD_CRATE", undefined, &giveCrateKillstreak );
	registerCrateType( "gambler", "killstreak", "satellite", 25, &"KILLSTREAK_SATELLITE_CRATE", undefined, &giveCrateKillstreak );
	registerCrateType( "gambler", "killstreak", "inventory_ai_tank_drop", 25, &"KILLSTREAK_AI_TANK_CRATE", undefined, &giveCrateKillstreak );
	registerCrateType( "gambler", "killstreak", "helicopter_comlink", 50, &"KILLSTREAK_HELICOPTER_CRATE", undefined, &giveCrateKillstreak );
	registerCrateType( "gambler", "killstreak", "emp", 0, &"KILLSTREAK_EMP_CRATE", undefined, &giveCrateKillstreak );
//	registerCrateType( "gambler", "killstreak", "helicopter_player_gunner", 0, &"KILLSTREAK_HELICOPTER_GUNNER_CRATE", undefined, &giveCrateKillstreak );
	registerCrateType( "gambler", "killstreak", "raps", 25, &"KILLSTREAK_RAPS_CRATE", undefined, &giveCrateKillstreak );
//	registerCrateType( "gambler", "killstreak", "dart", 0, &"KILLSTREAK_DART_CRATE", undefined, &giveCrateKillstreak );		
	registerCrateType( "gambler", "killstreak", "sentinel", 50, &"KILLSTREAK_SENTINEL_CRATE", undefined, &giveCrateKillstreak );		
	registerCrateType( "gambler", "killstreak", "combat_robot", 0, &"KILLSTREAK_COMBAT_ROBOT_CRATE", undefined, &giveCrateKillstreak );		
...
/#
	...
	{
		killstreaks::devgui_scorestreak_command( name, "Care Package", "set scr_supply_drop_gui "+ name +"; set scr_inventory_supply_drop_give 1");
	}
#/
}
...
function useSupplyDropMarker( package_contents_id, useVTOL )
{
	//self endon("death");
	...
	self thread supplyDropWatcher( package_contents_id, trigger_event, useVTOL );
	...
	//while( true )
	{
		...
		//if( !isdefined(useVTOL) || (useVTOL && isdefined( level.dogtag_origin )))
			//break;
	}
...
function supplyDropWatcher( package_contents_id, trigger_event, useVTOL )
{
	...
	while( true )
	{
		...
		{
			if( isdefined( useVTOL ) && useVTOL )
			{
				//if( !isdefined( level.dogtag_origin ) )
					//continue;
				
				//self thread heliDeliverCrate( level.dogtag_origin, weapon_instance, self, team, killstreak_id, package_contents_id, useVTOL );
				//self thread heliDeliverCrate( weapon_instance.origin, weapon, self, team, killstreak_id, package_contents_id, useVTOL );
				self thread doSupplyDrop( weapon_instance, weapon, self, killstreak_id, package_contents_id, useVTOL );
...
function doSupplyDrop( weapon_instance, weapon, owner, killstreak_id, package_contents_id, useVTOL )
{
	...
	self thread heliDeliverCrate( weapon_instance.origin, weapon, owner, team, killstreak_id, package_contents_id, useVTOL );
}
...
function dropCrate( origin, angle, category, owner, team, killcamEnt, killstreak_id, package_contents_id, crate )
{
...
function crateTimeOut( time )
{
	...
	wait (time);
/#
	if ( killstreaks::should_not_timeout("inventory_supply_drop" ) ) 
		return;
#/
	self crateDelete( );
}
...
function spawn_helicopter( owner, team, origin, angles, model, targetname, killstreak_id, useVTOL )
{
...
function heliDeliverCrate( origin, weapon, owner, team, killstreak_id, package_contents_id, useVTOL )
{
...
#/
	...
	if ( isdefined( useVTOL ) && useVTOL )
	{
		...
		helicopterFriendly = level.vtolDropHelicopterFriendly;
		helicopterEnemy = level.vtolDropHelicopterEnemy;
	}
	else
	{
		helicopterVehicleInfo = level.suppyDropHelicopterVehicleInfo;
		helicopterFriendly = level.supplyDropHelicopterFriendly;
		helicopterEnemy = level.supplyDropHelicopterEnemy;
	}
	...
	chopper = spawn_helicopter(	owner, 
	                           	...
	                           	helicopterFriendly, 
	                           	killstreak_id, useVTOL );
	
	chopper setenemymodel( helicopterEnemy );
	...
	if( isdefined( useVTOL ) && useVTOL ) // we need callbacks for this
	{
		chopper combat_robot::prolog();
	}
	else
	{
		chopper thread heliDropCrate( weapon.name, owner, rear_hatch_offset_local, killCamEnt, killstreak_id, package_contents_id );
	}
...
function heliDropCrate( category, owner, offset, killCamEnt, killstreak_id, package_contents_id )
{
    ...
    {
    	crate LinkTo( self, "tag_attach", ( 0, 0, 0 ) );
