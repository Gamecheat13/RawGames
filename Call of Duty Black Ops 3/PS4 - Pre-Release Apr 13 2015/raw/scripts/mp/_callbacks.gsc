...
function autoexec __init__sytem__() {     system::register("cameraspike",&__init__,undefined,undefined);    }
	
//TODO - if this comes back, a gsc version needs to get created to register the watcher
//callback::add_weapon_watcher( &createCameraSpikeWatcher );
...
function __init__()
{
	...
	//TODO - needs a server side registry if brining this back
	...
	callback::on_spawned( &playerSpawned );
}
