...
function __init__()
{
	clientfield::register("vehicle", "vehicle_is_firing", 1, 1, "int",&vehicle_is_firing_function, true, !true);
	clientfield::register("helicopter", "vehicle_is_firing", 1, 1, "int",&vehicle_is_firing_function, true, !true);
...
/#	printLn( "^stated aircraft_dustkick" );	#/
	...
	while( isdefined( self ) )
	{
		...
		if ( !IsDefined( self.treadfx ) || !isdefined( self.treadfx[trace["surfacetype"]] ) )
		{
			/#
