...
#using scripts\cp\sidemissions\_sm_type_hvt;
...
{
	o_sm_hvt = new cSideMissionHVT();
	[[o_sm_hvt]]->init();
	[[o_sm_hvt]]->start_objective();
	
	level waittill ( "raid_objective_complete");
