...
function get_spawn_manager_array( targetname )
{
	if ( isdefined( targetname ) )
	{
		...
		{
			if ( ( IsDefined( level.spawn_managers[i].targetname ) && level.spawn_managers[i].targetname == targetname ) || ( IsDefined( level.spawn_managers[i].name ) && level.spawn_managers[i].name == targetname ) )
			{
