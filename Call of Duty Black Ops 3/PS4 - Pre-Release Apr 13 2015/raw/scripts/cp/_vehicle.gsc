...
//#precache( "fx", "_t6/maps/see2/fx_body_blood_splat" );//TODO T7 - contact FX team to get proper replacement
//#precache( "fx", "_t6/vehicle/vfire/fx_tank_sherman_smldr" );//TODO T7 - contact FX team to get proper replacement
//#precache( "fx", "_t6/vehicle/vfire/fx_vfire_med_12" );//TODO T7 - contact FX team to get proper replacement
//#precache( "fx", "_t6/vehicle/vfire/fx_vfire_sherman" );//TODO T7 - contact FX team to get proper replacement
	...
	for( ;; )
	{
		...
		if ( isdefined( entity ) )
		{
			if ( isdefined( entity.targetname ) )
			{
				...
				{
					entity rcbomb::rcbomb_force_explode();
				}
