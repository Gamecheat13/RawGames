...
function firefly_state(localClientNum, oldVal, newVal, bNewEnt, bInitialSnap, fieldName, bWasDemoJump)
{
	...
	switch(newVal)
	{
		...
		break;
		case 4:
			self.fx = PlayFxOnTag(	localClientNum, level._effect["swarm_attack"], self,"tag_origin");
		break;
		case 5:
			self.fx = PlayFxOnTag(	localClientNum, level._effect["swarm_attack_dmg"], self ,"tag_origin");
		break;
		case 6:
		...
		break;
		case 10:
			self.fx = PlayFxOnTag(	localClientNum, level._effect["upgraded_swarm_attack"], self,"tag_origin");
		break;
		case 11:
			self.fx = PlayFxOnTag(	localClientNum, level._effect["upgraded_swarm_attack_dmg"], self ,"tag_origin");
		break;
		case 12:
...
function actor_firefly_state(localClientNum, oldVal, newVal, bNewEnt, bInitialSnap, fieldName, bWasDemoJump)
{
	...
	{
		case 4:
			self.fx = PlayFxOnTag(	localClientNum, level._effect["swarm_attack"], self,"j_neck");
		break;
		case 10:
			self.fx = PlayFxOnTag(	localClientNum, level._effect["upgraded_swarm_attack"], self,"j_neck");
		break;
		case 5:
