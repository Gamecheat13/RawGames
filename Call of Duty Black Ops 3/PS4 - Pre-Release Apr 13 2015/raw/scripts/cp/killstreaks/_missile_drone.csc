...
#precache( "client_fx", "_t6/weapon/missile/fx_missile_drone_light_red" );
...
function __init__()
{
	level._effect["missile_drone_enemy_light"] = "_t6/weapon/missile/fx_missile_drone_light_red";
	level._effect["missile_drone_friendly_light"] = "_t6/weapon/missile/fx_missile_drone_light_red";
