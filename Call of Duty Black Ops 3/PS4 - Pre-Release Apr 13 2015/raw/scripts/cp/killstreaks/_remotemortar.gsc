...
#precache( "fx", "_t6/weapon/remote_mortar/fx_rmt_mortar_laser_loop" );
#precache( "fx", "_t6/weapon/remote_mortar/fx_rmt_mortar_explosion" );

#namespace remotemortar;

function init()
{
	level.remote_mortar_fx["laserTarget"] = "_t6/weapon/remote_mortar/fx_rmt_mortar_laser_loop";
	level.remote_mortar_fx["missileExplode"] = "_t6/weapon/remote_mortar/fx_rmt_mortar_explosion";
	...
	killstreaks::register_dev_dvar( "remote_mortar", "scr_givemortarremote" );
...
{	
	...
	while( true )
	{
		...
		if ( damageTaken >= maxHealth )
		{
			...
			level thread _popups::DisplayTeamMessageToAll( &"KILLSTREAK_DESTROYED_REMOTE_MORTAR", attacker ); 
...
//	self notify( "remote_done" );			
	...
	self thread spyplane::flattenYaw( self.angles[1] + yaw );
