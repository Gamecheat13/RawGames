...
//		iprintlnBold("damageDone");
		...
		if( self.damageTaken > self.maxhealth )
		{
			...
			if ( isSpyPlane )
			{
				level thread _popups::DisplayTeamMessageToAll( &"KILLSTREAK_DESTROYED_UAV", attacker ); 
			...
			{
				level thread _popups::DisplayTeamMessageToAll( &"KILLSTREAK_DESTROYED_COUNTERUAV", attacker ); 				
