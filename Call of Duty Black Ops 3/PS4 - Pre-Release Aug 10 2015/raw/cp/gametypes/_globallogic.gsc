...
{	
	...
	level.playersDrivingVehiclesBecomeInvulnerable = true;
...
function endGame( winner, endReasonText, endImage )
{
	...
	// allow the screen to be fully black, if you don't wait you notice hitching
	wait .3;
...
{
	// This is just delaying the save and quit so it has been commented out
...
function Callback_StartGameType()
{
	...
	if(!isdefined(level.disableClassSelection))level.disableClassSelection=GetGametypeSetting( "disableClassSelection" );  // don't overwite if already set
