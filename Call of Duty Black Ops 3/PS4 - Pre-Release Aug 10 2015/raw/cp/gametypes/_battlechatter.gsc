...
function __init__()
{
	...
	//array::run_all( aiSpawnerArray, &spawner::add_spawn_function, &on_joined_ai );
	...
	while (1)
	{
		...
		{					
			...
			case "concussiveReact":
			{
				if( !(isdefined(self.archetype) && ( self.archetype == "robot" )) )
				{
					level thread bc_MakeLine( self, "exert_cough", undefined, undefined, true );
				}
				break;
			}
			case "pukeStart":
			case "electrocute":
			{
				if( !(isdefined(self.archetype) && ( self.archetype == "robot" )) )
				{
					level thread bc_MakeLine( self, "exert_electrocution", undefined, undefined, true );
				}
				break;
			}
			case "puke":
			{
				if( !(isdefined(self.archetype) && ( self.archetype == "robot" )) )
				{
					level thread bc_MakeLine( self, "exert_vomit", undefined, undefined, true );
				}
				break;
			}
			case "scream":
			...
			case "fireflyAttack":
			{
				level thread bc_MakeLine( self, "exert_firefly", undefined, undefined, true );
				break;
			}
			case "fireflyAttackUpg":
			{
				level thread bc_MakeLine( self, "exert_firefly_burning", undefined, undefined, true );
				break;
			}
			case "rapidstrike":
			{
			...
			{
				level thread bc_MakeLine( self, "exert_charge", undefined, undefined, true );
				break;
			}
			case "reactImmolationLong":
			{
				level thread bc_MakeLine( self, "exert_immolation", undefined, undefined, true );
				break;
			}
			case "reactSensory":
			{
				level thread bc_MakeLine( self, "exert_screaming", undefined, undefined, true );
				break;
			}
			case "weaponmalfunction":
			{
				level thread bc_MakeLine( self, "exert_malfunction", undefined, undefined, true );
				break;
			}
			case "reactExosuit":
			{
				level thread bc_MakeLine( self, "exert_breakdown", undefined, undefined, true );
				break;
			}
			case "reactMisdirection":
			{
				level thread bc_MakeLine( self, "exert_misdirection", undefined, undefined, true );
				break;
			}
			case "reactBodyBlow":
			{
				level thread bc_MakeLine( self, "exert_body_blow", undefined, undefined, true );
				break;
			}					
			default:
			{
...
function bc_RobotBehindVox()
{
	...
	while(1)
	{
		...
		foreach( robot in level._bc_robotBehindArray )
		{
			...
			if( distancesquared( robot.origin, self.origin ) < 300*300 )
			{
...
/@
Name: bc_allow( <b_allow>, [str_category] = "bc" )
Summary: Turns on or off battlechatter.
Module: BattleChatter
MandatoryArg: <b_allow>: Boolean
OptionalArg: [str_category]: the category of battlechatter - default is "bc"
Example: bc_allow( true );
SPMP: server
@/
function bc_allow( b_allow, str_category = "bc" )
{
	Assert( isdefined( b_allow ), "b_allow is a madatory argument for bc_allow()" );
