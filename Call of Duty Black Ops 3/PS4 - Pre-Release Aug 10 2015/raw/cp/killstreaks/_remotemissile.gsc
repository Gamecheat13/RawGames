...
#precache( "fx", "_t6/weapon/predator/fx_predator_cluster_trigger" );
...
function init()
{
	...
	killstreaks::register_dialog( "remote_missile", "mpl_killstreak_cruisemissile", "kls_predator_used", "", "", "", "kls_predator_ready" );
	killstreaks::register_dev_dvar( "remote_missile", "scr_givemissileremote" );
	...
	level.missileRemoteDeployFX = "_t6/weapon/predator/fx_predator_cluster_trigger";
...
function _fire( lifeId, player, team, killstreak_id )
{
	...
	rocket spawning::create_entity_enemy_influencer( "small_vehicle" );
