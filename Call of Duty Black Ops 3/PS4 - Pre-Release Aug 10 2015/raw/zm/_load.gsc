...
function register_clientfields()
{
	...
	clientfield::register( "clientuimodel", "zmhud.swordEnergy", 1, 7, "float" ); // energy: 0 to 1
	clientfield::register( "clientuimodel", "zmhud.swordState", 1, 2, "int" ); // state: 0 = hidden, 1 = charging, 2 = ready, 3 = inuse, 4 = unavailable (grey)
