...
function autoexec __init__sytem__() {     system::register("zm_bgb_licensed_contractor",&__init__,undefined,"bgb");    }
...
function activation()
{
	...
	level thread zm_powerups::specific_powerup_drop( "carpenter", powerup_origin );
