...
function autoexec __init__sytem__() {     system::register("zm_bgb_kill_joy",&__init__,undefined,"bgb");    }
...
function activation()
{
	...
	level thread zm_powerups::specific_powerup_drop( "insta_kill", powerup_origin );
