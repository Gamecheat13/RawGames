...
function autoexec __init__sytem__() {     system::register("zm_bgb_dead_of_nuclear_winter",&__init__,undefined,"bgb");    }
...
function activation()
{
	...
	level thread zm_powerups::specific_powerup_drop( "nuke", powerup_origin );
