...
function autoexec __init__sytem__() {     system::register("zm_bgb_on_the_house",&__init__,undefined,"bgb");    }
...
function activation()
{
	...
	level thread zm_powerups::specific_powerup_drop( "free_perk", powerup_origin );
