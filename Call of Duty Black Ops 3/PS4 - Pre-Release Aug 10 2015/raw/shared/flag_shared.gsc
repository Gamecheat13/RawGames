...
function init( str_flag, b_val = false, b_is_trigger = false )
{
	...
	if ( b_is_trigger )	// TODO: this block should probably not be here, instead make sure it's actually needed and maybe move into the "trigger" namespace.
	{
...
/@
"Name: set_val( <str_flag>, <b_val> )"
"Summary: Sets the specified flag to the boolean value"
"Module: Flag"
"CallOn: "
"MandatoryArg: <str_flag> : name of the str_flag to set"
"MandatoryArg: <b_val> : value to set"
