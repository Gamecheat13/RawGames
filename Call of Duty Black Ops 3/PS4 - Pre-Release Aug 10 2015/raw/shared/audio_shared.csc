...
{
	clientfield::register( "world", "sndMatchSnapshot", 1, 2, "int", &audio::sndMatchSnapshot, true, !true );
	...
	clientfield::register( "toplayer", "sndCCHacking", 1, 1, "int", &audio::sndCChacking, true, true );
	clientfield::register( "world", "sndIGCsnapshot", 1, 2, "int", &audio::sndIGCsnapshot, true, !true );
}
...
function snd_snapshot_init()
{
	...
	{
		level._sndActiveSnapshot = "zmb_game_start";
		level._sndNextSnapshot = "zmb_game_start";
	}
...
// 1 = PreMatch
function sndMatchSnapshot(localClientNum, oldVal, newVal, bNewEnt, bInitialSnap, fieldName, bWasDemoJump)
{
	if( newVal )
	{
		switch( newVal )
...
function sndCChacking(localClientNum, oldVal, newVal, bNewEnt, bInitialSnap, fieldName, bWasDemoJump)
{
	if( newVal )
	{
...
function sndIGCsnapshot(localClientNum, oldVal, newVal, bNewEnt, bInitialSnap, fieldName, bWasDemoJump)
{
	if( newVal )
	{
		switch( newVal )
