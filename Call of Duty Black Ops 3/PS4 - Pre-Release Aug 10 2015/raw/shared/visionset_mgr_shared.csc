...
function register_overlay_info_style_speed_blur( name, version, lerp_step_count, amount, inner_radius, outer_radius, velocity_should_scale, velocity_scale, blur_in, blur_out )
{
	if ( !register_info( "overlay", name, version, lerp_step_count ) )
	{
		return;
...
#/
	...
	if( player getinkillcam( localClientNum ) )
	{
		...
		if( isdefined( curr_info.visionset_to ) && ( curr_info.visionset_to == "mp_vehicles_mothership" ) )
		{
