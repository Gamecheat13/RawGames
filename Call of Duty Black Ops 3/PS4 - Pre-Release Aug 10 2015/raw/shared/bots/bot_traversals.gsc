...
*/
	...
	self thread wait_traversal_abort();
}
...
function soft_fall_traversal( start, end )
{
	...
	self PressJumpButton();	// For hopping over barriers at the beginning
...
function wait_traversal_abort()
{
	...
	if ( isdefined( level.bot_traversal_abort ) )
	{
		self [[ level.bot_traversal_abort]]();
	}
}
