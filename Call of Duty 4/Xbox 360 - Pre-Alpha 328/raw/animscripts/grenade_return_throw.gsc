...
main()
{
	...
	{
		// really short range
		animArray[0] = %grenade_return_running_kick_forward_1;
		animArray[1] = %grenade_return_running_kick_forward_2;
		animArray[2] = %grenade_return_running_throw_forward;
	}
	else if ( throwDist < 650 )
	{
		// short range
		animArray[0] = %grenade_return_running_kick_forward_2;
		animArray[1] = %grenade_return_running_throw_forward;
		animArray[2] = %grenade_return_standing_throw_forward_1;
		animArray[3] = %grenade_return_standing_throw_forward_2;
	}
