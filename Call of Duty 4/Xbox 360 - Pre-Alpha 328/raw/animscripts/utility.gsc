...
initialize( animscript )
{
	...
	{
		assertex( animscript == "pain" || animscript == "death", animscript );
		if ( animscript != "pain" )
		{
	...
	/#
	if ( isdefined( self.a.mayOnlyDie ) )
		assertex( animscript == "death", animscript );
	#/
	...
	if ( isDefined( self.isHoldingGrenade ) && (animscript == "pain" || animscript == "death") )
	{
		self dropGrenade();
	}
