...
precacheClipFx()
{
	...
	if ( getdvar( "scr_generateClipModels" ) != "" && getdvar( "scr_generateClipModels" ) != "0" )
	{
		...
		for ( i = 0; i < spawners.size; i++ )
		{
			...
			weapons[ weapons.size ] = fakeai.primaryWeapon;
			weapons[ weapons.size ] = fakeai.secondaryWeapon;
			weapons[ weapons.size ] = fakeai.sidearm;
		...
		for ( i = 0; i < ai.size; i++ )
		{
			weapons[ weapons.size ] = ai[i].primaryWeapon;
			weapons[ weapons.size ] = ai[i].secondaryWeapon;
			weapons[ weapons.size ] = ai[i].sidearm;
		}
