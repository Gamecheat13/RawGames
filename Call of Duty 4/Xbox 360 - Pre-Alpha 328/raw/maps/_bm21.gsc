...
main( model, type )
{
	...
	build_deathfx( "explosions/vehicle_explosion_bm21_tires", "tag_deathfx",		undefined,							undefined,			undefined,		undefined,		0 );
	...
	build_deathfx( "explosions/grenadeexp_default",			"tag_missile18",		"explo_metal_rand",					undefined,			undefined,		undefined,		1 );
	build_deathfx( "explosions/grenadeexp_default",			"tag_missile19",		"explo_metal_rand",					undefined,			undefined,		undefined,		1.3 );
	build_deathfx( "explosions/grenadeexp_default",			"tag_missile14",		"explo_metal_rand",					undefined,			undefined,		undefined,		1.8 );
	build_deathfx( "explosions/grenadeexp_default",			"tag_flash",			"explo_metal_rand",					undefined,			undefined,		undefined,		2.4 );
//	build_deathfx( "explosions/helicopter_explosion",		undefined,				"car_explode",						undefined,			undefined,		undefined,		3.5 );
	build_deathfx( "explosions/vehicle_explosion_bm21",		"tag_deathfx",			"car_explode",						undefined,			undefined,		undefined,		3.5 );
	build_deathfx( "fire/firelp_med_pm",					"tag_fx_tire_right_r",	"smallfire",						undefined,			undefined,		true,			3.6 );
	build_deathfx( "fire/firelp_med_pm",					"tag_flash",			undefined,							undefined,			undefined,		true,			3.6 );
