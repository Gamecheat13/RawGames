...
// ***********************************************************
	...
	set_reverb_drylevel( "bunker", 		0.9 );
	...
	set_reverb_wetlevel( "exterior2", 		0.3 );
	...
	set_reverb_wetlevel( "exterior3", 		0.3 );
	...
	set_reverb_wetlevel( "exterior4", 		0.3 );
	...
	set_reverb_drylevel( "hangar", 		0.9 );
	set_reverb_wetlevel( "hangar", 		0.4 );
	...
	set_reverb_drylevel( "interior", 		0.7 );
	set_reverb_wetlevel( "interior", 		0.7 );
	...
	set_reverb_wetlevel( "interior_metal", 	0.1 );
	...
	set_reverb_drylevel( "tunnel", 		0.9 );
...
//	add_channel_to_filter( "ac130", 		"effects1" );
	...
	set_filter_freq( "interior_vehicle", 0, 	3500 );
	set_filter_gain( "interior_vehicle", 0, 	-6 );
