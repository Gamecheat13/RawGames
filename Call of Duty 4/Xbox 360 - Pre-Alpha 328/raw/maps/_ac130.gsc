...
overlay()
{
	...
	level.hud_weapon_text[ 0 ] = newHudElem();
	level.hud_weapon_text[ 0 ].x = 0;
	level.hud_weapon_text[ 0 ].y = 0;
	level.hud_weapon_text[ 0 ].alignX = "left";
	level.hud_weapon_text[ 0 ].alignY = "bottom";
	level.hud_weapon_text[ 0 ].horzAlign = "left";
	level.hud_weapon_text[ 0 ].vertAlign = "bottom";
	level.hud_weapon_text[ 0 ].fontScale = 2.5;
	level.hud_weapon_text[ 0 ] settext ( &"AC130_HUD_WEAPON_105MM" );
	level.hud_weapon_text[ 0 ].alpha = 1.0;
	
	level.hud_weapon_text[ 1 ] = newHudElem();
	level.hud_weapon_text[ 1 ].x = 0;
	level.hud_weapon_text[ 1 ].y = -30;
	level.hud_weapon_text[ 1 ].alignX = "left";
	level.hud_weapon_text[ 1 ].alignY = "bottom";
	level.hud_weapon_text[ 1 ].horzAlign = "left";
	level.hud_weapon_text[ 1 ].vertAlign = "bottom";
	level.hud_weapon_text[ 1 ].fontScale = 2.5;
	level.hud_weapon_text[ 1 ] settext ( &"AC130_HUD_WEAPON_40MM" );
	level.hud_weapon_text[ 1 ].alpha = 1.0;
	
	level.hud_weapon_text[ 2 ] = newHudElem();
	level.hud_weapon_text[ 2 ].x = 0;
	level.hud_weapon_text[ 2 ].y = -60;
	level.hud_weapon_text[ 2 ].alignX = "left";
	level.hud_weapon_text[ 2 ].alignY = "bottom";
	level.hud_weapon_text[ 2 ].horzAlign = "left";
	level.hud_weapon_text[ 2 ].vertAlign = "bottom";
	level.hud_weapon_text[ 2 ].fontScale = 2.5;
	level.hud_weapon_text[ 2 ] settext ( &"AC130_HUD_WEAPON_25MM" );
	level.hud_weapon_text[ 2 ].alpha = 1.0;
	
	thread hud_timer();
	thread overlay_coords();
	thread blink_hud_elem( 0 );
	
	if ( getdvar( "ac130_post_effects_enabled") == "1" )
	{
		grain = newHudElem();
		grain.x = 0;
		grain.y = 0;
...
changeWeapons()
{
	...
	for(;;)
	{
		...
		thread blink_crosshairs( weapon[ currentWeapon ].weapon );
...
blink_hud_elem( curentWeapon )
{
	...
	for( i = 0 ; i < level.hud_weapon_text.size ; i++ )
		level.hud_weapon_text[ i ].alpha = 0.5;
	
	level.hud_weapon_text[ curentWeapon ].alpha = 1;
	for(;;)
	{
		level.hud_weapon_text[ curentWeapon ] fadeOverTime( 0.2 );
		level.hud_weapon_text[ curentWeapon ].alpha = 0;
		wait 0.2;
...
blink_crosshairs( weaponName )
{
	...
	for(;;)
	{
		level.ac130_overlay fadeOverTime( 0.3 );
		level.ac130_overlay.alpha = 0;
		wait 0.3;
