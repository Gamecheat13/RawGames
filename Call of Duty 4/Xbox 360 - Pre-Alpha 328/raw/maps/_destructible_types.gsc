...
makeType( destructibleType )
{
	...
	switch( destructibleType )
	{
		...
		case "vehicle_bm21_mobile_bed":
			vehicle_bm21_mobile_bed( destructibleType );
			break;
...
vehicle_tanker_truck( destructibleType )
{
	...
	destructible_create( destructibleType, 600, undefined, 32, "no_melee" );
			destructible_state( undefined, "vehicle_tanker_truck_static_low", 800, "no_ai", 32, "no_melee" );
				destructible_fx( undefined, "explosions/javelin_explosion" );
				destructible_sound( "building_explosion3" );
...
vehicle_bm21_mobile_bed( destructibleType )
{
	destructible_create( "vehicle_bm21_mobile_bed", 1500, undefined, 32, "no_melee" );
			destructible_state( undefined, "vehicle_bm21_mobile_bed_destructible", 100, "player_only", 32, "no_melee" );
...
vehicle_uaz_fabric( destructibleType )
{
	destructible_create( "vehicle_uaz_fabric", 1500, undefined, 32, "no_melee" );
...
vehicle_uaz_open_for_ride( destructibleType )
{
	...
	// small wagon
	//---------------------------------------------------------------------
	destructible_create( "vehicle_uaz_open_for_ride", 1500, undefined, 32, "no_melee" );
			destructible_state( undefined, "vehicle_uaz_open_destructible", 100, "player_only", 32, "no_melee" );
				destructible_fx( "tag_origin", "explosions/small_vehicle_explosion", false );
				destructible_sound( "car_explode" );
				destructible_explode( 4000, 5000, 250, 150, 300 ); 	// force_min, force_max, range, mindamage, maxdamage
