...
setanims ()
{
	...
	positions[ 0 ].idle = %ch46_unload_1;
	positions[ 1 ].idle = %ch46_unload_1; //these guys don't have an idle animation so I'm using copilot.
	positions[ 2 ].idle = %ch46_unload_1; //these guys don't have an idle animation so I'm using copilot.
	positions[ 3 ].idle = %ch46_unload_1; //these guys don't have an idle animation so I'm using copilot.
	positions[ 4 ].idle = %ch46_unload_1; //these guys don't have an idle animation so I'm using copilot.
	positions[ 5 ].idle = %ch46_unload_1;

	positions[ 0 ].hideidle = true;
	positions[ 1 ].hideidle = true;
	positions[ 2 ].hideidle = true;
	positions[ 3 ].hideidle = true;
	positions[ 4 ].hideidle = true;
	positions[ 5 ].hideidle = true;
