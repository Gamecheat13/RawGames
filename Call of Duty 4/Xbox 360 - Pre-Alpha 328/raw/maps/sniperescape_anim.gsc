...
*/
	...
	level.scr_sound[ "price" ][ "transport_sighted" ] = "sniperescape_mcm_enemysighted";

	//* Now get on the Barrett rifle and wait for my signal. Do not engage until I give the word.
	level.scr_sound[ "price" ][ "get_on_barrett" ] = "sniperescape_mcm_getonrifle";
	...
	level.scr_sound[ "price" ][ "remember_my_teaching" ] = "sniperescape_mcm_corioliseffect";

	//* Prepare for ranging. Standby.
	level.scr_sound[ "price" ][ "prepare_for_ranging" ] = "sniperescape_mcm_prepranging";

	//* White truck on the left, range, 1203.5 meters.
	level.scr_sound[ "price" ][ "white_truck" ] = "sniperescape_mcm_whitetruck";

	//* Range to BMP, 1207 meters.
	level.scr_sound[ "price" ][ "range_to_bmp" ] = "sniperescape_mcm_bmprange";

	//* The table with the briefcase, range, 1206 meters.
	level.scr_sound[ "price" ][ "table_with_case" ] = "sniperescape_mcm_table";

	//* Ok... I think I see him. Wait for my mark.
	level.scr_sound[ "price" ][ "i_see_him" ] = "sniperescape_mcm_mymark";

	//* Target...acquired. I have a positive I.D. on Imran Zakhaev.
	level.scr_sound[ "price" ][ "target_acquired" ] = "sniperescape_mcm_positiveid";

	//* Ach, where did he come from? Patience laddie... Wait for a clear shot�.
	level.scr_sound[ "price" ][ "where_did_he_come_from" ] = "sniperescape_mcm_clearshot";

	//* Wait - the wind's picked up. Let it die down before you take the shot. Don稚 rush it.
	level.scr_sound[ "price" ][ "wind_picked_up" ] = "sniperescape_mcm_windspickedup";

	//* Ok take the shot.
	level.scr_sound[ "price" ][ "take_the_shot" ] = "sniperescape_mcm_taketheshot";

	// Damn, my line of sight was blocked. Did you take him out? I thought I saw his arm fly off! Can you see him?
	level.scr_sound[ "price" ][ "did_you_take_him_out" ] = "sniperescape_mcm_armflyoff";

	// Shit... they池e on to us! Take out that helicopter, it値l buy us some time!
	level.scr_sound[ "price" ][ "take_out_that_heli" ] = "sniperescape_mcm_buysometime";

	// Great shot Leftenant! Now let's go! They'll be searching for us!
	level.scr_sound[ "price" ][ "great_shot_now_go" ] = "sniperescape_mcm_greatshot";
...
script_models()
{
	...
	level.scr_anim[ "curtain" ][ "curtain_right" ][ 0 ]			= %chechnya_curtain_sway_le;
	level.scr_anim[ "curtain" ][ "curtain_left" ][ 0 ]			= %chechnya_curtain_sway_ri;
