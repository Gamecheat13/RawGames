...
//	flag_init( "laundrymat_open" );
	...
	flag_init( "javelin_briefing_begins" );
	...
	// moving this down until we can compile the map again
	auto3556 = getent( "auto3556", "targetname" );
	auto3556.origin = ( 6099.2, 833.3, 19.0769 );
...
//	flag_wait( "price_in_alley_position" );
	flag_wait( "javelin_briefing_begins" );
...
bridge_attackers_attack_javelin_guy()
{
	...
	level.javelin_guy waittill_notify_or_timeout( "death", 0.5 );
	level.javelin_guy dodamage( level.javelin_guy.health + 150, (0,0,0) );
...
//	price_circle_node thread price_responds_to_overpass();
	...
	wait( 15 );
	flag_set( "javelin_briefing_begins" );
