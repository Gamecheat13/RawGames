...
//	addNotetrack_sound( "steve", "anim_pose = \"stand\"" ,"hunted_woundedhostage_check_soldier", "hunted_gm1_outcold" );
	...
	addNotetrack_dialogue( "leader", "dialog" ,"hunted_farmsequence", "hunted_ru2_yougotanimals" );
	...
	addNotetrack_dialogue( "farmer", "dialog" ,"hunted_farmsequence", "hunted_ruf_american" );
	...
	level.scr_sound[ "charlie" ][ "hunted_celebrate" ] ="hunted_sas2_showoffs";
...
//	addNotetrack_sound( "price", "dialog", ,"", "" );
	...
	// flight
	level.scr_sound[ "price" ][ "incomingmissile" ] =	"hunted_pri_incomingmissile";
...
//	level.scr_sound[ "steve" ][ "outcold" ] =				"hunted_gm1_outcold";
	...
	level.scr_sound[ "charlie" ][ "areaclear" ] =			"hunted_uk2_areaclear";
	...
	// farm
	level.scr_sound[ "charlie" ][ "helicoptersgone" ] =		"hunted_sas2_helicoptersgone";
