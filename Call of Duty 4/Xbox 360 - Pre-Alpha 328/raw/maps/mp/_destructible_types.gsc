...
vehicle_80s_sedan1( color )
{
	...
	// 80's Sedan
	//---------------------------------------------------------------------
	destructible_create( "vehicle_80s_sedan1_" + color, 550, undefined, 32, "no_melee" );
...
vehicle_80s_wagon1( color )
{
	...
	// 80's wagon
	//---------------------------------------------------------------------
	destructible_create( "vehicle_80s_wagon1_" + color, 550, undefined, 32, "no_melee" );
				destructible_loopfx( "tag_hood_fx", "smoke/car_damage_whitesmoke", 0.4 );
...
//			destructible_state( tag, "vehicle_80s_wagon1_" + color + "_hood_dam" );
		...
		*/
		...
		destructible_part( tag, "vehicle_80s_wagon1_glass_F", 99 );
			destructible_state( tag+"_d", "vehicle_80s_wagon1_glass_F_dam", 200 );
			destructible_fx( "tag_glass_front_fx", "props/car_glass_large" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Back )
		...
		destructible_part( tag, "vehicle_80s_wagon1_glass_B", 99 );
			destructible_state( tag+"_d", "vehicle_80s_wagon1_glass_B_dam", 200 );
			destructible_fx( "tag_glass_back_fx", "props/car_glass_large" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Left Front )
		...
		destructible_part( tag, "vehicle_80s_wagon1_glass_LF", 99 );
			destructible_state( tag+"_d", "vehicle_80s_wagon1_glass_LF_dam", 200 );
			destructible_fx( "tag_glass_left_front_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Right Front )
		...
		destructible_part( tag, "vehicle_80s_wagon1_glass_RF", 99 );
			destructible_state( tag+"_d", "vehicle_80s_wagon1_glass_RF_dam", 200 );
			destructible_fx( "tag_glass_right_front_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Left Back )
		...
		destructible_part( tag, "vehicle_80s_wagon1_glass_LB", 99 );
			destructible_state( tag+"_d", "vehicle_80s_wagon1_glass_LB_dam", 200 );
			destructible_fx( "tag_glass_left_back_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Right Back )
		...
		destructible_part( tag, "vehicle_80s_wagon1_glass_RB", 99 );
			destructible_state( tag+"_d", "vehicle_80s_wagon1_glass_RB_dam", 200 );
			destructible_fx( "tag_glass_right_back_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Left Back 2 )
		...
		destructible_part( tag, "vehicle_80s_wagon1_glass_LB2", 99 );
			destructible_state( tag+"_d", "vehicle_80s_wagon1_glass_LB2_dam", 200 );
		...
		destructible_part( tag, "vehicle_80s_wagon1_glass_RB2", 99 );
			destructible_state( tag+"_d", "vehicle_80s_wagon1_glass_RB2_dam", 200 );
...
vehicle_80s_hatch1( color )
{
	...
	// 80's hatchback
	//---------------------------------------------------------------------
	destructible_create( "vehicle_80s_hatch1_" + color, 550, undefined, 32, "no_melee" );
				destructible_loopfx( "tag_hood_fx", "smoke/car_damage_whitesmoke", 0.4 );
...
//			destructible_state( tag, "vehicle_80s_hatch1_" + color + "_hood_dam" );
		...
		*/
		...
		// Glass ( Front )
		tag = "tag_glass_front";
		destructible_part( tag, "vehicle_80s_hatch1_glass_F", 20 );
			destructible_state( tag+"_d", "vehicle_80s_hatch1_glass_F_dam", 200 );
			destructible_fx( "tag_glass_front_fx", "props/car_glass_large" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Back )
		tag = "tag_glass_back";
		destructible_part( tag, "vehicle_80s_hatch1_glass_B", 20 );
			destructible_state( tag+"_d", "vehicle_80s_hatch1_glass_B_dam", 200 );
			destructible_fx( "tag_glass_back_fx", "props/car_glass_large" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Left Front )
		...
		destructible_part( tag, "vehicle_80s_hatch1_glass_LF", 20 );
			destructible_state( tag+"_d", "vehicle_80s_hatch1_glass_LF_dam", 200 );
			destructible_fx( "tag_glass_left_front_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Right Front )
		...
		destructible_part( tag, "vehicle_80s_hatch1_glass_RF", 20 );
			destructible_state( tag+"_d", "vehicle_80s_hatch1_glass_RF_dam", 200 );
			destructible_fx( "tag_glass_right_front_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Left Back )
		...
		destructible_part( tag, "vehicle_80s_hatch1_glass_LB", 20 );
			destructible_state( tag+"_d", "vehicle_80s_hatch1_glass_LB_dam", 200 );
			destructible_fx( "tag_glass_left_back_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Right Back )
		...
		destructible_part( tag, "vehicle_80s_hatch1_glass_RB", 20 );
			destructible_state( tag+"_d", "vehicle_80s_hatch1_glass_RB_dam", 200 );
			destructible_fx( "tag_glass_right_back_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Head Light ( Left )
...
vehicle_small_wagon( color )
{
	...
	// small wagon
	//---------------------------------------------------------------------
	destructible_create( "vehicle_small_wagon_" + color, 550, undefined, 32, "no_melee" );
				destructible_loopfx( "tag_hood_fx", "smoke/car_damage_whitesmoke", 0.4 );
...
//			destructible_state( tag, "vehicle_small_wagon_" + color + "_hood_dam" );
		...
		*/
		...
		// Glass ( Front )
		tag = "tag_glass_front";
		destructible_part( tag, "vehicle_small_wagon_glass_F", 20 );
			destructible_state( tag+"_d", "vehicle_small_wagon_glass_F_dam", 200 );
			destructible_fx( "tag_glass_front_fx", "props/car_glass_large" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Back )
		tag = "tag_glass_back";
		destructible_part( tag, "vehicle_small_wagon_glass_B", 20 );
			destructible_state( tag+"_d", "vehicle_small_wagon_glass_B_dam", 200 );
			destructible_fx( "tag_glass_back_fx", "props/car_glass_large" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Left Front )
		...
		destructible_part( tag, "vehicle_small_wagon_glass_LF", 20 );
			destructible_state( tag+"_d", "vehicle_small_wagon_glass_LF_dam", 200 );
			destructible_fx( "tag_glass_left_front_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Right Front )
		...
		destructible_part( tag, "vehicle_small_wagon_glass_LB", 20 );
			destructible_state( tag+"_d", "vehicle_small_wagon_glass_LB_dam", 200 );
			destructible_fx( "tag_glass_left_back_fx", "props/car_glass_med" );
			destructible_sound( "veh_glass_break_large" );
			destructible_state( undefined );
		// Glass ( Right Back )
...
vehicle_small_hatch( color )
{
	...
	// small hatch
	//---------------------------------------------------------------------
	destructible_create( "vehicle_small_hatch_" + color, 550, undefined, 32, "no_melee" );
				destructible_loopfx( "tag_hood_fx", "smoke/car_damage_whitesmoke", 0.4 );
...
//			destructible_state( tag, "vehicle_small_hatch_" + color + "_hood_dam" );
		...
		*/
		...
		// Glass ( Front )
		tag = "tag_glass_front";
		destructible_part( tag, "vehicle_small_hatch_glass_F", 20 );
		...
		// Glass ( Back )
		tag = "tag_glass_back";
		destructible_part( tag, "vehicle_small_hatch_glass_B", 20 );
...
vehicle_80s_hatch2( color )
{
	...
	// 80's hatchback 2
	//---------------------------------------------------------------------
	destructible_create( "vehicle_80s_hatch2_" + color, 550, undefined, 32, "no_melee" );
				destructible_loopfx( "tag_hood_fx", "smoke/car_damage_whitesmoke", 0.4 );
...
//			destructible_state( tag, "vehicle_80s_hatch2_" + color + "_hood_dam" );
		...
		*/
		...
		// Glass ( Front )
		tag = "tag_glass_front";
		destructible_part( tag, "vehicle_80s_hatch2_glass_F", 20 );
		...
		// Glass ( Back )
		tag = "tag_glass_back";
		destructible_part( tag, "vehicle_80s_hatch2_glass_B", 20 );
