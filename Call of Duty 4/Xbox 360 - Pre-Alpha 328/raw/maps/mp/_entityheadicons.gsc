init()
{
	...
	switch( game["allies"] )
	{
		case "marines":
			...
			game["entity_headicon_allies_enemy"] = "headicon_american_enemy";
			break;
		case "sas":
			game["entity_headicon_allies"] = "headicon_american";
			game["entity_headicon_allies_enemy"] = "headicon_american_enemy";
	...
	switch( game["axis"] )
	{
		case "russian":
			...
			game["entity_headicon_axis_enemy"] = "headicon_opfor_enemy";
			break;
		case "arab":
		case "opfor":
			game["entity_headicon_axis"] = "headicon_opfor";
	...
	// for displaying other teams icon in red
	precacheShader( game["entity_headicon_allies_enemy"] );
	precacheShader( game["entity_headicon_axis_enemy"] );	
