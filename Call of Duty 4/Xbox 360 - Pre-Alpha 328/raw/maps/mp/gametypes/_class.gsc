...
cac_getdata()
{
	...
	*/ /*
	...
	for( i = 0; i < 5; i ++ )
	{
		...
		prof_end( "cac_getdata inner 1" );	
		
		prof_begin( "cac_getdata inner 2" );
		...
		*/
		...
		prof_end ( "cac_getdata inner 2" );
		
		prof_begin( "cac_getdata inner 4" );	
		...
		*/
		...
		prof_end( "cac_getdata inner 4" );	
	}
	prof_end( "cac_getdata" );
}
