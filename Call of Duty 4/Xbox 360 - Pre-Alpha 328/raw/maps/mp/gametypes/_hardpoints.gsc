...
//	bomb hide();
	...
	for( i = 0; i < repeat; i++ )
	{
		...
		losRadiusDamage( traceHit + (0,0,16), 512, 200, 30, owner ); // targetpos, radius, maxdamage, mindamage, player causing damage
	...
	for ( ;; )
	{
		...
		switch( currentWeapon )
		{
			...
			case "helicopter_mp":
				...
				{
					self iPrintLnBold( level.hardpointHints[currentWeapon+"_not_available"] );
				}
