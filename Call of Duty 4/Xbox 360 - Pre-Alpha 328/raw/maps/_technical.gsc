...
//	build_deathfx( "explosions/ammo_cookoff",					"tag_fx_bed",			undefined,			undefined,			undefined,		undefined,		1 );
	...
	build_deathfx( "fire/firelp_med_pm",						"tag_fx_cab",			"smallfire",		undefined,			undefined,		true,			3.01 );
...
//	positions[ 1 ].deathscript = ::deleteme;
	...
	positions[ 0 ].explosion_death_ragdollfraction = .5;
	positions[ 1 ].explosion_death_ragdollfraction = .5;
	positions[ 2 ].explosion_death_ragdollfraction = .5;
