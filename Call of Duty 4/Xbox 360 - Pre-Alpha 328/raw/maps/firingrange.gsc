...
main()
{
	...
	level.player SetActionSlot( 3, "weapon", "c4" );
...
weaponslots()
{
	...
	weaponslots = weaponadd("m4_silencer_acog",weaponslots);
	...
	weaponslots = weaponadd("m4m203_silencer_reflex",weaponslots);
	...
	weaponslots = weaponadd("stinger",weaponslots);
	...
	weaponslots = weaponadd("p90",weaponslots);
	...
	weaponslots = weaponadd("remington700",weaponslots);
	weaponslots = weaponadd("usp",weaponslots);
	weaponslots = weaponadd("uzi",weaponslots);
	weaponslots = weaponadd("uzi_sd",weaponslots);
	...
	weaponslots = weaponadd("p90_silencer",weaponslots);
	...
	weaponslots = weaponadd("javelin",weaponslots);
	weaponslots = weaponadd("barrett",weaponslots);
	return weaponslots;
}
