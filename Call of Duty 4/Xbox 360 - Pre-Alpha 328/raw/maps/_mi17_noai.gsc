...
main( model, type, no_death )
{
	...
	if ( !isdefined( no_death ) )
	{
		...
		build_deathfx( "explosions/aerial_explosion" , 		"tag_engine_right", "mi17_helicopter_hit", 				undefined, 			undefined, 		undefined, 		2.5, 		true );
		build_deathfx( "explosions/aerial_explosion" , 		"tag_deathfx", 		"mi17_helicopter_hit", 		 		undefined, 			undefined, 		undefined, 		4.0 );
		build_deathfx( mi17_death_fx[ model ], 		 					undefined, 			"mi17_helicopter_crash", 			undefined, 			undefined, 		undefined, 		8.5, 		undefined, 	"stop_crash_loop_sound" );
	}
	else
	{
