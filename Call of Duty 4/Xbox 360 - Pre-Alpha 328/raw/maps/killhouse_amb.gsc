...
main()
{
	...
	ambientEvent("mountains", "elm_insect_fly", 3.0);
	ambientEvent("mountains", "elm_helicopter_flyover_med",	1.0);
	ambientEvent("mountains", "elm_jet_flyover_med",	2.0);
	ambientEvent("mountains", "elm_jet_flyover_dist",	2.0);
