...
main( model, type )
{
	...
	build_deathmodel( "vehicle_bmp_woodland_low", "vehicle_bmp_woodland_dsty" );
	build_deathmodel( "vehicle_bmp_desert", "vehicle_bmp_desert_dsty" );
	...
	bmp_death_fx[ "vehicle_bmp_woodland_low" ] = "explosions/vehicle_explosion_bmp";
	...
	bmp_death_fx[ "vehicle_bmp_low" ] = "explosions/large_vehicle_explosion";
