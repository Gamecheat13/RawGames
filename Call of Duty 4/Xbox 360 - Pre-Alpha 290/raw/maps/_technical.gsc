...
main( model, type )
{
	...
	build_deathmodel( "vehicle_pickup_technical", "vehicle_pickup_technical_destroyed", 0 );
	...
	build_deathfx( "explosions/ammo_cookoff",				"tag_guy2",				undefined,			undefined,			undefined,		undefined,		1 );
	build_deathfx( "explosions/ammo_cookoff",				"tag_guy0",				undefined,			undefined,			undefined,		undefined,		2 );
	...
	build_radiusdamage( ( 0, 0, 53 ), 512, 300, 20, true );
}
