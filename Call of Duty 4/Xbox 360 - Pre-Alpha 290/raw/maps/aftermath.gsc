...
radiation_death()
{
	...
	wait .2;
	VisionSetNaked( "aftermath_pain", 0 );
	...
	VisionSetNaked( "aftermath_glow", 6 );
	wait 3;
	...
	setdvar( "ui_hud_showstanceicon", "" );
	missionsuccess( "village_assault", false );
}
...
player_heartbeat()
{
	...
	while( true )
	{
		...
		heart_delay = (50/level.player_speed) * (50/level.player_speed) * 0.4;
...
player_wakeup()
{
	...
	VisionSetNaked( "aftermath_glow", 0 );
	level.player setstance( "prone" );
...
fall()
{
	...
	level.player shellshock( "radiation_high", 3);
