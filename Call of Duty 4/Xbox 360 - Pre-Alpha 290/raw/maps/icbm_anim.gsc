...
main()
{
	...
	level.scr_sound[ "gm5" ][ "treelineS" ]				= "icbm_gm5_treelineS";	
	...
	level.scr_sound[ "generic" ][ "griggsnothere" ]				= "icbm_gm1_griggsnothere";	
	...
	level.scr_sound[ "price" ][ "keepquiet" ]				= "icbm_pri_keepquiet";

	//Price - Suns coming up. We’re running out of time.
	level.scr_sound[ "price" ][ "sunsup" ]				= "icbm_pri_sunsup";
		
	//Price - We need to blow up that power tower so second squad can breach the electric perimeter fence.
	level.scr_sound[ "price" ][ "blowuptower" ]				= "icbm_pri_blowuptower";
...
anims()
{
	...
	KNIFE KILL SEQUENCE
	-------------------------*/	
	level.scr_anim[ "price" ][ "knifekill_mark" ]			= %parabolic_knifekill_mark;
...
tower_explode_anims()
{
	...
	level.scr_anim[ "wire" ][ "explosion" ]			= %ICBM_power_tower_wire_LE1;
