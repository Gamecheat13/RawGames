...
stealth_ai()
{
	assertex( isdefined( level._stealth ), "call maps\_stealth::main() before calling stealth_ai()" );
	switch( self.team )
	{
		case "allies":
			self thread maps\_stealth::AIStealthDetection();
			break;
		case "axis":
			self thread maps\_stealth::enemy_stealth_logic();
			break;
	}		
}
...
function_stack( func, param1, param2, param3, param4 )
{
	...
	localentity waittill("function_done");
}
