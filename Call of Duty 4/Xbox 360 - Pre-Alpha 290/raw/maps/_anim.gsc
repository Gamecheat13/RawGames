...
anim_custom_animmode_on_guy( guy, custom_animmode, anime, org, angles, animname_override )
{
	...
	assertEx( isdefined( animname ), "Animating character of type " + guy.classname + " has no animname." );
	assertEx( isdefined( level.scr_anim[ animname ][ anime ] ), "Guy with animname " + animname + " is trying to do scene " + anime + " but level.scr_anim[ " + animname + " ][ " + anime + " ] does not exist!" );
