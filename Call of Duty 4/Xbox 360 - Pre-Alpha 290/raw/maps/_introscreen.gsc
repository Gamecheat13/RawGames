...
launchfacility_a_intro()
{
	...
	lines[ lines.size ] = "Day 06 – 0700 hrs";
	lines[ lines.size ] = "Altay Mountains, Russia";
	lines[ lines.size ] = "Player name: TBD";
	lines[ lines.size ] = "22nd SAS Regiment";
...
airlift_intro()
{
	...
	lines[ lines.size ] = "Day 03 – 1800 hrs";
	lines[ lines.size ] = "Player name: TBD";
...
bog_intro()
{
	...
	else if ( level.script == "bog_b" )
	{
		...
		lines[ lines.size ] = &"BOG_B_INTROSCREEN_LINE_2";	//"Day 3 – 1630 hrs"
...
ac130_intro()
{
	...
	lines[ lines.size ] = &"AC130_INTROSCREEN_LINE_3";	//"2200 Hours"
