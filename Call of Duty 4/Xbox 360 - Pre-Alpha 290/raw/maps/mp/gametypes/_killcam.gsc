...
)
{
	...
	*/
	...
	if(!level.splitscreen)
	{
		...
		if(!isdefined(self.kc_perk1))
		{
			self.kc_perk1 = createIcon( "white", 48, 48 );
			self.kc_perk1 setPoint( "BOTTOM", undefined, -140, -20 );
			self.kc_perk1.archived = false;
			self.kc_perk1.foreground = true;
		}		
		self.kc_perk1.alpha = 1;
		self.kc_perk1 setShader( level.perkIcons[perks[0]], 48, 48 );

		if(!isdefined(self.kc_perk1name))
		{
			self.kc_perk1name = createFontString( "default", 1.4 );
			self.kc_perk1name setPoint( "BOTTOM", undefined, -140, -10 );
			self.kc_perk1name.archived = false;
			self.kc_perk1name.foreground = true;
		}
		self.kc_perk1name.alpha = 1;
		self.kc_perk1name setText( level.perkNames[perks[0]] );

		if(!isdefined(self.kc_perk2))
		{
			self.kc_perk2 = createIcon( "white", 48, 48 );
			self.kc_perk2 setPoint( "BOTTOM", undefined, 0, -20 );
			self.kc_perk2.archived = false;
			self.kc_perk2.foreground = true;

		}		
		self.kc_perk2.alpha = 1;
		self.kc_perk2 setShader( level.perkIcons[perks[1]], 48, 48 );

		if(!isdefined(self.kc_perk2name))
		{
			self.kc_perk2name = createFontString( "default", 1.4 );
			self.kc_perk2name setPoint( "BOTTOM", undefined, 0, -10 );
			self.kc_perk2name.archived = false;
			self.kc_perk2name.foreground = true;
		}
		self.kc_perk2name.alpha = 1;
		self.kc_perk2name setText( level.perkNames[perks[1]] );


		if(!isdefined(self.kc_perk3))
		{
			self.kc_perk3 = createIcon( "white", 48, 48 );
			self.kc_perk3 setPoint( "BOTTOM", undefined, 140, -20 );
			self.kc_perk3.archived = false;
			self.kc_perk3.foreground = true;
		}		
		self.kc_perk3.alpha = 1;
		self.kc_perk3 setShader( level.perkIcons[perks[2]], 48, 48 );

		if(!isdefined(self.kc_perk3name))
		{
			self.kc_perk3name = createFontString( "default", 1.4 );
			self.kc_perk3name setPoint( "BOTTOM", undefined, 140, -10 );
			self.kc_perk3name.archived = false;
			self.kc_perk3name.foreground = true;
		}
		self.kc_perk3name.alpha = 1;
		self.kc_perk3name setText( level.perkNames[perks[2]] );
	}
...
endKillcam()
{
	...
	if(isDefined(self.kc_perk1))
		self.kc_perk1.alpha = 0;
	if(isDefined(self.kc_perk2))
		self.kc_perk2.alpha = 0;
	if(isDefined(self.kc_perk3))
		self.kc_perk3.alpha = 0;
	if(isDefined(self.kc_perk1name))
		self.kc_perk1name.alpha = 0;
	if(isDefined(self.kc_perk2name))
		self.kc_perk2name.alpha = 0;
	if(isDefined(self.kc_perk3name))
		self.kc_perk3name.alpha = 0;
