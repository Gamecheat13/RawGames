...
upgradeHardpointItem()
{
	...
	hardpointType = getNextHardpointItem( self.hardpointItem );

	if ( isDefined( self.hardpointItem ) && level.hardpointItems[hardpointType] < level.hardpointItems[self.hardPointItem] )
		return;
	...
	for ( ;; )
	{
		...
		switch( currentWeapon )
		{
			...
			case "helicopter_mp":
				...
				{	
					self thread maps\mp\gametypes\_missions::useHardpoint( self.hardPointItem );
