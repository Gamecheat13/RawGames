...
get_node_funcs_based_on_target( node, goal_type )
{
	...
	get_target_func[ true ] = ::get_target_ents;
	get_target_func[ false ] = ::get_target_nodes;
	set_goal_func_quits[ true ] = ::go_to_node_set_goal_pos;
	set_goal_func_quits[ false ] = ::go_to_node_set_goal_node;
...
go_to_node( node, goal_type )
{
	...
	go_to_node_using_funcs( array[ "node" ], array[ "get_target_func" ], array[ "set_goal_func_quits" ] );
}

go_to_node_using_funcs( node, get_target_func, set_goal_func_quits )
{
...
camper_trigger_think( trigger )
{
	...
	array_thread( spawners, ::add_spawn_function, ::set_goalradius, 8 );
