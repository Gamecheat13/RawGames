...
overlay()
{
	...
	level.hud_weapon_text[ 0 ].foreground = true;
	...
	level.hud_weapon_text[ 1 ].foreground = true;
	...
	level.hud_weapon_text[ 2 ].foreground = true;
...
attachPlayer()
{
	...
	//SetSavedDvar( "ui_hud_showstanceicon", 0 );
}
...
changeWeapons()
{
	...
	for(;;)
	{
		...
		level.player thread play_sound_on_entity( "truck_door_open" );
	}
}
