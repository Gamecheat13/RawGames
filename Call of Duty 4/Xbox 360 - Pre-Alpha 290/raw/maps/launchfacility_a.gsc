...
music_end()
{
	...
	//thread dialogue_loudspeaker("launchfacility_a_rul_avengefallen");
}
...
container_heli_sequence()
{
	...
	level.friendly_at4 attach("weapon_AT4", "TAG_INHAND");
	...
	level.friendly_at4 detach("weapon_AT4", "TAG_INHAND");
...
saw_sparks()
{
	...
	while( true )
	{
	playfxontag( getfx("saw_sparks"), self, "TAG_INHAND");
		wait (.1);
	}
}
...
friendly_vent_think( aTeam, sNumber, eVent )
{
	...
	/*-----------------------
	DO RAPPEL IDLE UNTIL VENT IS OPEN
	-------------------------*/		
