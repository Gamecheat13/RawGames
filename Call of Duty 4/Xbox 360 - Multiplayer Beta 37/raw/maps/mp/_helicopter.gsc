...
heli_update_global_dvars()
{
	for( ;; )
	{
		...
		level.heli_armor_bulletdamage = heli_get_dvar( "scr_heli_armor_bulletdamage", "0.15" );			// damage multiplier to bullets onto helicopter's armor
		
		level.heli_attract_strength = heli_get_dvar( "scr_heli_attract_strength", "2000" );		
		level.heli_attract_range = heli_get_dvar( "scr_heli_attract_range", "1024" );		
