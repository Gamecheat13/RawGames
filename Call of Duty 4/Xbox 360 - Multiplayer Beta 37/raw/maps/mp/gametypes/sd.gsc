...
onStartGameType()
{
	...
	maps\mp\gametypes\_rank::registerScoreInfo( "win", 2, &"MP_WIN" );
	maps\mp\gametypes\_rank::registerScoreInfo( "loss", 1, &"MP_LOSS" );
	maps\mp\gametypes\_rank::registerScoreInfo( "tie", 1.5, &"MP_TIE" );
	
	maps\mp\gametypes\_rank::registerScoreInfo( "kill", 50, &"MP_KILL" );
	maps\mp\gametypes\_rank::registerScoreInfo( "headshot", 50, &"MP_HEADSHOT" );
	maps\mp\gametypes\_rank::registerScoreInfo( "assist", 25, &"MP_ASSIST" );
...
bombs()
{
	...
	if ( !level.multiBomb )
	{
		...
		level.sdBomb maps\mp\gametypes\_gameobjects::setHeadIcon( "friendly", "waypoint_bomb_headicon" );
...
onBeginUse( player )
{
	// TODO: new bomb prep sound:
	//mp_prep_suitcase_bomb_plr
	//mp_prep_suitcase_bomb_npc
...
bombPlanted( destroyedObj, player )
{
	...
	defuseObject maps\mp\gametypes\_gameobjects::setUseTime( level.plantTime );
