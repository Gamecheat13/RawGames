...
updateDevSettings()
{
	...
	if ( getDvar( "scr_set_level" ) != "" )
	{
		...
		newRank = min( getDvarInt( "scr_set_level" ), 55 );
	...
	{
		level.players[0] maps\mp\gametypes\_hud_message::oldNotifyMessage( getDvar( "scr_do_notify" ), getDvar( "scr_do_notify" ), game["icons"]["allies"] );
