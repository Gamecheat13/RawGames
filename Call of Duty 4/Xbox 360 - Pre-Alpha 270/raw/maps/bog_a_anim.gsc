...
main()
{
	...
	addNotetrack_sound( "price", "dialog", "tank_is_stuck", "bog_gm1_halfaclick" );
...
//	level.scr_anim[ "price" ][ "javelin_take" ]					= %bog_javelin_dialogue_takejavelin;
	...
	level.scr_sound[ "price" ][ "get_jav" ] 						= "bog_pri_carverpickupjavelin";

	// Carver! Pick up the Javelin and get to the second floor!! Move!!!
	level.scr_sound[ "price" ][ "jav_reminder_1" ] 					= "bog_pri_javelinsecondfloormove";

	// Carver! Get to the second floor and take out those APCs!
	level.scr_sound[ "price" ][ "jav_reminder_2" ] 					= "bog_pri_carversecondfloor";
...
*/
	...
	level.scr_sound[ "guy_one" ][ "tank_is_stuck" ]						= "bog_gm1_halfaclick";
	...
	level.scr_sound[ "price" ][ "switch_to_night_vision" ]				= "bog_pri_contactright";
	...
	level.scr_sound[ "price" ][ "suppress_building" ]					= "bog_pri_suppressionbuilding";
	
	// Keep moving forward!
	level.scr_sound[ "price" ][ "keep_moving" ]							= "bog_pri_keepforward";
	
	// Alpha, let’s take the stairs and hit their flank! Bravo, give us covering fire!
	level.scr_sound[ "price" ][ "take_the_stairs" ]						= "bog_pri_alphatakestairs";
	
	// Let’s go Carver, follow me!
	level.scr_sound[ "price" ][ "follow_me" ]							= "bog_pri_letsgocarver";
	
	// Come on Carver, move it!
	level.scr_sound[ "price" ][ "move_it" ]								= "bog_pri_comeoncarver";
	
	// Carver! This way!
	level.scr_sound[ "price" ][ "this_way" ]							= "bog_pri_carverthisway";
	
	// Carver, you and Roycewicz head upstairs. We’ll cover this entrance. Go!
	level.scr_sound[ "price" ][ "head_upstairs" ]						= "bog_pri_carverheadupstairs";
	
	
	// Hit their flank with their machine gun!
	level.scr_sound[ "price" ][ "hit_their_flank" ]						= "bog_pri_hittheirflank";
	
	// Carver, use their machine gun!
	level.scr_sound[ "price" ][ "use_their_gun" ]						= "bog_pri_usemachinegun";
	
	// Cut ‘em down!! Shoot ‘em through the wall!!!
	level.scr_sound[ "price" ][ "shoot_through_wall" ]					= "bog_pri_cutemdown";
	
	// Good job!
	level.scr_sound[ "price" ][ "good_job" ]							= "bog_pri_goodjob";

	// All right let’s move out!
	level.scr_sound[ "price" ][ "move_out" ]							= "bog_pri_letsmoveout";


	// Squad! This way! Let's go!! We'll flank them from the right!
	level.scr_sound[ "price" ][ "flank_right" ]							= "bog_pri_squadthisway";

	// Carver! Paulsen! Secure the upper floors! We'll give you covering fire! Move!!!
	level.scr_sound[ "price" ][ "secure_the_upper_floors" ]				= "bog_pri_gowithsgtpaulsen";
	...
	level.scr_sound[ "price" ][ "working_on_it" ]						= "bog_pri_workingonit";
	...
	// Squad regroup!
	level.scr_sound[ "price" ][ "squad_regroup" ]						= "bog_pri_squadregroup";

	// Contact on the overpass!
	level.scr_sound[ "guy_one" ][ "contact_overpass" ]					= "bog_gm1_contactoverpass";

	// Carver, Rusedski, get on the roof! Go!
	level.scr_sound[ "price" ][ "get_on_the_roof" ]						= "bog_pri_skigettoroof";

	// Carver! I've got the Javelin! Let's go!
	level.scr_sound[ "guy_two" ][ "got_the_javelin"	]					= "bog_gm2_ivegotjavelin";
	
	// Carver! Pick up the Javelin! Get to the second floor and take out those APCs!!
	level.scr_sound[ "price" ][ "pickup_hint_1" ]						= "bog_pri_carverpickupjavelin";
	
	// Carver! Pick up the Javelin and get to the second floor!! Move!!!
	level.scr_sound[ "price" ][ "pickup_hint_2" ]						= "bog_pri_javelinsecondfloormove";
	
	// Carver! Get to the second floor and take out those APCs!
	level.scr_sound[ "price" ][ "second_floor_hint_1" ]					= "bog_pri_carversecondfloor";
	
	// APCs at the far end of the bridge! Carver! Take ‘em out with the Javelin!!
	level.scr_sound[ "price" ][ "second_floor_hint_2" ]					= "bog_gm1_apcbridge";
	
	// Hit those vehicles at the far end of the bridge! Hurry!
	level.scr_sound[ "price" ][ "second_floor_hint_3" ]					= "bog_gm1_vehiclesbridge";
	...
	// Thanks Carver
	level.scr_sound[ "paulsen" ][ "thanks_carver" ]						= "bog_pls_thankscarver";
	...
	level.scr_sound[ "price" ][ "shut_up" ]								= "bog_pri_shutup";
	...
	// Shifting fire!
	level.scr_radio[ "shifting_fire" ]						= "bog_gm1_shiftingfire";
	...
	level.scr_radio[ "coming_from_south" ]					= "bog_pri_cominginfromsouth";
	...
	level.scr_sound[ "price" ][ "almost_there" ]					= "bog_pri_almostthere";
	...
	// This way let’s go!
	level.scr_sound[ "price" ][ "this_way" ]						= "bog_pri_thiswayletsgo";
