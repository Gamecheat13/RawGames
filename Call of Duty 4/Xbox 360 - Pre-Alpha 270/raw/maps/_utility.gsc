...
fileprint_end()
{
	...
	if(saved != 1)
	{
		...
		println(" ");
		println("-----------------------------------");
		assertmsg( "File not saved( see console.log for info ) " );
	}
...
{
	assertex( isdefined( level.scr_generic_anim[ anime ] ), "Generic anim " + anime + " was not defined in your _anim file." );
	return level.scr_generic_anim[ anime ];
}
