...
GetBestJavelinTarget()
{
	...
	for ( idx = 0; idx < targetsAll.size; idx++ )
	{
		...
		target_setOffscreenShader( targetsAll[idx], "veh_hud_target_offscreen" );
	}
...
init()
{
	...
	setsaveddvar( "vehHudTargetScreenEdgeClampBufferX", 112 );
	setsaveddvar( "vehHudTargetScreenEdgeClampBufferY", 130 );	
