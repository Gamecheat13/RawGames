...
kill_enemies()
{
	kill_enemies = getent( "kill_enemies", "targetname" );

	kill_enemies waittill( "trigger" );
...
reinforcements_think()
{
	...
	reinforcement_dialog[ 3 ] = "armada_gm5_watchyourfire"; //"Watch your fire! Friendlies coming up!"
