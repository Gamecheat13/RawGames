...
//	maps\_blackhawk::main( "vehicle_blackhawk_low" );
	...
	add_hint_string( "disable_nvg", &"SCRIPT_NIGHTVISION_STOP_USE", maps\_nightvision::should_show_disable_nvg_print );
	thread do_in_order( ::flag_wait, "player_enters_laundrymat", ::display_hint, "disable_nvg" );
...
//	bridge_go_trigger wait_for_trigger_or_timeout( 3.5 ); // 3.8
	...
	objective_add( 2, "active", "Eliminate enemy forces in the apartment.", level.balcony_objective_org );
	objective_current( 2 );
...
//		badGuys[ i ] setFlashBanged( true, 1 );
	...
	if ( isalive( right_guy ) )
		right_guy set_force_color( "g" );
		
	if ( isalive( left_guy ) )
		left_guy set_force_color( "g" );
}	
