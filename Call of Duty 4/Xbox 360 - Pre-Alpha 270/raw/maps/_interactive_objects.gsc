...
glass_logic()
{
	...
	if ( isdefined( self.script_linkTo ) )
	{
		...
		ent = getent( links[0], "script_linkname" );
		self linkto(ent);
	}
	...
	if ( isdefined(cracked ) )
	{
		...
		{
			cracked waittill("damage", damage, other, direction_vec, point, damageType, modelName, tagName );
			if ( damageType == "MOD_GRENADE_SPLASH" )
				damage = damage * 1.75;
			if ( damageType == "MOD_IMPACT" )
				break;
