...
setPlayerModels()
{
	...
	if ( !isDefined( game["allies_soldiertype"] ) )
		game["allies_soldiertype"] = "desert";

	if ( !isDefined( game["axis_soldiertype"] ) )
	...
	else
	{
		...
		game["allies_model"]["CLASS_CLOSEQUARTERS"] = mptype\mptype_ally_woodland_recon::main;
		game["allies_model"]["CLASS_ASSAULT"] = mptype\mptype_ally_woodland_assault::main;
		game["allies_model"]["CLASS_SNIPER"] = mptype\mptype_ally_woodland_sniper::main;
		game["allies_model"]["CLASS_ENGINEER"] = mptype\mptype_ally_woodland_specops::main;
		game["allies_model"]["CLASS_ANTIARMOR"] = mptype\mptype_ally_woodland_specops::main;
		game["allies_model"]["CLASS_SUPPORT"] = mptype\mptype_ally_woodland_support::main;
	...
	if ( game["axis_soldiertype"] == "desert" )
	{
		...
		game["axis_model"]["CLASS_ASSAULT"] = mptype\mptype_axis_rifleman::main;
		...
		game["axis_model"]["CLASS_ANTIARMOR"] = mptype\mptype_axis_engineer::main;
	...
	else
	{
		...
		game["axis_model"]["CLASS_CLOSEQUARTERS"] = mptype\mptype_axis_woodland_cqb::main;
		game["axis_model"]["CLASS_ASSAULT"] = mptype\mptype_axis_woodland_rifleman::main;
		game["axis_model"]["CLASS_SNIPER"] = mptype\mptype_axis_woodland_sniper::main;
		game["axis_model"]["CLASS_ENGINEER"] = mptype\mptype_axis_woodland_engineer::main;
		game["axis_model"]["CLASS_ANTIARMOR"] = mptype\mptype_axis_woodland_engineer::main;
		game["axis_model"]["CLASS_SUPPORT"] = mptype\mptype_axis_woodland_support::main;
