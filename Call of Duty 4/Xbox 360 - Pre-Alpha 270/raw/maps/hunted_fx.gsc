...

{
	...
	{
		level._effect["spotlight"] = loadfx ("hunted/hunted_spotlight");
		level._effect["spotlight_dust"] = loadfx ("hunted/hunted_dust");
		level._effect["spotlight_cloud"] = loadfx ("hunted/hunted_cloud");
	}

	level.flare_fx["mi17"] 							= loadfx( "misc/flares_cobra" );

	// tmp exlosions for the gas station
	level._effect["big_explosion"]					= loadfx ("explosions/helicopter_explosion_mi17_woodland");
	level._effect["small_explosion"]				= loadfx ("explosions/small_vehicle_explosion");

	level._effect["heli_dlight"]					= loadfx ("misc/aircraft_light_cockpit_blue");
