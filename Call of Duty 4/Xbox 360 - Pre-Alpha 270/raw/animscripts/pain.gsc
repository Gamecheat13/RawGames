...
CornerRightGrenadeDeath()
{
	...
	self magicGrenadeManual( getGrenadeReleasePoint(), (0,0,0), randomfloatrange( 2.0, 3.0 ) );
	wait .05;
...
prematureCornerGrenadeDeath()
{
	...
	self MagicGrenadeManual( getGrenadeReleasePoint(), (0,0,10), 3.0 );
