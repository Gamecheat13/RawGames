...
set_anim_playback_rate()
{
	self.animplaybackrate = 1; // 0.9 + randomfloat( 0.2 );
}
...
//	anim.coverExit["prone_saw"	 ][7] = %saw_gunner_prone_runout_F; // need this anim or a way to exclude it
	...
	anim.coverExitSplit["left"][7] = 0.647;
	anim.coverExitSplit["left"][8] = 0.616;
	anim.coverExitSplit["left_crouch"][7] = 0.765;
	anim.coverExitSplit["left_crouch"][8] = 0.589;
	anim.coverExitSplit["right"][8] = 0.440;
	anim.coverExitSplit["right"][9] = 0.522;
	anim.coverExitSplit["right_crouch"][8] = 0.637;
	anim.coverExitSplit["right_crouch"][9] = 0.637;
	
	anim.coverTransSplit["left"][7] = 0.370;
	anim.coverTransSplit["left"][8] = 0.460;
	anim.coverTransSplit["left_crouch"][7] = 0.277;
	anim.coverTransSplit["left_crouch"][8] = 0.339;
	anim.coverTransSplit["right"][8] = 0.458;
	anim.coverTransSplit["right"][9] = 0.495;
	anim.coverTransSplit["right_crouch"][8] = 0.329;
	anim.coverTransSplit["right_crouch"][9] = 0.349;
	...
	for ( i = 7; i <= 8; i++ )
	{
		...
		/#
		/*FindBestSplitTime( anim.coverTrans["left"       ][i], true , false, "stand left arrival in dir " + i );
		FindBestSplitTime( anim.coverTrans["left_crouch"][i], true , false, "crouch left arrival in dir " + i );
		FindBestSplitTime( anim.coverExit ["left"       ][i], false, false, "stand left exit in dir " + i );
		FindBestSplitTime( anim.coverExit ["left_crouch"][i], false, false, "crouch left exit in dir " + i );*/
	...
	for ( i = 8; i <= 9; i++ )
	{
		...
		/#
		/*FindBestSplitTime( anim.coverTrans["right"       ][i], true , true, "stand right arrival in dir " + i );
		FindBestSplitTime( anim.coverTrans["right_crouch"][i], true , true, "crouch right arrival in dir " + i );
		FindBestSplitTime( anim.coverExit ["right"       ][i], false, true, "stand right exit in dir " + i );
		FindBestSplitTime( anim.coverExit ["right_crouch"][i], false, true, "crouch right exit in dir " + i );*/
...
//		anim.chargeRangeSq = 200*200;
	...
	anim.nextPlayerGrenadeTime = randomIntRange( 1000, 20000 );
	anim.nextAIGrenadeTime = randomIntRange( 0, 20000 );
...
//	anim.set_array_exposed["crouch"] = animscripts\exposed_modern::set_animarray_standing;
	...
	animscripts\shared::setupCQBPointsOfInterest();
