...
main( model, type )
{
	...
	build_deathfx( "explosions/grenadeexp_default" , 	"tag_engine_right", 	"blackhawk_helicopter_hit", 				undefined, 			undefined, 		undefined, 		0.5, 		true );
	build_deathfx( "fire/fire_smoke_trail_L" , 			"tag_engine_right", 	"blackhawk_helicopter_dying_loop", 		true, 				0.05, 			true, 			0.5, 		true );
	...
	build_deathfx( mi17_death_fx[ model ], 		 					undefined, 			"blackhawk_helicopter_crash", 			undefined, 			undefined, 		undefined, 		8.5, 		undefined, 	"stop_crash_loop_sound" );
