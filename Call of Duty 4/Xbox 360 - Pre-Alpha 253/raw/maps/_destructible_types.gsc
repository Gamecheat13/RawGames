...
vehicle_80s_hatch2( color )
{
	...
	destructible_create( "vehicle_80s_hatch2_" + color, 300, undefined, 32, "no_melee" );
		...
		// Tires
		destructible_part( "tag_wheel_left_front", "vehicle_80s_hatch2_" + color + "_wheel_LF", 99, undefined, undefined, "no_melee", undefined, 0.7 );
			destructible_anim( %vehicle_80s_sedan1_flattire_LF, #animtree, "setanim" );
			destructible_sound( "veh_tire_deflate", "bullet" );
		destructible_part( "tag_wheel_left_back", "vehicle_80s_hatch2_" + color + "_wheel_LF", 99, undefined, undefined, "no_melee" );
			destructible_anim( %vehicle_80s_sedan1_flattire_LB, #animtree, "setanim" );
			destructible_sound( "veh_tire_deflate", "bullet" );
		destructible_part( "tag_wheel_right_front", "vehicle_80s_hatch2_" + color + "_wheel_LF", 99, undefined, undefined, "no_melee", undefined, 0.7 );
			destructible_anim( %vehicle_80s_sedan1_flattire_RF, #animtree, "setanim" );
			destructible_sound( "veh_tire_deflate", "bullet" );
		destructible_part( "tag_wheel_right_back", "vehicle_80s_hatch2_" + color + "_wheel_LF", 99, undefined, undefined, "no_melee" );
			destructible_anim( %vehicle_80s_sedan1_flattire_RB, #animtree, "setanim" );
			destructible_sound( "veh_tire_deflate", "bullet" );
		// Doors
