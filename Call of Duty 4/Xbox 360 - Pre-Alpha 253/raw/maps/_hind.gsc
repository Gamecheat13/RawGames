...
main( model, type )
{
	...
	build_deathfx( "explosions/grenadeexp_default" , 	"tail_rotor_jnt", 	"hind_helicopter_hit", 				undefined, 			undefined, 		undefined, 		0.5, 		true );
	build_deathfx( "fire/fire_smoke_trail_L" , 			"tail_rotor_jnt", 	"hind_helicopter_dying_loop", 		true, 				0.05, 			true, 			0.5, 		true );
	build_deathfx( "explosions/aerial_explosion" , 		"tag_engine_right", "hind_helicopter_hit", 				undefined, 			undefined, 		undefined, 		2.5, 		true );
	build_deathfx( "explosions/aerial_explosion" , 		"tag_deathfx", 		"hind_helicopter_hit", 		 		undefined, 			undefined, 		undefined, 		4.0 );
	build_deathfx( hind_death_fx[ model ], 		 					undefined, 			"hind_helicopter_crash", 			undefined, 			undefined, 		undefined, 		8.5, 		undefined, 	"stop_crash_loop_sound" );
	
	build_predeathfx( "explosions/aerial_explosion", 		"tag_deathfx", 		"hind_helicopter_hit" );
	build_predeathfx( "fire/fire_smoke_trail_L", 			"tag_body", 		"hind_helicopter_dying_loop", 		true, 				0.05, 			true, 			0.5, 		true );
