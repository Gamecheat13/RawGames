...
//			destructible_sound( "veh_tire_deflate", "bullet" );
		destructible_part( "tag_wheel_right_front", "vehicle_80s_sedan1_" + color + "_wheel_LF", 99, undefined, undefined, "no_melee", undefined, 0.7 );
//			destructible_anim( %vehicle_80s_sedan1_flattire_RF, #animtree, "setanim" );
//			destructible_sound( "veh_tire_deflate", "bullet" );
		destructible_part( "tag_wheel_right_back", "vehicle_80s_sedan1_" + color + "_wheel_LF", 99, undefined, undefined, "no_melee", undefined, 0.7 );
...
vehicle_80s_sedan1_side( color )
{
	...
	destructible_create( "vehicle_80s_sedan1_" + color + "_side", 300, undefined, 32, "no_melee" );
		...
		destructible_part( tag, "vehicle_80s_sedan1_" + color + "_trunk", 1000, undefined, undefined,  undefined, 1.0 );
			destructible_state( tag, "vehicle_80s_sedan1_" + color + "_trunk_dam", 2000 );
		// Tires
		destructible_part( "tag_wheel_left_front", "vehicle_80s_sedan1_" + color + "_wheel_LF", 99, undefined, undefined, "no_melee", undefined, true );
			destructible_sound( "veh_tire_deflate", "bullet" );
		destructible_part( "tag_wheel_left_back", "vehicle_80s_sedan1_" + color + "_wheel_LF", 99, undefined, undefined, "no_melee", undefined, true );
			destructible_sound( "veh_tire_deflate", "bullet" );
		destructible_part( "tag_wheel_right_front", "vehicle_80s_sedan1_" + color + "_wheel_LF", 99, undefined, undefined, "no_melee" );
			destructible_sound( "veh_tire_deflate", "bullet" );
		destructible_part( "tag_wheel_right_back", "vehicle_80s_sedan1_" + color + "_wheel_LF", 99, undefined, undefined, "no_melee" );
			destructible_sound( "veh_tire_deflate", "bullet" );
		// Doors
		destructible_part( "tag_door_left_front", "vehicle_80s_sedan1_" + color + "_door_LF", undefined, undefined, undefined, undefined, 1.0 );
		destructible_part( "tag_door_left_back", "vehicle_80s_sedan1_" + color + "_door_LB", undefined, undefined, undefined, undefined, 1.0 );
