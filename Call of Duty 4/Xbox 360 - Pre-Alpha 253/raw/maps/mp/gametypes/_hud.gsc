...
init()
{
	...
	level.primaryProgressBarY = -66; // from center
	level.primaryProgressBarHeight = 26; //28; // this is the height and width of the whole progress bar, including the outline. the part that actually moves is 2 pixels smaller.
	level.primaryProgressBarWidth = 192;
	level.primaryProgressBarTextY = -68;
	...
	level.secondaryProgressBarY = -95; //-48; // from bottom
	level.secondaryProgressBarHeight = 26; //28;
	level.secondaryProgressBarWidth = 192;
	level.secondaryProgressBarTextY = -100;
	level.secondaryProgressBarFontSize = 1.65;
