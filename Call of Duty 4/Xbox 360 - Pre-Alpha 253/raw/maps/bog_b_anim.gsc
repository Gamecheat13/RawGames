...
main()
{
	...
	level.scr_anim[ "mgkiller_left" ][ "idle" ][0]		= %breach_kick_stackl1_idle;
	level.scr_anim[ "mgkiller_left" ][ "idle_reach" ]	= %breach_kick_stackl1_idle;
	level.scr_anim[ "mgkiller_left" ][ "enter" ]		= %breach_kick_stackl1_enter;
	level.scr_anim[ "mgkiller_right" ][ "enter" ]		= %breach_kick_kickerr1_enter;
	level.scr_sound[ "mgkiller_right" ][ "enter" ]		= "bog_gm1_breaching";					// "Breaching breaching!"
	addNotetrack_customFunction( "mgkiller_right", "kick", maps\bog_b::mg_killer_doorOpen );
	...
	//level.scr_anim[ "price" ][ "idle" ][0]				= %bog_b_spotter_idle_after;
...
tank_explode_anims()
{
	...
	level.scr_anim[ "tank" ][ "explosion" ]		= %bog_b_tank_explosion;
}
...
dialog()
{
	...
	level.scr_sound[ "tank_commander" ][ "fire1" ]				= "bog_tcm_fire1";
	level.scr_sound[ "tank_commander" ][ "fire2" ]				= "bog_tcm_fire2";
	level.scr_sound[ "tank_commander" ][ "fire3" ]				= "bog_tcm_fire3";
	...
	level.scr_sound[ "grigsby" ][ "staysharp" ]					= "bog_gri_staysharp";					// "They's pullin' back...stay sharp, could be a trap."
	...
	level.scr_sound[ "gm2" ][ "clear" ]							= "bog_gm2_clear";						// "Clear!"
	level.scr_sound[ "gm3" ][ "clear" ]							= "bog_gm3_clear2";						// "Clear!"
