...
onKill = root:AddCallback(
	__OnKill,
	function (context, killingPlayer, killingObject, deadPlayer, deadObject, source, type, modifier, assistingPlayers, weaponAttachments)
		...
		context.WeaponAttachments = weaponAttachments;
	end
	):Filter(
	function (context)
