...
main( model, type, classname )
{
	...
	//build_light( lightmodel, "combined_headlight_suburban", 		"tag_headlight_left", 		"misc/car_headlight_suburban_combined", 		"headlights" );
	//build_light( lightmodel, "headlight_truck_left", 		"tag_headlight_left", 		"misc/car_headlight_suburban_l", 		"headlights" );
	//build_light( lightmodel, "headlight_truck_right", 		"tag_light_right_front", 		"misc/car_headlight_suburban_r", 		"headlights" );
	//build_light( lightmodel, "combined_taillight_suburban", 		"tag_tail_light_left", 		"misc/car_taillight_suburban_combined", 		"taillights" );
	//build_light( lightmodel, "taillight_truck_left", 		"tag_tail_light_left", 		"misc/car_taillight_suburban_l", 		"taillights" );
	//build_light( lightmodel, "taillight_truck_right", 	 	"tag_tail_light_right", 	"misc/car_taillight_suburban_r", 		"taillights" );
