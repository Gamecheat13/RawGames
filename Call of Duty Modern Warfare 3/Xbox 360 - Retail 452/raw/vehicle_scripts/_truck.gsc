...
vehicle_scripts\_truck::main( "vehicle_opfor_truck", undefined, "script_vehicle_opfor_truck" );
...
vehicle_scripts\_truck::main( "vehicle_pickup_roobars", "truck_physics", "script_vehicle_pickup_roobars_physics" );
