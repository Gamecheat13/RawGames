...
/*QUAKED script_vehicle_mi28_flying (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER
...
include,vehicle_mi28_flying_mi28
...
/*QUAKED script_vehicle_mi28_flying_low (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER

This will be added to your precache script when compile with Repackage Zone/Script:

vehicle_scripts\_mi28::main( "vehicle_mi-28_flying_low", undefined, "script_vehicle_mi28_flying_low" );

These will be added to your levels CSV when compile with Repackage Zone/Script:

include,vehicle_mi28_flying_mi28_low
sound,vehicle_havoc,vehicle_standard,all_sp
