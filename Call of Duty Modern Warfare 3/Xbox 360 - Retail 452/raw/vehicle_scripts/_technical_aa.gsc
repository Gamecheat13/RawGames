...
main( type_override, classname )
{
	model = "vehicle_aa_truck";
	
	build_template( "aa_truck", model, type_override, classname );
	build_localinit( ::init_local );
	build_deathmodel( "vehicle_pickup_technical", "vehicle_pickup_technical_destroyed", 3 );
	
	build_turret( "aa_turret", "tag_aagun", "weapon_aa_gun", undefined, "auto_ai", 0.5, 20, -14 );
...
/*QUAKED script_vehicle_pickup_technical_aa (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER
...
include,vehicle_pickup_technical_aa
sound,vehicle_pickup,vehicle_standard,all_sp
sound,vehicle_car_exp,vehicle_standard,all_sp

defaultmdl="vehicle_aa_truck"
default:"vehicletype" "aa_truck"
default:"script_team" "axis"
*/

/*QUAKED script_vehicle_pickup_technical_aa_physics (1 0 0) (-16 -16 -24) (16 16 32) USABLE SPAWNER

This will be added to your precache script when compile with Repackage Zone/Script:

vehicle_scripts\_technical_aa::main( "aa_truck_physics", "script_vehicle_pickup_technical_aa_physics" );
...
defaultmdl="vehicle_aa_truck"
default:"vehicletype" "aa_truck_physics"
default:"script_team" "axis"
*/
