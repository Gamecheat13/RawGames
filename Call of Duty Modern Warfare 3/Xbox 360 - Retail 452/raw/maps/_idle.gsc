...
create_animation_list()
{
	...
	array[ array.size ] = "smoke_balcony";	// 6
	
	if(IsDefined(level.idle_animation_list_func))
	{
		//Level can choose to add or remove any of these anims
...
{
	// the balcony death guy doesn't go over the railings, so I have to force him to play his death anim
