...
spawnMine( origin, owner, type, angles )
{
	...
	mine thread createBombSquadModel( "projectile_bouncing_betty_grenade_bombsquad", "tag_origin", level.otherTeam[owner.team], owner ); // may have issues with team and owner here
