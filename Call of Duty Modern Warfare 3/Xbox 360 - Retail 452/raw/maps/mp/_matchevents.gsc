...
doHeliInsertion()
{
	...
	{	
		...
		chopper1 = spawnHelicopter( self, rightPos1, startSpawns["allies"][0].angles, "attack_littlebird_mp", "vehicle_little_bird_bench" );	
		chopper2 = spawnHelicopter( self, leftPos1, startSpawns["allies"][0].angles, "attack_littlebird_mp", "vehicle_little_bird_bench" );		
		...
		chopper3 = spawnHelicopter( self, rightPos2, startSpawns["axis"][0].angles, "attack_littlebird_mp", "vehicle_little_bird_bench" );		
		chopper4 = spawnHelicopter( self, leftPos2, startSpawns["axis"][0].angles, "attack_littlebird_mp", "vehicle_little_bird_bench" );
