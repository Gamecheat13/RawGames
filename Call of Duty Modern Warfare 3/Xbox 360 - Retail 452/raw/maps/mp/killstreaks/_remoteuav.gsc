...
setCarryingRemoteUAV( carryRemoteUAV )
{
	...
	self thread carryRemoteUAV_onDisconnect( carryRemoteUAV );
	...
	for ( ;; )
	{
		result = waittill_any_return( "place_carryRemoteUAV", "cancel_carryRemoteUAV", "weapon_switch_started", "force_cancel_placement" );
...
carryRemoteUAV_onDisconnect( carryRemoteUAV )
{
