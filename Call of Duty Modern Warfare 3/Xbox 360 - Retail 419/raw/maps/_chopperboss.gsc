...
CONST_CHOPPER_BOSS_SHOT_COUNT			= 20;	// Alternating shot count 
CONST_CHOPPER_BOSS_SHOT_COUNT_LONG		= 60;	// Alternating shot count for when the helicopter wants to coninuously fire
CONST_CHOPPER_BOSS_WIND_UP_TIME			= 2.0;
CONST_CHOPPER_BOSS_MIN_TARGET_DIST_2D	= 384;	// Chopper does not want to be closer than this to the target
CONST_CHOPPER_BOSS_MAX_TARGET_DIST_2D	= 3072;	// Chopper wants to be closer than this to the target
