...
isEMPed()
{
    ...
    {
    	return ( ( isDefined( level.empPlayer ) && level.empPlayer != self ) || ( isDefined( self.empGrenaded ) && self.empGrenaded ) || ( IsDefined( level.nukeInfo.player ) && self != level.nukeInfo.player ) );
	}
}
